...
#define WEEKEVENTREG_OCEANSIDE_SPIDER_HOUSE_COMPLETE PACK_WEEKEVENTREG_FLAG(13, 0x80)
...
#define WEEKEVENTREG_SWAMP_SPIDERHOUSE_TALKED PACK_WEEKEVENTREG_FLAG(34, 0x08)
