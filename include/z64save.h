...
void Sram_OpenSave(struct FileSelectState* fileChooseCtx, SramContext* sramCtx);
void func_8014546C(SramContext* sramCtx);
void func_801457CC(struct FileSelectState* fileChooseCtx, SramContext* sramCtx);
void func_80146580(struct FileSelectState* fileChooseCtx, SramContext* sramCtx, s32 fileNum);
void func_80146628(struct FileSelectState* fileChooseCtx, SramContext* sramCtx);
void Sram_InitSave(struct FileSelectState* fileChooseCtx, SramContext* sramCtx);
