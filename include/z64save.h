...
#define WEEKEVENTREG_60_08 PACK_WEEKEVENTREG_FLAG(60, 0x08) // Seen the mayor's meeting
#define WEEKEVENTREG_60_10 PACK_WEEKEVENTREG_FLAG(60, 0x10) // Completed mayor meeting event
#define WEEKEVENTREG_60_20 PACK_WEEKEVENTREG_FLAG(60, 0x20)
#define WEEKEVENTREG_60_40 PACK_WEEKEVENTREG_FLAG(60, 0x40) // Talked to mayor on final night
