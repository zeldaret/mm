...
// Attached to scene but unused. Entrance cutscene is instead triggered by `ACTOR_OBJ_DEMO`
...
// Entered the prison where the deku princess is kept. Also set in door_warp1.c
