...
#define WEEKEVENTREG_TALKED_TO_TINGLE PACK_WEEKEVENTREG_FLAG(10, 0x01)
...
#define WEEKEVENTREG_BOUGHT_TINGLE_MAP_CLOCK_TOWN PACK_WEEKEVENTREG_FLAG(35, 0x01)
#define WEEKEVENTREG_BOUGHT_TINGLE_MAP_WOODFALL PACK_WEEKEVENTREG_FLAG(35, 0x02)
#define WEEKEVENTREG_BOUGHT_TINGLE_MAP_SNOWHEAD PACK_WEEKEVENTREG_FLAG(35, 0x04)
#define WEEKEVENTREG_BOUGHT_TINGLE_MAP_ROMANI_RANCH PACK_WEEKEVENTREG_FLAG(35, 0x08)
#define WEEKEVENTREG_BOUGHT_TINGLE_MAP_GREAT_BAY PACK_WEEKEVENTREG_FLAG(35, 0x10)
#define WEEKEVENTREG_BOUGHT_TINGLE_MAP_STONE_TOWER PACK_WEEKEVENTREG_FLAG(35, 0x20)
...
#define WEEKEVENTREG_TALKED_TO_WINTER_SHRINE_GORON_A_AS_NONGORON_SON_CRYING PACK_WEEKEVENTREG_FLAG(36, 0x01)
#define WEEKEVENTREG_TALKED_TO_WINTER_SHRINE_GORON_A_AS_GORON_SON_CRYING PACK_WEEKEVENTREG_FLAG(36, 0x02)
#define WEEKEVENTREG_TALKED_TO_WINTER_SHRINE_GORON_A_AS_NONGORON_SON_CALM_CHAND_UNLIT PACK_WEEKEVENTREG_FLAG(36, 0x04)
#define WEEKEVENTREG_TALKED_TO_WINTER_SHRINE_GORON_A_AS_GORON_SON_CALM_CHAND_UNLIT PACK_WEEKEVENTREG_FLAG(36, 0x08)
#define WEEKEVENTREG_TALKED_TO_WINTER_SHRINE_GORON_A_SON_CALM_CHAND_LIT PACK_WEEKEVENTREG_FLAG(36, 0x10)
#define WEEKEVENTREG_TALKED_TO_WINTER_SHRINE_GORON_B_AS_NONGORON_SON_CRYING PACK_WEEKEVENTREG_FLAG(36, 0x20)
#define WEEKEVENTREG_TALKED_TO_WINTER_SHRINE_GORON_B_AS_GORON_SON_CRYING PACK_WEEKEVENTREG_FLAG(36, 0x40)
#define WEEKEVENTREG_TALKED_TO_WINTER_SHRINE_GORON_B_AS_NONGORON_SON_CALM PACK_WEEKEVENTREG_FLAG(36, 0x80)
#define WEEKEVENTREG_TALKED_TO_WINTER_SHRINE_GORON_B_AS_GORON_SON_CALM PACK_WEEKEVENTREG_FLAG(37, 0x01)
#define WEEKEVENTREG_TALKED_TO_WINTER_SHRINE_GORON_C_AS_GORON_SON_CRYING PACK_WEEKEVENTREG_FLAG(37, 0x02)
#define WEEKEVENTREG_TALKED_TO_WINTER_SHRINE_GORON_C_AS_GORON_SON_CALM PACK_WEEKEVENTREG_FLAG(37, 0x04)
...
#define WEEKEVENTREG_TINGLE_KNOWN_PLAYER_FORM_LOW_BIT PACK_WEEKEVENTREG_FLAG(64, 0x08)
#define WEEKEVENTREG_TINGLE_KNOWN_PLAYER_FORM_HIGH_BIT PACK_WEEKEVENTREG_FLAG(64, 0x10)
