...
#define HS_GET_BANK_RUPPEES() (HIGH_SCORE(HS_BANK_RUPPEES) & 0xFFFF)
#define HS_SET_BANK_RUPPEES(ruppees) (HIGH_SCORE(HS_BANK_RUPPEES) = ((HIGH_SCORE(HS_BANK_RUPPEES) & 0xFFFF0000) | (ruppees)))
