...
typedef struct SaveInfo {
    ...
    /* 0xF41 */ u8 scarecrowSpawnSongSet;                            // "oca_rec_flag8"                  scarecrows song set?
...
#define WEEKEVENTREG_BOMBERS_NOTEBOOK_EVENT_MET_MADAOME_AROMA               PACK_WEEKEVENTREG_FLAG(66, 0x80)
...
#define WEEKEVENTREG_BOMBERS_NOTEBOOK_EVENT_MET_GURU_GUGU                   PACK_WEEKEVENTREG_FLAG(68, 0x04)
