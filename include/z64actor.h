...
typedef struct Actor {
    ...
    /* 0x08C */ f32 yDirDistToWater; // Distance to the surface of active waterbox. Negative value means above water
    ...
    /* 0x09C */ f32 yDirDistToPlayer; // Dist is negative if the actor is above the player
