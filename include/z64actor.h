...
#define DYNA_INTERACT_SWITCH_PRESS (1 << 3) // Like the ACTOR_ON_TOP flag but only actors with ACTOR_FLAG_CAN_HOLD_SWITCH
#define DYNA_INTERACT_HEAVY_SWITCH_PRESSED (1 << 4)
