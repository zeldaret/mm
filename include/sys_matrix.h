...
void Matrix_InsertXRotation_f(f32 rotation, s32 mode);
...
void Matrix_InsertYRotation_f(f32 rotation, s32 mode);
void Matrix_RotateZS(s16 rotation, s32 mode);
void Matrix_InsertZRotation_f(f32 rotation, s32 mode);
