...
typedef struct {
    ...
    /* 0x2 */ s16 length;
    /* 0x4 */ s16 csCamSceneDataId; // Index of CsCameraEntry to use. Negative indices use sCsCamSceneDataGlobalSettings. Positive indices index CsCameraEntry from scene
    /* 0x6 */ s16 unk6;
