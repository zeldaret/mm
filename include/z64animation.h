...
typedef s32 (*OverrideCurveLimbDraw)(struct PlayState* play, SkelAnimeCurve* skelCuve, s32 limbIndex,
                                     struct Actor* actor);
typedef void (*PostCurveLimbDraw)(struct PlayState* play, SkelAnimeCurve* skelCuve, s32 limbIndex,
                                  struct Actor* actor);
