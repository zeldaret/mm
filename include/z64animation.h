...
#define LINK_ANIMETION_OFFSET(addr,offset) (((u32)&link_animetion_vrom_start)+((u32)addr & 0xFFFFFF)+((u32)offset))
...
typedef s32 (*OverrideLimbDrawSV)(struct GlobalContext* globalCtx, s32 limbIndex, Gfx** dList,
             Vec3f* pos, Vec3s* rot, struct Actor* actor);

typedef void (*PostLimbDrawSV)(struct GlobalContext* globalCtx, s32 limbIndex, Gfx** dList1,
            Gfx** dList2, Vec3s* rot, struct Actor* actor);
