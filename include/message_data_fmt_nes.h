...
#define CTRL_BANK_INPUT CC
#define CTRL_CD CD
#define CTRL_CE CE
#define CTRL_TIME_UNTIL_MOON_CRASH CF
#define CTRL_DOGGY_RACETRACK_BET_INPUT D0
#define CTRL_BOMBER_CODE_INPUT D1
#define CTRL_D2 D2
#define CTRL_TIME_SPEED D3
#define CTRL_OWL_WARP D4
#define CTRL_LOTTERY_CODE_INPUT D5
...
#define CTRL_POINTS_BOAT_ARCHERY DB
...
#define CTRL_HS_TIMER_BOAT_ARCHERY F3
#define CTRL_HS_TIMER_HORSE_BACK_BALLOON F4
#define CTRL_HS_TIMER_LOTTERY_GUESS F5
...
#define CMD_BANK_INPUT STR(CTRL_BANK_INPUT)
#define CMD_CD STR(CTRL_CD)
#define CMD_CE STR(CTRL_CE)
#define CMD_TIME_UNTIL_MOON_CRASH STR(CTRL_TIME_UNTIL_MOON_CRASH)
#define CMD_DOGGY_RACETRACK_BET_INPUT STR(CTRL_DOGGY_RACETRACK_BET_INPUT)
#define CMD_BOMBER_CODE_INPUT STR(CTRL_BOMBER_CODE_INPUT)
#define CMD_D2 STR(CTRL_D2)
#define CMD_TIME_SPEED STR(CTRL_TIME_SPEED)
#define CMD_OWL_WARP STR(CTRL_OWL_WARP)
#define CMD_LOTTERY_CODE_INPUT STR(CTRL_LOTTERY_CODE_INPUT)
...
#define CMD_HS_TIMER_BOAT_ARCHERY STR(CTRL_HS_TIMER_BOAT_ARCHERY)
#define CMD_HS_TIMER_HORSE_BACK_BALLOON STR(CTRL_HS_TIMER_HORSE_BACK_BALLOON)
#define CMD_HS_TIMER_LOTTERY_GUESS STR(CTRL_HS_TIMER_LOTTERY_GUESS)
...
#define MESSAGE_BANK_INPUT HEX(CTRL_BANK_INPUT)
...
#define MESSAGE_DOGGY_RACETRACK_BET_INPUT HEX(CTRL_DOGGY_RACETRACK_BET_INPUT)
#define MESSAGE_BOMBER_CODE_INPUT HEX(CTRL_BOMBER_CODE_INPUT)
#define MESSAGE_D2 HEX(CTRL_D2)
#define MESSAGE_TIME_SPEED HEX(CTRL_TIME_SPEED)
#define MESSAGE_OWL_WARP HEX(CTRL_OWL_WARP)
#define MESSAGE_LOTTERY_CODE_INPUT HEX(CTRL_LOTTERY_CODE_INPUT)
...
#define MESSAGE_HS_TIMER_BOAT_ARCHERY HEX(CTRL_HS_TIMER_BOAT_ARCHERY)
#define MESSAGE_HS_TIMER_HORSE_BACK_BALLOON HEX(CTRL_HS_TIMER_HORSE_BACK_BALLOON)
#define MESSAGE_HS_TIMER_LOTTERY_GUESS HEX(CTRL_HS_TIMER_LOTTERY_GUESS)
