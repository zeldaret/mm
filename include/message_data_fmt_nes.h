...
#define CTRL_HS_TIMER_BOAT_ARCHERY F3 // Note this interprets the highscore value as a timer (not the actual timer for the minigame)
#define CTRL_HS_TIMER_HORSE_BACK_BALLOON F4 // Note this interprets the highscore value as a timer (not the actual timer for the minigame)
