...
void SceneProc_DrawAnimatedMaterialTwoTexScroll(GlobalContext* globalCtx, u32 segment, TextureScrollAnimParams* params);
void SceneProc_SetColorInSegment(GlobalContext* globalCtx, u32 segment, SceneDrawPrimColor* primColor, SceneDrawEnvColor* envColor);
...
void SceneProc_DrawType4Texture(GlobalContext* ctxt, u32 segment, TextureColorAnimParams* params);
void SceneProc_DrawType5Texture(GlobalContext* ctxt, u32 segment, CyclingTextureParams* params);
void SceneProc_DrawAnimatedTextures(GlobalContext* ctxt, AnimatedMaterial* textures, f32 flashingAlpha, u32 step, u32 flags);
...
void SceneProc_DrawTranslucentSceneAnimatedTexturesWithAlpha(GlobalContext* ctxt, AnimatedMaterial* textures, f32 alpha);
...
void SceneProc_DrawOpaqueAnimatedTexturesWithAlpha(GlobalContext* ctxt, AnimatedMaterial* textures, f32 alpha, u32 step);
void SceneProc_DrawTranslucentAnimatedTexturesWithAlpha(GlobalContext* ctxt, AnimatedMaterial* textures, f32 alpha, u32 step);
