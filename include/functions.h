...
u32 func_800B7298(GlobalContext* globalCtx, Actor* param_2, u8 param_3);
...
s32 func_800B84D0(Actor* actor, GlobalContext* globalCtx); // its result should be treated as a boolean
