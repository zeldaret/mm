...
void func_800B5814(TargetContext* targetContext, Player* player, Actor* param_3, GlobalContext* ctxt);
...
void func_80123140(GlobalContext* ctxt, Player* param_2);
u32 func_80123358(GlobalContext* ctxt, Player* player);
...
u32 func_80152498(MessageContext* msgCtx);
