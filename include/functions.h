...
void Audio_PlaySfx_MessageDecide(void); // decide sfx
void Audio_PlaySfx_MessageCancel(void); // cancel sfx
...
// void Audio_PlaySfx_GiantsMaskUnused(void);
...
// void Audio_PlaySfx_AtPosWithFreqAndVolume(void);
...
// void Audio_PlaySfx_IncreasinglyTransposed(void);
// void Audio_PlaySfx_Transposed(void);
...
// void Audio_PlaySfx_IfNotInCutsceneImpl(UNK_TYPE1 param_1, UNK_TYPE1 param_2, UNK_TYPE1 param_3, UNK_TYPE1 param_4, UNK_TYPE4 param_5, UNK_TYPE4 param_6);
// void Audio_PlaySfx_IfNotInCutscene(void);
// void Audio_MuteSfxAndAmbienceSeqExceptOcaAndSys(UNK_TYPE1 param_1);
