...
void SceneProc_DrawMaterialAnimation(GlobalContext* globalCtx, MaterialAnimation* animatedMat, f32 flashingAlpha, u32 step, u32 flags);
...
void SceneProc_DrawOpaqueSceneAnimatedTexturesWithAlpha(GlobalContext* globalCtx, MaterialAnimation* textures, f32 alpha);
void SceneProc_DrawTranslucentSceneAnimatedTexturesWithAlpha(GlobalContext* globalCtx, MaterialAnimation* textures, f32 alpha);
...
void SceneProc_DrawAllAnimatedTexturesWithAlpha(GlobalContext* globalCtx, MaterialAnimation* textures, f32 alpha, u32 step);
void SceneProc_DrawOpaqueAnimatedTexturesWithAlpha(GlobalContext* globalCtx, MaterialAnimation* textures, f32 alpha, u32 step);
void SceneProc_DrawTranslucentAnimatedTexturesWithAlpha(GlobalContext* globalCtx, MaterialAnimation* textures, f32 alpha, u32 step);
