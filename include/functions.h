...
// void Player_ActionToModelGroup(void);
...
s32 Player_IsBurningStickInRange(GlobalContext* globalCtx, Vec3f* arg1, f32 arg2, f32 arg3);
...
// void Player_DrawGetItemImpl(void);
