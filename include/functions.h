...
void func_800B8898(GlobalContext* globalCtx, Actor* actor, s16* param_3, s16* param_4);
...
void func_8011552C(GlobalContext* globalCtx, UNK_TYPE arg1);
...
UNK_TYPE func_8013D68C(Path* arg0, s16 arg1, UNK_PTR arg2);
