...
s16 BgCheck_PolygonGetMinY(CollisionPoly* polygons, BgVertex* vertices);
...
void BgCheck_CreateColTriParamsFromPolygon(CollisionPoly* polygon, Vec3s* vertices, Vec3f* dest);
void func_800C02C0(CollisionPoly* poly, s32 index, CollisionContext* colCtx, Vec3f* dest);
