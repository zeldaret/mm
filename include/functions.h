...
void EffectSsKFire_Spawn(GlobalContext* globalCtx, Vec3f* pzParm2, Vec3f* pzParm3, Vec3f* pzParm4, s32 param_5, s32 param_6);
...
void func_8019FE1C(Vec3f*, u16 sfxId, f32);
