...
// void Jpeg_CopyToZbuffer(void);
// void Jpeg_GetUnalignedU16(void);
// void Jpeg_ParseMarkers(void);
// s32 Jpeg_Decode(UNK_TYPE4 param_1, UNK_TYPE4 param_2, s32 param_3, u32 param_4);
...
void SysUcode_GetUCodeBootSize(void);
