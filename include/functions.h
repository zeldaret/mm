...
void Audio_SetSfxBanksMute(s32 param_1);
// void Audio_SetFlagForBgmVolumeLow(void);
// void Audio_ClearFlagForBgmVolumeLow(void);
void Audio_PlaySfxGeneral(u16 sfxId, Vec3f* param_2, u8 param_3, f32* param_4, f32* param_5, s8* param_6);
// void Audio_RemoveMatchingSfxRequests(void);
// void Audio_ProcessSfxRequest(void);
// void Audio_RemoveSfxBankEntry(void);
// void Audio_ChooseActiveSfxs(void);
// void Audio_PlayActiveSfxs(void);
// void Audio_StopSfxByBank(void);
// void func_801A7168(void);
// void Audio_StopSfxByPosAndBank(void);
void Audio_StopSfxByPos(Vec3f* pos);
void Audio_StopSfxByPosAndId(Vec3f* pos, u16 sfxId);
// void Audio_StopSfxByTokenAndId(void);
void Audio_StopSfxById(u16 sfxId);
// void Audio_ProcessSfxRequests(void);
void Audio_SetUnusedBankLerp(u32 param_1, u32 param_2, u32 param_3);
// void Audio_StepUnusedBankLerp(void);
