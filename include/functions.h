...
DmaEntry* DmaMgr_FindDmaEntry(uintptr_t vromAddr);
u32 DmaMgr_TranslateVromToRom(uintptr_t vromAddr);
s32 DmaMgr_FindDmaIndex(uintptr_t vromAddr);
...
f32 cosf(f32 __x);
s32 osEPiReadIo(OSPiHandle* pihandle, uintptr_t devAddr, u32* data);
...
s32 osEPiWriteIo(OSPiHandle* pihandle, uintptr_t devAddr, u32 data);
