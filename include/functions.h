...
void SkinMatrix_MtxFToMtx(MtxF* src, RSPMatrix* dest);
RSPMatrix* SkinMatrix_MtxFToNewMtx(GraphicsContext* gfxCtx, MtxF* src);
void SkinMatrix_SetRotateAroundVec(MtxF* mf, s16 a, f32 x, f32 y, f32 z);
void SkinMatrix_SetXRotation(MtxF* mf, s16 angle);
void SkinMatrix_MulXRotation(MtxF* mf, s16 angle);
void SkinMatrix_SetYRotation(MtxF* mf, s16 angle);
void SkinMatrix_MulYRotation(MtxF* mf, s16 angle);
void SkinMatrix_SetZRotation(MtxF* mf, s16 angle);
