...
void* SystemArena_AllocMin1(u32 size);
...
void* SystemArena_Calloc(s32 param_1, s32 param_2);
void SystemArena_AnalyzeArena(u32* maxFreeBlock, u32* bytesFree, u32* bytesAllocated);
// s32 SystemArena_CheckArena(void);
void SystemArena_InitArena(u32 base, u32 size);
// void SystemArena_Cleanup(void);
// u32 SystemArena_IsInitialized(void);
s32 Rand_Next(void);
