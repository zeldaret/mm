...
void guLookAtHiliteF(f32 mf[4][4], LookAt* l, Hilite* h, f32 xEye, f32 yEye, f32 zEye, f32 xAt, f32 yAt, f32 zAt, f32 xUp, f32 yUp, f32 zUp, f32 xl1, f32 yl1, f32 zl1, f32 xl2, f32 yl2, f32 zl2, s32 twidth, s32 theight);
...
long long __f_to_ll(f32 f);
unsigned long long __d_to_ull(double d);
unsigned long long __f_to_ull(f32 f);
double __ll_to_d(long long l);
f32 __ll_to_f(long long l);
...
f32* Actor_GetWorldPosShapeRot(PosRot* dest, Actor* actor);
...
f32 func_800C41E4(GlobalContext* globalCtx, CollisionContext* colCtx, CollisionPoly** outPoly, s32* bgId,
...
f32 func_800C4488(CollisionContext* colCtx, CollisionPoly** outPoly, s32* bgId, Vec3f* pos);
...
// UNK_TYPE4 func_800C9844(CollisionContext* colCtx, CollisionPoly* poly, s32 bgId);
Vec3s* func_800C98CC(CollisionContext* colCtx, s32 camId, s32 bgId);
// UNK_TYPE4 func_800C9924(CollisionContext* colCtx, CollisionPoly* poly, s32 bgId);
u32 func_800C99AC(CollisionContext* colCtx, CollisionPoly* poly, s32 bgId);
...
u32 func_800C9A4C(CollisionContext* colCtx, CollisionPoly* poly, s32 bgId);
u32 func_800C9A7C(CollisionContext* colCtx, CollisionPoly* poly, s32 bgId);
u32 func_800C9AB0(CollisionContext* colCtx, CollisionPoly* poly, s32 bgId);
u32 func_800C9AE4(CollisionContext* colCtx, CollisionPoly* poly, s32 bgId);
...
u32 func_800C9B90(CollisionContext* colCtx, CollisionPoly* poly, s32 bgId);
u32 func_800C9BB8(CollisionContext* colCtx, CollisionPoly* poly, s32 bgId);
u32 func_800C9BDC(CollisionContext* colCtx, CollisionPoly* poly, s32 bgId);
// u32 func_800C9C24(CollisionContext* colCtx, CollisionPoly* poly, s32 bgId, UNK_TYPE4 param_4);
u32 func_800C9C74(CollisionContext* colCtx, CollisionPoly* poly, s32 bgId);
u32 func_800C9C9C(CollisionContext* colCtx, CollisionPoly* poly, s32 bgId);
u32 func_800C9CC4(CollisionContext* colCtx, CollisionPoly* poly, s32 bgId);
u32 func_800C9CEC(CollisionContext* colCtx, CollisionPoly* poly, s32 bgId);
...
u32 func_800C9E18(CollisionContext* colCtx, CollisionPoly* poly, s32 bgId);
u32 func_800C9E40(CollisionContext* colCtx, CollisionPoly* poly, s32 bgId);
u32 func_800C9E88(CollisionContext* colCtx, CollisionPoly* poly, s32 bgId);
s32 func_800C9EBC(GlobalContext* globalCtx, CollisionContext* colCtx, f32 x, f32 z, f32* ySurface,
                         WaterBox** outWaterBox, UNK_TYPE4 arg6);
...
s32 Gameplay_CreateSubCamera(GlobalContext* globalCtx);
s32 Gameplay_GetActiveCamId(GlobalContext* globalCtx);
void Gameplay_ChangeCameraStatus(GlobalContext* globalCtx, s16 param_2, s16 param_3);
void Gameplay_ClearCamera(GlobalContext* globalCtx, s16 param_2);
void Gameplay_ClearAllSubCameras(GlobalContext* globalCtx);
Camera* Gameplay_GetCamera(GlobalContext* globalCtx, s16 index);
s32 Gameplay_CameraSetAtEye(GlobalContext* globalCtx, s16 camId, Vec3f* at, Vec3f* eye);
// void Gameplay_CameraSetAtEyeUp(UNK_TYPE1 param_1, UNK_TYPE1 param_2, UNK_TYPE1 param_3, UNK_TYPE1 param_4, UNK_TYPE4 param_5);
// void Gameplay_CameraSetFov(void);
// void Gameplay_SetCameraRoll(void);
void Gameplay_CopyCamera(GlobalContext* globalCtx, s16 arg1, s16 arg2);
// void func_80169A50(void);
// void Gameplay_CameraChangeSetting(void);
void func_80169AFC(GlobalContext* globalCtx, s16 camId, s16 arg2);
u16 func_80169C64(GlobalContext* globalCtx, s32 camId);
Vec3s* func_80169C84(GlobalContext* globalCtx, s32 camId);
