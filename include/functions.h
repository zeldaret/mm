...
void func_801A9B10(u8* dqt, JpegQuantizationTable* qt, u8 count);
...
u32 func_801A9DCC(u8* dht, JpegHuffmanTable* ht, u8* codesLengths, u16* codes, u8 count);
...
s32 func_801AA020(JpegDecoder* decoder, u16* mcuBuff, s32 count, u8 isFollowing, JpegDecoderState* state);
