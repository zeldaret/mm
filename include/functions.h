...
void Scene_SetColor(GlobalContext* globalCtx, s32 segment, F3DPrimColor* primColor, F3DEnvColor* envColor);
...
void Scene_DrawMaterialAnimMain(GlobalContext* globalCtx, MaterialAnimation* matAnim, f32 alphaRatio, u32 step, u32 flags);
...
void Scene_DrawMaterialAnimStepOpa(GlobalContext* globalCtx, MaterialAnimation* matAnim, u32 step);
...
void Scene_DrawMaterialAnimAlphaStepOpa(GlobalContext* globalCtx, MaterialAnimation* matAnim, f32 alphaRatio, u32 step);
void Scene_DrawMaterialAnimAlphaStepXlu(GlobalContext* globalCtx, MaterialAnimation* matAnim, f32 alphaRatio, u32 step);
