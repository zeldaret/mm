...
u32 Quake_SetQuakeValues(s16 idx, s16 verticalMag, s16 horizontalMag, s16 zoom, s16 rotZ);
u32 Quake_SetQuakeValues2(s16 idx, s16 isPerpendicularShake, Vec3s rotOffset);
