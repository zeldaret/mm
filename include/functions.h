...
// void MapData_GetMapTexOffsetGameplayDangeonKeep(void);
// void MapData_GetMapDrawTypeGameplayDangeonKeep(void);
// void MapData_GetMapColorIndexGameplayDangeonKeep(void);
// void func_8010956C(void);
// void MapData_GetMapTexGameplayDangeonKeep(void);
// void func_801095AC(void);
// void MapData_GetMapTexGameplayDangeonKeepOffset(void);
// void MapData_GetMapGrandDrawType(void);
// void MapData_GetMapGrandColorIndex(void);
// void MapData_GetMapGrandScale(void);
// void MapData_MapGrandTexSizeTest(void);
// void MapData_GetSizeOfMapGrandTex(void);
// void MapData_MID_GetType(void);
// void func_80109754(void);
// void MapData_GetMapTexOffset(void);
// void func_8010983C(void);
// void MapData_GetDrawType(void);
// void MapData_GetMapColorIndex(void);
// UNK_TYPE4 func_80109964(s32 param_1);
// void MapData_GetMapITexDim(void);
// void MapData_GetMapITexOffset(void);
// void MapData_GetMapIDrawType(void);
// void MapData_GetMapIColorIndex(void);
// void MapData_GetMapIScale(void);
// void MapData_MapITexSizeTest(void);
// void MapDisp_GetSizeOfMapITex(void);
// void MapData_GetMapIId(void);
// void func_80109B38(void);
// void MapData_GetMapCompactId(void);
// void MapData_CPID_GetType(void);
// void func_80109C38(void);
// void MapData_GetIMapSize(void);
// void MapData_CPID_GetTexDim(void);
// void MapData_CPID_GetTexOffset(void);
// void MapData_CPID_GetDrawType(void);
// void MapData_CPID_GetMapColorIndex(void);
// void MapData_CPID_GetMapScale(void);
