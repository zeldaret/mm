...
void EnAObj_Init(Actor* thisx, GlobalContext* ctxt);
void EnAObj_Destroy(Actor* thisx, GlobalContext* ctxt);
void EnAObj_Update1(EnAObj* this, GlobalContext* ctxt);
void EnAObj_Update2(EnAObj* this, GlobalContext* ctxt);
void EnAObj_Update(Actor* thisx, GlobalContext* ctxt);
void EnAObj_Draw(Actor* thisx, GlobalContext* ctxt);
...
void EffectSsDust_Spawn(GlobalContext* ctxt, u16 drawFlags, Vec3f* pos, Vec3f* velocity, Vec3f* accel, ColorRGBA8* primColor, ColorRGBA8* envColor, s16 scale, s16 scaleStep, s16 life, u8 updateMode);
...
void EffectSsKiraKira_SpawnDispersed (GlobalContext * globalCtx, Vec3f * pos, Vec3f * velocity, Vec3f * accel, ColorRGBA8 * primColor, ColorRGBA8 * envColor, s16 scale, s32 life);
...
// void EffectSsBlast_Spawn(UNK_TYPE4 uParm1, Vec3f* pzParm2, Vec3f* pzParm3, Vec3f* pzParm4, ColorRGBA8* param_5, ColorRGBA8* param_6, UNK_TYPE2 param_7, UNK_TYPE2 param_8, UNK_TYPE2 param_9, UNK_TYPE2 param_10);
...
// void EffectSsGSpk_SpawnAccel(UNK_TYPE4 uParm1, UNK_TYPE4 uParm2, Vec3f* pzParm3, Vec3f* pzParm4, Vec3f* param_5, ColorRGBA8* param_6, ColorRGBA8* param_7, UNK_TYPE2 param_8, UNK_TYPE2 param_9);
...
// void EffectSsGRipple_Spawn(UNK_TYPE4 uParm1, Vec3f* pzParm2, UNK_TYPE2 uParm3, UNK_TYPE2 uParm4, UNK_TYPE2 param_5);
...
// void EffectSsFireTail_Spawn(UNK_TYPE4 uParm1, UNK_TYPE4 uParm2, Vec3f* pzParm3, UNK_TYPE4 uParm4, Vec3f* param_5, UNK_TYPE2 param_6, ColorRGBA8* param_7, ColorRGBA8* param_8, UNK_TYPE2 param_9, UNK_TYPE2 param_10, UNK_TYPE4 param_11);
...
void ActorShadow_Draw(Actor* actor, Lights* mapper, GlobalContext* ctxt, Gfx* displayList, ColorRGBA8* color);
...
void BgCheck_CreateTriNormFromPolygon(CollisionPoly* polygon, BgVertex* vertices, TriNorm* tri);
...
void ZeldaArena_Init(void* base, u32 size);
...
void SkelAnime_LodDraw(GlobalContext* globalCtx, Skeleton* skeleton, Vec3s* limbDrawTable, OverrideLimbDrawOpa overrideLimbDraw, PostLimbDrawOpa postLimbDraw, Actor* actor, s32 dListIndex);
...
void SkelAnime_DrawLimb(GlobalContext* globalCtx, s32 limbIndex, Skeleton* skeleton, Vec3s* limbDrawTable, OverrideLimbDrawOpa overrideLimbDraw, PostLimbDrawOpa postLimbDraw, Actor* actor);
void SkelAnime_Draw(GlobalContext* globalCtx, Skeleton* skeleton, Vec3s* limbDrawTable, OverrideLimbDrawOpa overrideLimbDraw, PostLimbDrawOpa postLimbDraw, Actor* actor);
void SkelAnime_DrawLimbSV(GlobalContext* globalCtx, s32 limbIndex, Skeleton* skeleton, Vec3s* limbDrawTable, OverrideLimbDrawOpa overrideLimbDraw, PostLimbDrawOpa postLimbDraw, Actor* actor, RSPMatrix** limbMatricies);
void SkelAnime_DrawSV(GlobalContext* globalCtx, Skeleton* skeleton, Vec3s* limbDrawTable, s32 dListCount, OverrideLimbDrawOpa overrideLimbDraw, PostLimbDrawOpa postLimbDraw, Actor* actor);
...
void* GameState_Alloc(GameStateHeap* heap, u32 size);
...
// void ListAlloc_Init(void);
// void ListAlloc_Alloc(void);
// void ListAlloc_Free(void);
// void ListAlloc_FreeAll(void);
void main(void* arg);
