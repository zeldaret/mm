...
void Environment_UpdateTime(PlayState* play, EnvironmentContext* envCtx, PauseContext* pauseCtx, MessageContext* msgCtx, GameOverContext* gameOverCtx);
...
void Environment_DrawLensFlare(PlayState* play, EnvironmentContext* envCtx, View* view, GraphicsContext* gfxCtx, Vec3f vec, f32 arg5, f32 arg6, s16 arg7, s8 arg8);
...
void Environment_ChangeLightSetting(PlayState* play, u8 arg1);
...
// void Environment_UpdateTimeBasedSequence(void);
...
// void Environment_UpdateRain(void);
...
void Environment_LerpRGB8(Color_RGB8* param_1, Color_RGB8* param_2, f32 param_3, Vec3s* param_4);
void Environment_LerpAmbientColor(PlayState* play, Color_RGB8* pzParm2, f32 fParm3);
void Environment_LerpDiffuseColor(PlayState* play, Color_RGB8* pzParm2, f32 fParm3);
void Environment_LerpFogColor(PlayState* play, Color_RGB8* pzParm2, f32 fParm3);
void Environment_LerpFog(PlayState* play, s16 arg1, s16 arg2, f32 arg3);
...
void Environment_DrawSkyboxStar(Gfx** arg0, f32 arg1, f32 arg2, s32 arg3, s32 arg4);
...
void Environment_SetTimeJump(f32 arg0);
