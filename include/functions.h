...
void SceneProc_SetColor(GlobalContext* globalCtx, u32 segment, SceneDrawPrimColor* primColor, SceneDrawEnvColor* envColor);
...
void SceneProc_DrawMaterialAnimation(GlobalContext* ctxt, MaterialAnimation* animatedMat, f32 flashingAlpha, u32 step, u32 flags);
...
void SceneProc_DrawTranslucentSceneAnimatedTexturesWithAlpha(GlobalContext* ctxt, MaterialAnimation* textures, f32 alpha);
...
void SceneProc_DrawOpaqueAnimatedTexturesWithAlpha(GlobalContext* ctxt, MaterialAnimation* textures, f32 alpha, u32 step);
void SceneProc_DrawTranslucentAnimatedTexturesWithAlpha(GlobalContext* ctxt, MaterialAnimation* textures, f32 alpha, u32 step);
