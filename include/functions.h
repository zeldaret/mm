...
// void Map_GetDungeonAreaIndex(void);
// void Map_IsInDungeonArea(void);
// void Map_GetBossAreaIndex(void);
// void Map_IsInBossArea(void);
// void func_8010A238(void);
// void func_8010A2AC(void);
void Map_SavePlayerInitialInfo(PlayState* play);
void Map_InitRoomData(PlayState* play, s16 param_2);
