...
u16 BgCheck_GetBgCamSettingImpl(CollisionContext* colCtx, u32 camId, s32 bgId);
...
Vec3s* BgCheck_GetBgCamFuncDataImpl(CollisionContext* colCtx, s32 camId, s32 bgId);
