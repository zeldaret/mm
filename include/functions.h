...
Path* SubS_GetAdditionalPath(GlobalContext* globalCtx, u8 arg1, s32 arg2);
...
s32 SubS_HasReachedPoint(Actor* actor, Path* path, s32 arg2);
Path* SubS_GetDayDependentPath(GlobalContext* globalCtx, u8 arg1, u8 arg2, s32* arg3);
...
s32 SubS_CopyPointFromPathCheckBounds(Path* path, s32 arg1, Vec3f* arg2);
...
Path* SubS_GetPathByIndex(GlobalContext* globalCtx, s16 arg1, s16 arg2);
s32 SubS_CopyPointFromPath(Path* path, s32 arg1, Vec3f* arg2);
s16 SubS_GetDistSqAndOrientPoints(Vec3f* arg0, Vec3f* arg1, f32* arg2);
s32 SubS_MoveActorToPoint(Actor* actor, Vec3f* arg1, s16 arg2);
...
s32 SubS_IsFloorAbove(GlobalContext* globalCtx, Vec3f* arg1, f32 arg2);
s32 SubS_CopyPointFromPathList(Path* arg0, s32 arg1, s32 arg2, Vec3f* arg3);
