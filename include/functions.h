...
void Audio_PlayActorSound2(Actor* actor, u16 uParm2);
...
void BgCheck_CreateColTriParamsFromPolygon(CollisionPoly* polygon, BgVertex* vertices, ColTriParams* tri);
void func_800C02C0(CollisionPoly* poly, s32 index, CollisionContext* bgCtxt, ColTriParams* tri);
