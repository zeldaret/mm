...
s32 Schedule_FlagCheckS(GlobalContext* globalCtx, u8** arg1, ScheduleResult* arg2);
s32 Schedule_FlagCheckL(GlobalContext* globalCtx, u8** arg1, ScheduleResult* arg2);
s32 Schedule_TimeRangeCheckS(GlobalContext* globalCtx, u8** arg1, ScheduleResult* arg2);
s32 Schedule_TimeRangeCheckL(GlobalContext* globalCtx, u8** arg1, ScheduleResult* arg2);
s32 Schedule_ReturnL(GlobalContext* globalCtx, u8** arg1, ScheduleResult* arg2);
s32 Schedule_End(GlobalContext* globalCtx, u8** arg1, ScheduleResult* arg2);
s32 Schedule_ReturnEmpty(GlobalContext* globalCtx, u8** arg1, ScheduleResult* arg2);
s32 Schedule_Nop(GlobalContext* globalCtx, u8** arg1, ScheduleResult* arg2);
s32 Schedule_ItemCheckS(GlobalContext* globalCtx, u8** arg1, ScheduleResult* arg2);
s32 Schedule_ReturnS(GlobalContext* globalCtx, u8** arg1, ScheduleResult* arg2);
s32 Schedule_SceneCheckS(GlobalContext* globalCtx, u8** arg1, ScheduleResult* arg2);
s32 Schedule_SceneCheckL(GlobalContext* globalCtx, u8** arg1, ScheduleResult* arg2);
s32 Schedule_DayCheckS(GlobalContext* globalCtx, u8** arg1, ScheduleResult* arg2);
s32 Schedule_DayCheckL(GlobalContext* globalCtx, u8** arg1, ScheduleResult* arg2);
s32 Schedule_ReturnTime(GlobalContext* globalCtx, u8** arg1, ScheduleResult* arg2);
s32 Schedule_TimeCheckS(GlobalContext* globalCtx, u8** arg1, ScheduleResult* arg2);
s32 Schedule_TimeCheckL(GlobalContext* globalCtx, u8** arg1, ScheduleResult* arg2);
s32 Schedule_JumpS(GlobalContext* globalCtx, u8** arg1, ScheduleResult* arg2);
s32 Schedule_JumpL(GlobalContext* globalCtx, u8** arg1, ScheduleResult* arg2);
s32 Schedule_RunScript(GlobalContext* globalCtx, u8* arg1, ScheduleResult* arg2);
