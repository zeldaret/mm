...
void Play_Destroy(GameState* gameState);
...
s32 Play_CameraChangeStatus(PlayState* play, s16 camId, s16 status);
...
u16 Play_GetCsCamDataSetting(PlayState* play, s32 csCamDataId);
Vec3s* Play_GetCsCamDataVec3s(PlayState* play, s32 csCamDataId);
