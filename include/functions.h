...
s32 func_8010BF58(Actor* actor, GlobalContext* globalCtx, s32* arg2, s32 (*arg3)(Actor*, GlobalContext*), s32* arg4);
// void Nmi_Init(void);
...
Gfx* func_8013AB00(GlobalContext* globalCtx, void** skeleton, Vec3s* limbDrawTable, s32 dListCount, OverrideLimbDraw2 overrideLimbDraw, PostLimbDraw2 postLimbDraw, UnkActorDraw2 unkActorDraw, Actor* actor, Gfx* gfx);
...
void func_80190B38(void (*dmaCallback0)(OSPiHandle*, OSIoMesg*, s32));
