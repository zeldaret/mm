...
s32 func_800C9A4C(CollisionContext* colCtx, CollisionPoly* polygon, s32 index);
s32 func_800C9A7C(CollisionContext* colCtx, CollisionPoly* polygon, s32 index);
s32 func_800C9AB0(CollisionContext* colCtx, CollisionPoly* polygon, s32 index);
s32 func_800C9AE4(CollisionContext* colCtx, CollisionPoly* polygon, s32 index);
...
u16 func_800C9BDC(CollisionContext* colCtx, CollisionPoly* polygon, s32 index);
...
s32 func_800C9D8C(CollisionContext* param_1, CollisionPoly* param_2, s32 param_3);
...
s32 func_800CA22C(GlobalContext* globalCtx, CollisionContext* colCtx, Vec3f* pos, f32 surfaceChkDist, WaterBox** outWaterBox, s32* bgId);
