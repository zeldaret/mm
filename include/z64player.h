...
#define GET_B_SWORD_FROM_AP(actionParam) ((actionParam) - PLAYER_IA_SWORD_KOKIRI + 1)

typedef enum PlayerBButtonSword {
    /* 0 */ PLAYER_BSWORD_NONE,
    /* 1 */ PLAYER_BSWORD_KOKIRI = GET_B_SWORD_FROM_AP(PLAYER_IA_SWORD_KOKIRI),
    /* 2 */ PLAYER_BSWORD_RAZOR = GET_B_SWORD_FROM_AP(PLAYER_IA_SWORD_RAZOR),
    /* 3 */ PLAYER_BSWORD_GILDED = GET_B_SWORD_FROM_AP(PLAYER_IA_SWORD_GILDED),
    /* 4 */ PLAYER_BSWORD_MAX
} PlayerBButtonSword;

#define GET_MELEE_WEAPON_FROM_AP(actionParam) ((actionParam) - PLAYER_IA_SWORD_KOKIRI + 1)

typedef enum PlayerMeleeWeapon {
    /* 0 */ PLAYER_MELEEWEAPON_NONE,
    /* 1 */ PLAYER_MELEEWEAPON_SWORD_KOKIRI = GET_MELEE_WEAPON_FROM_AP(PLAYER_IA_SWORD_KOKIRI),
    /* 2 */ PLAYER_MELEEWEAPON_SWORD_RAZOR = GET_MELEE_WEAPON_FROM_AP(PLAYER_IA_SWORD_RAZOR),
    /* 3 */ PLAYER_MELEEWEAPON_SWORD_GILDED = GET_MELEE_WEAPON_FROM_AP(PLAYER_IA_SWORD_GILDED),
    /* 4 */ PLAYER_MELEEWEAPON_SWORD_GREAT_FAIRY = GET_MELEE_WEAPON_FROM_AP(PLAYER_IA_SWORD_GREAT_FAIRY),
    /* 5 */ PLAYER_MELEEWEAPON_STICK = GET_MELEE_WEAPON_FROM_AP(PLAYER_IA_STICK),
    /* 6 */ PLAYER_MELEEWEAPON_ZORA_FINS = GET_MELEE_WEAPON_FROM_AP(PLAYER_IA_ZORA_FINS),
    /* 7 */ PLAYER_MELEEWEAPON_MAX
} PlayerMeleeWeapon;

#define GET_BOTTLE_FROM_AP(actionParam) ((actionParam) - PLAYER_IA_BOTTLE)

typedef enum PlayerBottle {
    /* -1 */ PLAYER_BOTTLE_NONE = -1,
    /*  0 */ PLAYER_BOTTLE_EMPTY = GET_BOTTLE_FROM_AP(PLAYER_IA_BOTTLE),
    /*  1 */ PLAYER_BOTTLE_FISH = GET_BOTTLE_FROM_AP(PLAYER_IA_BOTTLE_FISH),
    /*  2 */ PLAYER_BOTTLE_SPRING_WATER = GET_BOTTLE_FROM_AP(PLAYER_IA_BOTTLE_SPRING_WATER),
    /*  3 */ PLAYER_BOTTLE_HOT_SPRING_WATER = GET_BOTTLE_FROM_AP(PLAYER_IA_BOTTLE_HOT_SPRING_WATER),
    /*  4 */ PLAYER_BOTTLE_ZORA_EGG = GET_BOTTLE_FROM_AP(PLAYER_IA_BOTTLE_ZORA_EGG),
    /*  5 */ PLAYER_BOTTLE_DEKU_PRINCESS = GET_BOTTLE_FROM_AP(PLAYER_IA_BOTTLE_DEKU_PRINCESS),
    /*  6 */ PLAYER_BOTTLE_GOLD_DUST = GET_BOTTLE_FROM_AP(PLAYER_IA_BOTTLE_GOLD_DUST),
    /*  7 */ PLAYER_BOTTLE_1C = GET_BOTTLE_FROM_AP(PLAYER_IA_BOTTLE_1C),
    /*  8 */ PLAYER_BOTTLE_SEAHORSE = GET_BOTTLE_FROM_AP(PLAYER_IA_BOTTLE_SEAHORSE),
    /*  9 */ PLAYER_BOTTLE_MUSHROOM = GET_BOTTLE_FROM_AP(PLAYER_IA_BOTTLE_MUSHROOM),
    /* 10 */ PLAYER_BOTTLE_HYLIAN_LOACH = GET_BOTTLE_FROM_AP(PLAYER_IA_BOTTLE_HYLIAN_LOACH),
    /* 11 */ PLAYER_BOTTLE_BUG = GET_BOTTLE_FROM_AP(PLAYER_IA_BOTTLE_BUG),
    /* 12 */ PLAYER_BOTTLE_POE = GET_BOTTLE_FROM_AP(PLAYER_IA_BOTTLE_POE),
    /* 13 */ PLAYER_BOTTLE_BIG_POE = GET_BOTTLE_FROM_AP(PLAYER_IA_BOTTLE_BIG_POE),
    /* 14 */ PLAYER_BOTTLE_POTION_RED = GET_BOTTLE_FROM_AP(PLAYER_IA_BOTTLE_POTION_RED),
    /* 15 */ PLAYER_BOTTLE_POTION_BLUE = GET_BOTTLE_FROM_AP(PLAYER_IA_BOTTLE_POTION_BLUE),
    /* 16 */ PLAYER_BOTTLE_POTION_GREEN = GET_BOTTLE_FROM_AP(PLAYER_IA_BOTTLE_POTION_GREEN),
    /* 17 */ PLAYER_BOTTLE_MILK = GET_BOTTLE_FROM_AP(PLAYER_IA_BOTTLE_MILK),
    /* 18 */ PLAYER_BOTTLE_MILK_HALF = GET_BOTTLE_FROM_AP(PLAYER_IA_BOTTLE_MILK_HALF),
    /* 19 */ PLAYER_BOTTLE_CHATEAU = GET_BOTTLE_FROM_AP(PLAYER_IA_BOTTLE_CHATEAU),
    /* 20 */ PLAYER_BOTTLE_FAIRY = GET_BOTTLE_FROM_AP(PLAYER_IA_BOTTLE_FAIRY),
    /* 21 */ PLAYER_BOTTLE_MAX
} PlayerBottle;

#define GET_EXPLOSIVE_FROM_AP(actionParam) ((actionParam) - PLAYER_IA_BOMB)

typedef enum PlayerExplosive {
    /* -1 */ PLAYER_EXPLOSIVE_NONE = -1,
    /*  0 */ PLAYER_EXPLOSIVE_BOMB = GET_EXPLOSIVE_FROM_AP(PLAYER_IA_BOMB),
    /*  1 */ PLAYER_EXPLOSIVE_POWDER_KEG = GET_EXPLOSIVE_FROM_AP(PLAYER_IA_POWDER_KEG),
    /*  2 */ PLAYER_EXPLOSIVE_BOMBCHU = GET_EXPLOSIVE_FROM_AP(PLAYER_IA_BOMBCHU),
    /*  3 */ PLAYER_EXPLOSIVE_MAX
} PlayerExplosive;

#define GET_SWORD_FROM_AP(actionParam) ((actionParam) - PLAYER_IA_SWORD_KOKIRI)

typedef enum PlayerSword {
    /* -1 */ PLAYER_SWORD_NONE = -1,
    /*  0 */ PLAYER_SWORD_KOKIRI = GET_SWORD_FROM_AP(PLAYER_IA_SWORD_KOKIRI),
    /*  1 */ PLAYER_SWORD_RAZOR = GET_SWORD_FROM_AP(PLAYER_IA_SWORD_RAZOR),
    /*  2 */ PLAYER_SWORD_GILDED = GET_SWORD_FROM_AP(PLAYER_IA_SWORD_GILDED),
    /*  3 */ PLAYER_SWORD_GREAT_FAIRY = GET_SWORD_FROM_AP(PLAYER_IA_SWORD_GREAT_FAIRY),
    /*  4 */ PLAYER_SWORD_MAX
} PlayerSword;
