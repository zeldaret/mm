...
#define GET_B_SWORD_FROM_IA(itemAction) ((itemAction) - PLAYER_IA_SWORD_KOKIRI + 1)

typedef enum PlayerBButtonSword {
    /* 0 */ PLAYER_BSWORD_NONE,
    /* 1 */ PLAYER_BSWORD_KOKIRI = GET_B_SWORD_FROM_IA(PLAYER_IA_SWORD_KOKIRI),
    /* 2 */ PLAYER_BSWORD_RAZOR = GET_B_SWORD_FROM_IA(PLAYER_IA_SWORD_RAZOR),
    /* 3 */ PLAYER_BSWORD_GILDED = GET_B_SWORD_FROM_IA(PLAYER_IA_SWORD_GILDED),
    /* 4 */ PLAYER_BSWORD_MAX
} PlayerBButtonSword;
