...
typedef enum PlayerStartMode {
    ...
    /*  0x6 */ PLAYER_START_MODE_OWL, // Arriving from either a song of soaring owl statue warp, from a song of soaring dungeon entrance warp, or from an owl statue save.
