...
#define GET_BBUTTONSWORD_FROM_AP(actionParam) ((actionParam) - PLAYER_AP_SWORD_KOKIRI + 1)

typedef enum PlayerBButtonSword {
    /* 0 */ PLAYER_BBUTTONSWORD_NONE,
    /* 1 */ PLAYER_BBUTTONSWORD_KOKIRI = GET_BBUTTONSWORD_FROM_AP(PLAYER_AP_SWORD_KOKIRI),
    /* 2 */ PLAYER_BBUTTONSWORD_RAZOR = GET_BBUTTONSWORD_FROM_AP(PLAYER_AP_SWORD_RAZOR),
    /* 3 */ PLAYER_BBUTTONSWORD_GILDED = GET_BBUTTONSWORD_FROM_AP(PLAYER_AP_SWORD_GILDED),
    /* 4 */ PLAYER_BBUTTONSWORD_MAX
} PlayerBButtonSword;

typedef enum PlayerMeleeWeapon {
    /* 0 */ PLAYER_MELEEWEAPON_NONE,
    /* 1 */ PLAYER_MELEEWEAPON_SWORD_KOKIRI = PLAYER_AP_SWORD_KOKIRI - PLAYER_AP_SWORD_KOKIRI + 1,
    /* 2 */ PLAYER_MELEEWEAPON_SWORD_RAZOR = PLAYER_AP_SWORD_RAZOR - PLAYER_AP_SWORD_KOKIRI + 1,
    /* 3 */ PLAYER_MELEEWEAPON_SWORD_GILDED = PLAYER_AP_SWORD_GILDED - PLAYER_AP_SWORD_KOKIRI + 1,
    /* 4 */ PLAYER_MELEEWEAPON_SWORD_GREAT_FAIRY = PLAYER_AP_SWORD_GREAT_FAIRY - PLAYER_AP_SWORD_KOKIRI + 1,
    /* 5 */ PLAYER_MELEEWEAPON_STICK = PLAYER_AP_STICK - PLAYER_AP_SWORD_KOKIRI + 1,
    /* 6 */ PLAYER_MELEEWEAPON_ZORA_FINS = PLAYER_AP_ZORA_FINS - PLAYER_AP_SWORD_KOKIRI + 1,
