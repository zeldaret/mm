...
typedef enum PlayerItemAction {
    ...
    /* 0x1D */ PLAYER_IA_BOTTLE_SEAHORSE = 0x1D,
    ...
    /* 0x33 */ PLAYER_IA_LETTER_MAMA = 0x33,
    /* 0x36 */ PLAYER_IA_PENDANT_OF_MEMORIES = 0x36,
    /* 0x3A */ PLAYER_IA_MASK_TRUTH = 0x3A,
