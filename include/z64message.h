...
#define TEXTBOX_BG_DEFAULT 0x0
#define TEXTBOX_BG_WOODEN 0x1
#define TEXTBOX_BG_OCARINA 0x2
#define TEXTBOX_BG_FADED 0x3
#define TEXTBOX_BG_NOTEBOOK 0x4

#define TEXTBOX_BG_NONE 0xE
