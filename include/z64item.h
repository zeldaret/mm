...
typedef enum ItemId {
    ...
    // Regions used with item pause menu
    /* 0xA4 */ ITEM_REGION_GREAT_BAY,
    /* 0xA5 */ ITEM_REGION_ZORA_HALL,
    /* 0xA6 */ ITEM_REGION_ROMANI_RANCH,
    /* 0xA7 */ ITEM_REGION_DEKU_PALACE,
    /* 0xA8 */ ITEM_REGION_WOODFALL,
    /* 0xA9 */ ITEM_REGION_CLOCK_TOWN,
    /* 0xAA */ ITEM_REGION_SNOWHEAD,
    /* 0xAB */ ITEM_REGION_IKANA_GRAVEYARD,
    /* 0xAC */ ITEM_REGION_IKANA_CANYON,
    ...
    /* 0xB2 */ ITEM_OWL_WARP_MILK_ROAD,
    /* 0xB3 */ ITEM_OWL_WARP_ZORA_CAPE,
    // Player
