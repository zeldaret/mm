...
beginseg
    ...
    include "build/data/boot/boot_80086280.rodata.o"
...
beginseg
    ...
    include "build/data/code/code_800F23E0.rodata.o"
    ...
    include "build/data/code/code_80161180.rodata.o"
    ...
    include "build/data/code/code_801830A0.rodata.o"
    ...
    include "build/data/code/code_801AA610.rodata.o"
