...
void func_808715B8(EnBom* this, GlobalContext* globalCtx) {
    ...
    if (globalCtx->envCtx.lightAdjustments.diffuseColor1[0] != 0) {
        globalCtx->envCtx.lightAdjustments.diffuseColor1[0] -= 25;
    }

    if (globalCtx->envCtx.lightAdjustments.diffuseColor1[1] != 0) {
        globalCtx->envCtx.lightAdjustments.diffuseColor1[1] -= 25;
    }

    if (globalCtx->envCtx.lightAdjustments.diffuseColor1[2] != 0) {
        globalCtx->envCtx.lightAdjustments.diffuseColor1[2] -= 25;
    }

    if (globalCtx->envCtx.lightAdjustments.ambientColor[0] != 0) {
        globalCtx->envCtx.lightAdjustments.ambientColor[0] -= 25;
    }

    if (globalCtx->envCtx.lightAdjustments.ambientColor[1] != 0) {
        globalCtx->envCtx.lightAdjustments.ambientColor[1] -= 25;
    }

    if (globalCtx->envCtx.lightAdjustments.ambientColor[2] != 0) {
