...
void func_808984E0(EnPeehat* this) {
    ...
    Actor_SetColorFilter(&this->actor, COLORFILTER_COLORFLAG_R, 255, COLORFILTER_XLUFLAG_OPA, 14);
    this->colliderSphere.base.acFlags &= ~AC_ON;
    this->unk_2C4 = 0.0f;
    if (this->actor.colChkInfo.health == 0) {
        this->actor.velocity.y = 6.0f;
    ...
    if (this->colliderSphere.base.acFlags & AC_HIT) {
        ...
        if ((this->drawDmgEffType != ACTOR_DRAW_DMGEFF_FROZEN_NO_SFX) ||
            ...
            if (this->actor.colChkInfo.damageEffect == 5) {
                ...
                this->unk_2B0 = 40;
                Actor_SetColorFilter(&this->actor, COLORFILTER_COLORFLAG_B, 200, COLORFILTER_XLUFLAG_OPA, 40);
                Actor_PlaySfxAtPos(&this->actor, NA_SE_EN_COMMON_FREEZE);
                func_80898414(this);
