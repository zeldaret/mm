...
extern Gfx object_ladder_12rung_dlist[];
extern Gfx object_ladder_16rung_dlist[];
extern Gfx object_ladder_20rung_dlist[];
extern Gfx object_ladder_24rung_dlist[];

extern CollisionHeader object_ladder_12rung_collision;
extern CollisionHeader object_ladder_16rung_collision;
extern CollisionHeader object_ladder_20rung_collision;
extern CollisionHeader object_ladder_24rung_collision;
...
void BgLadder_Init(Actor* thisx, GlobalContext* globalCtx) {
    ...
    if (size == LADDER_SIZE_12RUNG) {
        BgCheck3_LoadMesh(globalCtx, &this->dyna, &object_ladder_12rung_collision);
    } else if (size == LADDER_SIZE_16RUNG) {
        BgCheck3_LoadMesh(globalCtx, &this->dyna, &object_ladder_16rung_collision);
    } else if (size == LADDER_SIZE_20RUNG) {
        BgCheck3_LoadMesh(globalCtx, &this->dyna, &object_ladder_20rung_collision);
    } else if (size == LADDER_SIZE_24RUNG) {
        BgCheck3_LoadMesh(globalCtx, &this->dyna, &object_ladder_24rung_collision);
    } else {
