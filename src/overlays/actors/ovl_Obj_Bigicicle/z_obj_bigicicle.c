...
ActorInit Obj_Bigicicle_InitVars = {
    ACTOR_OBJ_BIGICICLE,  ACTORCAT_PROP,        FLAGS,
    OBJECT_BIGICICLE,     sizeof(ObjBigicicle), ObjBigicicle_Init,
    ObjBigicicle_Destroy, ObjBigicicle_Update,  ObjBigicicle_Draw,
};
