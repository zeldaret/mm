...
ActorInit En_Ending_Hero5_InitVars = {
    ACTOR_EN_ENDING_HERO5, ACTORCAT_NPC,          FLAGS,
    OBJECT_DAIKU,          sizeof(EnEndingHero5), EnEndingHero5_Init,
    EnEndingHero5_Destroy, EnEndingHero5_Update,  EnEndingHero5_Draw,
};
