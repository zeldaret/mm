...
void func_80959844(EnMk* this, PlayState* play) {
    ...
    if ((this->unk_27A & 2) && (func_80959524(play) >= 7)) {
        textId = 0xFB3;
    } else if (GET_WEEKEVENTREG(WEEKEVENTREG_20_40)) {
        textId = 0xFB9;
    } else if (GET_WEEKEVENTREG(WEEKEVENTREG_19_40)) {
        textId = 0xFB5;
        ...
        switch (gSaveContext.save.playerForm) {
            case PLAYER_FORM_DEKU:
                if (GET_WEEKEVENTREG(WEEKEVENTREG_19_10)) {
            ...
            case PLAYER_FORM_GORON:
                if (GET_WEEKEVENTREG(WEEKEVENTREG_19_08)) {
                    if (GET_WEEKEVENTREG(WEEKEVENTREG_55_80)) {
                        textId = 0xFAB;
                    } else {
                        textId = 0xFAA;
            ...
            case PLAYER_FORM_HUMAN:
                if (func_80959524(play) > 0) {
                    textId = 0xFA7;
                } else if (GET_WEEKEVENTREG(WEEKEVENTREG_19_04)) {
                    if (GET_WEEKEVENTREG(WEEKEVENTREG_55_80)) {
                        textId = 0xFBF;
                    } else {
                        textId = 0xFA6;
            ...
            default:
                if (func_80959524(play) > 0) {
                    textId = 0xFB0;
                } else if (GET_WEEKEVENTREG(WEEKEVENTREG_19_20)) {
                    textId = 0xFB2;
                } else {
                    textId = 0xFB1;
                }
...
void func_80959D28(EnMk* this, PlayState* play) {
    ...
    if ((play->csCtx.state == 0) && (this->actor.cutscene == -1)) {
        if (GET_WEEKEVENTREG(WEEKEVENTREG_20_40)) {
            this->unk_27A &= ~1;
            this->actionFunc = func_80959774;
...
void func_80959E18(EnMk* this, PlayState* play) {
    ...
    if (func_800B8718(&this->actor, &play->state)) {
        ...
        if (!(GET_WEEKEVENTREG(WEEKEVENTREG_20_40)) && (GET_WEEKEVENTREG(WEEKEVENTREG_19_40))) {
