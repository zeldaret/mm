...
void ItemEtcetera_SetupAction(ItemEtcetera* this, ItemEtceteraActionFunc funcSetup);
...
static s16 D_8092024C[] = { GID_BOTTLE, GID_BOTTLE, GID_BOTTLE, GID_BOTTLE, GID_BOTTLE, GID_BOTTLE, GID_01,
