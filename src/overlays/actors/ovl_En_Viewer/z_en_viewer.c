...
void EnViewer_Init(Actor* thisx, PlayState* play) {
    ...
    switch (ENVIEWER_GET_3(&this->actor)) {
        case 0:
            this->unk_148 = ENVIEWER_GET_FFFF(&this->actor) * 40.0f;
            this->unk_150 = (u8)ENVIEWER_GET_7F(&this->actor) * 40.0f;
            EnViewer_SetupAction(this, func_8089F17C);
            break;
        case 1:
            this->unk_148 = (u16)ENVIEWER_GET_9(&this->actor) * 40.0f;
            this->unk_150 = (u8)ENVIEWER_GET_7F(&this->actor) * 40.0f;
        ...
        case 2:
            this->unk_148 = (u16)ENVIEWER_GET_9(&this->actor) * 40.0f;
            this->unk_14C = (u8)ENVIEWER_GET_7F(&this->actor) * 40.0f;
