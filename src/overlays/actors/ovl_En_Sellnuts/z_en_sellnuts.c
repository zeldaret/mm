...
void func_80ADB254(EnSellnuts* this, GlobalContext* globalCtx) {
    ...
    if (((this->actor.yDirDistToPlayer < 50.0f) && (this->actor.yDirDistToPlayer > -50.0f) ? true : false) &&
    ...
    if (func_800B84D0(&this->actor, globalCtx)) {
        if (func_800B8708(globalCtx) == 0x2A) {
            ...
            switch (this->unk_340) {
                ...
                (((this->actor.yDirDistToPlayer < 50.0f) && (this->actor.yDirDistToPlayer > -50.0f)) ? true : false)) ||
...
void func_80ADC37C(EnSellnuts* this, GlobalContext* globalCtx) {
    ...
    } else if (this->actor.yDirDistToPlayer > 500.0f) {
        ActorCutscene_Stop(this->cutscene);
        this->actionFunc = func_80ADC580;
    }
