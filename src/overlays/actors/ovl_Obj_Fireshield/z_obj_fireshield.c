...
ActorInit Obj_Fireshield_InitVars = {
    ACTOR_OBJ_FIRESHIELD,  ACTORCAT_PROP,         FLAGS,
    GAMEPLAY_KEEP,         sizeof(ObjFireshield), ObjFireshield_Init,
    ObjFireshield_Destroy, ObjFireshield_Update,  ObjFireshield_Draw,
};
