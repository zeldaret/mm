...
static MsgScript sMsgScript[] = {
    ...
    /* 0x0034 0x03 */ MSCRIPT_SET_COLLECTIBLE(0x000C),
    ...
    /* 0x0042 0x03 */ MSCRIPT_SET_WEEK_EVENT_REG(WEEKEVENTREG_73_08),
    /* 0x0045 0x03 */ MSCRIPT_SET_WEEK_EVENT_REG(WEEKEVENTREG_90_80),
    /* 0x0048 0x01 */ MSCRIPT_DONE(),

    /* 0x0049 0x03 */ MSCRIPT_BRANCH_ON_CALLBACK(0x0),
    /* 0x004C 0x05 */ MSCRIPT_OFFER_ITEM(GI_RUPEE_BLUE, 0x0),
    /* 0x0051 0x03 */ MSCRIPT_SET_COLLECTIBLE(0x0002),
    ...
    /* 0x005C 0x03 */ MSCRIPT_SET_WEEK_EVENT_REG(WEEKEVENTREG_90_80),
