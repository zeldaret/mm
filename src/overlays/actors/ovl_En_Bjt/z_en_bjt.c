...
static MsgScript sMsgEventScript[] = {
    ...
    /* 0x0007 0x07 */ MSCRIPT_BRANCH_ON_CALLBACK_MULTI(0x0, 0x0060 - 0x000E, 0x006D - 0x000E),
    /* 0x000E 0x03 */ MSCRIPT_PLAYER_TALK(0x294A),
    /* 0x0011 0x01 */ MSCRIPT_AWAIT_TEXT(),
    /* 0x0012 0x03 */ MSCRIPT_JUMP(0x0),
    /* 0x0015 0x01 */ MSCRIPT_AWAIT_TEXT(),
    /* 0x0016 0x01 */ MSCRIPT_PAUSE(),
    /* 0x0017 0x03 */ MSCRIPT_BRANCH_ON_CALLBACK(0x0),
    /* 0x001A 0x03 */ MSCRIPT_BEGIN_TEXT(0x294B),
    /* 0x001D 0x01 */ MSCRIPT_AWAIT_TEXT(),
    /* 0x001E 0x01 */ MSCRIPT_PAUSE(),
    /* 0x001F 0x03 */ MSCRIPT_BRANCH_ON_CALLBACK(0x0),
    /* 0x0022 0x03 */ MSCRIPT_BEGIN_TEXT(0x294C),
    /* 0x0025 0x01 */ MSCRIPT_AWAIT_TEXT(),
    /* 0x0026 0x01 */ MSCRIPT_CLOSE_TEXT(),
    /* 0x0027 0x05 */ MSCRIPT_BRANCH_ON_WEEK_EVENT_REG(WEEKEVENTREG_73_08, 0x0049 - 0x002C),
    ...
    /* 0x0037 0x03 */ MSCRIPT_JUMP(0x0),
    /* 0x003A 0x01 */ MSCRIPT_AWAIT_TEXT_DONE(),
    ...
    /* 0x0042 0x03 */ MSCRIPT_WEEK_EVENT_REG_SET(WEEKEVENTREG_73_08),
    /* 0x0045 0x03 */ MSCRIPT_WEEK_EVENT_REG_SET(WEEKEVENTREG_90_80),
    ...
    /* 0x0054 0x03 */ MSCRIPT_JUMP(0x0),
    /* 0x0057 0x01 */ MSCRIPT_AWAIT_TEXT_DONE(),
    /* 0x0058 0x03 */ MSCRIPT_NOTEBOOK_EVENT(BOMBERS_NOTEBOOK_EVENT_MET_TOLIET_HAND),
    /* 0x005B 0x01 */ MSCRIPT_AWAIT_TEXT(),
    /* 0x005C 0x03 */ MSCRIPT_WEEK_EVENT_REG_SET(WEEKEVENTREG_90_80),
    /* 0x005F 0x01 */ MSCRIPT_DONE(),

    /* 0x0060 0x03 */ MSCRIPT_PLAYER_TALK(0x2949),
    /* 0x0063 0x01 */ MSCRIPT_AWAIT_TEXT(),
    /* 0x0064 0x03 */ MSCRIPT_JUMP(0x0),
