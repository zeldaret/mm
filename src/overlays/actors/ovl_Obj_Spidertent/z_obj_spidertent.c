...
ActorInit Obj_Spidertent_InitVars = {
    ACTOR_OBJ_SPIDERTENT,  ACTORCAT_BG,           FLAGS,
    OBJECT_SPIDERTENT,     sizeof(ObjSpidertent), ObjSpidertent_Init,
    ObjSpidertent_Destroy, ObjSpidertent_Update,  ObjSpidertent_Draw,
};
