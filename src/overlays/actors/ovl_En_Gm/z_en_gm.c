...
s32 func_80950690(EnGm* this, GlobalContext* globalCtx) {
    ...
    switch (this->unk_258) {
        ...
        case 7:
            this->unk_3D0 += 992;
            if (DECR(this->unk_3B8) == 0) {
                Audio_PlayActorSound2(&this->actor, NA_SE_VO_GO_SLEEP);
                this->unk_3B8 = 30;
            }
            break;
...
void func_80950F2C(EnGm* this, GlobalContext* globalCtx) {
    ...
    if (Cutscene_CheckActorAction(globalCtx, 0x20E)) {
        sp2C = globalCtx->csCtx.actorActions[Cutscene_GetActorActionIndex(globalCtx, 0x20E)]->action;
