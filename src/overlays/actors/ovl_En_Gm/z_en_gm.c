...
static MsgScript D_80951A98[] = {
    /* 0x0000 0x05 */ MSCRIPT_BRANCH_ON_WEEK_EVENT_REG(WEEKEVENTREG_86_40, 0x001F - 0x0005),
    ...
    /* 0x001B 0x03 */ MSCRIPT_SET_WEEK_EVENT_REG(WEEKEVENTREG_86_40),
    ...
    /* 0x0026 0x03 */ MSCRIPT_BRANCH_ON_CALLBACK(0x0),
...
static MsgScript D_80951AD8[] = {
    /* 0x0000 0x05 */ MSCRIPT_BRANCH_ON_WEEK_EVENT_REG(WEEKEVENTREG_86_20, 0x00A6 - 0x0005),
    /* 0x0005 0x03 */ MSCRIPT_BRANCH_ON_CALLBACK(0x0),
    ...
    /* 0x003C 0x03 */ MSCRIPT_BRANCH_ON_CALLBACK(0x0),
    ...
    /* 0x00A1 0x03 */ MSCRIPT_SET_WEEK_EVENT_REG(WEEKEVENTREG_86_20),
    /* 0x00A4 0x01 */ MSCRIPT_CLOSE_TEXT(),
    /* 0x00A5 0x01 */ MSCRIPT_DONE(),

    /* 0x00A6 0x03 */ MSCRIPT_BRANCH_ON_CALLBACK(0x0),
    /* 0x00A9 0x03 */ MSCRIPT_BEGIN_TEXT(0x2AEA),
    /* 0x00AC 0x01 */ MSCRIPT_AWAIT_TEXT(),
    /* 0x00AD 0x03 */ MSCRIPT_BRANCH_ON_CALLBACK(0x0),
    ...
    /* 0x00BB 0x03 */ MSCRIPT_BRANCH_ON_CALLBACK(0x0),
    /* 0x00BE 0x01 */ MSCRIPT_CLOSE_TEXT(),
    /* 0x00BF 0x01 */ MSCRIPT_DONE(),
};

static MsgScript D_80951B98[] = {
    /* 0x0000 0x05 */ MSCRIPT_BRANCH_ON_WEEK_EVENT_REG(WEEKEVENTREG_75_01, 0x0047 - 0x0005),
    /* 0x0005 0x03 */ MSCRIPT_BRANCH_ON_CALLBACK(0x0),
    ...
    /* 0x003E 0x03 */ MSCRIPT_SET_WEEK_EVENT_REG(WEEKEVENTREG_75_01),
...
static MsgScript D_80951BE8[] = {
    ...
    /* 0x0003 0x05 */ MSCRIPT_BRANCH_ON_WEEK_EVENT_REG(WEEKEVENTREG_50_01, 0x0039 - 0x0008),
    /* 0x0008 0x05 */ MSCRIPT_BRANCH_ON_WEEK_EVENT_REG(WEEKEVENTREG_51_80, 0x0039 - 0x000D),
    /* 0x000D 0x05 */ MSCRIPT_BRANCH_ON_WEEK_EVENT_REG(WEEKEVENTREG_75_02, 0x001F - 0x0012),
    ...
    /* 0x0019 0x03 */ MSCRIPT_SET_WEEK_EVENT_REG(WEEKEVENTREG_75_02),
