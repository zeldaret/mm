...
static u8 D_80951820[] = {
    /* 0x0000 */ SCHEDULE_CMD_CHECK_DAY_L(1, 0x013B - 0x0005),
    /* 0x0005 */ SCHEDULE_CMD_CHECK_SCENE_S(SCENE_YADOYA, 0x002E - 0x0009),
    /* 0x0009 */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(6, 0, 9, 0, 0x0028 - 0x000F),
    /* 0x000F */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(9, 0, 9, 10, 0x0022 - 0x0015),
    /* 0x0015 */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(9, 10, 9, 15, 0x001C - 0x001B),
    /* 0x001B */ SCHEDULE_CMD_RET_NONE(),
    /* 0x001C */ SCHEDULE_CMD_RET_TIME(9, 10, 9, 15, 15),
    /* 0x0022 */ SCHEDULE_CMD_RET_TIME(9, 0, 9, 10, 24),
    /* 0x0028 */ SCHEDULE_CMD_RET_TIME(6, 0, 9, 0, 6),
    /* 0x002E */ SCHEDULE_CMD_CHECK_SCENE_S(SCENE_TOWN, 0x007B - 0x0032),
    /* 0x0032 */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(9, 10, 9, 15, 0x0075 - 0x0038),
    /* 0x0038 */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(9, 15, 10, 0, 0x006F - 0x003E),
    /* 0x003E */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(10, 0, 10, 5, 0x0069 - 0x0044),
    /* 0x0044 */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(12, 15, 12, 20, 0x0063 - 0x004A),
    /* 0x004A */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(12, 20, 12, 50, 0x005D - 0x0050),
    /* 0x0050 */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(12, 50, 12, 55, 0x0057 - 0x0056),
    /* 0x0056 */ SCHEDULE_CMD_RET_NONE(),
    /* 0x0057 */ SCHEDULE_CMD_RET_TIME(12, 50, 12, 55, 12),
    /* 0x005D */ SCHEDULE_CMD_RET_TIME(12, 20, 12, 50, 22),
    /* 0x0063 */ SCHEDULE_CMD_RET_TIME(12, 15, 12, 20, 11),
    /* 0x0069 */ SCHEDULE_CMD_RET_TIME(10, 0, 10, 5, 10),
    /* 0x006F */ SCHEDULE_CMD_RET_TIME(9, 15, 10, 0, 21),
    /* 0x0075 */ SCHEDULE_CMD_RET_TIME(9, 10, 9, 15, 9),
    /* 0x007B */ SCHEDULE_CMD_CHECK_SCENE_L(SCENE_SONCHONOIE, 0x0105 - 0x0080),
    /* 0x0080 */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(10, 0, 10, 5, 0x00FF - 0x0086),
    /* 0x0086 */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(10, 5, 10, 10, 0x00F9 - 0x008C),
    /* 0x008C */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(10, 10, 10, 30, 0x00F3 - 0x0092),
    /* 0x0092 */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(10, 30, 10, 40, 0x00ED - 0x0098),
    /* 0x0098 */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(10, 40, 10, 45, 0x00E7 - 0x009E),
    /* 0x009E */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(10, 45, 10, 55, 0x00E1 - 0x00A4),
    /* 0x00A4 */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(10, 55, 11, 45, 0x00DB - 0x00AA),
    /* 0x00AA */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(11, 45, 11, 55, 0x00D5 - 0x00B0),
    /* 0x00B0 */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(11, 55, 12, 0, 0x00CF - 0x00B6),
    /* 0x00B6 */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(12, 0, 12, 15, 0x00C9 - 0x00BC),
    /* 0x00BC */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(12, 15, 12, 20, 0x00C3 - 0x00C2),
    /* 0x00C2 */ SCHEDULE_CMD_RET_NONE(),
    /* 0x00C3 */ SCHEDULE_CMD_RET_TIME(12, 15, 12, 20, 17),
    /* 0x00C9 */ SCHEDULE_CMD_RET_TIME(12, 0, 12, 15, 29),
    /* 0x00CF */ SCHEDULE_CMD_RET_TIME(11, 55, 12, 0, 19),
    /* 0x00D5 */ SCHEDULE_CMD_RET_TIME(11, 45, 11, 55, 28),
    /* 0x00DB */ SCHEDULE_CMD_RET_TIME(10, 55, 11, 45, 2),
    /* 0x00E1 */ SCHEDULE_CMD_RET_TIME(10, 45, 10, 55, 27),
    /* 0x00E7 */ SCHEDULE_CMD_RET_TIME(10, 40, 10, 45, 18),
    /* 0x00ED */ SCHEDULE_CMD_RET_TIME(10, 30, 10, 40, 26),
    /* 0x00F3 */ SCHEDULE_CMD_RET_TIME(10, 10, 10, 30, 1),
    /* 0x00F9 */ SCHEDULE_CMD_RET_TIME(10, 5, 10, 10, 25),
    /* 0x00FF */ SCHEDULE_CMD_RET_TIME(10, 0, 10, 5, 16),
    /* 0x0105 */ SCHEDULE_CMD_CHECK_SCENE_S(SCENE_MILK_BAR, 0x013A - 0x0109),
    /* 0x0109 */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(12, 55, 13, 0, 0x0134 - 0x010F),
    /* 0x010F */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(13, 0, 13, 25, 0x012E - 0x0115),
    /* 0x0115 */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(13, 25, 21, 5, 0x0128 - 0x011B),
    /* 0x011B */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(21, 55, 5, 5, 0x0122 - 0x0121),
    /* 0x0121 */ SCHEDULE_CMD_RET_NONE(),
    /* 0x0122 */ SCHEDULE_CMD_RET_TIME(21, 55, 5, 5, 5),
    /* 0x0128 */ SCHEDULE_CMD_RET_TIME(13, 25, 21, 5, 3),
    /* 0x012E */ SCHEDULE_CMD_RET_TIME(13, 0, 13, 25, 30),
    /* 0x0134 */ SCHEDULE_CMD_RET_TIME(12, 55, 13, 0, 20),
    /* 0x013A */ SCHEDULE_CMD_RET_NONE(),
    /* 0x013B */ SCHEDULE_CMD_CHECK_DAY_L(2, 0x01EB - 0x0140),
    /* 0x0140 */ SCHEDULE_CMD_CHECK_FLAG_L(0x32, 0x01, 0x01CD - 0x0145),
    /* 0x0145 */ SCHEDULE_CMD_CHECK_SCENE_S(SCENE_YADOYA, 0x017A - 0x0149),
    /* 0x0149 */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(6, 0, 18, 0, 0x0174 - 0x014F),
    /* 0x014F */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(18, 0, 21, 0, 0x016E - 0x0155),
    /* 0x0155 */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(21, 0, 21, 10, 0x0168 - 0x015B),
    /* 0x015B */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(21, 10, 21, 15, 0x0162 - 0x0161),
    /* 0x0161 */ SCHEDULE_CMD_RET_NONE(),
    /* 0x0162 */ SCHEDULE_CMD_RET_TIME(21, 10, 21, 15, 15),
    /* 0x0168 */ SCHEDULE_CMD_RET_TIME(21, 0, 21, 10, 24),
    /* 0x016E */ SCHEDULE_CMD_RET_TIME(18, 0, 21, 0, 6),
    /* 0x0174 */ SCHEDULE_CMD_RET_TIME(6, 0, 18, 0, 7),
    /* 0x017A */ SCHEDULE_CMD_CHECK_SCENE_S(SCENE_TOWN, 0x01A3 - 0x017E),
    /* 0x017E */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(21, 10, 21, 15, 0x019D - 0x0184),
    /* 0x0184 */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(21, 15, 21, 25, 0x0197 - 0x018A),
    /* 0x018A */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(21, 25, 21, 30, 0x0191 - 0x0190),
    /* 0x0190 */ SCHEDULE_CMD_RET_NONE(),
    /* 0x0191 */ SCHEDULE_CMD_RET_TIME(21, 25, 21, 30, 14),
    /* 0x0197 */ SCHEDULE_CMD_RET_TIME(21, 15, 21, 25, 23),
    /* 0x019D */ SCHEDULE_CMD_RET_TIME(21, 10, 21, 15, 13),
    /* 0x01A3 */ SCHEDULE_CMD_CHECK_SCENE_S(SCENE_MILK_BAR, 0x01CC - 0x01A7),
    /* 0x01A7 */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(21, 30, 21, 45, 0x01C6 - 0x01AD),
    /* 0x01AD */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(21, 45, 22, 10, 0x01C0 - 0x01B3),
    /* 0x01B3 */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(22, 10, 6, 0, 0x01BA - 0x01B9),
    /* 0x01B9 */ SCHEDULE_CMD_RET_NONE(),
    /* 0x01BA */ SCHEDULE_CMD_RET_TIME(22, 10, 6, 0, 5),
    /* 0x01C0 */ SCHEDULE_CMD_RET_TIME(21, 45, 22, 10, 30),
    /* 0x01C6 */ SCHEDULE_CMD_RET_TIME(21, 30, 21, 45, 20),
    /* 0x01CC */ SCHEDULE_CMD_RET_NONE(),
    /* 0x01CD */ SCHEDULE_CMD_CHECK_SCENE_S(SCENE_YADOYA, 0x01EA - 0x01D1),
    /* 0x01D1 */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(6, 0, 18, 0, 0x01E4 - 0x01D7),
    /* 0x01D7 */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(18, 0, 6, 0, 0x01DE - 0x01DD),
    /* 0x01DD */ SCHEDULE_CMD_RET_NONE(),
    /* 0x01DE */ SCHEDULE_CMD_RET_TIME(0, 0, 0, 0, 8),
    /* 0x01E4 */ SCHEDULE_CMD_RET_TIME(6, 0, 18, 0, 7),
    /* 0x01EA */ SCHEDULE_CMD_RET_NONE(),
    /* 0x01EB */ SCHEDULE_CMD_RET_NONE(),
};
