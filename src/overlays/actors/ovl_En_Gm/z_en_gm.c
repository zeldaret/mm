...
s32 func_8094E52C(EnGm* this, PlayState* play) {
    ...
    switch (this->unk_3E0) {
        ...
        case 2:
            if (!(GET_WEEKEVENTREG(WEEKEVENTREG_86_40)) && (this->unk_3E0 == 2)) {
...
s32 func_8094EB1C(EnGm* this, PlayState* play) {
    ...
    switch (this->unk_3E0) {
        case 0:
            if ((GET_WEEKEVENTREG(WEEKEVENTREG_50_01)) || (GET_WEEKEVENTREG(WEEKEVENTREG_51_80)) ||
                (GET_WEEKEVENTREG(WEEKEVENTREG_75_02))) {
                ret = true;
                break;
            }
            Actor_PlaySfxAtPos(&this->actor, NA_SE_EV_CHAIR_ROLL);
...
s32 func_8094EE84(EnGm* this, PlayState* play) {
    ...
    if (this->unk_3A4 & 7) {
        if (Actor_ProcessTalkRequest(&this->actor, &play->state)) {
            ...
            if ((this->unk_258 == 5) && !(GET_WEEKEVENTREG(WEEKEVENTREG_50_01)) &&
                !(GET_WEEKEVENTREG(WEEKEVENTREG_51_80)) && !(GET_WEEKEVENTREG(WEEKEVENTREG_75_02))) {
                this->unk_3A4 |= 0x20;
            } else if ((this->unk_258 != 1) && (this->unk_258 != 5) && (this->unk_258 != 7)) {
                this->unk_3A4 |= 0x20;
            }

            if ((this->unk_258 == 3) && (GET_WEEKEVENTREG(WEEKEVENTREG_75_01))) {
                this->unk_3A4 &= ~0x20;
            }
...
s32 func_8094FE10(EnGm* this, PlayState* play, ScheduleOutput* scheduleOutput) {
    ...
    if (func_8094F7D0(this, play, scheduleOutput, ACTORCAT_NPC, ACTOR_EN_TOTO) && (al != NULL) &&
        ...
        SubS_UpdateFlags(&this->unk_3A4, 3, 7);
        this->unk_268 = al;
        if (!(GET_WEEKEVENTREG(WEEKEVENTREG_86_20))) {
            this->unk_3C8 = 2;
            this->unk_3CA = 2;
            this->unk_3CC = 8;
        }
