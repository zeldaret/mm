...
s32 func_8094EE84(EnGm* this, PlayState* play) {
    ...
    if (((this->unk_3A4 & SUBS_OFFER_MODE_MAX) != SUBS_OFFER_MODE_NONE) &&
        Actor_ProcessTalkRequest(&this->actor, &play->state)) {
        SubS_UpdateFlags(&this->unk_3A4, SUBS_OFFER_MODE_NONE, SUBS_OFFER_MODE_MAX);
        this->unk_3E0 = 0;
        this->unk_3E4 = NULL;
...
s32 func_8094FAC4(EnGm* this, PlayState* play, ScheduleOutput* scheduleOutput) {
    ...
    if (this->timePath != NULL) {
        ...
        this->unk_3A4 &= ~0x8;
        this->unk_3A4 &= ~0x10;
        SubS_UpdateFlags(&this->unk_3A4, SUBS_OFFER_MODE_ONSCREEN, SUBS_OFFER_MODE_MAX);
        this->unk_3A4 |= 0x100;
        this->unk_3A4 |= 0x200;
        func_8094E054(this, play, 7);
...
void EnGm_Update(Actor* thisx, PlayState* play) {
    ...
    if (!func_8094E0F8(this, play)) {
        ...
        if (this->unk_258 != 0) {
            ...
            func_8094E2D0(this);
            func_8094F2E8(this);
            SubS_OfferItem(&this->actor, play, this->unk_3B4, 30.0f, PLAYER_IA_NONE,
                           this->unk_3A4 & SUBS_OFFER_MODE_MAX);
