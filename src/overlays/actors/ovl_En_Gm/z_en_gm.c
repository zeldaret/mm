...
static MsgScript D_80951AD8[] = {
    ...
    /* 0x003C 0x03 */ MSCRIPT_CHECK_CALLBACK(0x0),
    ...
    /* 0x00A6 0x03 */ MSCRIPT_CHECK_CALLBACK(0x0),
    /* 0x00A9 0x03 */ MSCRIPT_BEGIN_TEXT(0x2AEA),
    /* 0x00AC 0x01 */ MSCRIPT_AWAIT_TEXT(),
    /* 0x00AD 0x03 */ MSCRIPT_CHECK_CALLBACK(0x0),
    ...
    /* 0x00BB 0x03 */ MSCRIPT_CHECK_CALLBACK(0x0),
