...
ActorInit Obj_Makekinsuta_InitVars = {
    ACTOR_OBJ_MAKEKINSUTA,  ACTORCAT_ITEMACTION,   FLAGS, GAMEPLAY_KEEP, sizeof(ObjMakekinsuta), ObjMakekinsuta_Init,
    ObjMakekinsuta_Destroy, ObjMakekinsuta_Update, NULL,
};
