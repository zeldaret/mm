...
s32 func_80AF86F0(EnPm* this, PlayState* play) {
    ...
    if (((this->unk_356 & SUBS_OFFER_MODE_MAX) != SUBS_OFFER_MODE_NONE) &&
        Actor_ProcessTalkRequest(&this->actor, &play->state)) {
        SubS_UpdateFlags(&this->unk_356, SUBS_OFFER_MODE_NONE, SUBS_OFFER_MODE_MAX);
        this->unk_398 = 0;
        this->unk_378 = 0;
        this->unk_37C = NULL;
...
s32 func_80AF91E8(EnPm* this, PlayState* play, ScheduleOutput* scheduleOutput) {
    ...
    if (this->timePath != 0) {
        ...
        switch (scheduleOutput->result) {
            ...
            default:
                SubS_UpdateFlags(&this->unk_356, SUBS_OFFER_MODE_ONSCREEN, SUBS_OFFER_MODE_MAX);
                func_80AF7E98(this, 0);
                if (CHECK_WEEKEVENTREG(WEEKEVENTREG_90_08)) {
                    this->unk_356 |= 0x800;
                }
...
void EnPm_Update(Actor* thisx, PlayState* play) {
    ...
    if (!func_80AF86F0(this, play) && func_80AF87C4(this, play)) {
        ...
        if (this->unk_258 != 0) {
            ...
            func_80AF7E6C(this);
            func_80AF8AC8(this);
            SubS_OfferItem(&this->actor, play, this->unk_368, 30.0f, this->unk_394,
                           this->unk_356 & SUBS_OFFER_MODE_MAX);
            Actor_MoveWithGravity(&this->actor);
            Actor_UpdateBgCheckInfo(play, &this->actor, 30.0f, 12.0f, 0.0f, UPDBGCHECKINFO_FLAG_4);
