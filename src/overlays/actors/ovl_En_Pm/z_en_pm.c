...
static u8 D_80AFAD80[] = {
    /* 0x0000 */ SCHEDULE_CMD_CHECK_DAY_L(1, 0x0240 - 0x0005),
    /* 0x0005 */ SCHEDULE_CMD_CHECK_TIME_RANGE_L(9, 0, 12, 0, 0x0117 - 0x000C),
    /* 0x000C */ SCHEDULE_CMD_CHECK_TIME_RANGE_L(12, 0, 13, 1, 0x010C - 0x0013),
    /* 0x0013 */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(13, 1, 15, 0, 0x002B - 0x0019),
    /* 0x0019 */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(15, 0, 0, 5, 0x0020 - 0x001F),
    /* 0x001F */ SCHEDULE_CMD_RET_NONE(),
    /* 0x0020 */ SCHEDULE_CMD_CHECK_SCENE_S(SCENE_POSTHOUSE, 0x002A - 0x0024),
    /* 0x0024 */ SCHEDULE_CMD_RET_TIME(15, 0, 0, 5, 8),
    /* 0x002A */ SCHEDULE_CMD_RET_NONE(),
    /* 0x002B */ SCHEDULE_CMD_CHECK_SCENE_S(SCENE_ICHIBA, 0x0060 - 0x002F),
    /* 0x002F */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(13, 1, 13, 4, 0x005A - 0x0035),
    /* 0x0035 */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(13, 4, 13, 21, 0x0054 - 0x003B),
    /* 0x003B */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(14, 48, 14, 56, 0x004E - 0x0041),
    /* 0x0041 */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(14, 56, 15, 0, 0x0048 - 0x0047),
    /* 0x0047 */ SCHEDULE_CMD_RET_NONE(),
    /* 0x0048 */ SCHEDULE_CMD_RET_TIME(14, 56, 15, 0, 2),
    /* 0x004E */ SCHEDULE_CMD_RET_TIME(14, 48, 14, 56, 62),
    /* 0x0054 */ SCHEDULE_CMD_RET_TIME(13, 4, 13, 21, 53),
    /* 0x005A */ SCHEDULE_CMD_RET_TIME(13, 1, 13, 4, 1),
    /* 0x0060 */ SCHEDULE_CMD_CHECK_SCENE_S(SCENE_CLOCKTOWER, 0x0095 - 0x0064),
    /* 0x0064 */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(13, 4, 13, 21, 0x008F - 0x006A),
    /* 0x006A */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(13, 21, 13, 39, 0x0089 - 0x0070),
    /* 0x0070 */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(14, 38, 14, 48, 0x0083 - 0x0076),
    /* 0x0076 */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(14, 48, 14, 56, 0x007D - 0x007C),
    /* 0x007C */ SCHEDULE_CMD_RET_NONE(),
    /* 0x007D */ SCHEDULE_CMD_RET_TIME(14, 48, 14, 56, 61),
    /* 0x0083 */ SCHEDULE_CMD_RET_TIME(14, 38, 14, 48, 60),
    /* 0x0089 */ SCHEDULE_CMD_RET_TIME(13, 21, 13, 39, 55),
    /* 0x008F */ SCHEDULE_CMD_RET_TIME(13, 4, 13, 21, 54),
    /* 0x0095 */ SCHEDULE_CMD_CHECK_SCENE_S(SCENE_TOWN, 0x00CA - 0x0099),
    /* 0x0099 */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(13, 39, 13, 56, 0x00C4 - 0x009F),
    /* 0x009F */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(13, 56, 14, 0, 0x00BE - 0x00A5),
    /* 0x00A5 */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(14, 26, 14, 30, 0x00B8 - 0x00AB),
    /* 0x00AB */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(14, 30, 14, 38, 0x00B2 - 0x00B1),
    /* 0x00B1 */ SCHEDULE_CMD_RET_NONE(),
    /* 0x00B2 */ SCHEDULE_CMD_RET_TIME(14, 30, 14, 38, 59),
    /* 0x00B8 */ SCHEDULE_CMD_RET_TIME(14, 26, 14, 30, 11),
    /* 0x00BE */ SCHEDULE_CMD_RET_TIME(13, 56, 14, 0, 10),
    /* 0x00C4 */ SCHEDULE_CMD_RET_TIME(13, 39, 13, 56, 56),
    /* 0x00CA */ SCHEDULE_CMD_CHECK_SCENE_S(SCENE_YADOYA, 0x010B - 0x00CE),
    /* 0x00CE */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(13, 56, 14, 0, 0x0105 - 0x00D4),
    /* 0x00D4 */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(14, 0, 14, 8, 0x00FF - 0x00DA),
    /* 0x00DA */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(14, 8, 14, 18, 0x00F9 - 0x00E0),
    /* 0x00E0 */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(14, 18, 14, 26, 0x00F3 - 0x00E6),
    /* 0x00E6 */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(14, 26, 14, 30, 0x00ED - 0x00EC),
    /* 0x00EC */ SCHEDULE_CMD_RET_NONE(),
    /* 0x00ED */ SCHEDULE_CMD_RET_TIME(14, 26, 14, 30, 13),
    /* 0x00F3 */ SCHEDULE_CMD_RET_TIME(14, 18, 14, 26, 58),
    /* 0x00F9 */ SCHEDULE_CMD_RET_TIME(14, 8, 14, 18, 16),
    /* 0x00FF */ SCHEDULE_CMD_RET_TIME(14, 0, 14, 8, 57),
    /* 0x0105 */ SCHEDULE_CMD_RET_TIME(13, 56, 14, 0, 12),
    /* 0x010B */ SCHEDULE_CMD_RET_NONE(),
    /* 0x010C */ SCHEDULE_CMD_CHECK_SCENE_S(SCENE_POSTHOUSE, 0x0116 - 0x0110),
    /* 0x0110 */ SCHEDULE_CMD_RET_TIME(12, 0, 13, 1, 9),
    /* 0x0116 */ SCHEDULE_CMD_RET_NONE(),
    /* 0x0117 */ SCHEDULE_CMD_CHECK_SCENE_S(SCENE_ICHIBA, 0x014C - 0x011B),
    /* 0x011B */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(9, 0, 9, 3, 0x0146 - 0x0121),
    /* 0x0121 */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(9, 3, 9, 17, 0x0140 - 0x0127),
    /* 0x0127 */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(11, 43, 11, 57, 0x013A - 0x012D),
    /* 0x012D */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(11, 57, 12, 0, 0x0134 - 0x0133),
    /* 0x0133 */ SCHEDULE_CMD_RET_NONE(),
    /* 0x0134 */ SCHEDULE_CMD_RET_TIME(11, 57, 12, 0, 2),
    /* 0x013A */ SCHEDULE_CMD_RET_TIME(11, 43, 11, 57, 52),
    /* 0x0140 */ SCHEDULE_CMD_RET_TIME(9, 3, 9, 17, 38),
    /* 0x0146 */ SCHEDULE_CMD_RET_TIME(9, 0, 9, 3, 1),
    /* 0x014C */ SCHEDULE_CMD_CHECK_SCENE_S(SCENE_CLOCKTOWER, 0x01B1 - 0x0150),
    /* 0x0150 */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(9, 3, 9, 17, 0x01AB - 0x0156),
    /* 0x0156 */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(9, 17, 9, 31, 0x01A5 - 0x015C),
    /* 0x015C */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(9, 31, 9, 35, 0x019F - 0x0162),
    /* 0x0162 */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(9, 35, 9, 49, 0x0199 - 0x0168),
    /* 0x0168 */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(10, 57, 11, 11, 0x0193 - 0x016E),
    /* 0x016E */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(11, 11, 11, 25, 0x018D - 0x0174),
    /* 0x0174 */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(11, 25, 11, 29, 0x0187 - 0x017A),
    /* 0x017A */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(11, 29, 11, 43, 0x0181 - 0x0180),
    /* 0x0180 */ SCHEDULE_CMD_RET_NONE(),
    /* 0x0181 */ SCHEDULE_CMD_RET_TIME(11, 29, 11, 43, 50),
    /* 0x0187 */ SCHEDULE_CMD_RET_TIME(11, 25, 11, 29, 7),
    /* 0x018D */ SCHEDULE_CMD_RET_TIME(11, 11, 11, 25, 48),
    /* 0x0193 */ SCHEDULE_CMD_RET_TIME(10, 57, 11, 11, 47),
    /* 0x0199 */ SCHEDULE_CMD_RET_TIME(9, 35, 9, 49, 41),
    /* 0x019F */ SCHEDULE_CMD_RET_TIME(9, 31, 9, 35, 3),
    /* 0x01A5 */ SCHEDULE_CMD_RET_TIME(9, 17, 9, 31, 40),
    /* 0x01AB */ SCHEDULE_CMD_RET_TIME(9, 3, 9, 17, 39),
    /* 0x01B1 */ SCHEDULE_CMD_CHECK_SCENE_S(SCENE_BACKTOWN, 0x01DA - 0x01B5),
    /* 0x01B5 */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(9, 49, 10, 3, 0x01D4 - 0x01BB),
    /* 0x01BB */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(10, 3, 10, 7, 0x01CE - 0x01C1),
    /* 0x01C1 */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(10, 7, 10, 21, 0x01C8 - 0x01C7),
    /* 0x01C7 */ SCHEDULE_CMD_RET_NONE(),
    /* 0x01C8 */ SCHEDULE_CMD_RET_TIME(10, 7, 10, 21, 43),
    /* 0x01CE */ SCHEDULE_CMD_RET_TIME(10, 3, 10, 7, 4),
    /* 0x01D4 */ SCHEDULE_CMD_RET_TIME(9, 49, 10, 3, 42),
    /* 0x01DA */ SCHEDULE_CMD_CHECK_SCENE_S(SCENE_TOWN, 0x023F - 0x01DE),
    /* 0x01DE */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(10, 21, 10, 35, 0x0239 - 0x01E4),
    /* 0x01E4 */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(10, 35, 10, 39, 0x0233 - 0x01EA),
    /* 0x01EA */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(10, 39, 10, 53, 0x022D - 0x01F0),
    /* 0x01F0 */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(10, 53, 10, 57, 0x0227 - 0x01F6),
    /* 0x01F6 */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(10, 57, 11, 11, 0x0221 - 0x01FC),
    /* 0x01FC */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(11, 11, 11, 25, 0x021B - 0x0202),
    /* 0x0202 */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(11, 25, 11, 29, 0x0215 - 0x0208),
    /* 0x0208 */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(11, 29, 11, 43, 0x020F - 0x020E),
    /* 0x020E */ SCHEDULE_CMD_RET_NONE(),
    /* 0x020F */ SCHEDULE_CMD_RET_TIME(11, 29, 11, 43, 51),
    /* 0x0215 */ SCHEDULE_CMD_RET_TIME(11, 25, 11, 29, 7),
    /* 0x021B */ SCHEDULE_CMD_RET_TIME(11, 11, 11, 25, 49),
    /* 0x0221 */ SCHEDULE_CMD_RET_TIME(10, 57, 11, 11, 46),
    /* 0x0227 */ SCHEDULE_CMD_RET_TIME(10, 53, 10, 57, 6),
    /* 0x022D */ SCHEDULE_CMD_RET_TIME(10, 39, 10, 53, 45),
    /* 0x0233 */ SCHEDULE_CMD_RET_TIME(10, 35, 10, 39, 5),
    /* 0x0239 */ SCHEDULE_CMD_RET_TIME(10, 21, 10, 35, 44),
    /* 0x023F */ SCHEDULE_CMD_RET_NONE(),
    /* 0x0240 */ SCHEDULE_CMD_CHECK_DAY_L(2, 0x0414 - 0x0245),
    /* 0x0245 */ SCHEDULE_CMD_CHECK_FLAG_L(0x1C, 0x08, 0x02EF - 0x024A),
    /* 0x024A */ SCHEDULE_CMD_CHECK_TIME_RANGE_L(9, 0, 12, 0, 0x0117 - 0x0251),
    /* 0x0251 */ SCHEDULE_CMD_CHECK_TIME_RANGE_L(12, 0, 13, 1, 0x02E4 - 0x0258),
    /* 0x0258 */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(13, 1, 15, 0, 0x02DC - 0x025E),
    /* 0x025E */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(0, 0, 2, 0, 0x0265 - 0x0264),
    /* 0x0264 */ SCHEDULE_CMD_RET_NONE(),
    /* 0x0265 */ SCHEDULE_CMD_CHECK_SCENE_S(SCENE_ICHIBA, 0x029A - 0x0269),
    /* 0x0269 */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(0, 0, 0, 4, 0x0294 - 0x026F),
    /* 0x026F */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(0, 4, 0, 31, 0x028E - 0x0275),
    /* 0x0275 */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(1, 29, 1, 56, 0x0288 - 0x027B),
    /* 0x027B */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(1, 56, 2, 0, 0x0282 - 0x0281),
    /* 0x0281 */ SCHEDULE_CMD_RET_NONE(),
    /* 0x0282 */ SCHEDULE_CMD_RET_TIME(1, 56, 2, 0, 2),
    /* 0x0288 */ SCHEDULE_CMD_RET_TIME(1, 29, 1, 56, 79),
    /* 0x028E */ SCHEDULE_CMD_RET_TIME(0, 4, 0, 31, 74),
    /* 0x0294 */ SCHEDULE_CMD_RET_TIME(0, 0, 0, 4, 1),
    /* 0x029A */ SCHEDULE_CMD_CHECK_SCENE_S(SCENE_CLOCKTOWER, 0x02DB - 0x029E),
    /* 0x029E */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(0, 4, 0, 31, 0x02D5 - 0x02A4),
    /* 0x02A4 */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(0, 31, 0, 58, 0x02CF - 0x02AA),
    /* 0x02AA */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(0, 58, 1, 2, 0x02C9 - 0x02B0),
    /* 0x02B0 */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(1, 2, 1, 29, 0x02C3 - 0x02B6),
    /* 0x02B6 */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(1, 29, 1, 56, 0x02BD - 0x02BC),
    /* 0x02BC */ SCHEDULE_CMD_RET_NONE(),
    /* 0x02BD */ SCHEDULE_CMD_RET_TIME(1, 29, 1, 56, 78),
    /* 0x02C3 */ SCHEDULE_CMD_RET_TIME(1, 2, 1, 29, 77),
    /* 0x02C9 */ SCHEDULE_CMD_RET_TIME(0, 58, 1, 2, 18),
    /* 0x02CF */ SCHEDULE_CMD_RET_TIME(0, 31, 0, 58, 76),
    /* 0x02D5 */ SCHEDULE_CMD_RET_TIME(0, 4, 0, 31, 75),
    /* 0x02DB */ SCHEDULE_CMD_RET_NONE(),
    /* 0x02DC */ SCHEDULE_CMD_CHECK_SCENE_S(SCENE_POSTHOUSE, 0x02E3 - 0x02E0),
    /* 0x02E0 */ SCHEDULE_CMD_RET_VAL_L(14),
    /* 0x02E3 */ SCHEDULE_CMD_RET_NONE(),
    /* 0x02E4 */ SCHEDULE_CMD_CHECK_SCENE_S(SCENE_POSTHOUSE, 0x02EE - 0x02E8),
    /* 0x02E8 */ SCHEDULE_CMD_RET_TIME(12, 0, 13, 1, 20),
    /* 0x02EE */ SCHEDULE_CMD_RET_NONE(),
    /* 0x02EF */ SCHEDULE_CMD_CHECK_TIME_RANGE_L(9, 0, 12, 0, 0x0117 - 0x02F6),
    /* 0x02F6 */ SCHEDULE_CMD_CHECK_TIME_RANGE_L(12, 0, 13, 1, 0x0409 - 0x02FD),
    /* 0x02FD */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(13, 1, 17, 0, 0x0315 - 0x0303),
    /* 0x0303 */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(17, 0, 0, 5, 0x030A - 0x0309),
    /* 0x0309 */ SCHEDULE_CMD_RET_NONE(),
    /* 0x030A */ SCHEDULE_CMD_CHECK_SCENE_S(SCENE_POSTHOUSE, 0x0314 - 0x030E),
    /* 0x030E */ SCHEDULE_CMD_RET_TIME(17, 0, 0, 5, 8),
    /* 0x0314 */ SCHEDULE_CMD_RET_NONE(),
    /* 0x0315 */ SCHEDULE_CMD_CHECK_SCENE_S(SCENE_ICHIBA, 0x034A - 0x0319),
    /* 0x0319 */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(13, 1, 13, 4, 0x0344 - 0x031F),
    /* 0x031F */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(13, 4, 13, 15, 0x033E - 0x0325),
    /* 0x0325 */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(16, 35, 16, 57, 0x0338 - 0x032B),
    /* 0x032B */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(16, 57, 17, 0, 0x0332 - 0x0331),
    /* 0x0331 */ SCHEDULE_CMD_RET_NONE(),
    /* 0x0332 */ SCHEDULE_CMD_RET_TIME(16, 57, 17, 0, 2),
    /* 0x0338 */ SCHEDULE_CMD_RET_TIME(16, 35, 16, 57, 73),
    /* 0x033E */ SCHEDULE_CMD_RET_TIME(13, 4, 13, 15, 63),
    /* 0x0344 */ SCHEDULE_CMD_RET_TIME(13, 1, 13, 4, 1),
    /* 0x034A */ SCHEDULE_CMD_CHECK_SCENE_S(SCENE_CLOCKTOWER, 0x037F - 0x034E),
    /* 0x034E */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(13, 4, 13, 15, 0x0379 - 0x0354),
    /* 0x0354 */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(13, 15, 13, 30, 0x0373 - 0x035A),
    /* 0x035A */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(13, 52, 14, 45, 0x036D - 0x0360),
    /* 0x0360 */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(16, 15, 16, 35, 0x0367 - 0x0366),
    /* 0x0366 */ SCHEDULE_CMD_RET_NONE(),
    /* 0x0367 */ SCHEDULE_CMD_RET_TIME(16, 15, 16, 35, 72),
    /* 0x036D */ SCHEDULE_CMD_RET_TIME(13, 52, 14, 45, 67),
    /* 0x0373 */ SCHEDULE_CMD_RET_TIME(13, 15, 13, 30, 65),
    /* 0x0379 */ SCHEDULE_CMD_RET_TIME(13, 4, 13, 15, 64),
    /* 0x037F */ SCHEDULE_CMD_CHECK_SCENE_S(SCENE_TOWN, 0x039C - 0x0383),
    /* 0x0383 */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(13, 30, 13, 52, 0x0396 - 0x0389),
    /* 0x0389 */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(13, 52, 14, 50, 0x0390 - 0x038F),
    /* 0x038F */ SCHEDULE_CMD_RET_NONE(),
    /* 0x0390 */ SCHEDULE_CMD_RET_TIME(13, 52, 14, 50, 68),
    /* 0x0396 */ SCHEDULE_CMD_RET_TIME(13, 30, 13, 52, 66),
    /* 0x039C */ SCHEDULE_CMD_CHECK_SCENE_S(SCENE_ALLEY, 0x0408 - 0x03A0),
    /* 0x03A0 */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(14, 45, 15, 5, 0x0402 - 0x03A6),
    /* 0x03A6 */ SCHEDULE_CMD_CHECK_DAY_S(2, 0x03DB - 0x03AA),
    /* 0x03AA */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(15, 5, 15, 20, 0x03D5 - 0x03B0),
    /* 0x03B0 */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(15, 20, 15, 25, 0x03CF - 0x03B6),
    /* 0x03B6 */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(15, 25, 15, 40, 0x03C9 - 0x03BC),
    /* 0x03BC */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(15, 40, 16, 15, 0x03C3 - 0x03C2),
    /* 0x03C2 */ SCHEDULE_CMD_RET_NONE(),
    /* 0x03C3 */ SCHEDULE_CMD_RET_TIME(15, 40, 16, 15, 81),
    /* 0x03C9 */ SCHEDULE_CMD_RET_TIME(15, 25, 15, 40, 17),
    /* 0x03CF */ SCHEDULE_CMD_RET_TIME(15, 20, 15, 25, 80),
    /* 0x03D5 */ SCHEDULE_CMD_RET_TIME(15, 5, 15, 20, 23),
    /* 0x03DB */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(15, 5, 15, 20, 0x03FC - 0x03E1),
    /* 0x03E1 */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(15, 20, 15, 50, 0x03F6 - 0x03E7),
    /* 0x03E7 */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(15, 50, 16, 15, 0x03F0 - 0x03ED),
    /* 0x03ED */ SCHEDULE_CMD_RET_VAL_L(0),
    /* 0x03F0 */ SCHEDULE_CMD_RET_TIME(15, 50, 16, 15, 71),
    /* 0x03F6 */ SCHEDULE_CMD_RET_TIME(15, 20, 15, 50, 25),
    /* 0x03FC */ SCHEDULE_CMD_RET_TIME(15, 5, 15, 20, 23),
    /* 0x0402 */ SCHEDULE_CMD_RET_TIME(14, 45, 15, 5, 70),
    /* 0x0408 */ SCHEDULE_CMD_RET_NONE(),
    /* 0x0409 */ SCHEDULE_CMD_CHECK_SCENE_S(SCENE_POSTHOUSE, 0x0413 - 0x040D),
    /* 0x040D */ SCHEDULE_CMD_RET_TIME(12, 0, 13, 1, 21),
    /* 0x0413 */ SCHEDULE_CMD_RET_NONE(),
    /* 0x0414 */ SCHEDULE_CMD_CHECK_DAY_L(3, 0x0588 - 0x0419),
    /* 0x0419 */ SCHEDULE_CMD_CHECK_FLAG_L(0x1C, 0x08, 0x055D - 0x041E),
    /* 0x041E */ SCHEDULE_CMD_CHECK_FLAG_L(0x1C, 0x10, 0x052F - 0x0423),
    /* 0x0423 */ SCHEDULE_CMD_CHECK_TIME_RANGE_L(9, 0, 12, 0, 0x0117 - 0x042A),
    /* 0x042A */ SCHEDULE_CMD_CHECK_TIME_RANGE_L(12, 0, 13, 1, 0x0527 - 0x0431),
    /* 0x0431 */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(13, 1, 15, 0, 0x0446 - 0x0437),
    /* 0x0437 */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(18, 0, 6, 0, 0x043E - 0x043D),
    /* 0x043D */ SCHEDULE_CMD_RET_NONE(),
    /* 0x043E */ SCHEDULE_CMD_CHECK_SCENE_S(SCENE_POSTHOUSE, 0x0445 - 0x0442),
    /* 0x0442 */ SCHEDULE_CMD_RET_VAL_L(24),
    /* 0x0445 */ SCHEDULE_CMD_RET_NONE(),
    /* 0x0446 */ SCHEDULE_CMD_CHECK_SCENE_S(SCENE_ICHIBA, 0x047B - 0x044A),
    /* 0x044A */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(13, 0, 13, 1, 0x0475 - 0x0450),
    /* 0x0450 */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(13, 5, 13, 15, 0x046F - 0x0456),
    /* 0x0456 */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(14, 45, 14, 55, 0x0469 - 0x045C),
    /* 0x045C */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(14, 55, 15, 0, 0x0463 - 0x0462),
    /* 0x0462 */ SCHEDULE_CMD_RET_NONE(),
    /* 0x0463 */ SCHEDULE_CMD_RET_TIME(14, 55, 15, 0, 2),
    /* 0x0469 */ SCHEDULE_CMD_RET_TIME(14, 45, 14, 55, 52),
    /* 0x046F */ SCHEDULE_CMD_RET_TIME(13, 5, 13, 15, 38),
    /* 0x0475 */ SCHEDULE_CMD_RET_TIME(13, 0, 13, 1, 1),
    /* 0x047B */ SCHEDULE_CMD_CHECK_SCENE_S(SCENE_CLOCKTOWER, 0x04C8 - 0x047F),
    /* 0x047F */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(13, 5, 13, 15, 0x04C2 - 0x0485),
    /* 0x0485 */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(13, 15, 13, 25, 0x04BC - 0x048B),
    /* 0x048B */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(13, 25, 13, 35, 0x04B6 - 0x0491),
    /* 0x0491 */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(14, 15, 14, 25, 0x04B0 - 0x0497),
    /* 0x0497 */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(14, 25, 14, 35, 0x04AA - 0x049D),
    /* 0x049D */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(14, 35, 14, 45, 0x04A4 - 0x04A3),
    /* 0x04A3 */ SCHEDULE_CMD_RET_NONE(),
    /* 0x04A4 */ SCHEDULE_CMD_RET_TIME(14, 35, 14, 45, 50),
    /* 0x04AA */ SCHEDULE_CMD_RET_TIME(14, 25, 14, 35, 48),
    /* 0x04B0 */ SCHEDULE_CMD_RET_TIME(14, 15, 14, 25, 47),
    /* 0x04B6 */ SCHEDULE_CMD_RET_TIME(13, 25, 13, 35, 41),
    /* 0x04BC */ SCHEDULE_CMD_RET_TIME(13, 15, 13, 25, 40),
    /* 0x04C2 */ SCHEDULE_CMD_RET_TIME(13, 5, 13, 15, 39),
    /* 0x04C8 */ SCHEDULE_CMD_CHECK_SCENE_S(SCENE_BACKTOWN, 0x04E5 - 0x04CC),
    /* 0x04CC */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(13, 35, 13, 45, 0x04DF - 0x04D2),
    /* 0x04D2 */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(13, 45, 13, 55, 0x04D9 - 0x04D8),
    /* 0x04D8 */ SCHEDULE_CMD_RET_NONE(),
    /* 0x04D9 */ SCHEDULE_CMD_RET_TIME(13, 45, 13, 55, 43),
    /* 0x04DF */ SCHEDULE_CMD_RET_TIME(13, 35, 13, 45, 42),
    /* 0x04E5 */ SCHEDULE_CMD_CHECK_SCENE_S(SCENE_TOWN, 0x0526 - 0x04E9),
    /* 0x04E9 */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(13, 55, 14, 5, 0x0520 - 0x04EF),
    /* 0x04EF */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(14, 5, 14, 15, 0x051A - 0x04F5),
    /* 0x04F5 */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(14, 15, 14, 25, 0x0514 - 0x04FB),
    /* 0x04FB */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(14, 25, 14, 35, 0x050E - 0x0501),
    /* 0x0501 */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(14, 35, 14, 45, 0x0508 - 0x0507),
    /* 0x0507 */ SCHEDULE_CMD_RET_NONE(),
    /* 0x0508 */ SCHEDULE_CMD_RET_TIME(14, 35, 14, 45, 51),
    /* 0x050E */ SCHEDULE_CMD_RET_TIME(14, 25, 14, 35, 49),
    /* 0x0514 */ SCHEDULE_CMD_RET_TIME(14, 15, 14, 25, 46),
    /* 0x051A */ SCHEDULE_CMD_RET_TIME(14, 5, 14, 15, 45),
    /* 0x0520 */ SCHEDULE_CMD_RET_TIME(13, 55, 14, 5, 44),
    /* 0x0526 */ SCHEDULE_CMD_RET_NONE(),
    /* 0x0527 */ SCHEDULE_CMD_CHECK_SCENE_S(SCENE_POSTHOUSE, 0x052E - 0x052B),
    /* 0x052B */ SCHEDULE_CMD_RET_VAL_L(22),
    /* 0x052E */ SCHEDULE_CMD_RET_NONE(),
    /* 0x052F */ SCHEDULE_CMD_CHECK_TIME_RANGE_L(9, 0, 12, 0, 0x0117 - 0x0536),
    /* 0x0536 */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(12, 0, 13, 1, 0x0552 - 0x053C),
    /* 0x053C */ SCHEDULE_CMD_CHECK_TIME_RANGE_L(13, 1, 17, 0, 0x0315 - 0x0543),
    /* 0x0543 */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(18, 0, 6, 0, 0x054A - 0x0549),
    /* 0x0549 */ SCHEDULE_CMD_RET_NONE(),
    /* 0x054A */ SCHEDULE_CMD_CHECK_SCENE_S(SCENE_POSTHOUSE, 0x0551 - 0x054E),
    /* 0x054E */ SCHEDULE_CMD_RET_VAL_L(24),
    /* 0x0551 */ SCHEDULE_CMD_RET_NONE(),
    /* 0x0552 */ SCHEDULE_CMD_CHECK_SCENE_S(SCENE_POSTHOUSE, 0x055C - 0x0556),
    /* 0x0556 */ SCHEDULE_CMD_RET_TIME(12, 0, 13, 1, 21),
    /* 0x055C */ SCHEDULE_CMD_RET_NONE(),
    /* 0x055D */ SCHEDULE_CMD_CHECK_TIME_RANGE_L(9, 0, 12, 0, 0x0117 - 0x0564),
    /* 0x0564 */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(12, 0, 13, 1, 0x0580 - 0x056A),
    /* 0x056A */ SCHEDULE_CMD_CHECK_TIME_RANGE_L(13, 1, 15, 0, 0x0446 - 0x0571),
    /* 0x0571 */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(18, 0, 6, 0, 0x0578 - 0x0577),
    /* 0x0577 */ SCHEDULE_CMD_RET_NONE(),
    /* 0x0578 */ SCHEDULE_CMD_CHECK_SCENE_S(SCENE_POSTHOUSE, 0x057F - 0x057C),
    /* 0x057C */ SCHEDULE_CMD_RET_VAL_L(24),
    /* 0x057F */ SCHEDULE_CMD_RET_NONE(),
    /* 0x0580 */ SCHEDULE_CMD_CHECK_SCENE_S(SCENE_POSTHOUSE, 0x0587 - 0x0584),
    /* 0x0584 */ SCHEDULE_CMD_RET_VAL_L(20),
    /* 0x0587 */ SCHEDULE_CMD_RET_NONE(),
    /* 0x0588 */ SCHEDULE_CMD_RET_NONE(),
};

static u8 D_80AFB30C[] = {
    /* 0x0000 */ SCHEDULE_CMD_CHECK_SCENE_S(SCENE_POSTHOUSE, 0x0032 - 0x0004),
    /* 0x0004 */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(0, 0, 0, 10, 0x002C - 0x000A),
    /* 0x000A */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(0, 10, 0, 13, 0x0029 - 0x0010),
    /* 0x0010 */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(0, 13, 0, 23, 0x0023 - 0x0016),
    /* 0x0016 */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(0, 23, 0, 26, 0x001D - 0x001C),
    /* 0x001C */ SCHEDULE_CMD_RET_NONE(),
    /* 0x001D */ SCHEDULE_CMD_RET_TIME(0, 23, 0, 26, 32),
    /* 0x0023 */ SCHEDULE_CMD_RET_TIME(0, 13, 0, 23, 83),
    /* 0x0029 */ SCHEDULE_CMD_RET_VAL_L(27),
    /* 0x002C */ SCHEDULE_CMD_RET_TIME(0, 0, 0, 10, 82),
    /* 0x0032 */ SCHEDULE_CMD_CHECK_SCENE_S(SCENE_ICHIBA, 0x004F - 0x0036),
    /* 0x0036 */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(0, 23, 0, 26, 0x0049 - 0x003C),
    /* 0x003C */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(0, 26, 0, 36, 0x0043 - 0x0042),
    /* 0x0042 */ SCHEDULE_CMD_RET_NONE(),
    /* 0x0043 */ SCHEDULE_CMD_RET_TIME(0, 26, 0, 36, 84),
    /* 0x0049 */ SCHEDULE_CMD_RET_TIME(0, 23, 0, 26, 33),
    /* 0x004F */ SCHEDULE_CMD_CHECK_SCENE_S(SCENE_CLOCKTOWER, 0x006C - 0x0053),
    /* 0x0053 */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(0, 26, 0, 36, 0x0066 - 0x0059),
    /* 0x0059 */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(0, 36, 0, 46, 0x0060 - 0x005F),
    /* 0x005F */ SCHEDULE_CMD_RET_NONE(),
    /* 0x0060 */ SCHEDULE_CMD_RET_TIME(0, 36, 0, 46, 86),
    /* 0x0066 */ SCHEDULE_CMD_RET_TIME(0, 26, 0, 36, 85),
    /* 0x006C */ SCHEDULE_CMD_CHECK_SCENE_S(SCENE_TOWN, 0x0089 - 0x0070),
    /* 0x0070 */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(0, 46, 0, 56, 0x0083 - 0x0076),
    /* 0x0076 */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(0, 56, 0, 59, 0x007D - 0x007C),
    /* 0x007C */ SCHEDULE_CMD_RET_NONE(),
    /* 0x007D */ SCHEDULE_CMD_RET_TIME(0, 56, 0, 59, 34),
    /* 0x0083 */ SCHEDULE_CMD_RET_TIME(0, 46, 0, 56, 87),
    /* 0x0089 */ SCHEDULE_CMD_CHECK_SCENE_S(SCENE_MILK_BAR, 0x00B2 - 0x008D),
    /* 0x008D */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(0, 56, 0, 59, 0x00AC - 0x0093),
    /* 0x0093 */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(0, 59, 1, 9, 0x00A6 - 0x0099),
    /* 0x0099 */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(1, 9, 1, 40, 0x00A0 - 0x009F),
    /* 0x009F */ SCHEDULE_CMD_RET_NONE(),
    /* 0x00A0 */ SCHEDULE_CMD_RET_TIME(1, 9, 1, 40, 28),
    /* 0x00A6 */ SCHEDULE_CMD_RET_TIME(0, 59, 1, 9, 88),
    /* 0x00AC */ SCHEDULE_CMD_RET_TIME(0, 56, 0, 59, 36),
    /* 0x00B2 */ SCHEDULE_CMD_RET_NONE(),
};

static u8 D_80AFB3C0[] = {
    /* 0x0000 */ SCHEDULE_CMD_CHECK_SCENE_S(SCENE_TOWN, 0x001D - 0x0004),
    /* 0x0004 */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(0, 10, 0, 13, 0x0017 - 0x000A),
    /* 0x000A */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(0, 13, 0, 23, 0x0011 - 0x0010),
    /* 0x0010 */ SCHEDULE_CMD_RET_NONE(),
    /* 0x0011 */ SCHEDULE_CMD_RET_TIME(0, 13, 0, 23, 90),
    /* 0x0017 */ SCHEDULE_CMD_RET_TIME(0, 10, 0, 13, 35),
    /* 0x001D */ SCHEDULE_CMD_CHECK_SCENE_S(SCENE_MILK_BAR, 0x003A - 0x0021),
    /* 0x0021 */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(0, 0, 0, 10, 0x0034 - 0x0027),
    /* 0x0027 */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(0, 10, 0, 13, 0x002E - 0x002D),
    /* 0x002D */ SCHEDULE_CMD_RET_NONE(),
    /* 0x002E */ SCHEDULE_CMD_RET_TIME(0, 10, 0, 13, 37),
    /* 0x0034 */ SCHEDULE_CMD_RET_TIME(0, 0, 0, 10, 89),
    /* 0x003A */ SCHEDULE_CMD_RET_NONE(),
};

static u8 D_80AFB3FC[] = {
    /* 0x0000 */ SCHEDULE_CMD_CHECK_SCENE_S(SCENE_TOWN, 0x001D - 0x0004),
    /* 0x0004 */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(18, 0, 6, 0, 0x0017 - 0x000A),
    /* 0x000A */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(5, 0, 5, 10, 0x0011 - 0x0010),
    /* 0x0010 */ SCHEDULE_CMD_RET_NONE(),
    /* 0x0011 */ SCHEDULE_CMD_RET_TIME(5, 0, 5, 10, 91),
    /* 0x0017 */ SCHEDULE_CMD_RET_TIME(18, 0, 6, 0, 29),
    /* 0x001D */ SCHEDULE_CMD_RET_NONE(),
};

static u8 D_80AFB41C[] = {
    /* 0x0000 */ SCHEDULE_CMD_CHECK_SCENE_S(SCENE_TOWN, 0x0011 - 0x0004),
    /* 0x0004 */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(0, 0, 0, 10, 0x000B - 0x000A),
    /* 0x000A */ SCHEDULE_CMD_RET_NONE(),
    /* 0x000B */ SCHEDULE_CMD_RET_TIME(0, 0, 0, 10, 91),
    /* 0x0011 */ SCHEDULE_CMD_RET_NONE(),
};
