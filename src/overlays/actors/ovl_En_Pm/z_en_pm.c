...
s32 func_80AF8ED4(EnPm* this, PlayState* play, ScheduleResult* arg2, u8 actorCat, s16 actorId) {
    ...
    if (D_80AFB430[arg2->result] >= 0) {
        this->unk_234 = SubS_GetAdditionalPath(play, sp4F, D_80AFB430[arg2->result]);
    }
...
s32 func_80AF9008(EnPm* this, PlayState* play, ScheduleResult* arg2) {
    ...
    if (D_80AFB430[arg2->result] >= 0) {
        this->unk_234 = SubS_GetAdditionalPath(play, sp55, D_80AFB430[arg2->result]);
    }
...
s32 func_80AF91E8(EnPm* this, PlayState* play, ScheduleResult* arg2) {
    ...
    if (D_80AFB430[arg2->result] >= 0) {
        this->unk_234 = SubS_GetAdditionalPath(play, sp2B, D_80AFB430[arg2->result]);
    }
...
s32 func_80AF95E8(EnPm* this, PlayState* play, ScheduleResult* arg2) {
    ...
    if (phi_a3 >= 0) {
        this->unk_234 = SubS_GetAdditionalPath(play, sp4F, phi_a3);
    }
...
s32 func_80AF9D04(EnPm* this, PlayState* play) {
    ...
    if (!SubS_InCsMode(play) && (this->unk_374 != 0)) {
        if ((door != NULL) && (door->dyna.actor.update != NULL)) {
...
s32 func_80AF9E7C(EnPm* this, PlayState* play) {
    ...
    if (!(this->unk_356 & 8)) {
        ...
        func_8013B6B0(this->unk_234, &this->unk_244, &this->unk_254, this->unk_24C, this->unk_248, &this->unk_250, sp7C,
                      &sp58, this->unk_374);
        func_8013B878(play, this->unk_234, this->unk_250, &sp58);
