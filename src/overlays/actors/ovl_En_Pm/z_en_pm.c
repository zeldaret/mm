...
s32 func_80AF91E8(EnPm* this, GlobalContext* globalCtx, struct_80133038_arg2* arg2) {
    ...
    if (this->unk_234 != 0) {
        ...
        this->unk_356 &= ~0x10;
        if (this->unk_258 == 27) {
            Actor_PlaySfxByPos2(&this->actor, NA_SE_EV_ROOM_CARTAIN);
...
s32 func_80AF9D04(EnPm* this, GlobalContext* globalCtx) {
    ...
    if (!func_8013AD6C(globalCtx) && (this->unk_374 != 0)) {
        ...
        if (Animation_OnFrame(&this->skelAnime, 3.0f) || Animation_OnFrame(&this->skelAnime, 8.0f)) {
            Actor_PlaySfxByPos2(&this->actor, NA_SE_EV_POSTMAN_WALK);
        }
    }
    return false;
}
    ...
    switch (this->unk_258) {
        ...
        case 19:
            ...
            if ((this->unk_384 == 11) && Animation_OnFrame(&this->skelAnime, 8.0f)) {
                Actor_PlaySfxByPos2(&this->actor, NA_SE_EV_POSTMACHINE_HIT_OPEN);
            }
    ...
    switch (this->unk_258) {
        ...
        case 22:
            if (Animation_OnFrame(&this->skelAnime, 0.0f)) {
                Actor_PlaySfxByPos2(&this->actor, NA_SE_VO_NP_SLEEP_OUT);
            }
            break;
