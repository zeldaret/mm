...
static MsgScript D_80AFB5A0[] = {
    /* 0x0000 0x05 */ MSCRIPT_CMD_CHECK_WEEK_EVENT_REG(WEEKEVENTREG_LISTENED_ANJU_POSTMAN_CONVERSATION, 0x004A - 0x0005),
    ...
    /* 0x0043 0x03 */ MSCRIPT_CHECK_CALLBACK(0x0),
    /* 0x0046 0x03 */ MSCRIPT_SET_WEEK_EVENT_REG(WEEKEVENTREG_LISTENED_ANJU_POSTMAN_CONVERSATION),
    ...
    /* 0x005A 0x03 */ MSCRIPT_CHECK_CALLBACK(0x0),
    ...
    /* 0x0068 0x03 */ MSCRIPT_CHECK_CALLBACK(0x0),
...
static MsgScript D_80AFB644[] = {
    ...
    /* 0x0003 0x03 */ MSCRIPT_NOTEBOOK_EVENT(BOMBERS_NOTEBOOK_EVENT_MET_POSTMAN),
    /* 0x0006 0x01 */ MSCRIPT_AWAIT_TEXT(),
    /* 0x0007 0x03 */ MSCRIPT_SET_WEEK_EVENT_REG(WEEKEVENTREG_88_02),
...
static MsgScript D_80AFB658[] = {
    /* 0x0000 0x05 */ MSCRIPT_CHECK_ITEM(ITEM_LETTER_MAMA, 0x001F - 0x0005),
    ...
    /* 0x0011 0x03 */ MSCRIPT_SET_WEEK_EVENT_REG(WEEKEVENTREG_82_80),
    ...
    /* 0x0026 0x09 */ MSCRIPT_CHECK_ITEM_ACTION(PLAYER_IA_LETTER_MAMA, 0x0, 0x0047 - 0x002F, 0x0057 - 0x002F),
    /* 0x002F 0x03 */ MSCRIPT_PLAYER_TALK(0xFFFF),
    /* 0x0032 0x03 */ MSCRIPT_CHECK_CALLBACK(0x0),
    ...
    /* 0x0051 0x01 */ MSCRIPT_AWAIT_TEXT(),
    /* 0x0052 0x03 */ MSCRIPT_SET_WEEK_EVENT_REG(WEEKEVENTREG_82_80),
    ...
    /* 0x005E 0x03 */ MSCRIPT_SET_WEEK_EVENT_REG(WEEKEVENTREG_82_80),
...
static MsgScript D_80AFB6BC[] = {
    ...
    /* 0x0006 0x01 */ MSCRIPT_AWAIT_TEXT(),
    /* 0x0007 0x03 */ MSCRIPT_CHECK_CALLBACK(0x0),
    ...
    /* 0x0027 0x03 */ MSCRIPT_CHECK_CALLBACK(0x0),
    ...
    /* 0x004D 0x03 */ MSCRIPT_SET_WEEK_EVENT_REG(WEEKEVENTREG_89_08),
    /* 0x0050 0x03 */ MSCRIPT_CHECK_CALLBACK(0x0),
    /* 0x0053 0x01 */ MSCRIPT_DONE(),
};

static MsgScript D_80AFB710[] = {
    /* 0x0000 0x05 */ MSCRIPT_CHECK_ITEM(ITEM_MASK_POSTMAN, 0x0028 - 0x0005),
    ...
    /* 0x0013 0x03 */ MSCRIPT_SET_COLLECTIBLE(0x0084),
    /* 0x0016 0x03 */ MSCRIPT_SET_WEEK_EVENT_REG(WEEKEVENTREG_90_04),
    ...
    /* 0x0024 0x03 */ MSCRIPT_SET_WEEK_EVENT_REG(WEEKEVENTREG_90_01),
    ...
    /* 0x002E 0x01 */ MSCRIPT_AWAIT_TEXT(),
    /* 0x002F 0x03 */ MSCRIPT_SET_WEEK_EVENT_REG(WEEKEVENTREG_90_01),
...
static MsgScript D_80AFB764[] = {
    ...
    /* 0x0003 0x03 */ MSCRIPT_NOTEBOOK_EVENT(BOMBERS_NOTEBOOK_EVENT_MET_POSTMAN),
    /* 0x0006 0x01 */ MSCRIPT_AWAIT_TEXT(),
    /* 0x0007 0x03 */ MSCRIPT_SET_WEEK_EVENT_REG(WEEKEVENTREG_82_80),
