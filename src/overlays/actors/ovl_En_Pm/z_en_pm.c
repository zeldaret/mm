...
static MsgScript D_80AFB5A0[] = {
    /* 0x0000 0x05 */ MSCRIPT_BRANCH_ON_WEEK_EVENT_REG(WEEKEVENTREG_LISTENED_ANJU_POSTMAN_CONVERSATION, 0x004A - 0x0005),
    ...
    /* 0x0043 0x03 */ MSCRIPT_BRANCH_ON_CALLBACK(0x0),
    /* 0x0046 0x03 */ MSCRIPT_WEEK_EVENT_REG_SET(WEEKEVENTREG_LISTENED_ANJU_POSTMAN_CONVERSATION),
    ...
    /* 0x005A 0x03 */ MSCRIPT_BRANCH_ON_CALLBACK(0x0),
    ...
    /* 0x0068 0x03 */ MSCRIPT_BRANCH_ON_CALLBACK(0x0),
...
static MsgScript D_80AFB644[] = {
    ...
    /* 0x0003 0x03 */ MSCRIPT_NOTEBOOK_EVENT(BOMBERS_NOTEBOOK_EVENT_MET_POSTMAN),
    /* 0x0006 0x01 */ MSCRIPT_AWAIT_TEXT(),
    /* 0x0007 0x03 */ MSCRIPT_WEEK_EVENT_REG_SET(WEEKEVENTREG_88_02),
...
static MsgScript D_80AFB658[] = {
    ...
    /* 0x0005 0x05 */ MSCRIPT_BRANCH_ON_WEEK_EVENT_REG(WEEKEVENTREG_82_80, 0x0016 - 0x000A),
    ...
    /* 0x0011 0x03 */ MSCRIPT_WEEK_EVENT_REG_SET(WEEKEVENTREG_82_80),
    ...
    /* 0x0026 0x09 */ MSCRIPT_BRANCH_ON_ITEMACTION(PLAYER_IA_LETTER_MAMA, 0x0, 0x0047 - 0x002F, 0x0057 - 0x002F),
    /* 0x002F 0x03 */ MSCRIPT_PLAYER_TALK(0xFFFF),
    /* 0x0032 0x03 */ MSCRIPT_BRANCH_ON_CALLBACK(0x0),
    ...
    /* 0x003C 0x03 */ MSCRIPT_WEEK_EVENT_REG_SET(WEEKEVENTREG_82_80),
    /* 0x003F 0x03 */ MSCRIPT_WEEK_EVENT_REG_SET(WEEKEVENTREG_86_01),
    /* 0x0042 0x03 */ MSCRIPT_DEL_ITEM(ITEM_LETTER_MAMA),
    /* 0x0045 0x01 */ MSCRIPT_CLOSE_TEXT(),
    /* 0x0046 0x01 */ MSCRIPT_DONE(),

    /* 0x0047 0x03 */ MSCRIPT_PLAYER_TALK(0x277D),
    /* 0x004A 0x01 */ MSCRIPT_AWAIT_TEXT(),
    /* 0x004B 0x03 */ MSCRIPT_JUMP(0x0),
    /* 0x004E 0x03 */ MSCRIPT_NOTEBOOK_EVENT(BOMBERS_NOTEBOOK_EVENT_MET_POSTMAN),
    /* 0x0051 0x01 */ MSCRIPT_AWAIT_TEXT(),
    /* 0x0052 0x03 */ MSCRIPT_WEEK_EVENT_REG_SET(WEEKEVENTREG_82_80),
    ...
    /* 0x005E 0x03 */ MSCRIPT_WEEK_EVENT_REG_SET(WEEKEVENTREG_82_80),
...
static MsgScript D_80AFB6BC[] = {
    ...
    /* 0x0006 0x01 */ MSCRIPT_AWAIT_TEXT(),
    /* 0x0007 0x03 */ MSCRIPT_BRANCH_ON_CALLBACK(0x0),
    ...
    /* 0x0027 0x03 */ MSCRIPT_BRANCH_ON_CALLBACK(0x0),
    ...
    /* 0x004D 0x03 */ MSCRIPT_WEEK_EVENT_REG_SET(WEEKEVENTREG_89_08),
...
static MsgScript D_80AFB710[] = {
    ...
    /* 0x0016 0x03 */ MSCRIPT_WEEK_EVENT_REG_SET(WEEKEVENTREG_90_04),
    /* 0x0019 0x03 */ MSCRIPT_JUMP(0x0),
    /* 0x001C 0x01 */ MSCRIPT_AWAIT_TEXT_DONE(),
    ...
    /* 0x0024 0x03 */ MSCRIPT_WEEK_EVENT_REG_SET(WEEKEVENTREG_90_01),
    ...
    /* 0x002E 0x01 */ MSCRIPT_AWAIT_TEXT(),
    /* 0x002F 0x03 */ MSCRIPT_WEEK_EVENT_REG_SET(WEEKEVENTREG_90_01),
...
static MsgScript D_80AFB74C[] = {
    ...
    /* 0x000C 0x01 */ MSCRIPT_AWAIT_TEXT(),
    /* 0x000D 0x03 */ MSCRIPT_WEEK_EVENT_REG_SET(WEEKEVENTREG_82_80),
    /* 0x0010 0x03 */ MSCRIPT_WEEK_EVENT_REG_SET(WEEKEVENTREG_86_01),
...
static MsgScript D_80AFB764[] = {
    /* 0x0000 0x03 */ MSCRIPT_PLAYER_TALK(0x277D),
    /* 0x0003 0x03 */ MSCRIPT_NOTEBOOK_EVENT(BOMBERS_NOTEBOOK_EVENT_MET_POSTMAN),
    /* 0x0006 0x01 */ MSCRIPT_AWAIT_TEXT(),
    /* 0x0007 0x03 */ MSCRIPT_WEEK_EVENT_REG_SET(WEEKEVENTREG_82_80),
