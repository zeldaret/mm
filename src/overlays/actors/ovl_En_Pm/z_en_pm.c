...
s32 func_80AF8ED4(EnPm* this, PlayState* play, ScheduleOutput* arg2, u8 actorCat, s16 actorId) {
...
s32 func_80AF9008(EnPm* this, PlayState* play, ScheduleOutput* arg2) {
...
s32 func_80AF91E8(EnPm* this, PlayState* play, ScheduleOutput* arg2) {
...
s32 func_80AF94AC(EnPm* this, PlayState* play, ScheduleOutput* arg2) {
    u8 sp4F = this->actor.params & 0xFF;
    Vec3f sp40;
    Vec3f sp34;
    Vec3s* sp30;
...
s32 func_80AF95E8(EnPm* this, PlayState* play, ScheduleOutput* arg2) {
    u8 sp4F = this->actor.params & 0xFF;
    Vec3f sp40;
    Vec3f sp34;
    Vec3s* sp30;
...
s32 func_80AF992C(EnPm* this, PlayState* play, ScheduleOutput* arg2) {
...
s32 func_80AF9A0C(EnPm* this, PlayState* play, ScheduleOutput* arg2) {
    s32 ret = false;
...
s32 func_80AF9AB0(EnPm* this, PlayState* play, ScheduleOutput* arg2) {
    s32 ret = false;
...
s32 func_80AF9B54(EnPm* this, PlayState* play, ScheduleOutput* arg2) {
    s32 ret = false;
...
s32 func_80AF9BF8(EnPm* this, PlayState* play, ScheduleOutput* arg2) {
    s32 ret;
