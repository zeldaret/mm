...
void func_80C11590(EnThiefbird* this, PlayState* play) {
    ...
    if ((this->unk_18E == 0) && (this->actor.xzDistToPlayer < 300.0f) && !(player->stateFlags1 & PLAYER_STATE1_800000) &&
...
void func_80C1193C(EnThiefbird* this, PlayState* play) {
    ...
    if ((this->unk_18E == 0) || (player->stateFlags1 & PLAYER_STATE1_800000) || (Player_GetMask(play) == PLAYER_MASK_STONE) ||
