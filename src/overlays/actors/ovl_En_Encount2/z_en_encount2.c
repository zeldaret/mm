...
void EnEncount2_UpdateParticles(EnEncount2* this, PlayState* play);
void EnEncount2_DrawParticles(EnEncount2* this, PlayState* play);
...
void EnEncount2_Update(Actor* thisx, PlayState* play) {
    ...
    EnEncount2_UpdateParticles(this, play);
...
void EnEncount2_Draw(Actor* thisx, PlayState* play) {
    ...
    EnEncount2_DrawParticles(this, play);
}
