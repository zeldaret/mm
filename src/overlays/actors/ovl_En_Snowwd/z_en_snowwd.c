...
void func_80AF76F0(EnSnowwd* this, PlayState* play) {
    ...
    static Vec3f velocity = { 0.0f, -4.0f, 0.0f };
    static Color_RGBA8 primColor = { 255, 255, 255, 255 };
    static Color_RGBA8 envColor = { 200, 200, 220, 0 };
    s32 pad;
    ...
    if (thisx->home.rot.y != 0) {
        ...
        if (thisx->home.rot.z == 0) {
            if (SNOWWD_GET_PARAM_F80(&this->actor) < 0x10) {
                pos = thisx->world.pos;
                pos.y += 200.0f;
                Item_DropCollectibleRandom(play, NULL, &pos, SNOWWD_GET_PARAM_F80(&this->actor) * 0x10);
            }
            thisx->home.rot.z = 1;
        }
    }
    ...
    if (this->timer > 0) {
        ...
        func_800B0EB0(play, &pos, &velocity, &accel, &primColor, &envColor, 200, 10, 20);
    }
}
