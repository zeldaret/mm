...
ActorInit En_Ending_Hero6_InitVars = {
    ACTOR_EN_ENDING_HERO6, ACTORCAT_NPC,          FLAGS,
    GAMEPLAY_KEEP,         sizeof(EnEndingHero6), EnEndingHero6_Init,
    EnEndingHero6_Destroy, EnEndingHero6_Update,  EnEndingHero6_Draw,
};
