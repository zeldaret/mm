...
void EnFsn_AskBuyOrSell(EnFsn* this, PlayState* play) {
    ...
    if (talkState == 5) {
        ...
        if (!EnFsn_TestEndInteraction(this, play, CONTROLLER1(play)) && Message_ShouldAdvance(play)) {
            switch (play->msgCtx.choiceIndex) {
                case 0:
                    func_8019F208();
                    this->isSelling = true;
...
void EnFsn_BrowseShelf(EnFsn* this, PlayState* play) {
    ...
    if (!EnFsn_ReturnItemToShelf(this)) {
        ...
        if (talkstate == 5) {
            func_8011552C(play, 6);
            if (!EnFsn_HasPlayerSelectedItem(this, play, CONTROLLER1(play))) {
...
void EnFsn_SelectItem(EnFsn* this, PlayState* play) {
    ...
    if (EnFsn_TakeItemOffShelf(this) && talkState == 4) {
        func_8011552C(play, 6);
        if (!EnFsn_TestCancelOption(this, play, CONTROLLER1(play)) && Message_ShouldAdvance(play)) {
            switch (play->msgCtx.choiceIndex) {
                case 0:
...
void EnFsn_FaceShopkeeperSelling(EnFsn* this, PlayState* play) {
    ...
    if (talkState == 4) {
        func_8011552C(play, 6);
        if (!EnFsn_TestEndInteraction(this, play, CONTROLLER1(play)) &&
...
void EnFsn_Update(Actor* thisx, PlayState* play) {
    ...
    func_800E9250(play, &this->actor, &this->headRot, &this->unk27A, this->actor.focus.pos);
...
void EnFsn_DrawTextRec(PlayState* play, s32 r, s32 g, s32 b, s32 a, f32 x, f32 y, f32 z, s32 s, s32 t, f32 dx,
                       f32 dy) {
    f32 unk;
    s32 ulx;
    s32 uly;
