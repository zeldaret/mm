...
void EnMm_Init(Actor* thisx, GlobalContext* globalCtx) {
    ...
    if ((this->actor.params >= 0) && ((((gSaveContext.weekEventReg[0x25] & 0x10) == 0)) ||
                                      ((gSaveContext.weekEventReg[0x25] & 8) != 0) || (gSaveContext.unk_1014 != 0))) {
...
void func_80665D3C(EnMm* this, GlobalContext* globalCtx) {
    s16 cutscene = ActorCutscene_GetAdditionalCutscene((s16)this->actor.cutscene);
