...
ActorInit Obj_Moon_Stone_InitVars = {
    ACTOR_OBJ_MOON_STONE, ACTORCAT_PROP,        FLAGS,
    OBJECT_GI_RESERVE00,  sizeof(ObjMoonStone), ObjMoonStone_Init,
    ObjMoonStone_Destroy, ObjMoonStone_Update,  ObjMoonStone_Draw,
};
