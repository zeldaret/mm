...
Actor* func_80BDE384(EnAl* this, PlayState* play) {
    ...
    switch (this->unk_35C) {
        case 2:
            if (!(GET_WEEKEVENTREG(WEEKEVENTREG_89_08)) && (GET_WEEKEVENTREG(WEEKEVENTREG_85_80))) {
...
s32 func_80BDEA14(EnAl* this, PlayState* play) {
    ...
    switch (this->unk_4E6) {
        case 0:
        case 1:
            if ((GET_WEEKEVENTREG(WEEKEVENTREG_75_02))) {
                sp18 = true;
...
void func_80BDF414(EnAl* this, PlayState* play) {
    ...
    switch (this->unk_4EA) {
        case 0:
        case 1:
            if (!(GET_WEEKEVENTREG(WEEKEVENTREG_89_08))) {
                if (GET_WEEKEVENTREG(WEEKEVENTREG_85_80)) {
