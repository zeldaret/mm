...
MsgScript D_80BDFCBC[] = {
    ...
    /* 0x004E 0x03 */ MSCRIPT_WEEK_EVENT_REG_SET(WEEKEVENTREG_89_08),
    /* 0x0051 0x03 */ MSCRIPT_BRANCH_ON_CALLBACK(0x0),
    /* 0x0054 0x01 */ MSCRIPT_DONE(),
};

MsgScript D_80BDFD14[] = {
    /* 0x0000 0x05 */ MSCRIPT_BRANCH_ON_WEEK_EVENT_REG(WEEKEVENTREG_86_20, 0x00A7 - 0x0005),
...
MsgScript D_80BDFDE8[] = {
    ...
    /* 0x000B 0x03 */ MSCRIPT_BRANCH_ON_CALLBACK(0x0),
...
MsgScript D_80BDFDF8[] = {
    /* 0x0000 0x03 */ MSCRIPT_BRANCH_ON_CALLBACK(0x0),
    /* 0x0003 0x05 */ MSCRIPT_BRANCH_ON_WEEK_EVENT_REG(WEEKEVENTREG_57_04, 0x0079 - 0x0008),
    /* 0x0008 0x03 */ MSCRIPT_BEGIN_TEXT(0x2B1A),
    /* 0x000B 0x01 */ MSCRIPT_AWAIT_TEXT(),
    /* 0x000C 0x03 */ MSCRIPT_CONTINUE_TEXT(0x00FF),
    /* 0x000F 0x09 */ MSCRIPT_BRANCH_ON_ITEMACTION(PLAYER_IA_LETTER_MAMA, 0x0030 - 0x0018, 0x0025 - 0x0018, 0x0),
    ...
    /* 0x0025 0x03 */ MSCRIPT_PLAYER_TALK(0x2B1C),
    /* 0x0028 0x01 */ MSCRIPT_AWAIT_TEXT(),
    /* 0x0029 0x03 */ MSCRIPT_JUMP(0x0),
    /* 0x002C 0x01 */ MSCRIPT_AWAIT_TEXT(),
    /* 0x002D 0x03 */ MSCRIPT_JUMP(0x000C - 0x0030),

    /* 0x0030 0x03 */ MSCRIPT_PLAYER_TALK(0x2B1D),
    /* 0x0033 0x01 */ MSCRIPT_AWAIT_TEXT(),
    /* 0x0034 0x03 */ MSCRIPT_JUMP(0x0),
    /* 0x0037 0x01 */ MSCRIPT_AWAIT_TEXT(),
    ...
    /* 0x006F 0x01 */ MSCRIPT_UNSET_AUTOTALK(),
    /* 0x0070 0x03 */ MSCRIPT_WEEK_EVENT_REG_SET(WEEKEVENTREG_57_04),
    /* 0x0073 0x03 */ MSCRIPT_WEEK_EVENT_REG_SET(WEEKEVENTREG_57_08),
...
MsgScript D_80BDFE8C[] = {
    /* 0x0000 0x05 */ MSCRIPT_BRANCH_ON_WEEK_EVENT_REG(WEEKEVENTREG_57_02, 0x0014 - 0x0005),
    ...
    /* 0x002D 0x03 */ MSCRIPT_JUMP(0x0),
    /* 0x0030 0x01 */ MSCRIPT_AWAIT_TEXT_DONE(),
    ...
    /* 0x0041 0x03 */ MSCRIPT_WEEK_EVENT_REG_SET(WEEKEVENTREG_57_02),
    /* 0x0044 0x01 */ MSCRIPT_DONE(),
};

MsgScript D_80BDFED4[] = {
    /* 0x0000 0x03 */ MSCRIPT_BRANCH_ON_CALLBACK(0x0),
    /* 0x0003 0x03 */ MSCRIPT_PLAYER_TALK(0x2B1D),
    /* 0x0006 0x01 */ MSCRIPT_AWAIT_TEXT(),
    /* 0x0007 0x03 */ MSCRIPT_JUMP(0x0),
    ...
    /* 0x0042 0x01 */ MSCRIPT_UNSET_AUTOTALK(),
    /* 0x0043 0x03 */ MSCRIPT_WEEK_EVENT_REG_SET(WEEKEVENTREG_57_04),
    /* 0x0046 0x03 */ MSCRIPT_WEEK_EVENT_REG_SET(WEEKEVENTREG_57_08),
    /* 0x0049 0x01 */ MSCRIPT_PAUSE(),
    /* 0x004A 0x03 */ MSCRIPT_BRANCH_ON_CALLBACK(0x0),
...
MsgScript D_80BDFF24[] = {
    /* 0x0000 0x03 */ MSCRIPT_BRANCH_ON_CALLBACK(0x0),
    /* 0x0003 0x03 */ MSCRIPT_PLAYER_TALK(0x2B1C),
    /* 0x0006 0x01 */ MSCRIPT_AWAIT_TEXT(),
    /* 0x0007 0x03 */ MSCRIPT_CONTINUE_TEXT(0x00FF),
    /* 0x000A 0x09 */ MSCRIPT_BRANCH_ON_ITEMACTION(PLAYER_IA_LETTER_MAMA, 0x0020 - 0x0013, 0x0003 - 0x0013, 0x0),
    ...
    /* 0x0020 0x03 */ MSCRIPT_PLAYER_TALK(0x2B1D),
    /* 0x0023 0x01 */ MSCRIPT_AWAIT_TEXT(),
    /* 0x0024 0x03 */ MSCRIPT_JUMP(0x0),
    /* 0x0027 0x01 */ MSCRIPT_AWAIT_TEXT(),
    ...
    /* 0x005F 0x01 */ MSCRIPT_UNSET_AUTOTALK(),
    /* 0x0060 0x03 */ MSCRIPT_WEEK_EVENT_REG_SET(WEEKEVENTREG_57_04),
    /* 0x0063 0x03 */ MSCRIPT_WEEK_EVENT_REG_SET(WEEKEVENTREG_57_08),
