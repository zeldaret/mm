...
s32 func_808D9A70(EnSw* this, GlobalContext* globalCtx) {
    ...
    if (DECR(this->unk_454) == 0) {
        if (!Animation_OnFrame(&this->skelAnime, this->skelAnime.endFrame)) {
            ...
            if (this->unk_456 != 0) {
                if (!ENSW_GET_3(&this->actor)) {
                    Actor_PlaySfxByPos2(&this->actor, NA_SE_EN_STALWALL_ROLL);
                } else {
                    Actor_PlaySfxByPos2(&this->actor, NA_SE_EN_STALGOLD_ROLL);
                }
                this->unk_456--;
...
s32 func_808D9C18(EnSw* this) {
    ...
    Actor_PlaySfxByPos2(&this->actor, NA_SE_EN_STALTURA_APPEAR);
...
s32 func_808DA08C(EnSw* this, GlobalContext* globalCtx) {
    ...
    if (func_808D99C8(this, globalCtx) || (this->collider.base.acFlags & AC_HIT)) {
        ...
        if (this->unk_412 == 10) {
            ...
            Actor_PlaySfxByPos2(&this->actor, NA_SE_EN_STALTU_DAMAGE);
            this->unk_458 = 20;
            this->unk_45A = 0;
            Actor_SetColorFilter(&this->actor, 0x4000, 200, 0, this->unk_458);
        }
...
void func_808DA350(EnSw* this, GlobalContext* globalCtx) {
    ...
    if ((player->stateFlags1 & 0x200000) && (this->actor.xyzDistToPlayerSq < 8000.0f)) {
        Actor_PlaySfxByPos2(&this->actor, NA_SE_EN_STALWALL_LAUGH);
...
void func_808DA3F4(EnSw* this, GlobalContext* globalCtx) {
    ...
    if (!Animation_OnFrame(&this->skelAnime, this->skelAnime.endFrame)) {
        ...
        if (ABS_ALT(temp_v0) < temp_s1) {
            this->skelAnime.curFrame = 0.0f;
            Actor_PlaySfxByPos2(&this->actor, NA_SE_EN_STALWALL_DASH);
            this->unk_414 = 0.0f;
