        ...
        if (this->unk_378 == 9) {
            ...
            if (this->unk_378 == 1) {
                if (Actor_ProcessTalkRequest(&this->actor, &play->state)) {
                    ...
                    this->unk_378 = 2;
                } else if (Actor_OfferExchangeItem(&this->actor, play, this->actor.xzDistToPlayer, this->actor.playerHeightRel,
                                         PLAYER_IA_HELD)) {
                ...
                if (Actor_ProcessTalkRequest(&this->actor, &play->state)) {
                    ...
                    if ((sp56 >= 0) && (sp56 <= SCREEN_WIDTH) && (sp54 >= 0) && (sp54 <= SCREEN_HEIGHT) &&
                        Actor_OfferExchangeItem(&this->actor, play, 120.0f, 120.0f, PLAYER_IA_NONE)) {
