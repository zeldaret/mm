...
s32 func_80BD3374(EnAh* this, PlayState* play, ScheduleOutput* arg2) {
    s32 pad;
...
s32 func_80BD33FC(EnAh* this, PlayState* play, ScheduleOutput* arg2) {
    s32 pad;
...
s32 func_80BD3484(EnAh* this, PlayState* play, ScheduleOutput* arg2) {
    s32 ret = false;
...
s32 func_80BD3548(EnAh* this, PlayState* play, ScheduleOutput* arg2) {
    s32 ret;
