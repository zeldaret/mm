...
s32 func_80BD2BE8(EnAh* this, PlayState* play) {
    ...
    if (((this->unk_2D8 & SUBS_OFFER_MODE_MAX) != SUBS_OFFER_MODE_NONE) &&
        Actor_ProcessTalkRequest(&this->actor, &play->state)) {
        SubS_UpdateFlags(&this->unk_2D8, SUBS_OFFER_MODE_NONE, SUBS_OFFER_MODE_MAX);
        ret = true;
        this->unk_2D8 |= 8;
...
s32 func_80BD3374(EnAh* this, PlayState* play, ScheduleOutput* scheduleOutput) {
    ...
    func_80BD2B0C(this, 0);
    SubS_UpdateFlags(&this->unk_2D8, SUBS_OFFER_MODE_ONSCREEN, SUBS_OFFER_MODE_MAX);
    this->unk_2D8 |= 0x40;
    return true;
}
...
void EnAh_Update(Actor* thisx, PlayState* play) {
    ...
    if (this->unk_1DC != 0) {
        ...
        SubS_OfferItem(&this->actor, play, radius, height, PLAYER_IA_NONE, this->unk_2D8 & SUBS_OFFER_MODE_MAX);
