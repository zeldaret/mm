...
s32 func_80A50E40(EnDnh* this, PlayState* play) {
    if (((this->unk18C & SUBS_OFFER_MODE_MAX) == SUBS_OFFER_MODE_NONE) ||
        !Actor_ProcessTalkRequest(&this->actor, &play->state)) {
        return 0;
    }
    SubS_UpdateFlags(&this->unk18C, SUBS_OFFER_MODE_NONE, SUBS_OFFER_MODE_MAX);
...
void func_80A50F38(EnDnh* this, PlayState* play) {
    if (func_8010BF58(&this->actor, play, this->msgEventScript, this->msgEventCallback, &this->unk194)) {
        SubS_UpdateFlags(&this->unk18C, SUBS_OFFER_MODE_ONSCREEN, SUBS_OFFER_MODE_MAX);
        this->unk194 = 0;
        this->unk198 = 0;
...
void EnDnh_Init(Actor* thisx, PlayState* play) {
    ...
    if (gSaveContext.save.entrance != ENTRANCE(TOURIST_INFORMATION, 1)) {
        ...
        SubS_UpdateFlags(&this->unk18C, SUBS_OFFER_MODE_AUTO, SUBS_OFFER_MODE_MAX);
