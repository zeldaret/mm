...
MsgScript D_80A51250[] = {
    ...
    /* 0x000D 0x03 */ MSCRIPT_CHECK_HUMAN(0x0015 - 0x0010),
    ...
    /* 0x0023 0x05 */ MSCRIPT_CHECK_ITEM(ITEM_PICTOGRAPH_BOX, 0x0040 - 0x0028),
    ...
    /* 0x004B 0x03 */ MSCRIPT_CHECK_CALLBACK(0x0),
    ...
    /* 0x0063 0x07 */ MSCRIPT_CHECK_TEXT_CHOICE(0x0070 - 0x006A, 0x008E - 0x006A, 0x0070 - 0x006A),
    ...
    /* 0x0075 0x05 */ MSCRIPT_CHECK_RUPEES(10, 0x007F - 0x007A),
    ...
    /* 0x00B5 0x07 */ MSCRIPT_CHECK_TEXT_CHOICE(0x0, 0x00D5 - 0x00BC, 0x0),
    ...
    /* 0x00D1 0x03 */ MSCRIPT_CHECK_CALLBACK(0x0),
    ...
    /* 0x00F6 0x07 */ MSCRIPT_CHECK_TEXT_CHOICE(0x0, 0x0114 - 0x00FD, 0x0),
    /* 0x00FD 0x05 */ MSCRIPT_CHECK_RUPEES(10, 0x0108 - 0x0102),
    ...
    /* 0x012E 0x03 */ MSCRIPT_CHECK_CALLBACK(0x0),
...
MsgScript D_80A5138C[] = {
    /* 0x0000 0x05 */ MSCRIPT_CHECK_EVENT_INF(EVENTINF_36, 0x006C - 0x0005),
    /* 0x0005 0x05 */ MSCRIPT_CMD_CHECK_WEEK_EVENT_REG(WEEKEVENTREG_26_40, 0x0044 - 0x000A),
    /* 0x000A 0x05 */ MSCRIPT_CHECK_EVENT_INF(EVENTINF_37, 0x0029 - 0x000F),
    ...
    /* 0x0044 0x05 */ MSCRIPT_CHECK_EVENT_INF(EVENTINF_37, 0x0054 - 0x0049),
