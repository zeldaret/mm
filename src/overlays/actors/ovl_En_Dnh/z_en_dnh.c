...
MsgScript D_80A51250[] = {
    /* 0x0000 0x05 */ MSCRIPT_BRANCH_ON_WEEK_EVENT_REG(WEEKEVENTREG_SAVED_KOUME, 0x000D - 0x0005),
    /* 0x0005 0x03 */ MSCRIPT_BEGIN_TEXT(0x0862),
    /* 0x0008 0x01 */ MSCRIPT_AWAIT_TEXT(),
    /* 0x0009 0x03 */ MSCRIPT_SET_WEEK_EVENT_REG(WEEKEVENTREG_TALKED_KOUME_KIOSK_EMPTY),
    ...
    /* 0x0015 0x05 */ MSCRIPT_BRANCH_ON_WEEK_EVENT_REG(WEEKEVENTREG_CLEARED_WOODFALL_TEMPLE, 0x0094 - 0x001A),
    /* 0x001A 0x05 */ MSCRIPT_BRANCH_ON_WEEK_EVENT_REG(WEEKEVENTREG_25_10, 0x004F - 0x001F),
    ...
    /* 0x0032 0x03 */ MSCRIPT_SET_COLLECTIBLE(0x0043),
    /* 0x0035 0x01 */ MSCRIPT_AWAIT_TEXT(),
    /* 0x0036 0x03 */ MSCRIPT_AUTOTALK(0x0),
    ...
    /* 0x0048 0x03 */ MSCRIPT_SET_WEEK_EVENT_REG(WEEKEVENTREG_25_10),
    /* 0x004B 0x03 */ MSCRIPT_BRANCH_ON_CALLBACK(0x0),
    /* 0x004E 0x01 */ MSCRIPT_DONE(),

    /* 0x004F 0x05 */ MSCRIPT_BRANCH_ON_WEEK_EVENT_REG(WEEKEVENTREG_26_10, 0x006A - 0x0054),
    /* 0x0054 0x03 */ MSCRIPT_BEGIN_TEXT(0x085A),
    /* 0x0057 0x03 */ MSCRIPT_SET_WEEK_EVENT_REG(WEEKEVENTREG_26_10),
    ...
    /* 0x0094 0x05 */ MSCRIPT_BRANCH_ON_WEEK_EVENT_REG(WEEKEVENTREG_25_20, 0x00E2 - 0x0099),
    /* 0x0099 0x05 */ MSCRIPT_BRANCH_ON_WEEK_EVENT_REG(WEEKEVENTREG_26_10, 0x00DB - 0x009E),
    /* 0x009E 0x03 */ MSCRIPT_BEGIN_TEXT(0x0868),
    /* 0x00A1 0x03 */ MSCRIPT_SET_WEEK_EVENT_REG(WEEKEVENTREG_26_10),
    ...
    /* 0x00C0 0x03 */ MSCRIPT_SET_WEEK_EVENT_REG(WEEKEVENTREG_25_20),
    /* 0x00C3 0x03 */ MSCRIPT_SET_EVENT_INF(EVENTINF_35),
    /* 0x00C6 0x03 */ MSCRIPT_UNSET_EVENT_INF(EVENTINF_36),
    /* 0x00C9 0x03 */ MSCRIPT_UNSET_EVENT_INF(EVENTINF_37),
    /* 0x00CC 0x03 */ MSCRIPT_UNSET_EVENT_INF(EVENTINF_40),
    /* 0x00CF 0x01 */ MSCRIPT_AWAIT_TEXT(),
    /* 0x00D0 0x01 */ MSCRIPT_CLOSE_TEXT(),
    /* 0x00D1 0x03 */ MSCRIPT_BRANCH_ON_CALLBACK(0x0),
    ...
    /* 0x00E2 0x05 */ MSCRIPT_BRANCH_ON_WEEK_EVENT_REG(WEEKEVENTREG_25_20, 0x00EE - 0x00E7),
    ...
    /* 0x00FD 0x05 */ MSCRIPT_BRANCH_ON_RUPEES(10, 0x0108 - 0x0102),
    ...
    /* 0x0109 0x03 */ MSCRIPT_CHANGE_RUPEES(-10),
    /* 0x010C 0x05 */ MSCRIPT_BRANCH_ON_WEEK_EVENT_REG(WEEKEVENTREG_26_40, 0x011A - 0x0111),
    ...
    /* 0x011D 0x03 */ MSCRIPT_SET_WEEK_EVENT_REG(WEEKEVENTREG_25_20),
    /* 0x0120 0x03 */ MSCRIPT_SET_EVENT_INF(EVENTINF_35),
    /* 0x0123 0x03 */ MSCRIPT_UNSET_EVENT_INF(EVENTINF_36),
    /* 0x0126 0x03 */ MSCRIPT_UNSET_EVENT_INF(EVENTINF_37),
    /* 0x0129 0x03 */ MSCRIPT_UNSET_EVENT_INF(EVENTINF_40),
    /* 0x012C 0x01 */ MSCRIPT_AWAIT_TEXT(),
    /* 0x012D 0x01 */ MSCRIPT_CLOSE_TEXT(),
    /* 0x012E 0x03 */ MSCRIPT_BRANCH_ON_CALLBACK(0x0),
...
MsgScript D_80A51384[] = {
    ...
    /* 0x0004 0x01 */ MSCRIPT_UNSET_AUTOTALK(),
    /* 0x0005 0x01 */ MSCRIPT_DONE(),
};

MsgScript D_80A5138C[] = {
    /* 0x0000 0x05 */ MSCRIPT_BRANCH_ON_EVENT_INF(EVENTINF_36, 0x006C - 0x0005),
    /* 0x0005 0x05 */ MSCRIPT_BRANCH_ON_WEEK_EVENT_REG(WEEKEVENTREG_26_40, 0x0044 - 0x000A),
    /* 0x000A 0x05 */ MSCRIPT_BRANCH_ON_EVENT_INF(EVENTINF_37, 0x0029 - 0x000F),
    /* 0x000F 0x03 */ MSCRIPT_BEGIN_TEXT(0x087C),
    /* 0x0012 0x01 */ MSCRIPT_AWAIT_TEXT(),
    /* 0x0013 0x05 */ MSCRIPT_BRANCH_ON_WEEK_EVENT_REG(WEEKEVENTREG_91_20, 0x0022 - 0x0018),
    /* 0x0018 0x03 */ MSCRIPT_CONTINUE_TEXT(0x087E),
    /* 0x001B 0x01 */ MSCRIPT_AWAIT_TEXT(),
    /* 0x001C 0x03 */ MSCRIPT_SET_WEEK_EVENT_REG(WEEKEVENTREG_91_20),
    ...
    /* 0x0033 0x03 */ MSCRIPT_SET_COLLECTIBLE(0x000C),
    /* 0x0036 0x01 */ MSCRIPT_AWAIT_TEXT(),
    /* 0x0037 0x03 */ MSCRIPT_AUTOTALK(0x0),
    /* 0x003A 0x03 */ MSCRIPT_BEGIN_TEXT(0x087E),
    /* 0x003D 0x01 */ MSCRIPT_AWAIT_TEXT(),
    /* 0x003E 0x03 */ MSCRIPT_SET_WEEK_EVENT_REG(WEEKEVENTREG_26_40),
    /* 0x0041 0x03 */ MSCRIPT_JUMP(0x0070 - 0x0044),
    /* 0x0044 0x05 */ MSCRIPT_BRANCH_ON_EVENT_INF(EVENTINF_37, 0x0054 - 0x0049),
    ...
    /* 0x005E 0x03 */ MSCRIPT_SET_COLLECTIBLE(0x0005),
    /* 0x0061 0x01 */ MSCRIPT_AWAIT_TEXT(),
    /* 0x0062 0x03 */ MSCRIPT_AUTOTALK(0x0),
    ...
    /* 0x0070 0x03 */ MSCRIPT_UNSET_EVENT_INF(EVENTINF_35),
    /* 0x0073 0x03 */ MSCRIPT_UNSET_EVENT_INF(EVENTINF_36),
    /* 0x0076 0x03 */ MSCRIPT_UNSET_EVENT_INF(EVENTINF_37),
    /* 0x0079 0x03 */ MSCRIPT_UNSET_EVENT_INF(EVENTINF_40),
    /* 0x007C 0x01 */ MSCRIPT_UNSET_AUTOTALK(),
