...
s32 func_80BABC48(EnSuttari* this, PlayState* play, ScheduleResult* unkStruct) {
    ...
    if (sp1C >= 0) {
        this->unk404 = SubS_GetAdditionalPath(play, sp23, sp1C);
    }
    if (this->unk404 == NULL) {
        return 0;
    }
...
s32 func_80BABDD8(EnSuttari* this, PlayState* play, ScheduleResult* unkStruct) {
    s32 pad;
    EnDoor* sp48;
    u8 sp47;
    u16 sp44;
    ...
    if ((sp48 != NULL) && (sp24 >= 0)) {
        this->unk404 = SubS_GetAdditionalPath(play, sp47, sp24);
    }
...
s32 func_80BABF64(EnSuttari* this, PlayState* play, ScheduleResult* unkStruct) {
    s32 ret;
    ...
    switch (unkStruct->result) {
        ...
        case 13:
        case 12:
            ret = func_80BABC48(this, play, unkStruct);
            break;
        case 11:
        case 10:
        case 9:
        ...
        case 7:
        case 6:
            ret = func_80BABDD8(this, play, unkStruct);
            break;
        case 5:
        case 4:
        case 3:
...
s32 func_80BABFD4(EnSuttari* this, PlayState* play) {
    ...
    if (this->unk42C == 0) {
        ...
        func_8013B6B0(this->unk404, &this->unk414, &this->unk424, this->unk41C, this->unk418, &this->unk420, sp7C,
                      &sp58, this->unk42A);
        func_8013B878(play, this->unk404, this->unk420, &sp58);
...
void func_80BACEE0(EnSuttari* this, PlayState* play) {
    ...
    if (!Schedule_RunScript(play, D_80BAE820, &unkStruct) ||
        ((this->unk428 != unkStruct.result) && !func_80BABF64(this, play, &unkStruct))) {
        this->actor.flags &= ~ACTOR_FLAG_1;
        unkStruct.result = 0;
    } else {
        this->actor.flags |= ACTOR_FLAG_1;
...
s32 EnSuttari_OverrideLimbDraw(PlayState* play, s32 limbIndex, Gfx** dList, Vec3f* pos, Vec3s* rot,
                               Actor* thisx) {
    EnSuttari* this = THIS;
    ...
    if (((this->flags1 & 8) && (this->flags1 & 0x10)) || ((this->flags1 & 2) && !(this->flags1 & 0x20)) ||
        ...
        if (limbIndex == 8) {
            ...
            if (this->actor.child == NULL) {
                if (this->flags1 & 0x100) {
                    bombBag =
                        Actor_SpawnAsChild(&play->actorCtx, &this->actor, play, ACTOR_EN_NIMOTSU,
