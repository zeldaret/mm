...
s32 func_80BABC48(EnSuttari* this, GlobalContext* globalCtx, ScheduleOutput* scheduleOutput) {
    ...
    if (D_80BAE8F8[scheduleOutput->result] >= 0) {
        this->timePath = SubS_GetAdditionalPath(globalCtx, sp23, D_80BAE8F8[scheduleOutput->result]);
    }
...
s32 func_80BABDD8(EnSuttari* this, GlobalContext* globalCtx, ScheduleOutput* scheduleOutput) {
    s32 pad;
    EnDoor* sp48;
...
s32 func_80BABF64(EnSuttari* this, GlobalContext* globalCtx, ScheduleOutput* scheduleOutput) {
    s32 ret;
    ...
    switch (scheduleOutput->result) {
        ...
        case 13:
        case 12:
            ret = func_80BABC48(this, globalCtx, scheduleOutput);
            break;
        case 11:
        case 10:
        case 9:
        ...
        case 7:
        case 6:
            ret = func_80BABDD8(this, globalCtx, scheduleOutput);
            break;
        case 5:
        case 4:
        case 3:
...
void func_80BACEE0(EnSuttari* this, GlobalContext* globalCtx) {
    ...
    if (!Schedule_RunScript(globalCtx, D_80BAE820, &scheduleOutput) ||
        ((this->unk428 != scheduleOutput.result) && !func_80BABF64(this, globalCtx, &scheduleOutput))) {
        this->actor.flags &= ~ACTOR_FLAG_1;
