...
static AnimationInfo sAnimationInfo[] = { &gSkullKidTPoseAnim, 1.0f, 0.0f, -1.0f, 0, 0.0f };
...
void EnZl4_Init(Actor* thisx, PlayState* play) {
    ...
    EnZl4_ChangeAnim(&this->skelAnime, sAnimationInfo, 0);
...
void EnZl4_postLimbDraw(PlayState* play, s32 limbIndex, Gfx** dList, Vec3s* pos, Actor* thisx) {
}
