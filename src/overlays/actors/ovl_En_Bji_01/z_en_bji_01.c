...
void func_809CCE98(EnBji01* this, PlayState* play) {
    SubS_ChangeAnimationBySpeedInfo(&this->skelAnime, D_809CDC7C, 0, &this->animIndex);
    this->actor.textId = 0;
...
void func_809CD028(EnBji01* this, PlayState* play) {
    ...
    SubS_ChangeAnimationBySpeedInfo(&this->skelAnime, D_809CDC7C, 2, &this->animIndex);
        ...
        case TEXT_STATE_5:
            if (Message_ShouldAdvance(play)) {
                ...
                switch (play->msgCtx.currentTextId) {
                    case 0x5DE:
                        SubS_ChangeAnimationBySpeedInfo(&this->skelAnime, D_809CDC7C, 3, &this->animIndex);
