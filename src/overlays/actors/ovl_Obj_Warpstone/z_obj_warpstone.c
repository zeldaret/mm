...
ActorInit Obj_Warpstone_InitVars = {
    ACTOR_OBJ_WARPSTONE,  ACTORCAT_ITEMACTION,  FLAGS,
    OBJECT_SEK,           sizeof(ObjWarpstone), ObjWarpstone_Init,
    ObjWarpstone_Destroy, ObjWarpstone_Update,  ObjWarpstone_Draw,
};
