...
ActorInit En_Grasshopper_InitVars = {
    ACTOR_EN_GRASSHOPPER,  ACTORCAT_ENEMY,        FLAGS,
    OBJECT_GRASSHOPPER,    sizeof(EnGrasshopper), EnGrasshopper_Init,
    EnGrasshopper_Destroy, EnGrasshopper_Update,  EnGrasshopper_Draw,
};
