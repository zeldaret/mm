...
static s8 sLimbToShadowBodyParts[DRAGONFLY_LIMB_MAX] = {
    -1, // DRAGONFLY_LIMB_NONE
    -1, // DRAGONFLY_LIMB_ROOT
    0,  // DRAGONFLY_LIMB_TAIL_SEGMENT_1
    1,  // DRAGONFLY_LIMB_TAIL_SEGMENT_2
    2,  // DRAGONFLY_LIMB_TAIL_SEGMENT_3
    3,  // DRAGONFLY_LIMB_TAIL_SEGMENT_4
    4,  // DRAGONFLY_LIMB_TAIL_TIP
    5,  // DRAGONFLY_LIMB_THORAX
    -1, // DRAGONFLY_LIMB_LEFT_WING
    -1, // DRAGONFLY_LIMB_RIGHT_WING
    6,  // DRAGONFLY_LIMB_BACK_LEFT_UPPER_LEG
    7,  // DRAGONFLY_LIMB_BACK_LEFT_LOWER_LEG
    -1, // DRAGONFLY_LIMB_BACK_LEFT_FOOT
    8,  // DRAGONFLY_LIMB_BACK_RIGHT_UPPER_LEG
    9,  // DRAGONFLY_LIMB_BACK_RIGHT_LOWER_LEG
    -1, // DRAGONFLY_LIMB_BACK_RIGHT_FOOT
    10, // DRAGONFLY_LIMB_FRONT_LEFT_UPPER_LEG
    11, // DRAGONFLY_LIMB_FRONT_LEFT_LOWER_LEG
    -1, // DRAGONFLY_LIMB_FRONT_LEFT_FOOT
    12, // DRAGONFLY_LIMB_FRONT_RIGHT_UPPER_LEG
    13, // DRAGONFLY_LIMB_FRONT_RIGHT_LOWER_LEG
    -1, // DRAGONFLY_LIMB_FRONT_RIGHT_FOOT
    -1, // DRAGONFLY_LIMB_HEAD
    -1, // DRAGONFLY_LIMB_JAW
};

// Should be `DRAGONFLY_SHADOW_BODYPART_MAX`
static s8 sParentShadowBodyParts[DRAGONFLY_LIMB_MAX] = {
    -1,                           // DRAGONFLY_SHADOW_BODYPART_0
    -1,                           // DRAGONFLY_SHADOW_BODYPART_1
    -1,                           // DRAGONFLY_SHADOW_BODYPART_2
    ...
    -1,                           // DRAGONFLY_SHADOW_BODYPART_7
    -1,                           // DRAGONFLY_SHADOW_BODYPART_8
    -1,                           // DRAGONFLY_SHADOW_BODYPART_9
    -1,                           // DRAGONFLY_SHADOW_BODYPART_10
    DRAGONFLY_SHADOW_BODYPART_6,  // DRAGONFLY_SHADOW_BODYPART_11
    -1,                           // DRAGONFLY_SHADOW_BODYPART_12
    -1,                           // DRAGONFLY_SHADOW_BODYPART_13
...
void EnGrasshopper_PostLimbDraw(PlayState* play, s32 limbIndex, Gfx** dList, Vec3s* rot, Actor* thisx) {
    ...
    if ((this->type != DRAGONFLY_TYPE_WOODFALL_TEMPLE_FINAL_ROOM) && (this->type != DRAGONFLY_TYPE_WOODFALL)) {
        if ((s8)(sLimbToShadowBodyParts[limbIndex] > -1)) {
