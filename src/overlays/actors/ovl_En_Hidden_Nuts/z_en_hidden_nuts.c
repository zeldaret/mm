...
void func_80BDB2B8(EnHiddenNuts* this, PlayState* play) {
    ...
    if (this->unk_218 == 0) {
        ...
        for (i = 0; i < 3; i++) {
            ...
            EffectSsDtBubble_SpawnCustomColor(play, &sp74, &sp94, &sp88, &sp84, &sp80, Rand_S16Offset(120, 90), 30, true);
        }
        this->unk_218 = 30;
    }
...
void func_80BDB59C(EnHiddenNuts* this, PlayState* play) {
    ...
    if (this->unk_218 == 0) {
        ...
        for (i = 0; i < 3; i++) {
            ...
            EffectSsDtBubble_SpawnCustomColor(play, &sp78, &sp98, &sp8C, &sp88, &sp84, Rand_S16Offset(120, 90), 30, true);
        }
        this->unk_218 = 30;
    }
