...
void EnWeatherTag_Init(Actor* thisx, GlobalContext* globalCtx) {
    ...
    switch (WEATHER_TAG_TYPE(this)) {
        ...
        case WEATHERTAG_TYPE_UNK5:
            ...
            globalCtx->envCtx.unk1F = 5;
            globalCtx->envCtx.unk20 = 5;
            D_801F4E74 = 1.0f;
...
u8 func_80966608(EnWeatherTag* this, GlobalContext* globalCtx, UNK_TYPE a3, UNK_TYPE a4, u8 new1F, u8 new20, u16 new24,
    ...
    if (WEATHER_TAG_RANGE100(this) > Actor_XZDistanceBetweenActors(&player->actor, &this->actor)) {
        if (globalCtx->envCtx.unk1F == globalCtx->envCtx.unk20) {
            D_801BDBB8 = 1;
            if (!(globalCtx->envCtx.unk1E == 0) ||
                ((globalCtx->envCtx.unk1F != 1) && (globalCtx->envCtx.unk21 == 0))) {

                D_801BDBB8 = 0;
                if (D_801BDBB0 != weatherMode) {
                    D_801BDBB0 = weatherMode;
                    globalCtx->envCtx.unk21 = 1;
                    globalCtx->envCtx.unk1F = new1F;
                    globalCtx->envCtx.unk20 = new20;
                    D_801BDBB4 = new20;
                    globalCtx->envCtx.unk24 = new24;
                    globalCtx->envCtx.unk22 = globalCtx->envCtx.unk24;
                }
                returnVal = 1;
            }
        }
...
void func_8096689C(EnWeatherTag* this, GlobalContext* globalCtx) {
    ...
    globalCtx->envCtx.windClothIntensity = (this->actor.world.rot.z * partialResult) + 30.0f;
...
void func_80966B08(EnWeatherTag* this, GlobalContext* globalCtx) {
    if (func_80966608(this, globalCtx, 0, 0, globalCtx->envCtx.unk1F, 5, 100, 2) || D_801BDBB0 == 2) {
        globalCtx->skyboxId = 3;
...
void func_80966BF4(EnWeatherTag* this, GlobalContext* globalCtx) {
    ...
    if (func_800EE29C(globalCtx, 0x237) != 0) {
        ...
        if ((globalCtx->csCtx.frames >= tmpAction->startFrame) && (tmpAction->unk0 >= 2)) {
            ...
            if (globalCtx->envCtx.unk20 != newUnk20) {
                globalCtx->envCtx.unk21 = 1;
                globalCtx->envCtx.unk20 = newUnk20;
                globalCtx->envCtx.unk24 = 100;
                globalCtx->envCtx.unk22 = globalCtx->envCtx.unk24;
            }
        }
    }
...
void func_809672DC(EnWeatherTag* this, GlobalContext* globalCtx) {
    ...
    Math_SmoothStepToS(&globalCtx->envCtx.unkA4, (s16)(-40.0f * strength), 1, 1, 1);
}
#else
    ...
    if (Actor_XZDistanceBetweenActors(&player->actor, &this->actor) < WEATHER_TAG_RANGE100(this)) {
        if (CURRENT_DAY == 2) {
            if ((gSaveContext.time >= 0x4AAA) && (gSaveContext.time < 0xBAAA) &&
                (globalCtx->envCtx.unkF2[2] == 0)) {

                D_801BDBB0 = 1;
                func_800FD78C(globalCtx);
                globalCtx->envCtx.unkF2[4] = 0x20;
                EnWeatherTag_SetupAction(this, func_80967608);
            }
        }
    } else {
        if ((globalCtx->envCtx.unkF2[4] != 0) && !(globalCtx->state.frames & 3)) {
            globalCtx->envCtx.unkF2[4]--;
            if ((globalCtx->envCtx.unkF2[4]) == 8) {
                func_800FD858(globalCtx);
            }
        }
    }
...
void EnWeatherTag_Update(Actor* thisx, GlobalContext* globalCtx) {
    ...
    if ((globalCtx->actorCtx.unk5 & 2) && (globalCtx->msgCtx.unk11F22 != 0) && (globalCtx->msgCtx.unk11F04 == 0x5E6) &&
        (!FrameAdvance_IsEnabled(globalCtx)) && (globalCtx->sceneLoadFlag == 0) && (ActorCutscene_GetCurrentIndex() == -1) &&
