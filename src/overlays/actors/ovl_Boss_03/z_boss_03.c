...
void func_809E34B8(Boss03* this, PlayState* play) {
    ...
    Math_ApproachS(&this->actor.world.rot.x, Math_Atan2S_Depr(sqrtf(SQ(xDiff) + SQ(zDiff)), -yDiff), 0xA,
                   this->unk_274);
                    ...
                    if (this->csTimer > 105) {
                        ...
                        case 2:
                            ...
                            Math_ApproachS(&this->actor.world.rot.x,
                                           Math_Atan2S_Depr(sqrtf(SQ(xDiff) + SQ(zDiff)), -yDiff), 0xA, this->unk_274);
                            Math_ApproachS(&this->actor.world.rot.y, Math_Atan2S_Depr(zDiff, xDiff), 0xA,
                                           this->unk_274);
