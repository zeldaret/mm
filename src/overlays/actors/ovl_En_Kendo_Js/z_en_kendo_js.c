...
void func_80B274BC(EnKendoJs* this, PlayState* play) {
    ...
    if (this->unk_290 >= 140) {
        ...
        func_80B279F0(this, play, ((Rand_Next() & 0xFF) % 3) + 1);
        func_80B279F0(this, play, ((Rand_Next() & 0xFF) % 3) + 4);
        this->unk_290 = 0;
        this->unk_284++;
...
void EnKendoJs_Update(Actor* thisx, PlayState* play) {
    ...
    func_800E9250(play, &this->actor, &this->unk_278, &this->unk_27E, this->actor.focus.pos);
