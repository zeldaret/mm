            ...
            switch (this->unk_344) {
                case 0:
                    this->actor.world.pos.y = BgCheck_EntityRaycastFloor3(&play->colCtx, &this->actor.floorPoly, &bgId,
                                              ...
                                              50.0f;
                    if (GET_WEEKEVENTREG(WEEKEVENTREG_84_10)) {
                        ...
                        if (this->unk_360 != NULL) {
                            ...
                            if (GET_WEEKEVENTREG(WEEKEVENTREG_32_01)) {
...
void func_80B5C6DC(EnOt* this, PlayState* play) {
    ...
    if ((GET_WEEKEVENTREG(WEEKEVENTREG_84_10)) && (this->unk_33C == 1)) {
        this->actor.textId = 0;
        this->unk_384 = 1;
...
void func_80B5CEC8(EnOt* this, PlayState* play) {
    ...
    if (!(GET_WEEKEVENTREG(WEEKEVENTREG_84_10)) && (ENOT_GET_C000(&this->actor) == 1)) {
                    ...
                    case 0:
                        if ((this->unk_33C != 1) && (this->unk_33C == 2)) {
                            if (this->unk_32C & 1) {
                                ...
                                if (GET_WEEKEVENTREG(WEEKEVENTREG_23_10)) {
                                    phi_a1 = 0x106C;
                                } else {
                                    phi_a1 = 0x106B;
                                }
...
void func_80B5DB6C(Actor* thisx, PlayState* play) {
    ...
    if (!(GET_WEEKEVENTREG(WEEKEVENTREG_84_10)) && !(this->unk_32C & 8)) {
        if (GET_WEEKEVENTREG(WEEKEVENTREG_25_04)) {
            Vec3f sp50;
