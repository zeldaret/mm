...
void func_8082F8BC(PlayState* play, Player* this, PlayerItemAction actionParam);
...
PlayerAgeProperties sPlayerAgeProperties[PLAYER_FORM_MAX] = {
    {
        ...
        // u16 voiceSfxIdOffset;
        SFX_VOICE_BANK_SIZE * 0,
        // u16 surfaceSfxIdOffset;
        0x80,
        // f32 unk_98;
        33.0f,
        // f32 unk_9C;
    ...
    do {
        ...
        if (LinkAnimation_OnFrame(&this->skelAnime, fabsf(ANIMSFX_GET_FRAME(data)))) {
            if (type == ANIMSFX_SHIFT_TYPE(ANIMSFX_TYPE_GENERAL)) {
                ...
                func_800B8E58(this, entry->sfxId + this->ageProperties->surfaceSfxIdOffset);
            }
        }
...
void func_8082EA10(PlayState* play, Player* this, LinkAnimationHeader* anim, s32 moveFlags) {
    func_8082E9C8(play, this, anim, moveFlags, 3.0f / 3.0f);
}

void func_8082EA38(PlayState* play, Player* this, LinkAnimationHeader* anim, s32 moveFlags) {
...
void func_8082F470(PlayState* play, Player* this, PlayerItemAction actionParam) {
...
PlayerItemAction Player_ItemToActionParam(Player* this, ItemId item) {
    if (item >= ITEM_FD) {
...
PlayerFuncAC4 D_8085C9F0[PLAYER_IA_MAX] = {
    ...
    func_80848780, // PLAYER_IA_BOTTLE
...
void (*D_8085CB3C[PLAYER_IA_MAX])(PlayState*, Player*) = {
    ...
    func_8082F594,         // PLAYER_IA_BOTTLE
...
ExplosiveInfo sPlayerExplosiveInfo[] = {
    { ITEM_BOMB, ACTOR_EN_BOM },        // PLAYER_IA_BOMB
    { ITEM_POWDER_KEG, ACTOR_EN_BOM },  // PLAYER_IA_POWDER_KEG
    { ITEM_BOMBCHU, ACTOR_EN_BOM_CHU }, // PLAYER_IA_BOMBCHU
};
...
void func_8082F8BC(PlayState* play, Player* this, PlayerItemAction actionParam) {
    this->itemAction = this->heldItemAction = actionParam;
        ...
        if (this->transformation == PLAYER_FORM_GORON) {
            ...
            if (this->meleeWeaponAnimation >= PLAYER_MWA_SPIN_ATTACK_1H) {
                ...
                if (this->unk_ADD >= 3) {
                    ...
                    itemSfx = (this->heldItemAction == PLAYER_IA_SWORD_GREAT_FAIRY) ? NA_SE_IT_HAMMER_SWING
...
s32 func_8082FC78(Player* this, ItemId item) {
    if ((item < ITEM_FD) && (Player_ItemToActionParam(this, item) == this->itemAction)) {
        return true;
    } else {
        return false;
    }
...
s32 func_8082FCC4(Player* this, ItemId item, PlayerItemAction actionParam) {
...
s32 func_8082FD0C(Player* this, PlayerItemAction actionParam) {
    s32 btn;
...
void func_8082FE0C(Player* this, PlayState* play) {
    ...
    if (((this->actor.id == ACTOR_PLAYER) && (this->itemAction >= PLAYER_IA_FISHING_ROD)) &&
        ...
        if (item >= ITEM_FD) {
            ...
            item = func_8012364C(play, this, i);
            if ((item < ITEM_FD) && (Player_ItemToActionParam(this, item) == this->heldItemAction)) {
                D_80862B4C = 1;
            }
...
void func_808302CC(Player* this, PlayState* play) {
    ...
    if ((actionParam == PLAYER_IA_ZORA_FINS) || (this->heldItemAction == PLAYER_IA_ZORA_FINS)) {
        var_v1 = (actionParam == PLAYER_IA_NONE) ? -14 : 14;
    } else if ((actionParam == PLAYER_IA_BOTTLE) || (actionParam == PLAYER_IA_11) ||
               ((actionParam == PLAYER_IA_NONE) &&
                ((this->heldItemAction == PLAYER_IA_BOTTLE) || (this->heldItemAction == PLAYER_IA_11)))) {
        var_v1 = (actionParam == PLAYER_IA_NONE) ? -13 : 13;
    }
...
void func_808308DC(PlayState* play, Player* this) {
    ...
    if ((this->heldItemAction != PLAYER_IA_NONE) && !isGoronOrDeku) {
        if (Player_ActionToSword(&this->actor, this->heldItemAction) >= 0) {
            ...
            if ((this->transformation != PLAYER_FORM_DEKU) && !(this->stateFlags3 & PLAYER_STATE3_400)) {
                if (gSaveContext.minigameStatus == 1) {
                    if ((play->sceneId != SCENE_SYATEKI_MIZU) && (play->sceneId != SCENE_F01) &&
                        ...
                        play->interfaceCtx.minigameAmmo -= 1;
                    }
...
void func_808313F0(Player* this, PlayState* play) {
    if (!func_808313A8(play, this, this->heldActor)) {
        ...
        LinkAnimation_PlayLoop(play, &this->unk_284, &gPlayerAnim_link_normal_carryB_wait);
    }
}
...
void func_80831760(PlayState* play, Player* this, PlayerActionFunc actionFunc, s32 arg3) {
    if (this->itemAction >= 0) {
        s32 heldItemActionParam = this->itemAction;

        this->itemAction = this->heldItemAction;
        Player_SetAction(play, this, actionFunc, arg3);
        this->itemAction = heldItemActionParam;
...
void func_80831990(PlayState* play, Player* this, ItemId item) {
    PlayerItemAction actionParam = Player_ItemToActionParam(this, item);
    ...
    if ((((this->heldItemAction == this->itemAction) &&
        ...
        if (var_v1 || (CHECK_FLAG_ALL(this->actor.flags, ACTOR_FLAG_100) && (actionParam != PLAYER_IA_NONE)) ||
            ...
            if (var_v1) {
                PlayerTransformation playerForm = (actionParam < PLAYER_IA_MASK_FIERCE_DEITY)
                                                      ? PLAYER_FORM_HUMAN
            ...
            if ((actionParam == PLAYER_IA_MAGIC_BEANS) && (AMMO(ITEM_MAGIC_BEANS) == 0)) {
                play_sound(NA_SE_SY_ERROR);
            } else {
                this->itemAction = actionParam;
                this->unk_AA5 = PLAYER_UNKAA5_5;
            }
        } else if (((actionParam == PLAYER_IA_STICK) && (AMMO(ITEM_STICK) == 0)) ||
            ...
            play_sound(NA_SE_SY_ERROR);
        } else if (actionParam == PLAYER_IA_LENS) {
            func_808318C0(play);
        } else if (actionParam == PLAYER_IA_PICTO_BOX) {
            if (!func_80831814(this, play, PLAYER_UNKAA5_2)) {
                play_sound(NA_SE_SY_ERROR);
            }
        } else if ((actionParam == PLAYER_IA_NUT) &&
        ...
        } else if ((actionParam != this->heldItemAction) ||
            ...
            var_v1 = ((this->transformation != PLAYER_FORM_GORON) || (actionParam == PLAYER_IA_POWDER_KEG));
...
s32 func_80832090(Player* this) {
    return (!(func_8084D770 == this->actionFunc) ||
           ...
           (!(func_80848808 == this->unk_AC4) ||
            Player_ItemToActionParam(this, this->heldItemId) == this->heldItemAction);
}
...
s32 func_808323C0(Player* this, s16 csIndex) {
    ...
    this->currentActorCsIndex = csIndex;

    return true;
}

s32 func_80832444(Player* this) {
    if (this->currentActorCsIndex >= 0) {
        if (!ActorCutscene_GetCanPlayNext(this->currentActorCsIndex)) {
            ActorCutscene_SetIntentToPlay(this->currentActorCsIndex);
            return false;
        }

        ActorCutscene_Start(this->currentActorCsIndex, &this->actor);
    }
    return true;
}

s32 func_8083249C(Player* this) {
    if ((this->currentActorCsIndex >= 0) && (ActorCutscene_GetCurrentIndex() != this->currentActorCsIndex)) {
        return func_80832444(this);
    }
    return true;
}

s32 func_808324EC(PlayState* play, Player* this, PlayerFuncD58 arg2, s32 actorCsIndex) {
    this->unk_D58 = arg2;
    this->currentActorCsIndex = actorCsIndex;
...
void func_80833864(PlayState* play, Player* this, PlayerMeleeWeaponAnimation meleeWeaponAnimation) {
    ...
    if ((meleeWeaponAnimation < PLAYER_MWA_FLIPSLASH_START) ||
        ...
        func_8082E920(play, this, (1 | 8 | ANIM_FLAG_NOMOVE));
    }
    this->currentYaw = this->actor.shape.rot.y;
}
...
s32 func_808373F8(PlayState* play, Player* this, u16 sfxId) {
    ...
    if (this->transformation == PLAYER_FORM_DEKU) {
        ...
        if ((this->actor.depthInWater > 0.0f) && (this->remainingHopsCounter != 0)) {
            ...
            func_800B8E58(this, (NA_SE_PL_DEKUNUTS_JUMP5 + 1 - this->remainingHopsCounter));
            Player_AnimSfx_PlayVoice(this, sfxId);
...
void Player_StopCurrentActorCutscene(Player* this) {
    if (this->currentActorCsIndex >= 0) {
        ActorCutscene_Stop(this->currentActorCsIndex);
        this->currentActorCsIndex = -1;
    }
}
...
// TODO: standarize
#define BOTTLE_ACTION(item) ((item)-PLAYER_IA_BOTTLE)
    ...
    if (this->unk_AA5 != PLAYER_UNKAA5_0) {
        ...
        if (!func_808387A0(play, this)) {
            if (this->unk_AA5 == PLAYER_UNKAA5_5) {
                if ((this->itemAction > PLAYER_IA_39) && (this->itemAction <= PLAYER_IA_MASK_DEKU)) {
                    s32 maskId = this->itemAction - PLAYER_IA_39;
                            ...
                            ((this->itemAction == PLAYER_IA_BOTTLE_BIG_POE) ||
                             ...
                             ((this->talkActor != NULL) && (this->exchangeItemId > 0) &&
                              (((this->exchangeItemId == PLAYER_IA_MAGIC_BEANS) &&
                               ...
                               ((this->exchangeItemId != PLAYER_IA_MAGIC_BEANS) &&
                                (Player_ActionToBottle(this, this->itemAction) > -1))))))) {
                    Actor* talkActor;
                    ...
                    if ((talkActor != NULL) && (((this->exchangeItemId == PLAYER_IA_MAGIC_BEANS) &&
                        ...
                        this->currentActorCsIndex = play->playerActorCsIds[3];
                        this->unk_AE7 = 1;
                    ...
                    bottleAction = Player_ActionToBottle(this, this->itemAction);

                    if (bottleAction > -1) {
                        Player_StopCurrentActorCutscene(this);
                        if (bottleAction >= BOTTLE_ACTION(PLAYER_IA_BOTTLE_FAIRY)) {
                            func_80831760(play, this, func_80853754, 0);
                            func_8082DB90(play, this, &gPlayerAnim_link_bottle_bug_out);
                        } else if ((bottleAction > BOTTLE_ACTION(PLAYER_IA_BOTTLE)) &&
                                   (bottleAction < BOTTLE_ACTION(PLAYER_IA_BOTTLE_POE))) {
                            func_80831760(play, this, func_80853850, 0);
                            func_8082DB90(play, this, &gPlayerAnim_link_bottle_fish_out);
                            this->currentActorCsIndex = play->playerActorCsIds[2];
                        } else {
                    ...
                    if (this->getItemId != GI_NONE) {
                        if (CHECK_BTN_ALL(sPlayerControlInput->press.button, BTN_A)) {
                            ...
                            if ((giEntry->itemId != ITEM_NONE) && (giEntry->gid >= 0) &&
                                (Item_CheckObtainability(giEntry->itemId) == ITEM_NONE)) {
                                this->currentActorCsIndex = chest->cutsceneIdxB;
...
s32 func_8083FF30(PlayState* play, Player* this) {
    if ((this->heldItemAction == PLAYER_IA_STICK) && (this->unk_B08[1] > 0.5f)) {
...
void func_80840770(PlayState* play, Player* this) {
    if (this->unk_AE8 != 0) {
        ...
        Player_StopCurrentActorCutscene(this);
        this->currentActorCsIndex = play->playerActorCsIds[7];
        this->unk_AE8 = 60;
...
void Player_InitCommon(Player* this, PlayState* play, FlexSkeletonHeader* skelHeader) {
    ...
    if ((PLAYER_GET_INITMODE(&this->actor) != PLAYER_INITMODE_TELESCOPE) &&
        ...
        if (this->transformation == PLAYER_FORM_GORON) {
            SkelAnime_InitFlex(play, &this->unk_2C8, &gLinkGoronShieldingSkel, &object_link_goron_Anim_0178D0,
...
void Player_UpdateCommon(Player* this, PlayState* play, Input* input) {
    ...
    if ((this->transformation == PLAYER_FORM_FIERCE_DEITY) && (func_8082FBE8(this) != 0)) {
    ...
    if (this->stateFlags2 & PLAYER_STATE2_8000) {
            ...
            if (!Play_InCsMode(play)) {
                if ((this->actor.id == ACTOR_PLAYER) && !(this->stateFlags1 & PLAYER_STATE1_80000000) &&
                    ...
                    if (this->stateFlags3 & PLAYER_STATE3_1000000) {
                        ...
                        func_8082DD2C(play, this);
                        func_80833AA0(this, play);
                    } else if ((this->actor.bgCheckFlags & 1) || (this->stateFlags1 & PLAYER_STATE1_8000000)) {
        ...
        } else if (!(this->actor.bgCheckFlags & 1) && (func_8084D820 == this->actionFunc) && (this->unk_397 == 4)) {
...
s32 func_80847190(PlayState* play, Player* this, s32 arg2) {
    ...
    if (!func_800B7128(this) && !func_8082EF20(this) && !arg2) {
        var_s0 = (s16)(sPlayerControlInput->rel.stick_y * 0xF0);
        Math_SmoothStepToS(&this->actor.focus.rot.x, var_s0, 0xE, 0xFA0, 0x1E);

        var_s0 = (s16)(sPlayerControlInput->rel.stick_x * -0x10);
...
void func_80847A50(Player* this) {
    func_800B8E58(this, ((this->unk_AE7 != 0) ? NA_SE_PL_WALK_METAL1 : NA_SE_PL_WALK_LADDER) +
    ...
    if ((this->unk_ACE > 0) && ((this->unk_B28 < 0) || ((D_80862B4C == 0) && !func_80830FD4(play)))) {
        ...
        if (this->unk_B28 >= 0) {
            if (index != 0) {
                ...
                if (this->transformation == PLAYER_FORM_DEKU) {
                    LinkAnimation_PlayOnceSetSpeed(play, &this->unk_284, &gPlayerAnim_pn_tamahaki, 2.0f / 3.0f);
                }
            } else if (this->actor.bgCheckFlags & 1) {
...
s32 func_8084923C(Player* this, PlayState* play) {
    if (LinkAnimation_Update(play, &this->unk_284)) {
        ...
        LinkAnimation_PlayLoop(play, &this->unk_284, &gPlayerAnim_pz_cutterwaitanim);
    }
...
s32 func_808492C4(Player* this, PlayState* play) {
    ...
    if (D_80862B4C == 0) {
        ...
        LinkAnimation_PlayOnce(play, &this->unk_284, &gPlayerAnim_pz_cutterattack);
    }
    return true;
}
...
s32 func_80849570(Player* this, PlayState* play) {
    ...
    if (this->stateFlags3 & PLAYER_STATE3_800000) {
        ...
        LinkAnimation_PlayOnce(play, &this->unk_284, &gPlayerAnim_pz_cuttercatch);
...
void func_8084CA24(Player* this, PlayState* play) {
    ...
    if (!func_80840A30(play, this, &this->linearVelocity, 0.0f)) {
        if (this->actor.bgCheckFlags & 1) {
            ...
            this->unk_AAA = Math_Atan2S_XY(this->actor.speedXZ, -this->actor.velocity.y);
...
void func_8084E724(Player* this, PlayState* play) {
    ...
    if (((temp_v1 == PLAYER_UNKAA5_2) && !(play->actorCtx.flags & ACTORCTX_FLAG_2)) ||
        ((temp_v1 != PLAYER_UNKAA5_2) &&
         (((((((((this->csMode != PLAYER_CSMODE_0) || (new_var == 0)) || ((s32)temp_v1 >= PLAYER_UNKAA5_5)) ||
            ...
            ((this->unk_AA5 == PLAYER_UNKAA5_3) &&
             (((((Player_ItemToActionParam(this, Inventory_GetBtnBItem(play)) != this->heldItemAction) &&
        ...
        if (this->unk_AE7 != 0) {
            if (!(this->stateFlags1 & PLAYER_STATE1_800)) {
                if (LinkAnimation_Update(play, &this->unk_284)) {
                    this->unk_AE7 -= 1;
                    if (this->unk_AE7 != 0) {
                        LinkAnimation_Change(play, &this->unk_284, &gPlayerAnim_link_normal_talk_free, 1.0f, 0.0f,
                                             Animation_GetLastFrame(&gPlayerAnim_link_normal_talk_free), ANIMMODE_ONCE,
                                             -6.0f);
                    }
                }
            }
    ...
    if (LinkAnimation_Update(play, &this->skelAnime)) {
        if (this->unk_AE8 != 0) {
            ...
            if ((this->getItemId == GI_STRAY_FAIRY) || (this->getItemId == GI_SKULL_TOKEN) ||
                ...
                func_8082E920(play, this, (1 | ANIM_FLAG_UPDATE_Y | 4 | 8 | ANIM_FLAG_NOMOVE | 0x80));
                Player_StopCurrentActorCutscene(this);
                this->currentActorCsIndex = play->playerActorCsIds[1];
                this->unk_AE8 = 2;
            }
        }
    } else if (this->unk_AE8 == 0) {
...
void func_80853850(Player* this, PlayState* play) {
    ...
    static struct_8085D80C D_8085D80C[] = {
        { ACTOR_EN_FISH, 0 },       // PLAYER_IA_BOTTLE_FISH
        { ACTOR_OBJ_AQUA, 0 },      // PLAYER_IA_BOTTLE_SPRING_WATER
        { ACTOR_OBJ_AQUA, 1 },      // PLAYER_IA_BOTTLE_HOT_SPRING_WATER
        { ACTOR_EN_ZORAEGG, 0x11 }, // PLAYER_IA_BOTTLE_ZORA_EGG
        { ACTOR_EN_DNP, 1 },        // PLAYER_IA_BOTTLE_DEKU_PRINCESS
        { ACTOR_EN_MUSHI2, 0 },     // PLAYER_IA_BOTTLE_GOLD_DUST
        { ACTOR_EN_MUSHI2, 0 },     // PLAYER_IA_BOTTLE_1C
        { ACTOR_EN_OT, 0x8000 },    // PLAYER_IA_BOTTLE_SEAHORSE
        { ACTOR_EN_MUSHI2, 0 },     // PLAYER_IA_BOTTLE_MUSHROOM
        { ACTOR_EN_MUSHI2, 0 },     // PLAYER_IA_BOTTLE_HYLIAN_LOACH
        { ACTOR_EN_MUSHI2, 0 },     // PLAYER_IA_BOTTLE_BUG
    };
    ...
    if (LinkAnimation_Update(play, &this->skelAnime)) {
        ...
        sp4C = &D_8085D80C[this->itemAction - PLAYER_IA_BOTTLE - 1];
...
void func_80853A5C(Player* this, PlayState* play) {
    ...
    if (LinkAnimation_Update(play, &this->skelAnime)) {
        ...
        if ((Player_ActionToBottle(this, this->itemAction) >= 0) && LinkAnimation_OnFrame(&this->skelAnime, 36.0f)) {
...
void func_808548B8(Player* this, PlayState* play) {
    ...
    if (LinkAnimation_Update(play, &this->skelAnime) ||
        ...
        if (!func_80848570(this, play)) {
            LinkAnimationHeader* anim = func_80123420(this) ? attackInfoEntry->unk_8 : attackInfoEntry->unk_4;
    ...
    if (MREG(64) != 0) {
        ...
        if (sp48) {
            if (ActorCutscene_GetCurrentIndex() == this->currentActorCsIndex) {
                func_800E0348(Play_GetCamera(play, ActorCutscene_GetCurrentSubCamId(this->currentActorCsIndex)));
            }
...
void func_80858EA0(PlayState* play, Player* this, void* anim) {
    func_8082EA10(play, this, anim, 4 | 8 | ANIM_FLAG_NOMOVE | 0x80);
}

void func_80858EC0(PlayState* play, Player* this, void* anim) {
    Player_AnimationPlayOnceReverse(play, this, anim);
    func_8082E920(play, this, 4 | 8 | ANIM_FLAG_NOMOVE | 0x80);
}
...
void func_80858F1C(PlayState* play, Player* this, void* anim) {
    func_8082EAC8(play, this, anim, 4 | 8 | ANIM_FLAG_NOMOVE | 0x80);
}
    ...
    if (actor->textId == 0xFFFF) {
        ...
        if (player->stateFlags1 & PLAYER_STATE1_800000) {
            ...
            if (player->skelAnime.animation == &gPlayerAnim_link_normal_backspace) {
                func_8082E920(play, player, 1 | 8 | ANIM_FLAG_NOMOVE);
            }
            func_8082DAD4(player);
        }
...
PlayerItemAction func_8085B854(PlayState* play, Player* player, ItemId itemId) {
    ...
    player->currentActorCsIndex = 0x7C;
