...
void func_80830CE8(PlayState* play, Player* this) {
    ...
    if (this->itemAction <= PLAYER_IA_CONTINUE) {
        func_80123C58(this);
    }
...
void func_80831990(PlayState* play, Player* this, ItemId item) {
    ...
    if ((((this->heldItemAction == this->itemAction) &&
         ...
         ((this->itemAction <= PLAYER_IA_CONTINUE) &&
          ((Player_MeleeWeaponFromIA(itemAction) != PLAYER_MELEEWEAPON_NONE) || (itemAction == PLAYER_IA_NONE)))) &&
        ...
        if (this->unk_AE8 != 0) {
            ...
            if (func_808482E0(play, this) && (this->unk_AE8 == 1)) {
                ...
                if ((this->getItemDrawIdPlusOne == GID_REMAINS_ODOLWA + 1) ||
                    ...
                    s32 var_a2 = ((this->talkActor != NULL) && (this->exchangeItemAction <= PLAYER_IA_CONTINUE)) ||
                                 (this->stateFlags3 & PLAYER_STATE3_20);
    ...
    if (PlayerAnimation_Update(play, &this->skelAnime)) {
        if (this->unk_AE7 != 0) {
            ...
            if (this->unk_AE8 == 0) {
                ...
                talkActor = this->talkActor;
                if ((talkActor != NULL) && (this->exchangeItemAction <= PLAYER_IA_CONTINUE)) {
                    Player_TalkWithPlayer(play, talkActor);
                }
            }
        } else {
