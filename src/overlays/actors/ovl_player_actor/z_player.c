...
int func_8082DA90(PlayState* play) {
...
int func_8082FBE8(Player* this) {
    return func_80123420(this) || func_80123434(this);
}

int func_8082FC24(Player* this) {
...
int Player_ItemIsInUse(Player* this, ItemId item) {
...
int Player_ItemIsItemAction(Player* this, ItemId item, PlayerItemAction itemAction) {
...
int func_80831010(Player* this, PlayState* play) {
...
int func_80831094(Player* this, PlayState* play) {
...
int func_80831124(PlayState* play, Player* this) {
...
int func_80831194(PlayState* play, Player* this) {
    if (this->heldActor != NULL) {
...
int func_808313A8(PlayState* play, Player* this, Actor* actor) {
    if (actor == NULL) {
...
int func_8083213C(Player* this) {
    return (Player_Action_11 == this->actionFunc) || (Player_Action_12 == this->actionFunc);
}

int Player_UpdateUpperBody(Player* this, PlayState* play) {
...
int func_808323C0(Player* this, s16 csId) {
...
int func_808340D4(FloorType floorType) {
...
int func_8083FE38(Player* this, PlayState* play) {
...
int func_8083FF30(PlayState* play, Player* this) {
...
int func_8083FFEC(PlayState* play, Player* this) {
...
int func_80851C40(PlayState* play, Player* this) {
