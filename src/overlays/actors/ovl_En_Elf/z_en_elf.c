...
void func_8088D9BC(EnElf* this, PlayState* play) {
    ...
    switch (this->unk_244) {
        case 0:
            targetYaw = Math_Atan2S_Depr(-(this->actor.world.pos.z - vec->z), -(this->actor.world.pos.x - vec->x));
            break;

        case 3:
            targetYaw = Math_Atan2S_Depr(-(this->actor.world.pos.z - player->actor.world.pos.z),
...
void func_8088E018(EnElf* this, PlayState* play) {
    ...
    this->unk_258 = Math_Atan2S_Depr(this->actor.velocity.z, this->actor.velocity.x);
}
