...
typedef struct EnElf {
    ...
    /* 0x01DC */ Color_RGBAf unk_1DC;
    /* 0x01EC */ Color_RGBAf unk_1EC;
    /* 0x01FC */ LightInfo lightInfo1;
    /* 0x020C */ LightNode* lightNode1;
    /* 0x0210 */ LightInfo lightInfo2;
    /* 0x0220 */ LightNode* lightNode2;
    /* 0x0224 */ Vec3f unk_224;
    /* 0x0230 */ Actor* unk_230;
