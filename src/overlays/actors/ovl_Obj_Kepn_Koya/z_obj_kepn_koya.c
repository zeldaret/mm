...
GLOBAL_ASM("asm/non_matchings/ovl_Obj_Kepn_Koya_0x80C07B20/ObjKepnKoya_Init.asm")

GLOBAL_ASM("asm/non_matchings/ovl_Obj_Kepn_Koya_0x80C07B20/ObjKepnKoya_Destroy.asm")

GLOBAL_ASM("asm/non_matchings/ovl_Obj_Kepn_Koya_0x80C07B20/ObjKepnKoya_Update.asm")

GLOBAL_ASM("asm/non_matchings/ovl_Obj_Kepn_Koya_0x80C07B20/ObjKepnKoya_Draw.asm")
