...
void EnHg_SetupWait(EnHg* this) {
    Actor_ChangeAnimByInfo(&this->skelAnime, sAnimationInfo, HG_ANIM_IDLE);
...
void EnHg_SetupChasePlayer(EnHg* this) {
    Actor_ChangeAnimByInfo(&this->skelAnime, sAnimationInfo, HG_ANIM_LURCH_FORWARD);
...
void EnHg_SetupReactToHit(EnHg* this) {
    Actor_ChangeAnimByInfo(&this->skelAnime, sAnimationInfo, HG_ANIM_RECOIL);
        ...
        if (this->csIdList[3] != play->csCtx.actorCues[cueChannel]->id) {
            ...
            switch (play->csCtx.actorCues[cueChannel]->id) {
                ...
                case 2:
                    ...
                    Actor_ChangeAnimByInfo(&this->skelAnime, sAnimationInfo, HG_ANIM_LEAN_FORWARD);
                    break;

                case 3:
                    this->csIdList[2] = 0;
                    this->animIndex = HG_ANIM_CURL_UP;
                    Actor_ChangeAnimByInfo(&this->skelAnime, sAnimationInfo, HG_ANIM_CURL_UP);
                    break;
                ...
                case 4:
                    ...
                    Actor_ChangeAnimByInfo(&this->skelAnime, sAnimationInfo, HG_ANIM_PANIC);
                    break;
            ...
            switch (this->animIndex) {
                case HG_ANIM_LEAN_FORWARD:
                    ...
                    Actor_ChangeAnimByInfo(&this->skelAnime, sAnimationInfo, HG_ANIM_REACH_FORWARD);
                    break;

                case HG_ANIM_CURL_UP:
                    this->animIndex = HG_ANIM_CROUCHED_PANIC;
                    Actor_ChangeAnimByInfo(&this->skelAnime, sAnimationInfo, HG_ANIM_CROUCHED_PANIC);
                    break;
            }
        }
