...
void func_80BCF398(EnHg* this, GlobalContext* globalCtx) {
    if (this->actor.colChkInfo.health == 1) {
        if ((this->actor.xzDistToPlayer < 200.0f && this->actor.yDirDistToPlayer < 40.0f) &&
...
void func_80BCFC0C(EnHg* this, GlobalContext* globalCtx) {
    ...
    if (this->actor.colChkInfo.health == 1 && !(fabsf(this->actor.yDirDistToPlayer) >= 80.0f)) {
        ...
        if (globalCtx->msgCtx.unk1202A == 3) {
            ...
            if (this->actor.xzDistToPlayer < 60.0f && fabsf(this->actor.yDirDistToPlayer) < 40.0f) {
