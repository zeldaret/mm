...
void EnMa4_HorsebackGameCheckPlayerInteractions(EnMa4* this, PlayState* play) {
    ...
    } else if (gSaveContext.timerTimeRemaining[TIMER_ID_MINIGAME_2] < SECONDS_TO_TIMER(115)) {
        func_800B8614(&this->actor, play, 100.0f);
    }
}
...
void EnMa4_HorsebackGameWait(EnMa4* this, PlayState* play) {
    ...
    if ((gSaveContext.timerTimeRemaining[TIMER_ID_MINIGAME_2] >= SECONDS_TO_TIMER(120)) ||
        ...
        case MA4_TYPE_DAY1:
            if (gSaveContext.save.playerForm != PLAYER_FORM_HUMAN) {
                ...
                if (gSaveContext.timerTimeRemaining[TIMER_ID_MINIGAME_2] >= SECONDS_TO_TIMER(120)) {
                    ...
                    time = gSaveContext.timerTimeRemaining[TIMER_ID_MINIGAME_2];
