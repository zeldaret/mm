...
static MsgScript D_8092DCB0[] = {
    /* 0x0000 0x05 */ MSCRIPT_BRANCH_ON_WEEK_EVENT_REG(WEEKEVENTREG_23_20, 0x000A - 0x0005),
...
static MsgScript D_8092DCF0[] = {
    ...
    /* 0x0004 0x03 */ MSCRIPT_BRANCH_ON_CALLBACK(0x0),
    /* 0x0007 0x01 */ MSCRIPT_PAUSE(),
    /* 0x0008 0x03 */ MSCRIPT_SET_EVENT_INF(EVENTINF_16),
    /* 0x000B 0x01 */ MSCRIPT_UNSET_AUTOTALK(),
