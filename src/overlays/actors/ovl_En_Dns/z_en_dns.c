...
s32 func_8092CAD0(EnDns* this, PlayState* play) {
    ...
    if (((this->unk_2C6 & SUBS_OFFER_MODE_MAX) != SUBS_OFFER_MODE_NONE) &&
        Actor_ProcessTalkRequest(&this->actor, &play->state)) {
        SubS_UpdateFlags(&this->unk_2C6, SUBS_OFFER_MODE_NONE, SUBS_OFFER_MODE_MAX);
        this->unk_2C6 &= ~0x10;
...
s32 func_8092CB98(EnDns* this, PlayState* play) {
    ...
    if (play->csCtx.state != CS_STATE_IDLE) {
        ...
        this->actor.flags |= ACTOR_FLAG_1;
        SubS_UpdateFlags(&this->unk_2C6, SUBS_OFFER_MODE_ONSCREEN, SUBS_OFFER_MODE_MAX);
        this->unk_2C6 &= ~0x80;
    }
    return phi_v1;
}
...
void func_8092D1B8(EnDns* this, PlayState* play) {
    ...
    if (!ENDNS_GET_4000(&this->actor) || (this->unk_2D2 != 0)) {
        if (!CHECK_WEEKEVENTREG(WEEKEVENTREG_23_20) && !CHECK_EVENTINF(EVENTINF_15) && func_8092CC68(play)) {
            ...
            this->unk_2C6 |= 0x100;
            SubS_UpdateFlags(&this->unk_2C6, SUBS_OFFER_MODE_AUTO, SUBS_OFFER_MODE_MAX);
...
void EnDns_Update(Actor* thisx, PlayState* play) {
    ...
    if (!func_8092CAD0(this, play) && func_8092CB98(this, play)) {
        ...
        SubS_OfferItem(&this->actor, play, 80.0f, 40.0f, PLAYER_IA_NONE, this->unk_2C6 & SUBS_OFFER_MODE_MAX);
