...
static s8 sLimbToShadowBodyParts[ZORA_LIMB_MAX] = {
    ...
    ZORA_SHADOW_BODYPART_14, // ZORA_LIMB_LEFT_FOOT
    ZORA_SHADOW_BODYPART_9,  // ZORA_LIMB_RIGHT_THIGH
    ZORA_SHADOW_BODYPART_10, // ZORA_LIMB_RIGHT_SHIN
    ZORA_SHADOW_BODYPART_11, // ZORA_LIMB_RIGHT_FOOT
    ZORA_SHADOW_BODYPART_0,  // ZORA_LIMB_TORSO
    ZORA_SHADOW_BODYPART_6,  // ZORA_LIMB_LEFT_UPPER_ARM
    ZORA_SHADOW_BODYPART_7,  // ZORA_LIMB_LEFT_FOREARM
    ZORA_SHADOW_BODYPART_8,  // ZORA_LIMB_LEFT_HAND
    ZORA_SHADOW_BODYPART_3,  // ZORA_LIMB_RIGHT_UPPER_ARM
...
static s8 sParentShadowBodyParts[ZORA_SHADOW_BODYPART_MAX] = {
    ZORA_SHADOW_BODYPART_0,  // ZORA_SHADOW_BODYPART_0
    ZORA_SHADOW_BODYPART_0,  // ZORA_SHADOW_BODYPART_1
    ZORA_SHADOW_BODYPART_0,  // ZORA_SHADOW_BODYPART_2
    ZORA_SHADOW_BODYPART_0,  // ZORA_SHADOW_BODYPART_3
    ZORA_SHADOW_BODYPART_3,  // ZORA_SHADOW_BODYPART_4
    ZORA_SHADOW_BODYPART_4,  // ZORA_SHADOW_BODYPART_5
    ZORA_SHADOW_BODYPART_0,  // ZORA_SHADOW_BODYPART_6
    ZORA_SHADOW_BODYPART_6,  // ZORA_SHADOW_BODYPART_7
    ZORA_SHADOW_BODYPART_7,  // ZORA_SHADOW_BODYPART_8
    ZORA_SHADOW_BODYPART_0,  // ZORA_SHADOW_BODYPART_9
    ZORA_SHADOW_BODYPART_9,  // ZORA_SHADOW_BODYPART_10
    ZORA_SHADOW_BODYPART_10, // ZORA_SHADOW_BODYPART_11
    ZORA_SHADOW_BODYPART_0,  // ZORA_SHADOW_BODYPART_12
    ZORA_SHADOW_BODYPART_12, // ZORA_SHADOW_BODYPART_13
    ZORA_SHADOW_BODYPART_13, // ZORA_SHADOW_BODYPART_14
};

static u8 sShadowSizes[ZORA_SHADOW_BODYPART_MAX] = {
    0, // ZORA_SHADOW_BODYPART_0
    0, // ZORA_SHADOW_BODYPART_1
    0, // ZORA_SHADOW_BODYPART_2
    0, // ZORA_SHADOW_BODYPART_3
    0, // ZORA_SHADOW_BODYPART_4
    0, // ZORA_SHADOW_BODYPART_5
    0, // ZORA_SHADOW_BODYPART_6
    0, // ZORA_SHADOW_BODYPART_7
    0, // ZORA_SHADOW_BODYPART_8
    0, // ZORA_SHADOW_BODYPART_9
    0, // ZORA_SHADOW_BODYPART_10
    0, // ZORA_SHADOW_BODYPART_11
    0, // ZORA_SHADOW_BODYPART_12
    0, // ZORA_SHADOW_BODYPART_13
    0, // ZORA_SHADOW_BODYPART_14
};
...
void EnZo_Draw(Actor* thisx, PlayState* play) {
    ...
    for (i = 0; i < 5; i++) {
        SubS_GenShadowTex(this->shadowBodyPartsPos, &this->actor.world.pos, shadowTex, i / 5.0f,
                          ZORA_SHADOW_BODYPART_MAX, sShadowSizes, sParentShadowBodyParts);
    }
