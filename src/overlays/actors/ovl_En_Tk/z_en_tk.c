...
s32 func_80AECE60(EnTk* this, PlayState* play) {
    ...
    if (!(this->unk_3CE & 4)) {
        ...
        func_8013B6B0(this->unk_3C8, &this->unk_3E0, &this->unk_3F0, this->unk_3E8, this->unk_3E4, &this->unk_3EC, spA0,
                      &sp7C, this->unk_3D0);
        func_8013B878(play, this->unk_3C8, this->unk_3EC, &sp7C);
    ...
    if ((play->unk_18B4A != 0) || (this->unk_3D0 == 0)) {
        sp78 = this->unk_3F0;
        sp74 = this->unk_3EC;
    ...
    label:
        do {
            door1 = SubS_FindActor(play, door1, ACTORCAT_DOOR, ACTOR_EN_DOOR);
            if (door1 != NULL) {
        ...
        door2 = NULL;
        do {
            door2 = SubS_FindActor(play, door2, ACTORCAT_DOOR, ACTOR_EN_DOOR);
            if (door2 != NULL) {
...
s32 func_80AED38C(EnTk* this, PlayState* play, ScheduleResult* arg2) {
    ...
    this->unk_3C8 = SubS_GetAdditionalPath(play, params, D_80AEF8E8[idx + 1]);
    if (this->unk_3C8 == 0) {
        return false;
    }
