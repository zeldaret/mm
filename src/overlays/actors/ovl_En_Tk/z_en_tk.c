...
s32 func_80AECE60(EnTk* this, GlobalContext* globalCtx) {
    ...
    label:
        do {
            door1 = SubS_GetActorById(globalCtx, door1, ACTORCAT_DOOR, ACTOR_EN_DOOR);
            if (door1 != NULL) {
        ...
        door2 = NULL;
        do {
            door2 = SubS_GetActorById(globalCtx, door2, ACTORCAT_DOOR, ACTOR_EN_DOOR);
            if (door2 != NULL) {
...
void func_80AED940(EnTk* this, GlobalContext* globalCtx) {
    ...
    if (!(this->unk_2CA & 0x40)) {
        ...
        do {
            actor = SubS_GetActorById(globalCtx, actor, ACTORCAT_NPC, ACTOR_EN_TK);
            if (actor != NULL) {
...
void func_80AEE374(EnTk* this, GlobalContext* globalCtx) {
    ...
    SubS_GetActorByFunction(globalCtx, &this->actor, NULL, ACTORCAT_NPC, ACTOR_EN_TK, &sp30, func_80AEE300);
    if (sp30.unk_00 == 0) {
        Actor_MarkForDeath(&this->actor);
    } else {
...
void func_80AEE4D0(EnTk* this, GlobalContext* globalCtx) {
    ...
    if (!(this->unk_2CA & 0x20)) {
        if (Animation_OnFrame(&this->skelAnime, 37.0f)) {
            bigPoe = NULL;
            do {
                bigPoe = SubS_GetActorById(globalCtx, bigPoe, ACTORCAT_PROP, ACTOR_EN_BIGPO);
