...
static u8 D_80AEF800[] = {
    /* 0x0000 */ SCHEDULE_CMD_CHECK_TIME_RANGE_L(6, 0, 18, 0, 0x0008 - 0x0007),
    /* 0x0007 */ SCHEDULE_CMD_RET_NONE(),
    /* 0x0008 */ SCHEDULE_CMD_RET_TIME(6, 0, 18, 0, 1),
    /* 0x000E */ SCHEDULE_CMD_RET_NONE(),
};
