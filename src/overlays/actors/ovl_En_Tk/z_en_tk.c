...
s32 func_80AECE60(EnTk* this, PlayState* play) {
    ...
    if ((door != NULL) && (this->unk_2CA & 0x400)) {
        ...
        Actor_OffsetOfPointInActorCoords(&this->actor, &sp5C, &door->door.dyna.actor.world.pos);
        door->unk_1A7 = 2;
        if (sp5C.z < -20.0f) {
            this->unk_2CA &= ~0x400;
            this->unk_2CA |= 0x800;
...
void EnTk_Update(Actor* thisx, PlayState* play) {
    ...
    if ((this->unk_2B0 == 0) && (SurfaceType_GetFloorProperty(&play->colCtx, this->actor.floorPoly, this->actor.floorBgId) == BG_FLOOR_PROPERTY_12)) {
