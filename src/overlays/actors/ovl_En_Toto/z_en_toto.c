...
extern ColliderCylinderInit D_80BA4FF0;
/*
...
extern EnTotoUnkStruct D_80BA5088;

extern EnTotoUnkStruct D_80BA5044;

extern EnTotoUnkStruct D_80BA50BC;

extern EnTotoUnkStruct D_80BA5068;

extern EnTotoUnkStruct D_80BA5074;

extern EnTotoUnkStruct D_80BA5048;

extern EnTotoUnkStruct D_80BA502C;

extern EnTotoUnkStruct D_80BA5034;

extern EnTotoUnkStruct D_80BA5038;

extern EnTotoUnkFunc D_80BA512C[];
/*
...
extern EnTotoUnkFunc D_80BA5174[];
/*
...
extern u16 D_80BA5120[];

extern u8 D_80BA5128[];

extern EnTotoUnkStruct2 D_80BA50DC[];

extern EnTotoUnkStruct2 D_80BA50D0[];

extern Vec3s D_80BA510C[];

extern EnTotoActionFunc D_80BA51B8[];
//static EnTotoActionFunc D_80BA51B8[] = {func_80BA39C8, func_80BA3CC4, func_80BA3DBC}

extern AnimationHeader* D_80BA5078[];


void func_80BA36C0(EnToto *this, GlobalContext *globalCtx, s32 index) {
    this->unk2B7 = 0;
    this->unk2B0 = index;
    D_80BA501C[index & 0xFF](this, globalCtx);
}
...
void EnToto_Init(Actor *thisx, GlobalContext *globalCtx) {
    ...
    Actor_ProcessInitChain(&this->actor, D_80BA5028);
    Collider_InitAndSetCylinder(globalCtx, &this->collider, &this->actor, &D_80BA4FF0);
            ...
            if (globalCtx->sceneNum == 0x12) {
                if (player->unk14B == 3) {
                    if (!Flags_GetSwitch(globalCtx, this->actor.home.rot.x)) {
                        this->unk2B8 = &D_80BA5068;
                    } else {
                        this->unk2B8 = &D_80BA5074;
                    }
                } else {
                    this->unk2B8 = &D_80BA5048;
                }
            } else if ((gSaveContext.perm.weekEventReg[50] & 1) != 0 || (gSaveContext.perm.weekEventReg[51] & 0x80) != 0) {
                this->unk2B8 = &D_80BA502C;
            } else if (!Flags_GetSwitch(globalCtx, this->actor.params & 0x7F)) {
                this->unk2B8 = &D_80BA5034;
            } else {
                this->unk2B8 = &D_80BA5038;
            }
        }
        this->actor.textId = this->unk2B8->unk2;
    }
}
...
void func_80BA3CC4(EnToto *this, GlobalContext *globalCtx) {
    ...
    if (func_800B867C(&this->actor, globalCtx)) {
        func_80BA36C0(this, globalCtx, this->unk2B8->unk1);
    } else {
...
void func_80BA3D38(EnToto *this, GlobalContext *globalCtx) {
    ...
    if ((gSaveContext.perm.weekEventReg[50] & 1) != 0 || (gSaveContext.perm.weekEventReg[51] & 0x80) != 0) {
        this->unk2B8 = &D_80BA50BC;
    } else {
        this->unk2B8 = &D_80BA5088;
    }
...
s32 func_80BA3F2C(EnToto *this, GlobalContext *globalCtx) {
    u16 tmp = this->unk2B8->unk2;

    if (tmp != 0) {
        tmp &= 0xFFFF;
        func_80151938(globalCtx, tmp);
    } else {
...
s32 func_80BA3FCC(EnToto *this, GlobalContext *globalCtx) {
    ...
    if (this->unk2B1 == 0) {
        ...
        tmp = --this->unk2B1 & 0xFF;
    }
    if (tmp == 0) {
        if(this->unk2B1){}
        func_801518B0(globalCtx, this->unk2B8->unk2, NULL);
        return 1;
    }
    return 0;
}
...
s32 func_80BA4204(EnToto *this, GlobalContext *globalCtx) {
    ...
    if (this->unk2B1 == 0) {
        ...
        phi_v0 = --this->unk2B1 & 0xFF;
    }
    if (phi_v0 == 0) {
        if(this->unk2B1){}
        if (((gSaveContext.perm.weekEventReg[50] & 1) == 0) && ((gSaveContext.perm.weekEventReg[51] & 0x80) == 0)) {
            temp_v1_2 = &D_80BA50DC[gSaveContext.perm.unk20 - 1];
            if (this->unk2B8->unk0 == 6) {
                phi_v0_2 = temp_v1_2->unk0.x;
            } else {
                phi_v0_2 = temp_v1_2->unk0.z;
            }
...
#if NON_MATCHING
//has negu than addu instead of just subu
s32 func_80BA42BC(EnToto *this, GlobalContext *globalCtx) {
    ActorPlayer *player = PLAYER;
    s32 phi_s0 = 0;
    s32 tmp;
    ...
    func_80122744(globalCtx, this->unk2BC, phi_s0, &D_80BA510C[6 - phi_s0]);
...
//Need to uncomment func_80122760 after more info is found about this->unk2BC
s32 func_80BA43F4(EnToto *this, GlobalContext *globalCtx) {
    func_80BA3C88(this);
...
#if NON_MATCHING
//Regalloc, looks like i'm wasting a register somewhere in the for loop
s32 func_80BA4530(EnToto *this, GlobalContext *globalCtx) {
    ActorPlayer *player = PLAYER;
        ...
        if (((gSaveContext.perm.weekEventReg[50] & 1) == 0) && ((gSaveContext.perm.weekEventReg[51] & 0x80) == 0)) {
            for(i=0; i<4; i++) {
                if (func_80BA44D4(&D_80BA50DC[i], player)) {
                    if (this->unk2B1 < 10) {
                        this->unk2B1++;
                        if ((this->unk2B1 & 0xFF) >= 10) {
                            func_801518B0(globalCtx, D_80BA50D0[gSaveContext.perm.unk20].unk0.y, NULL);
                        }
                    }
                    return 0;
                }
...
s32 func_80BA4C0C(EnToto *this, GlobalContext *globalCtx) {
    return D_80BA512C[this->unk2B8->unk0](this, globalCtx);
}

s32 func_80BA4C44(EnToto *this, GlobalContext *globalCtx) {
    s32 tmp;

    tmp = D_80BA5174[this->unk2B8->unk0](this, globalCtx);
    if (tmp != 0) {
        this->unk2B8 = &this->unk2B8[tmp];
...
#if NON_MATCHING
//Stack is one variable too big and regalloc, might be a switch(s)
void func_80BA4CB4(EnToto *this, GlobalContext *globalCtx) {
    AnimationHeader *animationHeader;
    u16 actorActionsUnk0;

    actorActionsUnk0 = globalCtx->csCtx.actorActions[func_800EE200(globalCtx, 0x20D)]->unk0;
    if (actorActionsUnk0 != this->unk2B5) {
        this->unk2B5 = actorActionsUnk0;
        if (this->unk2B5 != 4) {
            if (this->unk2B5 == 3) {
                SkelAnime_ChangeAnimTransitionStop(&this->skelAnime, &D_06001DF0, -4.0f);
            } else {
                if (this->unk2B5 == 1) {
                    animationHeader = &D_060016A4;
                } else {
                    animationHeader = &D_060022C8;
                }
                SkelAnime_ChangeAnimDefaultStop(&this->skelAnime, animationHeader);
    ...
    if (SkelAnime_FrameUpdateMatrix(&this->skelAnime)) {
        if (this->unk2B5 != 3) {
            if (this->unk2B5 == 1) {
                ...
                animationHeader = &D_06001324;
            }
            SkelAnime_ChangeAnimDefaultRepeat(&this->skelAnime, animationHeader);
        }
    }
