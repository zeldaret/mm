...
void EnToto_Init(Actor* thisx, GlobalContext* globalCtx) {
    ...
    SkelAnime_InitFlex(
        globalCtx, &this->skelAnime, &object_zm_Skel_00A978,
        ((globalCtx->sceneNum == SCENE_MAYORS_RESIDENCE) ? &object_zm_Anim_003AA8 : &object_zm_Anim_00C880),
...
void func_80BA3930(EnToto* this, GlobalContext* globalCtx) {
    ...
    if (globalCtx->sceneNum == SCENE_MAYORS_RESIDENCE) {
