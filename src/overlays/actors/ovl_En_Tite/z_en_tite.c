...
void func_8089408C(EnTite* this, GlobalContext* globalCtx) {
    ...
    if (!func_80893ADC(this)) {
        ...
        Actor_PlaySfxAtProjectedPos(&this->actor, NA_SE_EN_TEKU_JUMP_WATER);
    }
    ...
    if (((this->actor.bgCheckFlags & 1) || (func_80893ADC(this) && (this->actor.depthInWater > 0.0f))) &&
        ...
        if (!func_80893ADC(this)) {
            ...
            if (this->actor.velocity.y < -8.0f) {
                ...
                this->actor.velocity.y = 0.0f;
                Actor_PlaySfxAtProjectedPos(&this->actor, NA_SE_EN_TEKU_LAND_WATER2);
                func_80894414(this);
            }
        }
...
void func_8089452C(EnTite* this, GlobalContext* globalCtx) {
    ...
    Actor_PlaySfxAtProjectedPos(&this->actor, NA_SE_EN_TEKU_LAND_WATER);
...
void func_80894638(EnTite* this, GlobalContext* globalCtx) {
    ...
    if (Animation_OnFrame(&this->skelAnime, 7.0f)) {
        if (func_80893ADC(this)) {
            Actor_PlaySfxAtProjectedPos(&this->actor, NA_SE_EN_TEKU_WALK_WATER);
        } else {
            Actor_PlaySfxAtProjectedPos(&this->actor, NA_SE_EN_TEKU_WALK);
        }
    }
...
void func_808952EC(EnTite* this) {
    ...
    Actor_PlaySfxAtProjectedPos(&this->actor, NA_SE_EN_LAST1_GROW_HEAD);
    this->collider.base.acFlags &= ~AC_ON;
    func_80893A18(this);
    this->unk_2B9 = 1;
    this->unk_2BC = 400;
        ...
        if ((this->unk_2BB != 10) || !(this->collider.info.acHitInfo->toucher.dmgFlags & 0xDB0B3)) {
            ...
            if (this->actor.colChkInfo.damageEffect != 0xF) {
                ...
                if (this->actor.colChkInfo.health == 0) {
                    ...
                    Actor_PlaySfxAtProjectedPos(&this->actor, NA_SE_EN_TEKU_DAMAGE);
