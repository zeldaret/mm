...
MsgScript D_80BC1464[] = {
    /* 0x0000 0x05 */ MSCRIPT_BRANCH_ON_EVENT_INF(EVENTINF_43, 0x006F - 0x0005),
    /* 0x0005 0x0D */
    ...
    /* 0x003F 0x05 */ MSCRIPT_BRANCH_ON_WORN_MASK(PLAYER_MASK_ALL_NIGHT, 0x0048 - 0x0044),
    /* 0x0044 0x01 */ MSCRIPT_PAUSE(),
    /* 0x0045 0x03 */ MSCRIPT_BRANCH_ON_CALLBACK(0x010C - 0x0048),
    /* 0x0048 0x03 */ MSCRIPT_BRANCH_ON_CALLBACK(0x0),
    /* 0x004B 0x03 */ MSCRIPT_CONTINUE_TEXT(0x2905),
    /* 0x004E 0x01 */ MSCRIPT_AWAIT_TEXT(),
    /* 0x004F 0x01 */ MSCRIPT_PAUSE(),
    /* 0x0050 0x03 */ MSCRIPT_BRANCH_ON_CALLBACK(0x010C - 0x0053),
    ...
    /* 0x005B 0x05 */ MSCRIPT_BRANCH_ON_WORN_MASK(PLAYER_MASK_ALL_NIGHT, 0x0064 - 0x0060),
    /* 0x0060 0x01 */ MSCRIPT_PAUSE(),
    /* 0x0061 0x03 */ MSCRIPT_BRANCH_ON_CALLBACK(0x010C - 0x0064),
    /* 0x0064 0x03 */ MSCRIPT_BRANCH_ON_CALLBACK(0x0),
    /* 0x0067 0x03 */ MSCRIPT_CONTINUE_TEXT(0x290C),
    /* 0x006A 0x01 */ MSCRIPT_AWAIT_TEXT(),
    /* 0x006B 0x01 */ MSCRIPT_PAUSE(),
    /* 0x006C 0x03 */ MSCRIPT_BRANCH_ON_CALLBACK(0x010C - 0x006F),
    /* 0x006F 0x05 */ MSCRIPT_BRANCH_ON_WORN_MASK(PLAYER_MASK_ALL_NIGHT, 0x008B - 0x0074),
    /* 0x0074 0x05 */ MSCRIPT_BRANCH_ON_EVENT_INF(EVENTINF_42, 0x0082 - 0x0079),
    ...
    /* 0x008B 0x05 */ MSCRIPT_BRANCH_ON_EVENT_INF(EVENTINF_42, 0x00CB - 0x0090),
    ...
    /* 0x00A8 0x05 */ MSCRIPT_BRANCH_ON_WEEK_EVENT_REG(WEEKEVENTREG_50_04, 0x0106 - 0x00AD),
    ...
    /* 0x00E3 0x05 */ MSCRIPT_BRANCH_ON_WEEK_EVENT_REG(WEEKEVENTREG_50_02, 0x0106 - 0x00E8),
