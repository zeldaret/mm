...
MsgScript D_80BC1464[] = {
    /* 0x0000 0x05 */ MSCRIPT_CHECK_EVENT_INF(EVENTINF_43, 0x006F - 0x0005),
    /* 0x0005 0x0D */
    MSCRIPT_CHECK_DAY(0x0022 - 0x0012, 0x001A - 0x0012, 0x0022 - 0x0012, 0x001A - 0x0012, 0x0, 0x001A - 0x0012),
    ...
    /* 0x002A 0x07 */ MSCRIPT_CHECK_TEXT_CHOICE(0x0, 0x0037 - 0x0031, 0x0053 - 0x0031),
    ...
    /* 0x0038 0x03 */ MSCRIPT_SET_EVENT_INF(EVENTINF_42),
    /* 0x003B 0x03 */ MSCRIPT_BEGIN_TEXT(0x2904),
    /* 0x003E 0x01 */ MSCRIPT_AWAIT_TEXT(),
    /* 0x003F 0x05 */ MSCRIPT_CHECK_WORN_MASK(PLAYER_MASK_ALL_NIGHT, 0x0048 - 0x0044),
    /* 0x0044 0x01 */ MSCRIPT_PAUSE(),
    /* 0x0045 0x03 */ MSCRIPT_CHECK_CALLBACK(0x010C - 0x0048),
    /* 0x0048 0x03 */ MSCRIPT_CHECK_CALLBACK(0x0),
    /* 0x004B 0x03 */ MSCRIPT_CONTINUE_TEXT(0x2905),
    /* 0x004E 0x01 */ MSCRIPT_AWAIT_TEXT(),
    /* 0x004F 0x01 */ MSCRIPT_PAUSE(),
    /* 0x0050 0x03 */ MSCRIPT_CHECK_CALLBACK(0x010C - 0x0053),
    /* 0x0053 0x01 */ MSCRIPT_PLAY_DECIDE(),
    /* 0x0054 0x03 */ MSCRIPT_UNSET_EVENT_INF(EVENTINF_42),
    /* 0x0057 0x03 */ MSCRIPT_BEGIN_TEXT(0x290B),
    /* 0x005A 0x01 */ MSCRIPT_AWAIT_TEXT(),
    /* 0x005B 0x05 */ MSCRIPT_CHECK_WORN_MASK(PLAYER_MASK_ALL_NIGHT, 0x0064 - 0x0060),
    /* 0x0060 0x01 */ MSCRIPT_PAUSE(),
    /* 0x0061 0x03 */ MSCRIPT_CHECK_CALLBACK(0x010C - 0x0064),
    /* 0x0064 0x03 */ MSCRIPT_CHECK_CALLBACK(0x0),
    /* 0x0067 0x03 */ MSCRIPT_CONTINUE_TEXT(0x290C),
    /* 0x006A 0x01 */ MSCRIPT_AWAIT_TEXT(),
    /* 0x006B 0x01 */ MSCRIPT_PAUSE(),
    /* 0x006C 0x03 */ MSCRIPT_CHECK_CALLBACK(0x010C - 0x006F),
    /* 0x006F 0x05 */ MSCRIPT_CHECK_WORN_MASK(PLAYER_MASK_ALL_NIGHT, 0x008B - 0x0074),
    /* 0x0074 0x05 */ MSCRIPT_CHECK_EVENT_INF(EVENTINF_42, 0x0082 - 0x0079),
    ...
    /* 0x0080 0x01 */ MSCRIPT_UNSET_AUTOTALK(),
    ...
    /* 0x0089 0x01 */ MSCRIPT_UNSET_AUTOTALK(),
    /* 0x008A 0x01 */ MSCRIPT_DONE(),

    /* 0x008B 0x05 */ MSCRIPT_CHECK_EVENT_INF(EVENTINF_42, 0x00CB - 0x0090),
    /* 0x0090 0x03 */ MSCRIPT_BEGIN_TEXT(0x290D),
    /* 0x0093 0x01 */ MSCRIPT_AWAIT_TEXT(),
    /* 0x0094 0x07 */ MSCRIPT_CHECK_TEXT_CHOICE(0x0, 0x00A5 - 0x009B, 0x0),
    ...
    /* 0x00A3 0x01 */ MSCRIPT_UNSET_AUTOTALK(),
    ...
    /* 0x00B8 0x03 */ MSCRIPT_SET_COLLECTIBLE(0x000C),
    /* 0x00BB 0x03 */ MSCRIPT_JUMP_3(0x0),
    /* 0x00BE 0x01 */ MSCRIPT_AWAIT_TEXT_DONE(),
    ...
    /* 0x00C5 0x03 */ MSCRIPT_SET_WEEK_EVENT_REG(WEEKEVENTREG_50_04),
    /* 0x00C8 0x01 */ MSCRIPT_AWAIT_TEXT(),
    /* 0x00C9 0x01 */ MSCRIPT_UNSET_AUTOTALK(),
    /* 0x00CA 0x01 */ MSCRIPT_DONE(),

    /* 0x00CB 0x03 */ MSCRIPT_BEGIN_TEXT(0x2906),
    /* 0x00CE 0x01 */ MSCRIPT_AWAIT_TEXT(),
    /* 0x00CF 0x07 */ MSCRIPT_CHECK_TEXT_CHOICE(0x00E0 - 0x00D6, 0x0, 0x0),
    ...
    /* 0x00DE 0x01 */ MSCRIPT_UNSET_AUTOTALK(),
    ...
    /* 0x00F3 0x03 */ MSCRIPT_SET_COLLECTIBLE(0x000C),
    /* 0x00F6 0x03 */ MSCRIPT_JUMP_3(0x0),
    /* 0x00F9 0x01 */ MSCRIPT_AWAIT_TEXT_DONE(),
    ...
    /* 0x0100 0x03 */ MSCRIPT_SET_WEEK_EVENT_REG(WEEKEVENTREG_50_02),
    /* 0x0103 0x01 */ MSCRIPT_AWAIT_TEXT(),
    /* 0x0104 0x01 */ MSCRIPT_UNSET_AUTOTALK(),
    ...
    /* 0x010B 0x01 */ MSCRIPT_UNSET_AUTOTALK(),
