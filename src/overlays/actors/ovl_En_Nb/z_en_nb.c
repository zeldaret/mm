...
MsgScript D_80BC1464[] = {
    ...
    /* 0x00C5 0x03 */ MSCRIPT_WEEK_EVENT_REG_SET(WEEKEVENTREG_50_04),
    ...
    /* 0x0100 0x03 */ MSCRIPT_WEEK_EVENT_REG_SET(WEEKEVENTREG_50_02),
