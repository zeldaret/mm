...
static MsgScript sMsgScriptGoronGravemaker[] = {
    ...
    /* 0x0005 0x03 */ MSCRIPT_CHECK_GORON(0x002A - 0x0008),
    ...
    /* 0x004A 0x03 */ MSCRIPT_CHECK_GORON(0x0052 - 0x004D),
    ...
    /* 0x0057 0x03 */ MSCRIPT_CHECK_GORON(0x005F - 0x005A),
...
static MsgScript sMsgScriptGoronFrozen[] = {
    ...
    /* 0x0005 0x03 */ MSCRIPT_CHECK_GORON(0x0055 - 0x0008),
    ...
    /* 0x0088 0x03 */ MSCRIPT_CHECK_GORON(0x0090 - 0x008B),
    ...
    /* 0x0095 0x03 */ MSCRIPT_CHECK_GORON(0x009D - 0x0098),
...
static MsgScript sMsgScriptGoronAsideEldersSon[] = {
    ...
    /* 0x0005 0x03 */ MSCRIPT_CHECK_GORON(0x0018 - 0x0008),
...
static MsgScript sMsgScriptGoronAsideEldersRoom[] = {
    ...
    /* 0x0005 0x03 */ MSCRIPT_CHECK_GORON(0x0011 - 0x0008),
...
static MsgScript sMsgScriptGoronMedigoron[] = {
    /* 0x0000 0x03 */ MSCRIPT_CHECK_GORON(0x0015 - 0x0003),
    ...
    /* 0x0026 0x05 */ MSCRIPT_CHECK_ITEM(ITEM_POWDER_KEG, 0x009A - 0x002B),
    ...
    /* 0x003C 0x05 */ MSCRIPT_CHECK_ITEM(ITEM_POWDER_KEG, 0x009A - 0x0041),
    ...
    /* 0x004E 0x07 */ MSCRIPT_CHECK_TEXT_CHOICE(0x0, 0x006F - 0x0055, 0x006F - 0x0055),
    ...
    /* 0x0075 0x03 */ MSCRIPT_CHECK_HAS_POWDER_KEG(0x006A - 0x0078),
    ...
    /* 0x0085 0x07 */ MSCRIPT_CHECK_TEXT_CHOICE(0x0096 - 0x008C, 0x006F - 0x008C, 0x006F - 0x008C),
    ...
    /* 0x009A 0x03 */ MSCRIPT_CHECK_HAS_POWDER_KEG(0x00C9 - 0x009D),
    /* 0x009D 0x03 */ MSCRIPT_BEGIN_TEXT(0x0C8C),
    /* 0x00A0 0x01 */ MSCRIPT_AWAIT_TEXT(),
    /* 0x00A1 0x07 */ MSCRIPT_CHECK_TEXT_CHOICE(0x0, 0x00AD - 0x00A8, 0x0),
    /* 0x00A8 0x05 */ MSCRIPT_CHECK_RUPEES(100, 0x00B3 - 0x00AD),
...
static MsgScript sMsgScriptGoronGatekeeper[] = {
    ...
    /* 0x0005 0x03 */ MSCRIPT_CHECK_DEKU(0x0016 - 0x0008),
    /* 0x0008 0x03 */ MSCRIPT_CHECK_ZORA(0x001E - 0x000B),
    /* 0x000B 0x03 */ MSCRIPT_CHECK_GORON(0x0026 - 0x000E),
    /* 0x000E 0x05 */
    ...
    /* 0x0040 0x07 */ MSCRIPT_CHECK_TEXT_CHOICE(0x0, 0x0056 - 0x0047, 0x0056 - 0x0047),
    ...
    /* 0x004D 0x03 */ MSCRIPT_CHECK_CALLBACK(0x0),
...
static MsgScript sMsgScriptGoronAthleticA[] = {
    /* 0x0000 0x03 */ MSCRIPT_CHECK_GORON(0x0009 - 0x0003),
