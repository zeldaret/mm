...
static MsgScript sMsgScriptGoronGravemaker[] = {
    ...
    /* 0x0021 0x03 */ MSCRIPT_WEEK_EVENT_REG_SET(WEEKEVENTREG_21_02),
    ...
    /* 0x003B 0x03 */ MSCRIPT_WEEK_EVENT_REG_SET(WEEKEVENTREG_TALKED_GORON_GRAVEMAKER_AS_GORON),
...
static MsgScript sMsgScriptGoronFrozen[] = {
    ...
    /* 0x0021 0x03 */ MSCRIPT_WEEK_EVENT_REG_SET(WEEKEVENTREG_TALKED_THAWED_GRAVEYARD_GORON),
    /* 0x0024 0x01 */ MSCRIPT_DONE(),
    ...
    /* 0x0051 0x03 */ MSCRIPT_WEEK_EVENT_REG_SET(WEEKEVENTREG_TALKED_THAWED_GRAVEYARD_GORON),
    ...
    /* 0x007F 0x03 */ MSCRIPT_WEEK_EVENT_REG_SET(WEEKEVENTREG_TALKED_THAWED_GRAVEYARD_GORON),
...
static MsgScript sMsgScriptGoronAsideEldersSon[] = {
    ...
    /* 0x0014 0x03 */ MSCRIPT_WEEK_EVENT_REG_SET(WEEKEVENTREG_24_80),
    ...
    /* 0x0031 0x03 */ MSCRIPT_WEEK_EVENT_REG_SET(WEEKEVENTREG_22_08),
    /* 0x0034 0x03 */ MSCRIPT_WEEK_EVENT_REG_SET(WEEKEVENTREG_24_80),
...
static MsgScript sMsgScriptGoronAsideEldersRoom[] = {
    ...
    /* 0x001E 0x03 */ MSCRIPT_WEEK_EVENT_REG_SET(WEEKEVENTREG_23_01),
...
static MsgScript sMsgScriptGoronMedigoron[] = {
    ...
    /* 0x000B 0x01 */ MSCRIPT_AWAIT_TEXT(),
    /* 0x000C 0x03 */ MSCRIPT_WEEK_EVENT_REG_SET(WEEKEVENTREG_18_20),
    ...
    /* 0x001D 0x01 */ MSCRIPT_AWAIT_TEXT(),
    /* 0x001E 0x03 */ MSCRIPT_WEEK_EVENT_REG_SET(WEEKEVENTREG_18_40),
    ...
    /* 0x0066 0x03 */ MSCRIPT_WEEK_EVENT_REG_SET(WEEKEVENTREG_19_01),
    ...
    /* 0x0090 0x03 */ MSCRIPT_WEEK_EVENT_REG_SET(WEEKEVENTREG_HAS_POWDERKEG_PRIVILEGES),
...
static MsgScript sMsgScriptGoronGatekeeper[] = {
    ...
    /* 0x000E 0x05 */ MSCRIPT_BRANCH_ON_WEEK_EVENT_REG(WEEKEVENTREG_GATEKEEPER_OPENED_GORON_SHRINE_FOR_HUMAN, 0x0064 - 0x0013),
    /* 0x0013 0x03 */ MSCRIPT_JUMP(0x0034 - 0x0016),
    /* 0x0016 0x05 */ MSCRIPT_BRANCH_ON_WEEK_EVENT_REG(WEEKEVENTREG_GATEKEEPER_OPENED_GORON_SHRINE_FOR_DEKU, 0x0064 - 0x001B),
    /* 0x001B 0x03 */ MSCRIPT_JUMP(0x0034 - 0x001E),
    /* 0x001E 0x05 */ MSCRIPT_BRANCH_ON_WEEK_EVENT_REG(WEEKEVENTREG_GATEKEEPER_OPENED_GORON_SHRINE_FOR_ZORA, 0x0064 - 0x0023),
    /* 0x0023 0x03 */ MSCRIPT_JUMP(0x0034 - 0x0026),
    /* 0x0026 0x05 */ MSCRIPT_BRANCH_ON_WEEK_EVENT_REG(WEEKEVENTREG_GATEKEEPER_OPENED_GORON_SHRINE_FOR_GORON, 0x0064 - 0x002B),
