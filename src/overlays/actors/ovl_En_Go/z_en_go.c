...
static MsgScript sMsgScriptGoronGravemaker[] = {
    /* 0x0000 0x05 */ MSCRIPT_BRANCH_ON_WEEK_EVENT_REG(WEEKEVENTREG_TALKED_THAWED_GRAVEYARD_GORON, 0x0045 - 0x0005),
    /* 0x0005 0x03 */ MSCRIPT_BRANCH_IF_GORON(0x002A - 0x0008),
    /* 0x0008 0x05 */ MSCRIPT_BRANCH_ON_WEEK_EVENT_REG(WEEKEVENTREG_21_02, 0x0025 - 0x000D),
    ...
    /* 0x0021 0x03 */ MSCRIPT_SET_WEEK_EVENT_REG(WEEKEVENTREG_21_02),
    ...
    /* 0x002A 0x05 */ MSCRIPT_BRANCH_ON_WEEK_EVENT_REG(WEEKEVENTREG_TALKED_GORON_GRAVEMAKER_AS_GORON, 0x0040 - 0x002F),
    ...
    /* 0x003B 0x03 */ MSCRIPT_SET_WEEK_EVENT_REG(WEEKEVENTREG_TALKED_GORON_GRAVEMAKER_AS_GORON),
    /* 0x003E 0x01 */ MSCRIPT_UNSET_AUTOTALK(),
    ...
    /* 0x0045 0x05 */ MSCRIPT_BRANCH_ON_WEEK_EVENT_REG(WEEKEVENTREG_TALKED_GORON_GRAVEMAKER_AS_GORON, 0x0057 - 0x004A),
...
static MsgScript sMsgScriptGoronFrozen[] = {
    /* 0x0000 0x05 */ MSCRIPT_BRANCH_ON_WEEK_EVENT_REG(WEEKEVENTREG_TALKED_THAWED_GRAVEYARD_GORON, 0x0083 - 0x0005),
    /* 0x0005 0x03 */ MSCRIPT_BRANCH_IF_GORON(0x0055 - 0x0008),
    /* 0x0008 0x05 */ MSCRIPT_BRANCH_ON_WEEK_EVENT_REG(WEEKEVENTREG_TALKED_GORON_GRAVEMAKER_AS_GORON, 0x0025 - 0x000D),
    ...
    /* 0x0020 0x01 */ MSCRIPT_UNSET_AUTOTALK(),
    /* 0x0021 0x03 */ MSCRIPT_SET_WEEK_EVENT_REG(WEEKEVENTREG_TALKED_THAWED_GRAVEYARD_GORON),
    /* 0x0024 0x01 */ MSCRIPT_DONE(),
    ...
    /* 0x0050 0x01 */ MSCRIPT_UNSET_AUTOTALK(),
    /* 0x0051 0x03 */ MSCRIPT_SET_WEEK_EVENT_REG(WEEKEVENTREG_TALKED_THAWED_GRAVEYARD_GORON),
    ...
    /* 0x007E 0x01 */ MSCRIPT_UNSET_AUTOTALK(),
    /* 0x007F 0x03 */ MSCRIPT_SET_WEEK_EVENT_REG(WEEKEVENTREG_TALKED_THAWED_GRAVEYARD_GORON),
    /* 0x0082 0x01 */ MSCRIPT_DONE(),

    /* 0x0083 0x05 */ MSCRIPT_BRANCH_ON_WEEK_EVENT_REG(WEEKEVENTREG_TALKED_GORON_GRAVEMAKER_AS_GORON, 0x0095 - 0x0088),
...
static MsgScript sMsgScriptGoronAsideEldersSon[] = {
    /* 0x0000 0x05 */ MSCRIPT_BRANCH_ON_WEEK_EVENT_REG(WEEKEVENTREG_CALMED_GORON_ELDERS_SON, 0x003D - 0x0005),
    ...
    /* 0x0014 0x03 */ MSCRIPT_SET_WEEK_EVENT_REG(WEEKEVENTREG_24_80),
    /* 0x0017 0x01 */ MSCRIPT_DONE(),

    /* 0x0018 0x05 */ MSCRIPT_BRANCH_ON_WEEK_EVENT_REG(WEEKEVENTREG_22_08, 0x0038 - 0x001D),
    ...
    /* 0x0031 0x03 */ MSCRIPT_SET_WEEK_EVENT_REG(WEEKEVENTREG_22_08),
    /* 0x0034 0x03 */ MSCRIPT_SET_WEEK_EVENT_REG(WEEKEVENTREG_24_80),
...
static MsgScript sMsgScriptGoronAsideEldersRoom[] = {
    /* 0x0000 0x05 */ MSCRIPT_BRANCH_ON_WEEK_EVENT_REG(WEEKEVENTREG_CALMED_GORON_ELDERS_SON, 0x0027 - 0x0005),
    ...
    /* 0x0011 0x05 */ MSCRIPT_BRANCH_ON_WEEK_EVENT_REG(WEEKEVENTREG_23_01, 0x0022 - 0x0016),
    ...
    /* 0x001E 0x03 */ MSCRIPT_SET_WEEK_EVENT_REG(WEEKEVENTREG_23_01),
...
static MsgScript sMsgScriptGoronMedigoron[] = {
    ...
    /* 0x0003 0x05 */ MSCRIPT_BRANCH_ON_WEEK_EVENT_REG(WEEKEVENTREG_18_20, 0x0010 - 0x0008),
    /* 0x0008 0x03 */ MSCRIPT_BEGIN_TEXT(0x0C8E),
    /* 0x000B 0x01 */ MSCRIPT_AWAIT_TEXT(),
    /* 0x000C 0x03 */ MSCRIPT_SET_WEEK_EVENT_REG(WEEKEVENTREG_18_20),
    ...
    /* 0x0015 0x05 */ MSCRIPT_BRANCH_ON_WEEK_EVENT_REG(WEEKEVENTREG_18_40, 0x0037 - 0x001A),
    /* 0x001A 0x03 */ MSCRIPT_BEGIN_TEXT(0x0C80),
    /* 0x001D 0x01 */ MSCRIPT_AWAIT_TEXT(),
    /* 0x001E 0x03 */ MSCRIPT_SET_WEEK_EVENT_REG(WEEKEVENTREG_18_40),
    /* 0x0021 0x05 */ MSCRIPT_BRANCH_ON_WEEK_EVENT_REG(WEEKEVENTREG_HAS_POWDERKEG_PRIVILEGES, 0x009A - 0x0026),
    /* 0x0026 0x05 */ MSCRIPT_BRANCH_ON_ITEM(ITEM_POWDER_KEG, 0x009A - 0x002B),
    /* 0x002B 0x05 */ MSCRIPT_BRANCH_ON_WEEK_EVENT_REG(WEEKEVENTREG_19_01, 0x0075 - 0x0030),
    /* 0x0030 0x03 */ MSCRIPT_CONTINUE_TEXT(0x0C81),
    /* 0x0033 0x01 */ MSCRIPT_AWAIT_TEXT(),
    /* 0x0034 0x03 */ MSCRIPT_JUMP(0x004A - 0x0037),
    /* 0x0037 0x05 */ MSCRIPT_BRANCH_ON_WEEK_EVENT_REG(WEEKEVENTREG_HAS_POWDERKEG_PRIVILEGES, 0x009A - 0x003C),
    /* 0x003C 0x05 */ MSCRIPT_BRANCH_ON_ITEM(ITEM_POWDER_KEG, 0x009A - 0x0041),
    /* 0x0041 0x05 */ MSCRIPT_BRANCH_ON_WEEK_EVENT_REG(WEEKEVENTREG_19_01, 0x0075 - 0x0046),
    ...
    /* 0x005E 0x03 */ MSCRIPT_AUTOTALK(0x0),
    /* 0x0061 0x03 */ MSCRIPT_BEGIN_TEXT(0x0C84),
    /* 0x0064 0x01 */ MSCRIPT_UNSET_AUTOTALK(),
    /* 0x0065 0x01 */ MSCRIPT_AWAIT_TEXT(),
    /* 0x0066 0x03 */ MSCRIPT_SET_WEEK_EVENT_REG(WEEKEVENTREG_19_01),
    ...
    /* 0x0075 0x03 */ MSCRIPT_BRANCH_IF_HAS_POWDER_KEG(0x006A - 0x0078),

    /* 0x0078 0x05 */ MSCRIPT_BRANCH_ON_WEEK_EVENT_REG(WEEKEVENTREG_19_02, 0x008C - 0x007D),
    ...
    /* 0x0090 0x03 */ MSCRIPT_SET_WEEK_EVENT_REG(WEEKEVENTREG_HAS_POWDERKEG_PRIVILEGES),
    /* 0x0093 0x03 */ MSCRIPT_JUMP(0x00B7 - 0x0096),
    /* 0x0096 0x01 */ MSCRIPT_PLAY_DECIDE(),
    /* 0x0097 0x03 */ MSCRIPT_JUMP(0x005A - 0x009A),

    /* 0x009A 0x03 */ MSCRIPT_BRANCH_IF_HAS_POWDER_KEG(0x00C9 - 0x009D),
    ...
    /* 0x00B4 0x03 */ MSCRIPT_CHANGE_RUPEES(-100),
    /* 0x00B7 0x01 */ MSCRIPT_CLOSE_TEXT(),
    /* 0x00B8 0x05 */ MSCRIPT_OFFER_ITEM(GI_POWDER_KEG, 0x0),
    /* 0x00BD 0x03 */ MSCRIPT_SET_COLLECTIBLE(0x0034),
    /* 0x00C0 0x03 */ MSCRIPT_AUTOTALK(0x0),
    /* 0x00C3 0x03 */ MSCRIPT_BEGIN_TEXT(0x0C87),
    /* 0x00C6 0x01 */ MSCRIPT_AWAIT_TEXT(),
    /* 0x00C7 0x01 */ MSCRIPT_UNSET_AUTOTALK(),
...
static MsgScript sMsgScriptGoronGatekeeper[] = {
    /* 0x0000 0x05 */ MSCRIPT_BRANCH_ON_WEEK_EVENT_REG(WEEKEVENTREG_GATEKEEPER_OPENED_GORON_SHRINE, 0x002E - 0x0005),
    ...
    /* 0x000E 0x05 */
    MSCRIPT_BRANCH_ON_WEEK_EVENT_REG(WEEKEVENTREG_GATEKEEPER_OPENED_GORON_SHRINE_FOR_HUMAN, 0x0064 - 0x0013),
    /* 0x0013 0x03 */ MSCRIPT_JUMP(0x0034 - 0x0016),
    /* 0x0016 0x05 */
    MSCRIPT_BRANCH_ON_WEEK_EVENT_REG(WEEKEVENTREG_GATEKEEPER_OPENED_GORON_SHRINE_FOR_DEKU, 0x0064 - 0x001B),
    /* 0x001B 0x03 */ MSCRIPT_JUMP(0x0034 - 0x001E),
    /* 0x001E 0x05 */
    MSCRIPT_BRANCH_ON_WEEK_EVENT_REG(WEEKEVENTREG_GATEKEEPER_OPENED_GORON_SHRINE_FOR_ZORA, 0x0064 - 0x0023),
    /* 0x0023 0x03 */ MSCRIPT_JUMP(0x0034 - 0x0026),
    /* 0x0026 0x05 */
    MSCRIPT_BRANCH_ON_WEEK_EVENT_REG(WEEKEVENTREG_GATEKEEPER_OPENED_GORON_SHRINE_FOR_GORON, 0x0064 - 0x002B),
