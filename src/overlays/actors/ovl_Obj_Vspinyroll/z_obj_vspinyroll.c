...
ActorInit Obj_Vspinyroll_InitVars = {
    ACTOR_OBJ_VSPINYROLL,  ACTORCAT_PROP,         FLAGS,
    OBJECT_SPINYROLL,      sizeof(ObjVspinyroll), ObjVspinyroll_Init,
    ObjVspinyroll_Destroy, ObjVspinyroll_Update,  ObjVspinyroll_Draw,
};
