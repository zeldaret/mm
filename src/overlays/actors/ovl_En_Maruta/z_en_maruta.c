...
void func_80B37590(EnMaruta* this, GlobalContext* globalCtx);
...
void func_80B37EC0(EnMaruta* this, GlobalContext* globalCtx);
...
s32 D_80B386CC[] = {
    /* PLAYER_MWA_FORWARD_SLASH_1H */ 5,
    /* PLAYER_MWA_FORWARD_SLASH_2H */ 5,
    /* PLAYER_MWA_FORWARD_COMBO_1H */ 3,
    /* PLAYER_MWA_FORWARD_COMBO_2H */ 3,
    /* PLAYER_MWA_RIGHT_SLASH_1H */ 7,
    /* PLAYER_MWA_RIGHT_SLASH_2H */ 7,
    /* PLAYER_MWA_RIGHT_COMBO_1H */ 7,
    /* PLAYER_MWA_RIGHT_COMBO_2H */ 7,
    /* PLAYER_MWA_LEFT_SLASH_1H */ 3,
    /* PLAYER_MWA_LEFT_SLASH_2H */ 3,
    /* PLAYER_MWA_LEFT_COMBO_1H */ 3,
    /* PLAYER_MWA_LEFT_COMBO_2H */ 3,
    /* PLAYER_MWA_STAB_1H */ 7,
    /* PLAYER_MWA_STAB_2H */ 7,
    /* PLAYER_MWA_STAB_COMBO_1H */ 3,
    /* PLAYER_MWA_STAB_COMBO_2H */ 3,
    /* PLAYER_MWA_FLIPSLASH_START */ 0,
    /* PLAYER_MWA_JUMPSLASH_START */ 0,
    /* PLAYER_MWA_ZORA_JUMPKICK_START */ 0,
    /* PLAYER_MWA_FLIPSLASH_FINISH */ 0,
    /* PLAYER_MWA_JUMPSLASH_FINISH */ 5,
    /* PLAYER_MWA_ZORA_JUMPKICK_FINISH */ 0,
    /* PLAYER_MWA_BACKSLASH_RIGHT */ 0,
    /* PLAYER_MWA_BACKSLASH_LEFT */ 0,
    /* PLAYER_MWA_GORON_PUNCH_LEFT */ 0,
    /* PLAYER_MWA_GORON_PUNCH_RIGHT */ 0,
    /* PLAYER_MWA_GORON_PUNCH_BUTT */ 0,
    /* PLAYER_MWA_ZORA_PUNCH_LEFT */ 0,
    /* PLAYER_MWA_ZORA_PUNCH_COMBO */ 0,
    /* PLAYER_MWA_ZORA_PUNCH_KICK */ 0,
    /* PLAYER_MWA_SPIN_ATTACK_1H */ 7,
    /* PLAYER_MWA_SPIN_ATTACK_2H */ 7,
    /* PLAYER_MWA_BIG_SPIN_1H */ 7,
    /* PLAYER_MWA_BIG_SPIN_2H */ 7
};
...
s32 func_80B37B78(EnMaruta* this, GlobalContext* globalCtx) {
    Player* player = GET_PLAYER(globalCtx);
...
void func_80B37CA0(EnMaruta* this, GlobalContext* globalCtx) {
    Player* player = GET_PLAYER(globalCtx);
    ...
    if ((this->actionFunc == func_80B372CC) || (this->actionFunc == func_80B3738C) ||
        ...
        if ((this->collider.base.acFlags & AC_HIT) && (this->actionFunc == func_80B372CC)) {
            ...
            if (D_80B386CC[player->meleeWeaponAnimation] != 0) {
                ...
                Actor_SpawnAsChild(&globalCtx->actorCtx, &this->actor, globalCtx, ACTOR_EN_MARUTA,
        ...
        if (func_80B37B78(this, globalCtx) && (this->actionFunc == func_80B372CC)) {
...
void func_80B382E4(GlobalContext* globalCtx, Vec3f arg1) {
    ...
    for (i = 0; i < 10; i++) {
        ...
        sp6C.x = -0.2f * sp78.x;
        sp6C.z = -0.2f * sp78.z;
        func_800B0EB0(globalCtx, &sp84, &sp78, &sp6C, &sp68, &sp64, 60, 20, 10);
    }
}
