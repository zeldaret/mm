...
void func_80B37590(EnMaruta* this, PlayState* play) {
    ...
    switch (this->unk_210) {
        ...
        case 4:
            if (player->meleeWeaponAnimation == 8) {
                sp48 = D_80B3876C;
            } else {
                sp48 = D_80B38778;
            }
        ...
        case 5:
            if (player->meleeWeaponAnimation == 0) {
                sp48 = D_80B38784;
            } else {
                sp48 = D_80B38790;
            }
        ...
        case 8:
            if (player->meleeWeaponAnimation == 4) {
                sp48 = D_80B387B4;
            } else {
                sp48 = D_80B387C0;
            }
    ...
    if ((this->actionFunc == func_80B372CC) || (this->actionFunc == func_80B3738C) ||
        ...
        if ((this->collider.base.acFlags & AC_HIT) && (this->actionFunc == func_80B372CC)) {
            ...
            if (D_80B386CC[player->meleeWeaponAnimation] != 0) {
                ...
                if ((this->unk_210 == 5) || ((this->unk_210 == 7) && (player->meleeWeaponAnimation == 0xC))) {
                    func_80B37590(this, play);
                } else {
                    func_80B374B8(this);
                }
