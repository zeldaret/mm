    ...
    if (msgCtx->choiceIndex == 0) {
        ...
        if (gSaveContext.save.playerData.rupees >= play->msgCtx.unk1206C) {
            ...
            if (!(gSaveContext.save.weekEventReg[57] & 1)) {
                ...
                func_800E8EA0(play, &this->actor, 0x3475);
            }
        } else {
            play_sound(NA_SE_SY_ERROR);
            func_800E8EA0(play, &this->actor, 0x3473);
        }
    } else {
        func_8019F230();
        func_800E8EA0(play, &this->actor, 0x3472);
    }
    return 0;
}
...
s32 func_808F4270(PlayState* play, EnIn* this, s32 arg2, MessageContext* msgCtx, s32 arg4) {
    ...
    if (msgCtx->choiceIndex == 0) {
        ...
        if (gSaveContext.save.playerData.rupees >= fee) {
            ...
            if (!(gSaveContext.save.weekEventReg[57] & 1)) {
                if (arg4 != 0) {
                    func_800E8EA0(play, &this->actor, 0x3474);
                } else {
                    func_808F4108(this, play, 0x3474);
                }
            } else {
...
s32 func_808F4414(PlayState* play, EnIn* this, s32 arg2) {
    ...
    switch (textId) {
        case 0x34AF:
            func_800E8EA0(play, &this->actor, 0x34B0);
            ret = false;
            break;
        case 0x34A9:
        ...
        case 0x34AC:
            ...
            break;
        case 0x34AD:
            func_800E8EA0(play, &this->actor, 0x34AE);
            ret = false;
            break;
        case 0x34B1:
            func_800E8EA0(play, &this->actor, 0x34B2);
            ret = false;
            break;
        default:
            break;
    ...
    switch (arg2) {
        case 0:
            switch (textId) {
                case 0x3458:
                    ...
                    func_800E8EA0(play, &this->actor, 0x3459);
                    ret = false;
                    break;
                case 0x3459:
                    func_800E8EA0(play, &this->actor, 0x345A);
                    ret = false;
                    break;
                case 0x345A:
                    func_80151BB4(play, 0x11);
                ...
                case 0x345B:
                    ...
                    break;
                case 0x345C:
                    func_800E8EA0(play, &this->actor, 0x345D);
                    ret = false;
                    break;
                case 0x345D:
                    func_800E8EA0(play, &this->actor, 0x345E);
                    ret = false;
                    break;
                case 0x345E:
                    func_800E8EA0(play, &this->actor, 0x345F);
                    ret = false;
                    break;
                case 0x345F:
                    func_80151BB4(play, 0x11);
                    ...
                    break;
                case 0x3460:
                    func_800E8EA0(play, &this->actor, 0x3461);
                    ret = false;
                    break;
                case 0x3461:
                    func_800E8EA0(play, &this->actor, 0x3462);
                    ret = false;
                    break;
                case 0x3462:
                    func_80151BB4(play, 0x11);
        ...
        case 1:
            switch (textId) {
                case 0x3463:
                    ...
                    func_800E8EA0(play, &this->actor, 0x3464);
                    ret = false;
                    break;
                case 0x3464:
                    func_800E8EA0(play, &this->actor, 0x3465);
                    ret = false;
                    break;
                case 0x3465:
                    func_800E8EA0(play, &this->actor, 0x3466);
                    ret = false;
                    break;
                case 0x3466:
                    if (msgCtx->choiceIndex == 0) {
                        ...
                        if (gSaveContext.save.playerData.rupees >= play->msgCtx.unk1206C) {
                            if (Interface_HasEmptyBottle()) {
                                ...
                                func_800E8EA0(play, &this->actor, 0x3469);
                                ret = false;
                            }
                        } else {
                            play_sound(NA_SE_SY_ERROR);
                            func_800E8EA0(play, &this->actor, 0x3468);
                            ret = false;
                        }
                    } else {
                        func_8019F230();
                        func_800E8EA0(play, &this->actor, 0x3467);
                        ret = false;
                    }
                    break;
                case 0x3467:
                ...
                case 0x3469:
                    ...
                    break;
                case 0x346B:
                    func_800E8EA0(play, &this->actor, 0x346C);
                    ret = false;
                    break;
                case 0x346C:
                    func_800E8EA0(play, &this->actor, 0x3466);
        ...
        case 2:
            switch (textId) {
                case 0x346E:
                    ...
                    break;
                case 0x3470:
                    func_800E8EA0(play, &this->actor, 0x3471);
                    ret = false;
                    break;
                case 0x3483:
                    func_800E8EA0(play, &this->actor, 0x3471);
        ...
        case 3:
            switch (textId) {
                ...
                case 0x3474:
                    ...
                    break;
                case 0x3476:
                    func_800E8EA0(play, &this->actor, 0x3477);
                ...
                case 0x347A:
                    ...
                    if (INV_CONTENT(ITEM_MASK_GARO) == ITEM_MASK_GARO) {
                        func_800E8EA0(play, &this->actor, 0x347E);
                        ret = false;
                    } else {
                        gSaveContext.save.weekEventReg[56] |= 8;
                ...
                case 0x347E:
                    ...
                    if (Interface_HasEmptyBottle()) {
                        ...
                        func_800E8EA0(play, &this->actor, 0x347F);
                        ret = false;
                    }
                    break;
                case 0x347F:
                    func_800E8EA0(play, &this->actor, 0x3480);
                    ret = false;
                    break;
                case 0x3480:
                    func_808F43E0(this);
        ...
        case 4:
            switch (textId) {
                case 0x3486:
                    func_800E8EA0(play, &this->actor, 0x3487);
                    gSaveContext.save.weekEventReg[16] |= 1;
                    ret = false;
                    break;
                case 0x3487:
                    func_800E8EA0(play, &this->actor, 0x3488);
                    ret = false;
                    break;
                case 0x3488:
                    func_80151BB4(play, 0x11);
                ...
                case 0x348A:
                    ...
                    break;
                case 0x348B:
                    func_800E8EA0(play, &this->actor, 0x348C);
                    ret = false;
                    break;
                case 0x348C:
                    func_800E8EA0(play, &this->actor, 0x348D);
                    ret = false;
                    break;
                case 0x348D:
                    func_80151BB4(play, 0x11);
        ...
        case 5:
            switch (textId) {
                ...
                case 0x348E:
                case 0x34B3:
                    func_800E8EA0(play, &this->actor, 0x348F);
                    gSaveContext.save.weekEventReg[16] |= 2;
                    ret = false;
                    break;
                case 0x3493:
                    func_800E8EA0(play, &this->actor, 0x3494);
                    ret = false;
                    break;
                case 0x348F:
                case 0x3494:
                    func_800E8EA0(play, &this->actor, 0x3490);
                    ret = false;
                    break;
                case 0x3490:
                    if (msgCtx->choiceIndex == 0) {
                        ...
                        func_8019F230();
                        func_800E8EA0(play, &this->actor, 0x3491);
                        ret = false;
                    }
                    break;
                case 0x3492:
        ...
        case 7:
            switch (textId) {
                ...
                case 0x349D:
                    ...
                    func_808F30B0(&this->unk4A4->skelAnime, 7);
                    if (INV_CONTENT(ITEM_MASK_GARO) == ITEM_MASK_GARO) {
                        func_800E8EA0(play, &this->actor, 0x34A1);
                        ret = false;
                    } else {
                        gSaveContext.save.weekEventReg[56] |= 8;
                ...
                case 0x34A1:
                    ...
                    if (Interface_HasEmptyBottle()) {
                        ...
                        func_800E8EA0(play, &this->actor, 0x34A2);
                        ret = false;
                    }
                    break;
                case 0x34A2:
                    func_800E8EA0(play, &this->actor, 0x34A3);
                    ret = false;
                    break;
                case 0x34A3:
                    func_808F43E0(this);
                    ...
                    break;
                case 0x3499:
                    func_800E8EA0(play, &this->actor, 0x349A);
                    func_808F30B0(&this->skelAnime, 1);
                    func_808F30B0(&this->unk4A4->skelAnime, 7);
                    ret = false;
                    break;
                case 0x349A:
                    func_800E8EA0(play, &this->actor, 0x349B);
                    ret = false;
                    break;
                case 0x349B:
                    if (msgCtx->choiceIndex == 0) {
                        ...
                        func_8019F230();
                        func_800E8EA0(play, &this->actor, 0x349C);
                        ret = false;
                    }
                    break;
                case 0x349C:
...
s32 EnIn_OverrideLimbDraw(PlayState* play, s32 limbIndex, Gfx** dList, Vec3f* pos, Vec3s* rot, Actor* thisx) {
    ...
    if (limbIndex == 16) {
        ...
        AnimatedMat_DrawStep(play, Lib_SegmentedToVirtual(object_in_Matanimheader_001C30),
                             this->unk4AC & 8 ? 1 : 0);
    }
