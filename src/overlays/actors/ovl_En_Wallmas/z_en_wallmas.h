 ...
 * - EN_WALLMAS_TYPE_TIMER_ONLY: These Wallmasters don't check for anything to determine
 *   whether or not to drop; they just set a 130-frame timer and drop once it reaches 0.
 * - EN_WALLMAS_TYPE_PROXIMITY: These Wallmasters ensure that the player in within a certain
 ...
 * - EN_WALLMAS_TYPE_FLAG: These Wallmasters wait for a certain switch flag to be activated,
 ...
 * touching the ground). Additionally, EN_WALLMAS_TYPE_PROXIMITY-type Wallmasters will reset
 * the timer to 130 frames if the player strays too far from the Wallmaster's current position.
 */
typedef enum {
    /* 0x00 */ EN_WALLMAS_TYPE_TIMER_ONLY,
    /* 0x01 */ EN_WALLMAS_TYPE_PROXIMITY,
    /* 0x02 */ EN_WALLMAS_TYPE_FLAG
} WallmasType;
