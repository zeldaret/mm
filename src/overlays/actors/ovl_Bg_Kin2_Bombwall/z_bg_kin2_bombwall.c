...
extern s16 D_80B6E738; //? type before
...
loop_2:
        ...
        //phi_s0 = phi_s0_2;
        if ((phi_s0 =  (s32) (s16) (phi_s0 | 1),temp_s3 < 2) || (phi_s1 = 0, (Rand_Next() > 0))) {
            temp_s2 = Rand_Next();
            //;
        ...
        EffectSsKakera_Spawn(globalCtx, &spF0, &spE4, &spF0, (s16) -0x226, (s16) phi_s0, (s16) 0x1E, (s16) 0, (s16) 0, (s16) (s32) *(&D_80B6E738 + (temp_s3 * 2)), (s16) phi_s1, (s16) 0, 0x32, (s16) -1, (s16) 0x1F5, (Gfx *) &D_06000128);
