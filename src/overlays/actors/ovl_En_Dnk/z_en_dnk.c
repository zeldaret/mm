...
static AnimationInfoS sAnimations[] = {
    { &D_06000B70, 1.0f, 0, -1, ANIMMODE_ONCE, 0 },  { &D_06000B70, 1.0f, 0, -1, ANIMMODE_ONCE, -4 },
    { &D_06002A08, 1.0f, 0, -1, ANIMMODE_LOOP, -4 }, { &D_0600031C, 1.0f, 0, -1, ANIMMODE_LOOP, -4 },
    { &D_06000430, 1.0f, -1, -1, ANIMMODE_ONCE, 0 }, { &D_06000430, 1.0f, 0, -1, ANIMMODE_ONCE, -4 },
    { &D_06000894, 1.0f, 0, -1, ANIMMODE_ONCE, -4 }, { &D_06002B6C, 1.0f, 0, -1, ANIMMODE_LOOP, 0 },
    { &D_06002B6C, 1.0f, 0, -1, ANIMMODE_LOOP, -4 }, { &D_060006CC, 1.0f, 0, -1, ANIMMODE_LOOP, -4 },
    { &D_06000168, 1.0f, 0, -1, ANIMMODE_ONCE, -4 }, { &D_060024CC, 1.0f, -1, -1, ANIMMODE_ONCE, 0 },
    { &D_060024CC, 1.0f, 0, -1, ANIMMODE_ONCE, -4 }, { &D_060026C4, 1.0f, 0, -1, ANIMMODE_ONCE, -4 },
    { &D_06002894, 1.0f, 0, -1, ANIMMODE_ONCE, -4 }, { &D_06002B90, 1.0f, 0, -1, ANIMMODE_ONCE, -4 },
    { &D_06002F7C, 1.0f, 0, -1, ANIMMODE_LOOP, 0 },  { &D_06002F7C, 1.0f, 0, -1, ANIMMODE_LOOP, -4 },
    { &D_06003128, 1.0f, 0, -1, ANIMMODE_LOOP, 0 },  { &D_06003128, 1.0f, 0, -1, ANIMMODE_LOOP, -4 },
    { &D_060029BC, 1.0f, 0, -1, ANIMMODE_LOOP, -4 }, { &D_06002E84, 1.0f, 0, -1, ANIMMODE_LOOP, -4 },
    { &D_06000168, 1.0f, 0, -1, ANIMMODE_LOOP, -4 }, { &D_0600259C, 1.0f, 0, -1, ANIMMODE_ONCE, -4 },
    { &D_06002A5C, 1.0f, 0, -1, ANIMMODE_ONCE, 0 },  { &D_06002A5C, 1.0f, 0, -1, ANIMMODE_ONCE, -4 },
    { &D_06002BD4, 1.0f, 0, -1, ANIMMODE_ONCE, -4 }, { &D_06002DD4, 1.0f, 0, -1, ANIMMODE_ONCE, -4 },
    { &D_06002FA4, 1.0f, 0, -1, ANIMMODE_LOOP, -4 }, { &D_06003180, 1.0f, 0, -1, ANIMMODE_ONCE, -4 },
    { &D_0600326C, 1.0f, 0, -1, ANIMMODE_LOOP, 0 },  { &D_0600326C, 1.0f, 0, -1, ANIMMODE_LOOP, -4 },
    { &D_060033E4, 1.0f, 0, -1, ANIMMODE_LOOP, -4 }, { &D_06003780, 1.0f, 0, -1, ANIMMODE_LOOP, 0 },
    { &D_06003780, 1.0f, 0, -1, ANIMMODE_LOOP, -4 }, { &D_06002950, 1.0f, 0, -1, ANIMMODE_LOOP, 0 },
};
