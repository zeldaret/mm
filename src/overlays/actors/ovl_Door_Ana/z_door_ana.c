...
static u16 sEntranceIndexes[] = {
    NEXT_ENTRANCE(UNSET_0D, 0, 0), NEXT_ENTRANCE(GROTTOS, 0, 0),  NEXT_ENTRANCE(GROTTOS, 1, 0),
    NEXT_ENTRANCE(GROTTOS, 2, 0),  NEXT_ENTRANCE(GROTTOS, 3, 0),  NEXT_ENTRANCE(GROTTOS, 4, 0),
    NEXT_ENTRANCE(GROTTOS, 5, 0),  NEXT_ENTRANCE(GROTTOS, 6, 0),  NEXT_ENTRANCE(GROTTOS, 7, 0),
    NEXT_ENTRANCE(GROTTOS, 8, 0),  NEXT_ENTRANCE(GROTTOS, 9, 0),  NEXT_ENTRANCE(GROTTOS, 10, 0),
    NEXT_ENTRANCE(GROTTOS, 11, 0), NEXT_ENTRANCE(GROTTOS, 12, 0), NEXT_ENTRANCE(GROTTOS, 13, 0),
};
