...
s32 func_80BC19FC(EnJa* this, PlayState* play) {
    ...
    if (((this->unk_340 & SUBS_OFFER_MODE_MAX) != SUBS_OFFER_MODE_NONE) &&
        Actor_ProcessTalkRequest(&this->actor, &play->state)) {
        SubS_UpdateFlags(&this->unk_340, SUBS_OFFER_MODE_NONE, SUBS_OFFER_MODE_MAX);
...
s32 func_80BC1FC8(EnJa* this, PlayState* play, ScheduleOutput* scheduleOutput) {
    ...
    if (func_80BC1AE0(this, play)) {
        SubS_UpdateFlags(&this->unk_340, SUBS_OFFER_MODE_ONSCREEN, SUBS_OFFER_MODE_MAX);
        this->unk_340 |= 0x10;
