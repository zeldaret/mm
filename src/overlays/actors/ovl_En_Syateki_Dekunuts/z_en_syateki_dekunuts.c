...
void EnSyatekiDekunuts_SetupEmerge(EnSyatekiDekunuts* this) {
    ...
    Actor_ChangeAnimByInfo(&this->skelAnime, sAnimationInfo, EN_SYATEKI_DEKUNUTS_ANIM_UP);
    this->actor.shape.rot.y = this->actor.yawTowardsPlayer;
    this->actor.world.rot.y = this->actor.yawTowardsPlayer;
...
void EnSyatekiDekunuts_SetupLookAround(EnSyatekiDekunuts* this) {
    Actor_ChangeAnimByInfo(&this->skelAnime, sAnimationInfo, EN_SYATEKI_DEKUNUTS_ANIM_LOOK_AROUND);
    if (EN_SYATEKI_DEKUNUTS_GET_TYPE(&this->actor) != EN_SYATEKI_DEKUNUTS_TYPE_BONUS) {
...
void EnSyatekiDekunuts_SetupBurrow(EnSyatekiDekunuts* this) {
    Actor_ChangeAnimByInfo(&this->skelAnime, sAnimationInfo, EN_SYATEKI_DEKUNUTS_ANIM_BURROW);
...
void EnSyatekiDekunuts_SetupDead(EnSyatekiDekunuts* this, PlayState* play) {
    ...
    this->isAlive = false;
    Actor_ChangeAnimByInfo(&this->skelAnime, sAnimationInfo, EN_SYATEKI_DEKUNUTS_ANIM_DAMAGE);
    this->timer = 160;
...
void EnSyatekiDekunuts_Dead(EnSyatekiDekunuts* this, PlayState* play) {
    ...
    if (Animation_OnFrame(&this->skelAnime, this->skelAnime.endFrame)) {
        if (this->timer == 160) {
            Actor_ChangeAnimByInfo(&this->skelAnime, sAnimationInfo, EN_SYATEKI_DEKUNUTS_ANIM_DIE);
