...
void EnElforg_MoveToTargetFairyFountain(EnElforg* this, Vec3f* homePos) {
    ...
    targetAngle = Math_Atan2S_Depr(-zDifference, -xDifference);
...
void EnElforg_MoveToTarget(EnElforg* this, Vec3f* targetPos) {
    ...
    targetAngle = Math_Atan2S_Depr(-(this->actor.world.pos.z - targetPos->z), -(this->actor.world.pos.x - targetPos->x));
