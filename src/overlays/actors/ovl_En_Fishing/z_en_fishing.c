        ...
        case 0:
            ...
            if (D_80917204 == 0) {
                ...
                if (D_80917204 == 18) {
                    ...
                    Audio_PlaySfxByPos(&D_8090D614, NA_SE_IT_SWORD_SWING_HARD);
                }
            }
            break;
            ...
            if (spC8 > SQ(920.0f)) {
                ...
                if (sLurePos.y <= sp7C) {
                    ...
                    if ((sLurePos.y <= sp7C) && (sp7C < spE0) && (sp7C == WATER_SURFACE_Y(globalCtx))) {
                        D_80917264 = 10;
                        Audio_PlaySfxByPos(&D_8090D614, NA_SE_EV_BOMB_DROP_WATER);
                        D_80917248.y = 0.0f;
                        D_80917238.y *= 0.2f;
        ...
        case 3: {
            ...
            if (spC8 < SQ(920.0f)) {
                ...
                if (sLurePos.y <= spE4) {
                    ...
                    if (CHECK_BTN_ALL(input->press.button, BTN_B)) {
                        D_809101C0 += 6.0f;
                        Audio_PlaySfxByPos(&D_8090D614, NA_SE_PL_WALK_SAND);
                    }
                } else {
                    if (D_809101C0 > 150.0f) {
                        sLureRot.x = sReelLineRot[LINE_SEG_COUNT - 2].x + M_PI;
...
void EnFishing_UpdateOwner(Actor* thisx, GlobalContext* globalCtx2) {
    ...
    Audio_PlaySfxByPos(&sStreamSoundProjectedPos, NA_SE_EV_WATER_WALL - SFX_FLAG);
