...
void func_8098B464(EnDg* this, GlobalContext* globalCtx) {
    ...
    sp2C.y = this->actor.world.pos.y + this->actor.yDirDistToWaterSurface;
    ...
    if (this->actor.yDirDistToWaterSurface > 0.0f) {
...
void func_8098B560(EnDg* this, GlobalContext* globalCtx) {
    ...
    sp54.y = this->actor.world.pos.y + this->actor.yDirDistToWaterSurface;
    ...
    if (this->actor.yDirDistToWaterSurface > 15.0f) {
        this->actor.velocity.y = 0.5f;
    } else if (this->actor.yDirDistToWaterSurface < 10.0f) {
        this->actor.velocity.y = -0.5f;
    }
...
void func_8098B88C(EnDg* this, GlobalContext* globalCtx) {
    ...
    sp34.y = this->actor.world.pos.y + this->actor.yDirDistToWaterSurface;
