...
void func_80989974(EnDg* this) {
    if (Animation_OnFrame(&this->skelAnime, 1.0f) || Animation_OnFrame(&this->skelAnime, 7.0f)) {
        Actor_PlaySfxAtProjectedPos(&this->actor, NA_SE_EV_MONKEY_WALK);
    }
}

void func_809899C8(EnDg* this, f32 arg1) {
    if (Animation_OnFrame(&this->skelAnime, arg1)) {
        Actor_PlaySfxAtProjectedPos(&this->actor, NA_SE_EV_SMALL_DOG_BARK);
    }
}

void func_80989A08(EnDg* this, f32 arg1) {
    if (Animation_OnFrame(&this->skelAnime, arg1)) {
        Actor_PlaySfxAtProjectedPos(&this->actor, NA_SE_EV_SMALL_DOG_ANG_BARK);
    }
}

void func_80989A48(EnDg* this) {
    if (Animation_OnFrame(&this->skelAnime, 23.0f) || Animation_OnFrame(&this->skelAnime, 28.0f)) {
        Actor_PlaySfxAtProjectedPos(&this->actor, NA_SE_EV_SMALL_DOG_WHINE);
    }
}

void func_80989A9C(EnDg* this, f32 arg1) {
    if (Animation_OnFrame(&this->skelAnime, arg1)) {
        Actor_PlaySfxAtProjectedPos(&this->actor, NA_SE_EV_SMALL_DOG_GROAN);
    }
}
...
void func_8098A70C(EnDg* this, GlobalContext* globalCtx) {
    ...
    if (Animation_OnFrame(&this->skelAnime, 3.0f)) {
        Actor_PlaySfxAtProjectedPos(&this->actor, NA_SE_EV_SMALL_DOG_CRY);
...
void func_8098B464(EnDg* this, GlobalContext* globalCtx) {
    ...
    if (this->actor.depthInWater > 0.0f) {
        ...
        this->unk_284 = 10;
        Actor_PlaySfxAtProjectedPos(&this->actor, NA_SE_EV_BOMB_DROP_WATER);
...
void func_8098B560(EnDg* this, GlobalContext* globalCtx) {
    ...
    if (DECR(this->unk_284) == 0) {
        if (!(this->unk_280 & 4)) {
            this->unk_280 |= 4;
            Actor_PlaySfxAtProjectedPos(&this->actor, NA_SE_EV_OUT_OF_WATER);
        }
        this->unk_284 = 5;
