...
void func_809C8488(EnSyatekiMan* this, GlobalContext* globalCtx) {
    if ((this->unk_26A == 1) || (this->unk_26A == 5)) {
        ...
        this->unk_276 = 0;
        if (this->unk_270 <= 0) {
            if ((s32)((gSaveContext.save.roomInf[7][6] & 0xFFFF0000) >> 0x10) < this->unk_280) {
                gSaveContext.save.roomInf[7][6] =
                    ((gSaveContext.save.roomInf[7][6]) & 0xFFFF) | ((u16)this->unk_280 << 0x10);
            }
            this->unk_270 = 15;
            if (this->unk_280 >= 0x848) {
...
void func_809C8BF0(EnSyatekiMan* this, GlobalContext* globalCtx) {
    if (this->unk_26A == 1) {
        ...
        if ((this->unk_270 <= 0) && (globalCtx->interfaceCtx.unk_286 == 0)) {
            ...
            this->unk_270 = 15;
            if (((s32)(gSaveContext.save.roomInf[7][6] & 0xFFFF) < this->unk_280) || (this->unk_280 == 50)) {
                if ((s32)(gSaveContext.save.roomInf[7][6] & 0xFFFF) < this->unk_280) {
                    if (!(gSaveContext.save.weekEventReg[59] & 0x20)) {
                ...
                gSaveContext.save.roomInf[7][6] = (gSaveContext.save.roomInf[7][6] & 0xFFFF0000) | (this->unk_280 & 0xFFFF);
                this->unk_26A = 6;
            } else {
                if (CURRENT_DAY != 3) {
