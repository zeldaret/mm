...
#define TIMETAG_GET_KICKOUT_TEXT_TYPE(thisx) (((thisx)->params & 0x1FE0) >> 0x5)
#define TIMETAG_GET_KICKOUT_EXIT_INDEX(thisx) ((thisx)->params & 0x1F)
#define TIMETAG_KICKOUT_HOUR(thisx) ((thisx)->home.rot.x)
#define TIMETAG_KICKOUT_MINUTE(thisx) ((thisx)->home.rot.y)

#define TIMETAG_GET_SOARING_SWITCHFLAG(thisx) ((thisx)->params & 0x7F)

#define TIMETAG_GET_DIARY_TYPE(thisx) ((thisx)->params & 0x7F)
#define TIMETAG_GET_DIARY_TIMER(thisx) ((thisx)->home.rot.x)
#define TIMETAG_GET_DIARY_SONG(thisx) ((thisx)->home.rot.z)
