...
MsgScript sAnjuMsgScript_SchReceiveLetterFromPostman[] = {
    ...
    /* 0x0066 0x03 */ MSCRIPT_CHECK_CALLBACK(0x0),
    /* 0x0069 0x01 */ MSCRIPT_DONE(),
};

MsgScript sAnjuMsgScript_SchAttendGoron[] = {
    /* 0x0000 0x03 */ MSCRIPT_CHECK_CALLBACK(0x0),
    ...
    /* 0x0022 0x03 */ MSCRIPT_CHECK_CALLBACK(0x0),
    ...
    /* 0x007C 0x03 */ MSCRIPT_CHECK_CALLBACK(0x0),
...
MsgScript sAnjuMsgScript_SchGiveLunchToGranny[] = {
    ...
    /* 0x004E 0x03 */ MSCRIPT_CHECK_CALLBACK(0x0),
    /* 0x0051 0x01 */ MSCRIPT_DONE(),
};

MsgScript sAnjuMsgScript_ReceptionistDay1[] = {
    /* 0x0000 0x05 */ MSCRIPT_CHECK_BEFORE_TIME(11, 0, 0x006E - 0x0005),
    ...
    /* 0x001D 0x03 */ MSCRIPT_CHECK_CALLBACK(0x0),
    /* 0x0020 0x03 */ MSCRIPT_CONTINUE_TEXT(0x28A8),
    /* 0x0023 0x01 */ MSCRIPT_AWAIT_TEXT(),
    /* 0x0024 0x07 */ MSCRIPT_CHECK_TEXT_CHOICE(0x0, 0x005B - 0x002B, 0x0),
    ...
    /* 0x0060 0x03 */ MSCRIPT_CHECK_CALLBACK(0x0),
    ...
    /* 0x0099 0x03 */ MSCRIPT_CHECK_CALLBACK(0x0),
    ...
    /* 0x00A7 0x05 */ MSCRIPT_CHECK_SWITCH_FLAG(0x0040, 0x00BE - 0x00AC),
    /* 0x00AC 0x03 */ MSCRIPT_BEGIN_TEXT(0x28A0),
    /* 0x00AF 0x01 */ MSCRIPT_AWAIT_TEXT(),
    /* 0x00B0 0x03 */ MSCRIPT_CHECK_CALLBACK(0x0),
    ...
    /* 0x00C6 0x05 */ MSCRIPT_CHECK_SWITCH_FLAG(0x0041, 0x00D6 - 0x00CB),
...
MsgScript sAnjuMsgScript_SchCooking[] = {
    ...
    /* 0x000E 0x03 */ MSCRIPT_CHECK_CALLBACK(0x0),
    ...
    /* 0x0019 0x03 */ MSCRIPT_CHECK_CALLBACK(0x0),
...
MsgScript sAnjuMsgScript_SchMidnightMeeting[] = {
    ...
    /* 0x0013 0x01 */ MSCRIPT_AWAIT_TEXT(),
    /* 0x0014 0x07 */ MSCRIPT_CHECK_TEXT_CHOICE(0x0022 - 0x001B, 0x0, 0x0022 - 0x001B),
    ...
    /* 0x004C 0x03 */ MSCRIPT_CHECK_CALLBACK(0x0),
...
MsgScript sAnjuMsgScript_80B58A44[] = {
    ...
    /* 0x001F 0x05 */ MSCRIPT_CHECK_ITEM(ITEM_PENDANT_OF_MEMORIES, 0x0041 - 0x0024),
    /* 0x0024 0x05 */ MSCRIPT_CHECK_IN_DAY(3, 0x0031 - 0x0029),
    ...
    /* 0x0048 0x09 */
    MSCRIPT_CHECK_ITEM_ACTION(PLAYER_IA_PENDANT_OF_MEMORIES, 0x005F - 0x0051, 0x0, 0x005D - 0x0051),
...
MsgScript sAnjuMsgScript_SchLaundryPoolDefault[] = {
    ...
    /* 0x000F 0x03 */ MSCRIPT_CHECK_CALLBACK(0x0),
    ...
    /* 0x001B 0x03 */ MSCRIPT_CHECK_CALLBACK(0x0),
...
MsgScript sAnjuMsgScript_SchLaundryPoolKafeiMask[] = {
    ...
    /* 0x0013 0x03 */ MSCRIPT_CHECK_CALLBACK(0x0),
