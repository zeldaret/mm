...
MsgScript sAnjuMsgScript_SchReceiveLetterFromPostman[] = {
    /* 0x0000 0x05 */ MSCRIPT_BRANCH_ON_WEEK_EVENT_REG(WEEKEVENTREG_LISTENED_ANJU_POSTMAN_CONVERSATION,
                                                       0x0049 - 0x0005),
    ...
    /* 0x0045 0x03 */ MSCRIPT_SET_WEEK_EVENT_REG(WEEKEVENTREG_LISTENED_ANJU_POSTMAN_CONVERSATION),
...
MsgScript sAnjuMsgScript_SchAttendGoron[] = {
    ...
    /* 0x001E 0x03 */ MSCRIPT_SET_WEEK_EVENT_REG(WEEKEVENTREG_55_02),
    ...
    /* 0x0055 0x03 */ MSCRIPT_SET_WEEK_EVENT_REG(WEEKEVENTREG_86_10),
...
MsgScript sAnjuMsgScript_ReceptionistDay1[] = {
    ...
    /* 0x003E 0x03 */ MSCRIPT_SET_COLLECTIBLE(0x00A0),
    ...
    /* 0x0049 0x03 */ MSCRIPT_SET_WEEK_EVENT_REG(WEEKEVENTREG_RECEIVED_ROOM_KEY),
    ...
    /* 0x006A 0x03 */ MSCRIPT_SET_WEEK_EVENT_REG(WEEKEVENTREG_55_01),
    ...
    /* 0x00A3 0x03 */ MSCRIPT_SET_WEEK_EVENT_REG(WEEKEVENTREG_32_20),
...
MsgScript sAnjuMsgScript_SchCooking[] = {
    ...
    /* 0x001C 0x03 */ MSCRIPT_SET_WEEK_EVENT_REG(WEEKEVENTREG_53_01),
...
MsgScript sAnjuMsgScript_SchMidnightMeeting[] = {
    ...
    /* 0x0027 0x03 */ MSCRIPT_SET_WEEK_EVENT_REG(WEEKEVENTREG_HAD_MIDNIGHT_MEETING),
    /* 0x002A 0x03 */ MSCRIPT_SET_WEEK_EVENT_REG(WEEKEVENTREG_50_10),
    /* 0x002D 0x01 */ MSCRIPT_CLOSE_TEXT(),
    /* 0x002E 0x05 */ MSCRIPT_OFFER_ITEM(GI_LETTER_TO_KAFEI, 0x0),
    /* 0x0033 0x03 */ MSCRIPT_SET_COLLECTIBLE(0x00AA),
...
MsgScript sAnjuMsgScript_DekuDefault[] = {
    ...
    /* 0x0011 0x03 */ MSCRIPT_SET_WEEK_EVENT_REG(WEEKEVENTREG_82_20),
...
MsgScript sAnjuMsgScript_SchLaundryPoolDeku[] = {
    ...
    /* 0x000B 0x01 */ MSCRIPT_AWAIT_TEXT(),
    /* 0x000C 0x03 */ MSCRIPT_SET_WEEK_EVENT_REG(WEEKEVENTREG_82_40),
    /* 0x000F 0x01 */ MSCRIPT_DONE(),
...
MsgScript sAnjuMsgScript_80B58A44[] = {
    ...
    /* 0x0048 0x09 */
    MSCRIPT_BRANCH_ON_ITEMACTION(PLAYER_IA_PENDANT_OF_MEMORIES, 0x005F - 0x0051, 0x0, 0x005D - 0x0051),
    ...
    /* 0x0074 0x03 */ MSCRIPT_SET_WEEK_EVENT_REG(WEEKEVENTREG_DELIVERED_PENDANT_OF_MEMORIES),
...
MsgScript sAnjuMsgScript_80B58AC4[] = {
    ...
    /* 0x0013 0x03 */ MSCRIPT_NOTEBOOK_EVENT(BOMBERS_NOTEBOOK_EVENT_MET_ANJU),
    /* 0x0016 0x01 */ MSCRIPT_AWAIT_TEXT(),
    /* 0x0017 0x03 */ MSCRIPT_SET_WEEK_EVENT_REG(WEEKEVENTREG_PROMISED_MIDNIGHT_MEETING),
...
MsgScript sAnjuMsgScript_SchLaundryPoolDefault[] = {
    ...
    /* 0x002A 0x03 */ MSCRIPT_SET_WEEK_EVENT_REG(WEEKEVENTREG_TALKED_ANJU_IN_LAUNDRY_POOL),
    ...
    /* 0x0044 0x03 */ MSCRIPT_SET_WEEK_EVENT_REG(WEEKEVENTREG_TALKED_ANJU_IN_LAUNDRY_POOL),
...
MsgScript sAnjuMsgScript_SchLaundryPoolKafeiMask[] = {
    ...
    /* 0x0022 0x03 */ MSCRIPT_SET_WEEK_EVENT_REG(WEEKEVENTREG_TALKED_ANJU_IN_LAUNDRY_POOL),
    /* 0x0025 0x01 */ MSCRIPT_DONE(),
    ...
    /* 0x003C 0x03 */ MSCRIPT_SET_WEEK_EVENT_REG(WEEKEVENTREG_TALKED_ANJU_IN_LAUNDRY_POOL),
