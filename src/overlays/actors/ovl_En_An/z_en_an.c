...
MsgScript sAnjuMsgScript_SchReceiveLetterFromPostman[] = {
    /* 0x0000 0x05 */ MSCRIPT_BRANCH_ON_WEEK_EVENT_REG(0x56, 0x08, 0x0049 - 0x0005),
    ...
    /* 0x0045 0x03 */ MSCRIPT_WEEK_EVENT_REG_SET(0x56, 0x08),
    ...
    /* 0x0066 0x03 */ MSCRIPT_BRANCH_ON_CALLBACK_OPTIONAL(0x0),
    /* 0x0069 0x01 */ MSCRIPT_DONE(),
};

MsgScript sAnjuMsgScript_SchAttendGoron[] = {
    /* 0x0000 0x03 */ MSCRIPT_BRANCH_ON_CALLBACK_OPTIONAL(0x0),
    /* 0x0003 0x05 */ MSCRIPT_BRANCH_ON_WEEK_EVENT_REG(0x4B, 0x10, 0x0026 - 0x0008),
    ...
    /* 0x0022 0x03 */ MSCRIPT_BRANCH_ON_CALLBACK_OPTIONAL(0x0),
    /* 0x0025 0x01 */ MSCRIPT_DONE(),

    /* 0x0026 0x05 */ MSCRIPT_BRANCH_ON_WEEK_EVENT_REG(0x56, 0x10, 0x0059 - 0x002B),
    ...
    /* 0x0047 0x03 */ MSCRIPT_BRANCH_ON_CALLBACK_OPTIONAL(0x0),
    ...
    /* 0x0055 0x03 */ MSCRIPT_WEEK_EVENT_REG_SET(0x56, 0x10),
    ...
    /* 0x007C 0x03 */ MSCRIPT_BRANCH_ON_CALLBACK_OPTIONAL(0x0),
...
MsgScript sAnjuMsgScript_SchGiveLunchToGranny[] = {
    ...
    /* 0x004E 0x03 */ MSCRIPT_BRANCH_ON_CALLBACK_OPTIONAL(0x0),
    /* 0x0051 0x01 */ MSCRIPT_DONE(),
};

MsgScript sAnjuMsgScript_ReceptionistDay1[] = {
    /* 0x0000 0x05 */ MSCRIPT_BRANCH_ON_TIME_LEQ(0x0B, 0x00, 0x006E - 0x0005),
    /* 0x0005 0x05 */ MSCRIPT_BRANCH_ON_WEEK_EVENT_REG(0x20, 0x20, 0x006E - 0x000A),
    /* 0x000A 0x05 */ MSCRIPT_BRANCH_ON_WEEK_EVENT_REG(0x4B, 0x10, 0x00C6 - 0x000F),
    /* 0x000F 0x05 */ MSCRIPT_BRANCH_ON_WEEK_EVENT_REG(0x37, 0x01, 0x00BE - 0x0014),
    /* 0x0014 0x05 */ MSCRIPT_BRANCH_ON_WEEK_EVENT_REG(0x37, 0x02, 0x006E - 0x0019),
    ...
    /* 0x0049 0x03 */ MSCRIPT_WEEK_EVENT_REG_SET(0x4B, 0x10),
    ...
    /* 0x006A 0x03 */ MSCRIPT_WEEK_EVENT_REG_SET(0x37, 0x01),
    /* 0x006D 0x01 */ MSCRIPT_DONE(),

    /* 0x006E 0x05 */ MSCRIPT_BRANCH_ON_WEEK_EVENT_REG(0x20, 0x20, 0x00A7 - 0x0073),
    /* 0x0073 0x03 */ MSCRIPT_BEGIN_TEXT(0x28A0),
    /* 0x0076 0x01 */ MSCRIPT_AWAIT_TEXT(),
    /* 0x0077 0x03 */ MSCRIPT_BRANCH_ON_CALLBACK_OPTIONAL(0x0),
    ...
    /* 0x0099 0x03 */ MSCRIPT_BRANCH_ON_CALLBACK_OPTIONAL(0x0),
    ...
    /* 0x00A3 0x03 */ MSCRIPT_WEEK_EVENT_REG_SET(0x20, 0x20),
    ...
    /* 0x00B0 0x03 */ MSCRIPT_BRANCH_ON_CALLBACK_OPTIONAL(0x0),
...
MsgScript sAnjuMsgScript_SchCooking[] = {
    /* 0x0000 0x05 */ MSCRIPT_BRANCH_ON_WEEK_EVENT_REG(0x35, 0x01, 0x0021 - 0x0005),
    ...
    /* 0x0019 0x03 */ MSCRIPT_BRANCH_ON_CALLBACK_OPTIONAL(0x0),
    /* 0x001C 0x03 */ MSCRIPT_WEEK_EVENT_REG_SET(0x35, 0x01),
...
MsgScript sAnjuMsgScript_SchMidnightMeeting[] = {
    ...
    /* 0x0027 0x03 */ MSCRIPT_WEEK_EVENT_REG_SET(0x32, 0x20),
    /* 0x002A 0x03 */ MSCRIPT_WEEK_EVENT_REG_SET(0x32, 0x10),
    ...
    /* 0x004C 0x03 */ MSCRIPT_BRANCH_ON_CALLBACK_OPTIONAL(0x0),
...
MsgScript sAnjuMsgScript_DekuDefault[] = {
    /* 0x0000 0x05 */ MSCRIPT_BRANCH_ON_WEEK_EVENT_REG(0x52, 0x20, 0x0015 - 0x0005),
    ...
    /* 0x0011 0x03 */ MSCRIPT_WEEK_EVENT_REG_SET(0x52, 0x20),
...
MsgScript sAnjuMsgScript_SchLaundryPoolDeku[] = {
    /* 0x0000 0x05 */ MSCRIPT_BRANCH_ON_WEEK_EVENT_REG(0x52, 0x40, 0x0010 - 0x0005),
    /* 0x0005 0x03 */ MSCRIPT_BEGIN_TEXT(0x2952),
    /* 0x0008 0x03 */ MSCRIPT_NOTEBOOK_EVENT(BOMBERS_NOTEBOOK_EVENT_MET_ANJU),
    /* 0x000B 0x01 */ MSCRIPT_AWAIT_TEXT(),
    /* 0x000C 0x03 */ MSCRIPT_WEEK_EVENT_REG_SET(0x52, 0x40),
    /* 0x000F 0x01 */ MSCRIPT_DONE(),
...
MsgScript sAnjuMsgScript_80B58A44[] = {
    /* 0x0000 0x05 */ MSCRIPT_BRANCH_ON_WEEK_EVENT_REG(0x32, 0x08, 0x000D - 0x0005),
    /* 0x0005 0x03 */ MSCRIPT_BEGIN_TEXT(0x28D5),
    /* 0x0008 0x03 */ MSCRIPT_NOTEBOOK_EVENT(BOMBERS_NOTEBOOK_EVENT_MET_ANJU),
    /* 0x000B 0x01 */ MSCRIPT_AWAIT_TEXT(),
    /* 0x000C 0x01 */ MSCRIPT_DONE(),

    /* 0x000D 0x05 */ MSCRIPT_BRANCH_ON_WEEK_EVENT_REG(0x32, 0x20, 0x001A - 0x0012),
    ...
    /* 0x001A 0x05 */ MSCRIPT_BRANCH_ON_WEEK_EVENT_REG(0x33, 0x01, 0x0039 - 0x001F),
    /* 0x001F 0x05 */ MSCRIPT_BRANCH_ON_ITEM(ITEM_PENDANT_OF_MEMORIES, 0x0041 - 0x0024),
    /* 0x0024 0x05 */ MSCRIPT_BRANCH_IF_DAY(0x0003, 0x0031 - 0x0029),
    ...
    /* 0x0048 0x09 */ MSCRIPT_BRANCH_ON_ITEMACTION(0x0036, 0x005F - 0x0051, 0x0, 0x005D - 0x0051),
    ...
    /* 0x0074 0x03 */ MSCRIPT_WEEK_EVENT_REG_SET(0x33, 0x01),
...
MsgScript sAnjuMsgScript_80B58AC4[] = {
    /* 0x0000 0x05 */ MSCRIPT_BRANCH_ON_WEEK_EVENT_REG(0x32, 0x08, 0x001B - 0x0005),
    ...
    /* 0x0013 0x03 */ MSCRIPT_NOTEBOOK_EVENT(BOMBERS_NOTEBOOK_EVENT_MET_ANJU),
    /* 0x0016 0x01 */ MSCRIPT_AWAIT_TEXT(),
    /* 0x0017 0x03 */ MSCRIPT_WEEK_EVENT_REG_SET(0x32, 0x08),
...
MsgScript sAnjuMsgScript_SchLaundryPoolDefault[] = {
    /* 0x0000 0x05 */ MSCRIPT_BRANCH_ON_WEEK_EVENT_REG(0x37, 0x20, 0x002E - 0x0005),
    /* 0x0005 0x05 */ MSCRIPT_BRANCH_ON_WEEK_EVENT_REG(0x32, 0x08, 0x0034 - 0x000A),
    ...
    /* 0x002A 0x03 */ MSCRIPT_WEEK_EVENT_REG_SET(0x37, 0x20),
    ...
    /* 0x0044 0x03 */ MSCRIPT_WEEK_EVENT_REG_SET(0x37, 0x20),
    /* 0x0047 0x01 */ MSCRIPT_DONE(),
};

MsgScript sAnjuMsgScript_SchLaundryPoolKafeiMask[] = {
    /* 0x0000 0x05 */ MSCRIPT_BRANCH_ON_WEEK_EVENT_REG(0x37, 0x20, 0x0026 - 0x0005),
    /* 0x0005 0x05 */ MSCRIPT_BRANCH_ON_WEEK_EVENT_REG(0x32, 0x08, 0x002C - 0x000A),
    /* 0x000A 0x03 */ MSCRIPT_BEGIN_TEXT(0x28E8),
    /* 0x000D 0x01 */ MSCRIPT_AWAIT_TEXT(),
    ...
    /* 0x0022 0x03 */ MSCRIPT_WEEK_EVENT_REG_SET(0x37, 0x20),
    /* 0x0025 0x01 */ MSCRIPT_DONE(),
    ...
    /* 0x003C 0x03 */ MSCRIPT_WEEK_EVENT_REG_SET(0x37, 0x20),
