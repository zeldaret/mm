...
MsgScript D_80BE1914[] = {
    ...
    /* 0x0012 0x03 */ MSCRIPT_CHECK_CALLBACK(0x0),
...
MsgScript D_80BE1940[] = {
    ...
    /* 0x0016 0x03 */ MSCRIPT_CHECK_CALLBACK(0x0),
...
MsgScript D_80BE19A0[] = {
    ...
    /* 0x0003 0x01 */ MSCRIPT_AWAIT_TEXT(),
    /* 0x0004 0x07 */ MSCRIPT_CHECK_TEXT_CHOICE(0x0059 - 0x000B, 0x0, 0x0059 - 0x000B),
    /* 0x000B 0x01 */ MSCRIPT_PLAY_DECIDE(),
    /* 0x000C 0x03 */ MSCRIPT_CHECK_CALLBACK_CONTINUE(0x0014 - 0x000F),
    ...
    /* 0x0018 0x07 */ MSCRIPT_CHECK_TEXT_CHOICE(0x0, 0x0027 - 0x001F, 0x002F - 0x001F),
    /* 0x001F 0x05 */ MSCRIPT_CHECK_RUPEES(20, 0x004A - 0x0024),
    /* 0x0024 0x03 */ MSCRIPT_JUMP(0x0035 - 0x0027),
    /* 0x0027 0x05 */ MSCRIPT_CHECK_RUPEES(200, 0x003B - 0x002C),
