...
MsgScript D_80BE1914[] = {
    ...
    /* 0x0009 0x03 */ MSCRIPT_WEEK_EVENT_REG_SET(WEEKEVENTREG_58_02),
...
MsgScript D_80BE1940[] = {
    ...
    /* 0x0008 0x01 */ MSCRIPT_AWAIT_TEXT(),
    /* 0x0009 0x03 */ MSCRIPT_WEEK_EVENT_REG_SET(WEEKEVENTREG_63_04),
    /* 0x000C 0x01 */ MSCRIPT_DONE(),
...
MsgScript D_80BE1970[] = {
    ...
    /* 0x0008 0x01 */ MSCRIPT_AWAIT_TEXT(),
    /* 0x0009 0x03 */ MSCRIPT_WEEK_EVENT_REG_SET(WEEKEVENTREG_58_01),
    /* 0x000C 0x01 */ MSCRIPT_DONE(),
...
MsgScript D_80BE1984[] = {
    ...
    /* 0x0008 0x01 */ MSCRIPT_AWAIT_TEXT(),
    /* 0x0009 0x03 */ MSCRIPT_WEEK_EVENT_REG_SET(WEEKEVENTREG_80_01),
    /* 0x000C 0x01 */ MSCRIPT_DONE(),
