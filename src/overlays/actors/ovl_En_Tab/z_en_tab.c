...
MsgScript D_80BE1914[] = {
    /* 0x0000 0x05 */ MSCRIPT_BRANCH_ON_WEEK_EVENT_REG(WEEKEVENTREG_58_02, 0x000D - 0x0005),
    /* 0x0005 0x03 */ MSCRIPT_BEGIN_TEXT(0x2AF9),
    /* 0x0008 0x01 */ MSCRIPT_AWAIT_TEXT(),
    /* 0x0009 0x03 */ MSCRIPT_SET_WEEK_EVENT_REG(WEEKEVENTREG_58_02),
    /* 0x000C 0x01 */ MSCRIPT_DONE(),

    /* 0x000D 0x03 */ MSCRIPT_BEGIN_TEXT(0x2AFA),
    /* 0x0010 0x01 */ MSCRIPT_AWAIT_TEXT(),
    /* 0x0011 0x01 */ MSCRIPT_PAUSE(),
    /* 0x0012 0x03 */ MSCRIPT_BRANCH_ON_CALLBACK(0x0),
    /* 0x0015 0x03 */ MSCRIPT_BEGIN_TEXT(0x2AFB),
    /* 0x0018 0x01 */ MSCRIPT_AWAIT_TEXT(),
    /* 0x0019 0x05 */ MSCRIPT_BRANCH_ON_WEEK_EVENT_REG(WEEKEVENTREG_ESCORTED_CREMIA, 0x0027 - 0x001E),
...
MsgScript D_80BE1940[] = {
    /* 0x0000 0x05 */ MSCRIPT_BRANCH_ON_WEEK_EVENT_REG(WEEKEVENTREG_63_04, 0x000D - 0x0005),
    /* 0x0005 0x03 */ MSCRIPT_BEGIN_TEXT(0x2B3D),
    /* 0x0008 0x01 */ MSCRIPT_AWAIT_TEXT(),
    /* 0x0009 0x03 */ MSCRIPT_SET_WEEK_EVENT_REG(WEEKEVENTREG_63_04),
    /* 0x000C 0x01 */ MSCRIPT_DONE(),
    ...
    /* 0x0016 0x03 */ MSCRIPT_BRANCH_ON_CALLBACK(0x0),
    /* 0x0019 0x03 */ MSCRIPT_BEGIN_TEXT(0x2AFB),
    /* 0x001C 0x01 */ MSCRIPT_AWAIT_TEXT(),
    /* 0x001D 0x05 */ MSCRIPT_BRANCH_ON_WEEK_EVENT_REG(WEEKEVENTREG_ESCORTED_CREMIA, 0x002B - 0x0022),
...
MsgScript D_80BE1970[] = {
    /* 0x0000 0x05 */ MSCRIPT_BRANCH_ON_WEEK_EVENT_REG(WEEKEVENTREG_58_01, 0x000D - 0x0005),
    /* 0x0005 0x03 */ MSCRIPT_BEGIN_TEXT(0x2AFF),
    /* 0x0008 0x01 */ MSCRIPT_AWAIT_TEXT(),
    /* 0x0009 0x03 */ MSCRIPT_SET_WEEK_EVENT_REG(WEEKEVENTREG_58_01),
    /* 0x000C 0x01 */ MSCRIPT_DONE(),
...
MsgScript D_80BE1984[] = {
    /* 0x0000 0x05 */ MSCRIPT_BRANCH_ON_WEEK_EVENT_REG(WEEKEVENTREG_80_01, 0x000D - 0x0005),
    /* 0x0005 0x03 */ MSCRIPT_BEGIN_TEXT(0x2B3F),
    /* 0x0008 0x01 */ MSCRIPT_AWAIT_TEXT(),
    /* 0x0009 0x03 */ MSCRIPT_SET_WEEK_EVENT_REG(WEEKEVENTREG_80_01),
    /* 0x000C 0x01 */ MSCRIPT_DONE(),
...
MsgScript D_80BE19A0[] = {
    ...
    /* 0x000C 0x03 */ MSCRIPT_BRANCH_ON_CALLBACK_CONTINUE(0x0014 - 0x000F),
    ...
    /* 0x001F 0x05 */ MSCRIPT_BRANCH_ON_RUPEES(20, 0x004A - 0x0024),
    /* 0x0024 0x03 */ MSCRIPT_JUMP(0x0035 - 0x0027),
    /* 0x0027 0x05 */ MSCRIPT_BRANCH_ON_RUPEES(200, 0x003B - 0x002C),
