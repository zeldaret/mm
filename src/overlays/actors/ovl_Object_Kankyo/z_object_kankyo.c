...
ActorInit Object_Kankyo_InitVars = {
    ACTOR_OBJECT_KANKYO,  ACTORCAT_ITEMACTION,  FLAGS,
    GAMEPLAY_KEEP,        sizeof(ObjectKankyo), ObjectKankyo_Init,
    ObjectKankyo_Destroy, ObjectKankyo_Update,  ObjectKankyo_Draw,
};
