...
s32 func_808A0900(DoorShutter* this, PlayState* play) {
    ...
    if (frontRoom == transitionEntry->sides[1].room) {
        if (ABS_ALT(BINANG_SUB(this->door.dyna.actor.shape.rot.y, this->door.dyna.actor.yawTowardsPlayer)) < 0x4000) {
            frontRoom = -1;
        }
    }
    return frontRoom == this->door.dyna.actor.room;
}
...
s32 DoorShutter_SetupDoor(DoorShutter* this, PlayState* play) {
    ...
    if (doorType == 1) {
        if (!Flags_GetClear(play, this->door.dyna.actor.room)) {
...
void DoorShutter_Init(Actor* thisx, PlayState* play2) {
    ...
    if (sp24 < 0) {
        ...
        if (sp24 == 6) {
            this->door.dyna.actor.flags |= ACTOR_FLAG_10000000;
        }
    } else if (sp24 == 0) {
        ...
        this->door.unk_15E = bossDoorInfo->index;
    } else {
    ...
    Actor_SetFocus(&this->door.dyna.actor, 60.0f);
}

void DoorShutter_Destroy(Actor* thisx, PlayState* play) {
    DoorShutter* this = THIS;

    if (this->door.dyna.actor.room >= 0) {
        s32 transitionActorId = DOOR_GET_TRANSITION_ID(&this->door.dyna.actor);
...
f32 func_808A0D90(PlayState* play, DoorShutter* this, f32 arg2, f32 arg3, f32 arg4) {
    ...
    Actor_OffsetOfPointInActorCoords(&this->door.dyna.actor, &sp1C, &sp28);
...
s32 func_808A0E28(DoorShutter* this, PlayState* play) {
    ...
    if (!Player_InCsMode(play)) {
        ...
        if (fabsf(temp_f0) < 50.0f) {
            s16 temp_v0_2 = BINANG_SUB(player->actor.shape.rot.y, this->door.dyna.actor.shape.rot.y);
...
void func_808A0F88(DoorShutter* this, PlayState* play) {
    if (Flags_GetClear(play, this->door.dyna.actor.room) || Flags_GetClearTemp(play, this->door.dyna.actor.room)) {
        this->unk_160 = this->door.dyna.actor.cutscene;
        if (this->doorType == 7) {
            if (this->unk_160 != -1) {
        ...
        if (ActorCutscene_GetCanPlayNext(this->unk_160)) {
            ActorCutscene_StartAndSetUnkLinkFields(this->unk_160, &this->door.dyna.actor);
...
void func_808A1090(DoorShutter* this, PlayState* play) {
    if (this->door.unk_15C != 0) {
        ...
        if (this->unk_166 != 0) {
            Flags_SetSwitch(play, DOORSHUTTER_GET_7F(&this->door.dyna.actor));
            if (this->doorType != 5) {
                ...
                Actor_PlaySfxAtPos(&this->door.dyna.actor, NA_SE_EV_CHAIN_KEY_UNLOCK_B);
            }
        }
    } else {
...
void func_808A1288(DoorShutter* this, PlayState* play) {
    if (this->door.dyna.actor.category == ACTORCAT_DOOR) {
        Player* player = GET_PLAYER(play);
        ...
        Camera_ChangeDoorCam(play->cameraPtrs[CAM_ID_MAIN], &this->door.dyna.actor, player->doorBgCamIndex, this->unk_168, 12,
                             sp34, 10);
    }
}
...
s32 func_808A1340(DoorShutter* this, PlayState* play) {
    ...
    if (this->door.dyna.actor.velocity.y == 0.0f) {
    ...
    if (this->unk_163 == 7) {
        ...
        if (this->unk_163 == 7) {
            func_800B9010(&this->door.dyna.actor, NA_SE_EV_IKANA_DOOR_OPEN - SFX_FLAG);
        }

        Lib_Vec3f_TranslateAndRotateY(&this->door.dyna.actor.home.pos, this->door.dyna.actor.shape.rot.y,
                                      (this->unk_163 == 7) ? &D_808A22C4 : &D_808A22D0, &sp2C);
        Math_StepToF(&this->door.dyna.actor.velocity.y, 5.0f, 0.5f);

        if (Math_Vec3f_StepToXZ(&this->door.dyna.actor.world.pos, &sp2C, this->door.dyna.actor.velocity.y) == 0.0f) {
            return true;
        }
    } else {
        Math_StepToF(&this->door.dyna.actor.velocity.y, 15.0f, 3.0f);

        if (Math_StepToF(&this->door.dyna.actor.world.pos.y, this->door.dyna.actor.home.pos.y + 200.0f,
...
s32 func_808A1478(DoorShutter* this, PlayState* play, f32 arg2) {
    ...
    if (temp == this->unk_168) {
        if (arg2 == 1.0f) {
            Actor_PlaySfxAtPos(&this->door.dyna.actor, NA_SE_EV_METALDOOR_CLOSE);
        } else {
            Actor_PlaySfxAtPos(&this->door.dyna.actor, NA_SE_EV_METALDOOR_OPEN);
        }
...
void func_808A1618(DoorShutter* this, PlayState* play) {
    if ((this->door.unk_15C == 0) && !Flags_GetSwitch(play, DOORSHUTTER_GET_7F(&this->door.dyna.actor))) {
        DoorShutter_SetupAction(this, func_808A1548);
    } else {
...
void func_808A1684(DoorShutter* this, PlayState* play) {
    ...
    if ((DECR(this->unk_166) == 0) && (play->roomCtx.unk31 == 0) && func_808A1340(this, play)) {
        ...
        if (phi_f0 < this->door.dyna.actor.xzDistToPlayer) {
            if (this->unk_163 == 7) {
                this->door.dyna.actor.velocity.y = 0.0f;
            } else {
                if (DoorShutter_SetupDoor(this, play)) {
                    this->door.dyna.actor.velocity.y = 30.0f;
                }
...
void func_808A1784(DoorShutter* this, PlayState* play) {
    if (this->unk_167 != 0) {
        if (func_800F22C4(this->unk_160, &this->door.dyna.actor)) {
            if (this->unk_167 < 0) {
...
void func_808A1884(DoorShutter* this, PlayState* play) {
    Player* player = GET_PLAYER(play);
    s8 room = this->door.dyna.actor.room;
    Vec3f sp44;

    if (this->door.dyna.actor.room >= 0) {
        Actor_OffsetOfPointInActorCoords(&this->door.dyna.actor, &sp44, &player->actor.world.pos);

        this->door.dyna.actor.room = play->doorCtx.transitionActorList[DOOR_GET_TRANSITION_ID(&this->door.dyna.actor)]
                                         .sides[(sp44.z < 0.0f) ? 0 : 1]
                                         .room;

        if (room != this->door.dyna.actor.room) {
...
s32 func_808A1A70(DoorShutter* this) {
    if (this->unk_163 == 7) {
        if (this->unk_163 == 7) {
            func_800B9010(&this->door.dyna.actor, NA_SE_EV_IKANA_DOOR_CLOSE - SFX_FLAG);
        }

        Math_StepToF(&this->door.dyna.actor.velocity.y, 5.0f, 0.5f);

        if (Math_Vec3f_StepToXZ(&this->door.dyna.actor.world.pos, &this->door.dyna.actor.home.pos,
                                this->door.dyna.actor.velocity.y) == 0.0f) {
            return true;
        }
    } else {
        if (this->door.dyna.actor.velocity.y < 20.0f) {
...
void func_808A1B48(DoorShutter* this, PlayState* play) {
    ...
    if (func_808A1A70(this)) {
        if (this->door.dyna.actor.velocity.y > 20.0f) {
            ...
            Actor_SpawnFloorDustRing(play, &this->door.dyna.actor, &this->door.dyna.actor.world.pos, 45.0f, 10, 8.0f,
                                     500, 10, 0);
        }
...
void DoorShutter_Update(Actor* thisx, PlayState* play) {
    ...
    if (!(player->stateFlags1 & (PLAYER_STATE1_40 | PLAYER_STATE1_80 | PLAYER_STATE1_400 | PLAYER_STATE1_10000000)) ||
        ...
        if (this->unk_163 == 7) {
            this->door.dyna.actor.home.rot.z =
                Math_Vec3f_DistXZ(&this->door.dyna.actor.home.pos, &this->door.dyna.actor.world.pos) * -100.0f;
        }
    }
}
...
s32 func_808A1D68(DoorShutter* this, PlayState* play) {
    ...
    temp_a0 = BINANG_SUB(Actor_YawToPoint(&this->door.dyna.actor, &play->view.eye), this->door.dyna.actor.shape.rot.y);
...
void DoorShutter_Draw(Actor* thisx, PlayState* play) {
    ...
    if (func_808A1D68(this, play)) {
        ...
        if (this->unk_164 == 7) {
            ...
            Matrix_RotateZS(this->door.dyna.actor.home.rot.z, MTXMODE_APPLY);
            Matrix_Translate(0.0f, -64.96f, 0.0f, MTXMODE_APPLY);
        }
        ...
        if (sp44->unk_04 != 0) {
            ...
            if ((play->roomCtx.prevRoom.num >= 0) ||
                ...
                s16 yaw = this->door.dyna.actor.shape.rot.y -
                          Math_Vec3f_Yaw(&play->view.eye, &this->door.dyna.actor.world.pos);

                if (ABS_ALT(yaw) < 0x4000) {
                    Matrix_RotateYF(M_PI, MTXMODE_APPLY);
                }
            } else if (this->door.dyna.actor.room == transitionEntry->sides[0].room) {
                Matrix_RotateYF(M_PI, MTXMODE_APPLY);
            }
        } else if (this->doorType == 5) {
            gSPSegment(POLY_OPA_DISP++, 0x08, Lib_SegmentedToVirtual(D_808A22DC[this->door.unk_15E]));
        }
