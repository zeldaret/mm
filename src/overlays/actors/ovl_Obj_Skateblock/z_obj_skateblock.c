...
ActorInit Obj_Skateblock_InitVars = {
    ACTOR_OBJ_SKATEBLOCK,  ACTORCAT_BG,           FLAGS,
    GAMEPLAY_DANGEON_KEEP, sizeof(ObjSkateblock), ObjSkateblock_Init,
    ObjSkateblock_Destroy, ObjSkateblock_Update,  ObjSkateblock_Draw,
};
