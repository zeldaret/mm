...
static MsgScript D_80AE6F00[] = {
    /* 0x0000 0x05 */ MSCRIPT_BRANCH_ON_WEEK_EVENT_REG(WEEKEVENTREG_23_08, 0x0010 - 0x0005),
    ...
    /* 0x000D 0x03 */ MSCRIPT_SET_WEEK_EVENT_REG(WEEKEVENTREG_23_08),
    ...
    /* 0x001C 0x09 */ MSCRIPT_BRANCH_ON_ITEMACTION(PLAYER_IA_PICTOGRAPH_BOX, 0x0, 0x013A - 0x0025, 0x016C - 0x0025),
    /* 0x0025 0x03 */ MSCRIPT_BRANCH_ON_CALLBACK_CONTINUE(0x003A - 0x0028),
    /* 0x0028 0x03 */ MSCRIPT_BRANCH_ON_CALLBACK_CONTINUE(0x0044 - 0x002B),
    /* 0x002B 0x03 */ MSCRIPT_BRANCH_ON_CALLBACK_CONTINUE(0x005B - 0x002E),
    /* 0x002E 0x03 */ MSCRIPT_BRANCH_ON_CALLBACK_CONTINUE(0x008E - 0x0031),
    /* 0x0031 0x03 */ MSCRIPT_BRANCH_ON_CALLBACK_CONTINUE(0x00C7 - 0x0034),
    /* 0x0034 0x03 */ MSCRIPT_BRANCH_ON_CALLBACK_CONTINUE(0x006A - 0x0037),
    /* 0x0037 0x03 */ MSCRIPT_JUMP(0x0081 - 0x003A),
    /* 0x003A 0x03 */ MSCRIPT_PLAYER_TALK(0x09E7),
    ...
    /* 0x0044 0x03 */ MSCRIPT_PLAYER_TALK(0x09CB),
    ...
    /* 0x005B 0x03 */ MSCRIPT_PLAYER_TALK(0x09D1),
    ...
    /* 0x006A 0x03 */ MSCRIPT_PLAYER_TALK(0x09D3),
    ...
    /* 0x0081 0x03 */ MSCRIPT_PLAYER_TALK(0x09D9),
    ...
    /* 0x008E 0x03 */ MSCRIPT_PLAYER_TALK(0x09E8),
    ...
    /* 0x009E 0x05 */ MSCRIPT_BRANCH_ON_WEEK_EVENT_REG(WEEKEVENTREG_87_04, 0x00BA - 0x00A3),
    /* 0x00A3 0x01 */ MSCRIPT_CLOSE_TEXT(),
    /* 0x00A4 0x05 */ MSCRIPT_OFFER_ITEM(GI_HEART_PIECE, 0x0),
    /* 0x00A9 0x03 */ MSCRIPT_SET_COLLECTIBLE(0x000C),
    /* 0x00AC 0x01 */ MSCRIPT_AWAIT_TEXT(),
    /* 0x00AD 0x03 */ MSCRIPT_SET_WEEK_EVENT_REG(WEEKEVENTREG_87_04),
    /* 0x00B0 0x03 */ MSCRIPT_AUTOTALK(0x0),
    /* 0x00B3 0x03 */ MSCRIPT_BEGIN_TEXT(0x09EB),
    /* 0x00B6 0x01 */ MSCRIPT_AWAIT_TEXT(),
    /* 0x00B7 0x01 */ MSCRIPT_CLOSE_TEXT(),
    /* 0x00B8 0x01 */ MSCRIPT_UNSET_AUTOTALK(),
    /* 0x00B9 0x01 */ MSCRIPT_DONE(),

    /* 0x00BA 0x01 */ MSCRIPT_CLOSE_TEXT(),
    /* 0x00BB 0x05 */ MSCRIPT_OFFER_ITEM(GI_RUPEE_SILVER, 0x0),
    /* 0x00C0 0x03 */ MSCRIPT_SET_COLLECTIBLE(0x0006),
    /* 0x00C3 0x01 */ MSCRIPT_AWAIT_TEXT(),
    /* 0x00C4 0x03 */ MSCRIPT_AUTOTALK(0x00B3 - 0x00C7),

    /* 0x00C7 0x03 */ MSCRIPT_PLAYER_TALK(0x09EC),
    ...
    /* 0x012B 0x03 */ MSCRIPT_SET_EVENT_INF(EVENTINF_50),
    /* 0x012E 0x01 */ MSCRIPT_PAUSE(),
    /* 0x012F 0x03 */ MSCRIPT_BRANCH_ON_CALLBACK(0x0),
    ...
    /* 0x013A 0x05 */ MSCRIPT_BRANCH_ON_WEEK_EVENT_REG(WEEKEVENTREG_55_40, 0x015B - 0x013F),
    /* 0x013F 0x03 */ MSCRIPT_PLAYER_TALK(0x09DB),
    ...
    /* 0x0157 0x03 */ MSCRIPT_SET_WEEK_EVENT_REG(WEEKEVENTREG_55_40),
    /* 0x015A 0x01 */ MSCRIPT_DONE(),

    /* 0x015B 0x03 */ MSCRIPT_PLAYER_TALK(0x09E0),
    ...
    /* 0x016C 0x05 */ MSCRIPT_BRANCH_ON_WEEK_EVENT_REG(WEEKEVENTREG_55_40, 0x0189 - 0x0171),
    ...
    /* 0x0185 0x03 */ MSCRIPT_SET_WEEK_EVENT_REG(WEEKEVENTREG_55_40),
    ...
    /* 0x01A4 0x05 */ MSCRIPT_BRANCH_ON_WEEK_EVENT_REG(WEEKEVENTREG_CLEARED_WOODFALL_TEMPLE, 0x0196 - 0x01A9),
...
static MsgScript D_80AE70B8[] = {
    /* 0x0000 0x03 */ MSCRIPT_BRANCH_ON_CALLBACK_CONTINUE(0x0015 - 0x0003),
    /* 0x0003 0x03 */ MSCRIPT_BRANCH_ON_CALLBACK_CONTINUE(0x001B - 0x0006),
    /* 0x0006 0x03 */ MSCRIPT_BRANCH_ON_CALLBACK_CONTINUE(0x0031 - 0x0009),
    /* 0x0009 0x03 */ MSCRIPT_BRANCH_ON_CALLBACK_CONTINUE(0x0061 - 0x000C),
    /* 0x000C 0x03 */ MSCRIPT_BRANCH_ON_CALLBACK_CONTINUE(0x0099 - 0x000F),
    /* 0x000F 0x03 */ MSCRIPT_BRANCH_ON_CALLBACK_CONTINUE(0x003F - 0x0012),
    /* 0x0012 0x03 */ MSCRIPT_JUMP(0x0055 - 0x0015),
    /* 0x0015 0x03 */ MSCRIPT_PLAYER_TALK(0x09E7),
    /* 0x0018 0x01 */ MSCRIPT_AWAIT_TEXT(),
    /* 0x0019 0x01 */ MSCRIPT_CLOSE_TEXT(),
    /* 0x001A 0x01 */ MSCRIPT_DONE(),

    /* 0x001B 0x03 */ MSCRIPT_PLAYER_TALK(0x09CB),
    ...
    /* 0x0031 0x03 */ MSCRIPT_PLAYER_TALK(0x09D1),
    ...
    /* 0x003F 0x03 */ MSCRIPT_PLAYER_TALK(0x09D3),
    ...
    /* 0x0055 0x03 */ MSCRIPT_PLAYER_TALK(0x09D9),
    ...
    /* 0x0061 0x03 */ MSCRIPT_PLAYER_TALK(0x09E8),
    ...
    /* 0x0070 0x05 */ MSCRIPT_BRANCH_ON_WEEK_EVENT_REG(WEEKEVENTREG_87_04, 0x008C - 0x0075),
    /* 0x0075 0x01 */ MSCRIPT_CLOSE_TEXT(),
    /* 0x0076 0x05 */ MSCRIPT_OFFER_ITEM(GI_HEART_PIECE, 0x0),
    /* 0x007B 0x03 */ MSCRIPT_SET_COLLECTIBLE(0x000C),
    /* 0x007E 0x01 */ MSCRIPT_AWAIT_TEXT(),
    /* 0x007F 0x03 */ MSCRIPT_SET_WEEK_EVENT_REG(WEEKEVENTREG_87_04),
    /* 0x0082 0x03 */ MSCRIPT_AUTOTALK(0x0),
    /* 0x0085 0x03 */ MSCRIPT_BEGIN_TEXT(0x09EB),
    /* 0x0088 0x01 */ MSCRIPT_AWAIT_TEXT(),
    /* 0x0089 0x01 */ MSCRIPT_CLOSE_TEXT(),
    /* 0x008A 0x01 */ MSCRIPT_UNSET_AUTOTALK(),
    /* 0x008B 0x01 */ MSCRIPT_DONE(),

    /* 0x008C 0x01 */ MSCRIPT_CLOSE_TEXT(),
    /* 0x008D 0x05 */ MSCRIPT_OFFER_ITEM(GI_RUPEE_SILVER, 0x0),
    /* 0x0092 0x03 */ MSCRIPT_SET_COLLECTIBLE(0x0006),
    /* 0x0095 0x01 */ MSCRIPT_AWAIT_TEXT(),
    /* 0x0096 0x03 */ MSCRIPT_AUTOTALK(0x0085 - 0x0099),

    /* 0x0099 0x03 */ MSCRIPT_PLAYER_TALK(0x09EC),
    ...
    /* 0x00FC 0x03 */ MSCRIPT_SET_EVENT_INF(EVENTINF_50),
    /* 0x00FF 0x01 */ MSCRIPT_PAUSE(),
    /* 0x0100 0x03 */ MSCRIPT_BRANCH_ON_CALLBACK(0x0),
...
static MsgScript D_80AE71C4[] = {
    /* 0x0000 0x05 */ MSCRIPT_BRANCH_ON_WEEK_EVENT_REG(WEEKEVENTREG_55_40, 0x0021 - 0x0005),
    /* 0x0005 0x03 */ MSCRIPT_PLAYER_TALK(0x09DB),
    /* 0x0008 0x01 */ MSCRIPT_AWAIT_TEXT(),
    ...
    /* 0x001D 0x03 */ MSCRIPT_SET_WEEK_EVENT_REG(WEEKEVENTREG_55_40),
    /* 0x0020 0x01 */ MSCRIPT_DONE(),

    /* 0x0021 0x03 */ MSCRIPT_PLAYER_TALK(0x09E0),
