...
static MsgScript D_80AE6F00[] = {
    ...
    /* 0x0010 0x03 */ MSCRIPT_CHECK_DEKU(0x019F - 0x0013),
    /* 0x0013 0x03 */ MSCRIPT_CHECK_HUMAN(0x01A4 - 0x0016),
    /* 0x0016 0x03 */ MSCRIPT_JUMP(0x019F - 0x0019),
    /* 0x0019 0x03 */ MSCRIPT_CONTINUE_TEXT(0x00FF),
    /* 0x001C 0x09 */ MSCRIPT_CHECK_ITEM_ACTION(PLAYER_IA_PICTOGRAPH_BOX, 0x0, 0x013A - 0x0025, 0x016C - 0x0025),
    /* 0x0025 0x03 */ MSCRIPT_CHECK_CALLBACK_CONTINUE(0x003A - 0x0028),
    /* 0x0028 0x03 */ MSCRIPT_CHECK_CALLBACK_CONTINUE(0x0044 - 0x002B),
    /* 0x002B 0x03 */ MSCRIPT_CHECK_CALLBACK_CONTINUE(0x005B - 0x002E),
    /* 0x002E 0x03 */ MSCRIPT_CHECK_CALLBACK_CONTINUE(0x008E - 0x0031),
    /* 0x0031 0x03 */ MSCRIPT_CHECK_CALLBACK_CONTINUE(0x00C7 - 0x0034),
    /* 0x0034 0x03 */ MSCRIPT_CHECK_CALLBACK_CONTINUE(0x006A - 0x0037),
    ...
    /* 0x0054 0x07 */ MSCRIPT_CHECK_TEXT_CHOICE(0x0100 - 0x005B, 0x0126 - 0x005B, 0x0126 - 0x005B),
    ...
    /* 0x007A 0x07 */ MSCRIPT_CHECK_TEXT_CHOICE(0x0113 - 0x0081, 0x0133 - 0x0081, 0x0133 - 0x0081),
    ...
    /* 0x012F 0x03 */ MSCRIPT_CHECK_CALLBACK(0x0),
...
static MsgScript D_80AE70B8[] = {
    /* 0x0000 0x03 */ MSCRIPT_CHECK_CALLBACK_CONTINUE(0x0015 - 0x0003),
    /* 0x0003 0x03 */ MSCRIPT_CHECK_CALLBACK_CONTINUE(0x001B - 0x0006),
    /* 0x0006 0x03 */ MSCRIPT_CHECK_CALLBACK_CONTINUE(0x0031 - 0x0009),
    /* 0x0009 0x03 */ MSCRIPT_CHECK_CALLBACK_CONTINUE(0x0061 - 0x000C),
    /* 0x000C 0x03 */ MSCRIPT_CHECK_CALLBACK_CONTINUE(0x0099 - 0x000F),
    /* 0x000F 0x03 */ MSCRIPT_CHECK_CALLBACK_CONTINUE(0x003F - 0x0012),
    ...
    /* 0x002A 0x07 */ MSCRIPT_CHECK_TEXT_CHOICE(0x00D1 - 0x0031, 0x00F7 - 0x0031, 0x00F7 - 0x0031),
    ...
    /* 0x004E 0x07 */ MSCRIPT_CHECK_TEXT_CHOICE(0x00E4 - 0x0055, 0x0104 - 0x0055, 0x0104 - 0x0055),
    ...
    /* 0x0100 0x03 */ MSCRIPT_CHECK_CALLBACK(0x0),
