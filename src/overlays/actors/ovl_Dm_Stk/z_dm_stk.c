...
void func_80AA0B08(DmStk* this, GlobalContext* globalCtx) {
    ...
    switch (globalCtx->csCtx.frames) {
        case 64:
            Audio_PlaySfxByPos(&this->unk_310, NA_SE_EN_STAL06_SURPRISED);
            break;
        ...
        case 486:
            Audio_PlayActorSound2(&this->actor, NA_SE_EN_STALKIDS_MASK_OFF);
            Audio_PlaySfxByPos(&this->unk_310, NA_SE_EN_STAL08_CRY_BIG);
            break;

        case 496:
            Audio_PlaySfxByPos(&this->unk_310, NA_SE_EN_STAL09_SCREAM);
            break;
        ...
        case 594:
            Audio_PlaySfxByPos(&this->unk_310, NA_SE_EN_STAL24_SCREAM2);
            break;
    }
