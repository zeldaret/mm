...
#define GIANT_TYPE_IS_TERMINA_FIELD(type) (type < GIANT_TYPE_MOUNTAIN_CLOCK_TOWER_SUCCESS)
#define GIANT_TYPE_IS_NOT_TERMINA_FIELD(type) (type >= GIANT_TYPE_MOUNTAIN_CLOCK_TOWER_SUCCESS)
#define GIANT_TYPE_IS_CLOCK_TOWER_SUCCESS(type) (type >= GIANT_TYPE_MOUNTAIN_CLOCK_TOWER_SUCCESS && type < GIANT_TYPE_MOUNTAIN_GIANTS_CHAMBER_AND_ENDING)
#define GIANT_TYPE_IS_CHAMBER_OR_ENDING(type) (type >= GIANT_TYPE_MOUNTAIN_GIANTS_CHAMBER_AND_ENDING && type < GIANT_TYPE_MOUNTAIN_CLOCK_TOWER_FAILURE)
#define GIANT_TYPE_IS_CLOCK_TOWER_FAILURE(type) (type >= GIANT_TYPE_MOUNTAIN_CLOCK_TOWER_FAILURE && type < GIANT_TYPE_MAX)
