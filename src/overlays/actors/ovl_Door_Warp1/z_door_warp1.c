...
typedef enum {
    /* 0 */ DOORWARP1_REMAINS_NONE,
    /* 1 */ DOORWARP1_REMAINS_ODOLWA,
    /* 2 */ DOORWARP1_REMAINS_GOHT,
    /* 3 */ DOORWARP1_REMAINS_GYORG,
...
void func_808B9B30(DoorWarp1* this, PlayState* play) {
    if (fabsf(this->dyna.actor.xzDistToPlayer) >= 60.0f) {
        if (DoorWarp1_GetRemains(this, play) != DOORWARP1_REMAINS_NONE) {
            this->unk_1A0 = (DmHina*)Actor_SpawnAsChild(
                ...
                (DoorWarp1_GetRemains(this, play) - DOORWARP1_REMAINS_ODOLWA) + DMHINA_REMAINS_ODOLWA);
        }
...
void func_808B9CE8(DoorWarp1* this, PlayState* play) {
    ...
    if (!Actor_HasParent(&this->dyna.actor, play)) {
        Actor_OfferGetItem(&this->dyna.actor, play,
                           (DoorWarp1_GetRemains(this, play) - DOORWARP1_REMAINS_ODOLWA) + GI_REMAINS_ODOLWA, 30.0f,
                           80.0f);
        return;
    }
    ...
    Item_Give(play, (DoorWarp1_GetRemains(this, play) - DOORWARP1_REMAINS_ODOLWA) + ITEM_REMAINS_ODOLWA);
