...
ActorInit Obj_Spinyroll_InitVars = {
    ACTOR_OBJ_SPINYROLL,  ACTORCAT_PROP,        FLAGS,
    OBJECT_SPINYROLL,     sizeof(ObjSpinyroll), ObjSpinyroll_Init,
    ObjSpinyroll_Destroy, ObjSpinyroll_Update,  ObjSpinyroll_Draw,
};
