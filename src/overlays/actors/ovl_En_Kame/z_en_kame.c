...
void func_80AD8060(EnKame* this) {
    ...
    Actor_SetColorFilter(&this->actor, COLORFILTER_COLORFLAG_R, 255, COLORFILTER_XLUFLAG_OPA, sp36);
...
void func_80AD825C(EnKame* this, PlayState* play) {
    ...
    if ((this->actor.bgCheckFlags & 1) && (this->actor.velocity.y < 0.0f)) {
        ...
        if (this->unk_29E == 1) {
            ...
            Actor_SetColorFilter(&this->actor, COLORFILTER_COLORFLAG_NONE, 255, COLORFILTER_XLUFLAG_OPA, 100);
        }
