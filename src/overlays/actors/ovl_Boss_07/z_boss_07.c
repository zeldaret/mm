...
typedef enum TentacleState {
    /* 0 */ TENTACLE_STATE_DEFAULT,
    /* 1 */ TENTACLE_STATE_FIRING_BEAM,
...
void Boss07_Wrath_SetupSidestep(Boss07* this, PlayState* play) {
    ...
    Matrix_MultVecX(phi_f14, &this->targetPos);
...
void Boss07_Wrath_SetupShock(Boss07* this, PlayState* play) {
    ...
    temp_v1 = sWhipLength - 1;
    if (temp_v1 < temp_v0) {
        this->whipShockMaxIndex = this->whipShockMinIndex = temp_v1;
    }
...
void Boss07_Incarnation_Run(Boss07* this, PlayState* play) {
    ...
    if ((Actor_GetPlayerImpact(play, 5.0f, &this->actor.world.pos, &playerImpactType) >= 0.0f) &&
        ...
        sp30 = this->targetPos.z - this->actor.world.pos.z;
        ...
        Math_ApproachS(&this->actor.world.rot.y, Math_Atan2S(sp34, sp30), 5, this->speedToTarget);
...
void Boss07_Mask_Idle(Boss07* this, PlayState* play) {
    ...
    sp30 = this->targetPos.x - this->actor.world.pos.x;
    sp2C = this->targetPos.y - this->actor.world.pos.y;
    sp28 = this->targetPos.z - this->actor.world.pos.z;
    sp34 = Math_Atan2S(sp30, sp28);
    sp36 = Math_Atan2S(sp2C, sqrtf(SQ(sp30) + SQ(sp28)));
    sp36 += (s16)(Math_SinS(this->frameCounter * 0x1388) * 0xFA0);

    Math_ApproachS(&this->actor.world.rot.y, sp34, 0xA, this->speedToTarget);
    Math_ApproachS(&this->actor.world.rot.x, sp36, 5, this->speedToTarget);
...
void Boss07_Mask_SpinAttack(Boss07* this, PlayState* play) {
    ...
    switch (this->subAction) {
        ...
        case MAJORAS_MASK_SPIN_STATE_ATTACK:
            ...
            Math_ApproachS(&this->actor.world.rot.y, sp34, 0xA, this->speedToTarget);
            Math_ApproachS(&this->actor.world.rot.x, sp36, 0xA, this->speedToTarget);
...
void Boss07_Mask_Beam(Boss07* this, PlayState* play) {
    ...
    Math_ApproachS(&this->actor.shape.rot.y, this->actor.yawTowardsPlayer, phi_s0, this->speedToTarget);
    ...
    switch (this->subAction) {
        ...
        case MAJORAS_MASK_BEAM_STATE_END:
            ...
            temp_f22 = player->actor.world.pos.z - this->beamStartPos.z;
...
void Boss07_Mask_DeathCutscene(Boss07* this, PlayState* play) {
    ...
    switch (this->cutsceneState) {
        ...
        case MAJORAS_MASK_DEATH_STATE_1:
            ...
            this->tentacleState = TENTACLE_STATE_DEATH;
...
void Boss07_Mask_Update(Actor* thisx, PlayState* play2) {
    ...
    if ((sMajoraBattleHandler == NULL) || (sMajoraBattleHandler->subCamId == SUB_CAM_ID_DONE)) {
        ...
        if (KREG(63) == 0) {
            this->canEvade = false;
            this->maskEyeTexIndex = 0;
            this->tentacleState = TENTACLE_STATE_DEFAULT;
...
void Boss07_Mask_UpdateTentacles(Boss07* this, PlayState* play, Vec3f* base, Vec3f* pos, Vec3f* rot, Vec3f* velocity,
    ...
    if (this->tentacleState != TENTACLE_STATE_DEFAULT) {
...
void Boss07_Remains_Intro(Boss07* this, PlayState* play) {
    ...
    switch (this->subAction) {
        ...
        case REMAINS_CS_STATE_FLY:
            ...
            Math_ApproachS(&this->actor.world.rot.y, sp30, 5, this->speedToTarget);
            Math_ApproachS(&this->actor.world.rot.x, sp32, 5, this->speedToTarget);
            Math_ApproachF(&this->speedToTarget, sp40, 1.0f, sp3C);
...
void Boss07_Remains_Fly(Boss07* this, PlayState* play) {
    ...
    switch (this->subAction) {
        ...
        case REMAINS_STATE_FLY:
            ...
            sp78 = this->targetPos.x - this->actor.world.pos.x;
            sp74 = this->targetPos.y - this->actor.world.pos.y;
            sp70 = this->targetPos.z - this->actor.world.pos.z;
            sp7C = Math_Atan2S(sp78, sp70);
            sp7E = Math_Atan2S(sp74, sqrtf(SQ(sp78) + SQ(sp70)));
            sp7E += (s16)(Math_SinS(this->frameCounter * 0x1388) * 0xFA0);

            Math_ApproachS(&this->actor.world.rot.y, sp7C, 0xA, this->speedToTarget);
            Math_ApproachS(&this->actor.world.rot.x, sp7E, 5, this->speedToTarget);
            Math_ApproachF(&this->speedToTarget, 0x7D0, 1.0f, 0x64);
            Math_ApproachF(&this->actor.speed, this->flySpeedTarget, 1.0f, 1.0f);
...
void Boss07_Remains_Draw(Actor* thisx, PlayState* play2) {
    ...
    sp64 = this->damagedTimer * (M_PIf / 4.0f) * 0.06666667f;
    sp60 = Math_SinS(this->damagedTimer * 0x3500) * sp64 * 0.5f;
    Matrix_RotateYF(Math_SinS(this->damagedTimer * 0x4500) * sp64, MTXMODE_APPLY);
