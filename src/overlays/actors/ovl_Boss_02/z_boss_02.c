...
void func_809DAB78(Boss02* this, GlobalContext* globalCtx) {
    ...
    if ((this->unk_0144 != 10) && (this->unk_0144 <= 20)) {
        ...
        if (((this->unk_017C.y < temp_f0) && (temp_f0 <= this->unk_0188.y)) ||
            ...
            this->unk_016C = 120;
            Actor_PlaySfxAtProjectedPos(&this->actor, NA_SE_EN_INBOSS_ROAR_OLD);
        }
    ...
    switch (this->unk_0144) {
        ...
        case 20:
            ...
            if (this->unk_0146[1] == 0) {
                ...
                Actor_PlaySfxAtProjectedPos(&this->actor, NA_SE_EN_INBOSS_DAMAGE_OLD);
            }
            return;
        ...
        case 21:
            ...
            if (this->unk_0146[0] == 0) {
                ...
                if (this->unk_1678 <= 0) {
                    ...
                    Actor_PlaySfxAtProjectedPos(&this->actor, NA_SE_EN_INBOSS_DEAD_OLD);
                }
            }
            return;
...
void Boss02_Update(Actor* thisx, GlobalContext* globalCtx) {
    ...
    if (D_809E042C->unk_1D18 == 0) {
        ...
        if (this->unk_016C != 0) {
            ...
            Actor_PlaySfxAtProjectedPos(&this->actor, NA_SE_EN_INBOSS_SAND_OLD - SFX_FLAG);
