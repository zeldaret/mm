...
static AnimationInfoS sAnimationInfo[EN_DNP_ANIM_MAX] = {
    { &gDekuPrincessJumpKickAnim, 1.0f, 0, -1, ANIMMODE_ONCE, -4 },          // EN_DNP_ANIM_JUMP_KICK
    { &gDekuPrincessHurryAnim, 1.0f, 0, -1, ANIMMODE_LOOP, 0 },              // EN_DNP_ANIM_HURRY
    { &gDekuPrincessHurryAnim, 1.0f, 0, -1, ANIMMODE_LOOP, -4 },             // EN_DNP_ANIM_CUTSCENE_HURRY
    { &gDekuPrincessHurryEndAnim, 1.0f, 0, -1, ANIMMODE_ONCE, -4 },          // EN_DNP_ANIM_HURRY_END
    { &gDekuPrincessScoldAnim, 1.0f, 0, -1, ANIMMODE_ONCE, -4 },             // EN_DNP_ANIM_SCOLD
    { &gDekuPrincessLaughStartAnim, 1.0f, 0, -1, ANIMMODE_ONCE, -4 },        // EN_DNP_ANIM_LAUGH_START
    { &gDekuPrincessLaughLoopAnim, 1.0f, 0, -1, ANIMMODE_LOOP, -4 },         // EN_DNP_ANIM_LAUGH_LOOP
    { &gDekuPrincessTurnAroundAnim, 1.0f, 0, -1, ANIMMODE_ONCE, 0 },         // EN_DNP_ANIM_TURN_AROUND
    { &gDekuPrincessBowAnim, 1.0f, 0, -1, ANIMMODE_LOOP, -4 },               // EN_DNP_ANIM_BOW
    { &gDekuPrincessRunAnim, 1.0f, 0, -1, ANIMMODE_LOOP, -4 },               // EN_DNP_ANIM_RUN
    { &gDekuPrincessThinkStartAnim, 1.0f, 0, -1, ANIMMODE_ONCE, -4 },        // EN_DNP_ANIM_THINK_START
    { &gDekuPrincessThinkLoopAnim, 1.0f, 0, -1, ANIMMODE_LOOP, -4 },         // EN_DNP_ANIM_THINK_LOOP
    { &gDekuPrincessArmsTogetherStartAnim, 1.0f, 0, -1, ANIMMODE_ONCE, -4 }, // EN_DNP_ANIM_ARMS_TOGETHER_START
    { &gDekuPrincessArmsTogetherLoopAnim, 1.0f, 0, -1, ANIMMODE_LOOP, -4 },  // EN_DNP_ANIM_ARMS_TOGETHER_LOOP
    { &gDekuPrincessGreetingAnim, 1.0f, 0, -1, ANIMMODE_LOOP, -4 },          // EN_DNP_ANIM_GREETING
    { &gDekuPrincessIdleAnim, 1.0f, 0, -1, ANIMMODE_LOOP, 0 },               // EN_DNP_ANIM_IDLE
    { &gDekuPrincessIdleAnim, 1.0f, 0, -1, ANIMMODE_LOOP, -4 },              // EN_DNP_ANIM_CUTSCENE_IDLE
    { &gDekuPrincessWalkAnim, 1.0f, 0, -1, ANIMMODE_LOOP, -4 },              // EN_DNP_ANIM_UNUSED_WALK
    { &gDekuPrincessWalkAnim, 1.0f, 0, -1, ANIMMODE_LOOP, 0 },               // EN_DNP_ANIM_WALK
    { &gDekuPrincessAngryStartAnim, 1.0f, 0, -1, ANIMMODE_ONCE, -4 },        // EN_DNP_ANIM_ANGRY_START
    { &gDekuPrincessAngryLoopAnim, 1.0f, 0, -1, ANIMMODE_LOOP, -4 },         // EN_DNP_ANIM_ANGRY_LOOP
    { &gDekuPrincessJumpAnim, 1.0f, 0, -1, ANIMMODE_ONCE, -4 },              // EN_DNP_ANIM_JUMP
    { &gDekuPrincessBounceStartAnim, 1.0f, 0, -1, ANIMMODE_ONCE, 0 },        // EN_DNP_ANIM_BOUNCE_START
    { &gDekuPrincessBounceLoopAnim, 1.0f, 0, -1, ANIMMODE_LOOP, -4 },        // EN_DNP_ANIM_BOUNCE_LOOP
    { &gDekuPrincessGlareStartAnim, 1.0f, 0, -1, ANIMMODE_ONCE, 0 },         // EN_DNP_ANIM_GLARE_START
    { &gDekuPrincessGlareLoopAnim, 1.0f, 0, -1, ANIMMODE_LOOP, -4 },         // EN_DNP_ANIM_GLARE_LOOP
};
