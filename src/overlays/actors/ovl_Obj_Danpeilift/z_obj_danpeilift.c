...
ActorInit Obj_Danpeilift_InitVars = {
    ACTOR_OBJ_DANPEILIFT,  ACTORCAT_BG,           FLAGS,
    OBJECT_OBJ_DANPEILIFT, sizeof(ObjDanpeilift), ObjDanpeilift_Init,
    ObjDanpeilift_Destroy, ObjDanpeilift_Update,  ObjDanpeilift_Draw,
};
