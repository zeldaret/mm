...
void EnGg2_Update(Actor* thisx, PlayState* play) {
    ...
    func_80B3B8A4(this);
    func_800E9250(play, &this->actor, &this->unk_1E0, &this->unk_1E6, this->actor.focus.pos);
...
s32 func_80B3BD44(PlayState* play, s32 limbIndex, Gfx** dList, Vec3f* pos, Vec3s* rot, Actor* thisx,
                  Gfx** gfx) {
    EnGg2* this = THIS;
