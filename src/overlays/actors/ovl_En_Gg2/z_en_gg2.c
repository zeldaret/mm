...
void func_80B3AE60(EnGg2* this, PlayState* play) {
    ...
    if (curFrame == lastFrame) {
        switch (this->unk_2EE) {
            case 0:
                this->unk_2EE = 1;
                Actor_ChangeAnimByInfo(&this->skelAnime, D_80B3BF00, 1);
            ...
            case 8:
                ...
                Actor_ChangeAnimByInfo(&this->skelAnime, D_80B3BF00, 5);
                this->actionFunc = func_80B3B120;
                break;

            case 5:
                this->unk_2EE = 6;
                Actor_ChangeAnimByInfo(&this->skelAnime, D_80B3BF00, 0);
