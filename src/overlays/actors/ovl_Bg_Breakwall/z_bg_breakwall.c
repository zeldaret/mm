...
int func_808B736C(BgBreakwall* this, PlayState* play);
int func_808B7380(BgBreakwall* this, PlayState* play);
int func_808B73C4(BgBreakwall* this, PlayState* play);
int func_808B73FC(BgBreakwall* this, PlayState* play);
int func_808B7410(BgBreakwall* this, PlayState* play);
int func_808B7460(BgBreakwall* this, PlayState* play);
int func_808B74A8(BgBreakwall* this, PlayState* play);
int func_808B74D8(BgBreakwall* this, PlayState* play);
int func_808B751C(BgBreakwall* this, PlayState* play);
