...
void EnWizFire_Destroy(Actor* thisx, GlobalContext* globalCtx) {
    ...
    if (this->unk_162 == 0) {
        globalCtx->envCtx.lightAdjustments.fogColor[2] = 0;
        globalCtx->envCtx.lightAdjustments.fogColor[1] = globalCtx->envCtx.lightAdjustments.fogColor[2];
        globalCtx->envCtx.lightAdjustments.fogColor[0] = globalCtx->envCtx.lightAdjustments.fogColor[2];
        globalCtx->envCtx.lightAdjustments.diffuseColor2[2] = globalCtx->envCtx.lightAdjustments.fogColor[2];
        globalCtx->envCtx.lightAdjustments.diffuseColor2[1] = globalCtx->envCtx.lightAdjustments.fogColor[2];
        globalCtx->envCtx.lightAdjustments.diffuseColor2[0] = globalCtx->envCtx.lightAdjustments.fogColor[2];
        globalCtx->envCtx.lightAdjustments.diffuseColor1[2] = globalCtx->envCtx.lightAdjustments.fogColor[2];
        globalCtx->envCtx.lightAdjustments.diffuseColor1[1] = globalCtx->envCtx.lightAdjustments.fogColor[2];
        globalCtx->envCtx.lightAdjustments.diffuseColor1[0] = globalCtx->envCtx.lightAdjustments.fogColor[2];
        globalCtx->envCtx.lightAdjustments.ambientColor[2] = globalCtx->envCtx.lightAdjustments.fogColor[2];
        globalCtx->envCtx.lightAdjustments.ambientColor[1] = globalCtx->envCtx.lightAdjustments.fogColor[2];
        globalCtx->envCtx.lightAdjustments.ambientColor[0] = globalCtx->envCtx.lightAdjustments.fogColor[2];
        globalCtx->envCtx.lightAdjustments.fogNear = globalCtx->envCtx.lightAdjustments.fogColor[2];
    }
...
void func_80A49A44(EnWizFire* this, GlobalContext* globalCtx) {
        ...
        if ((this->unk_162 == 0) && (this->unk_168 != 0)) {
            if (this->actor.floorBgId == BGCHECK_SCENE) {
                ...
                if (this->unk_166 == 0) {
                    ...
                    if (this->unk_16A != 0) {
                        Audio_PlayActorSound2(&this->actor, NA_SE_EN_WIZ_EXP - SFX_FLAG);
                    }
    ...
    if ((this->unk_162 != 3) && (this->unk_168 != 0)) {
        ...
        if (func_8012405C(globalCtx) && (this->collider.base.atFlags & AT_BOUNCED)) {
            Audio_PlayActorSound2(&this->actor, NA_SE_IT_SHIELD_REFLECT_MG);
...
void EnWizFire_Update(Actor* thisx, GlobalContext* globalCtx2) {
    ...
    if (this->unk_162 == 0) {
        ...
        if ((wiz != NULL) && (wiz->id == ACTOR_EN_WIZ) && (wiz->update != NULL) && (((EnWiz*)wiz)->unk_74A != 2)) {
            ...
            globalCtx->envCtx.lightAdjustments.fogNear = (phi_f0 - (s16)globalCtx->envCtx.unk_C4.fogNear) * this->unk_204;
            ...
            globalCtx->envCtx.lightAdjustments.ambientColor[2] =
    ...
    if (this->collider.base.atFlags & AT_HIT) {
        ...
        if (this->unk_162 == 0) {
            Audio_PlayActorSound2(&this->actor, NA_SE_EN_WIZ_LAUGH2);
