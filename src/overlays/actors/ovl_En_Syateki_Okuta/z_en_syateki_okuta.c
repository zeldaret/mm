...
ActorInit En_Syateki_Okuta_InitVars = {
    ACTOR_EN_SYATEKI_OKUTA, ACTORCAT_ENEMY,         FLAGS,
    OBJECT_OKUTA,           sizeof(EnSyatekiOkuta), EnSyatekiOkuta_Init,
    EnSyatekiOkuta_Destroy, EnSyatekiOkuta_Update,  EnSyatekiOkuta_Draw,
};
