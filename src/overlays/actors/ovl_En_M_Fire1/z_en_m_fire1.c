...
GLOBAL_ASM("asm/non_matchings/ovl_En_M_Fire1_0x808B5230/EnMFire1_Init.asm")

GLOBAL_ASM("asm/non_matchings/ovl_En_M_Fire1_0x808B5230/EnMFire1_Destroy.asm")

GLOBAL_ASM("asm/non_matchings/ovl_En_M_Fire1_0x808B5230/EnMFire1_Update.asm")
