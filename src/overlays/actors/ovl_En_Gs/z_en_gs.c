...
s8 func_80997A90(s16 arg0, s16 arg1) {
    ...
    if ((arg0 == 0) || ((arg0 != 1) && (arg0 != 2) && (arg0 == 3))) {
        ...
        phi_v1 = (gSaveContext.save.saveInfo.unk_EC4 >> (arg1 * 3)) & 7;
    }
    return phi_v1;
}
...
void func_809985B8(EnGs* this, PlayState* play) {
    ...
    if (SubS_StartActorCutscene(&this->actor, this->unk_212[0], -1, SUBS_CUTSCENE_SET_UNK_LINK_FIELDS)) {
        ...
        this->unk_200 = 0.0f;
        gSaveContext.save.saveInfo.unk_EC4 = ((u32)gSaveContext.save.saveInfo.unk_EC4 & ~(7 << (this->unk_198 * 3))) |
...
void func_8099874C(EnGs* this, PlayState* play) {
    ...
    if (phi_v0 == 0) {
        ...
        if ((this->unk_19C == 5) && (this->unk_194 != 0)) {
            ...
            for (i = 0; i < 4; i++) {
                if (((gSaveContext.save.saveInfo.unk_EC4 >> (i * 3)) & 7) != (u32)this->unk_194) {
                    phi_v0 = 0;
                }
            }
