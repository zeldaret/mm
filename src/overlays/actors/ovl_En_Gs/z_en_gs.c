    ...
    if (phi_v0 == 0) {
        ...
        if ((this->unk_19C == 5) && (this->unk_194 != 0)) {
            ...
            if (phi_v0 != 0) {
                ...
                switch (this->unk_194) {
                    case 1:
                        if (!(GET_WEEKEVENTREG(WEEKEVENTREG_77_08))) {
                            this->unk_20C = 6;
                    ...
                    case 3:
                        if (!(GET_WEEKEVENTREG(WEEKEVENTREG_77_10))) {
                            this->unk_20C = 6;
                    ...
                    case 2:
                        if (!(GET_WEEKEVENTREG(WEEKEVENTREG_77_20))) {
                            this->unk_20C = 6;
                ...
                if (!(GET_WEEKEVENTREG(WEEKEVENTREG_90_10))) {
