...
u8 D_80B8AC44[] = {
    0x00, 0x00, 0x02, 0x00, 0x00, 0x02, 0x02, 0x02, 0x02, 0x02,
    0x02, 0x02, 0x00, 0x02, 0x02, 0x02, 0x02, 0x00, 0x02, 0x00,
};

Color_RGBA8 D_80B8AC58 = { 0xC8, 0xA0, 0x78, 0xFF };
Color_RGBA8 D_80B8AC5C = { 0x82, 0x5A, 0x32, 0xFF };
...
u32 D_80B8ACCC[] = {
    0x060093B8, 0x06009978, 0x0600A0F8, 0x06009978, 0x00000000,
};
...
void EnKaizoku_Init(Actor* thisx, PlayState* play) {
    ...
    SkelAnime_InitFlex(play, &this->skelAnime, &D_0600D828, &D_060058B8, this->jointTable, this->morphTable, 24);
    Collider_InitAndSetCylinder(play, &this->unk_3D4, &this->actor, &D_80B8AB7C);
    Collider_InitAndSetQuad(play, &this->unk_420, &this->actor, &D_80B8ABA8);
...
s32 func_80B85A00(EnKaizoku* this, PlayState* play, s16 arg2) {
    ...
    if (func_800BE184(play, &this->actor, 100.0f, 0x2710, 0x4000, this->actor.shape.rot.y)) {
        ...
        if ((this->actor.bgCheckFlags & 8) && ABS_ALT(sp32) < 12000 && this->actor.xzDistToPlayer < 90.0f) {
            ...
            return 1;
        } else if (player->meleeWeaponAnimation == 17) {
            if (this->unk_2B0 != 2) {
                func_80B874D8(this, play);
            }
        } else if (this->actor.xzDistToPlayer < gGameInfo->data[0x96B] + 180.0f) {
            func_80B87900(this);
...
extern u32 D_80B8ABF8[];
extern u8 D_80B8AC44[];
...
extern Vec3f D_80B8A8E4[];
extern Vec3f D_80B8AA04[];
...
void func_80B85FA8(EnKaizoku* this, PlayState* play) {
    ...
    switch (this->unk_59C) {
        case 0:
            ...
            func_800B7298(play, &this->actor, 0x15U);
        ...
        case 2:
            if (this->actor.bgCheckFlags & 1) {
                if (this->unk_2D8 != 0) {
                    ...
                    func_800B7298(play, &this->actor, 4U);
                    ...
                    Actor_PlaySfxAtPos(&this->actor, 0x3A66U);
                }
        ...
        case 5:
            ...
            if (Animation_OnFrame(&this->skelAnime, 20.0f) != 0) {
                Actor_PlaySfxAtPos(&this->actor, 0x3A4DU);
            }
            if (curFrame >= 30.0f) {
                this->unk_598 = 0;
                this->unk_59C += 1;
...
void func_80B86804(EnKaizoku* this, PlayState* play) {
    ...
    func_800B7298(play, &this->actor, 0x60U);
    this->unk_59E = ActorCutscene_GetCurrentCamera(this->actor.cutscene);
    this->unk_2B2 = 30;
    this->actor.flags &= ~1;
    this->unk_598 = 0;
    ...
    switch (this->unk_59C) {
        ...
        case 1:
            if (this->unk_2DC <= curFrame) {
                ...
                Actor_PlaySfxAtPos(&this->actor, 0x39B9U);
                this->unk_598 = 0;
                this->unk_59C++;
            }
            break;
...
void func_80B86B74(EnKaizoku* this, PlayState* play) {
    ...
    switch (this->unk_59C) {
        ...
        case 1:
            if (this->unk_2DC <= curFrame) {
                if (this->unk_2D9 == 0) {
                    Actor_PlaySfxAtPos(&this->actor, 0x3A73U);
                    this->unk_2D9 = 1;
                } else {
            ...
            if (Message_GetState(&play->msgCtx) == 5 && Message_ShouldAdvance(play) != 0) {
                ...
                func_800B7298(play, &this->actor, 0x85U);
                this->unk_5A0 = 0;
                this->unk_598 = 0;
                this->unk_59C += 1;
            }
        ...
        case 2:
            ...
            if (this->unk_5A0 == 0x12) {
                Actor* temp_v0_2;
                Actor_PlaySfxAtPos(&this->actor, 0x3A74U);
                temp_v0_2 = Actor_Spawn(&play->actorCtx, play, 0xF, this->actor.world.pos.x,
...
void func_80B872F4(EnKaizoku* this, PlayState* play) {
    ...
    if (this->unk_2B4 == 0 && !func_80B85858(this, play) && !func_80B85A00(this, play, 0)) {
        ...
        if (Actor_IsFacingPlayer(&this->actor, 3000)) {
...
extern Color_RGBA8 D_80B8AC58;
extern Color_RGBA8 D_80B8AC5C;
extern Vec3f D_80B8AC60;
extern Vec3f D_80B8AC6C;
...
void func_80B87E28(EnKaizoku* this) {
    ...
    Actor_PlaySfxAtPos(&this->actor, 0x386CU);
    ...
    if (!func_80B85858(this, play)) {
        ...
        if (!func_80B85A00(this, play, 0)) {
            if (this->actor.xzDistToPlayer < 210.0f && this->actor.xzDistToPlayer > 150.0f &&
                ...
                if (Actor_IsTargeted(play, &this->actor) != 0) {
                    if (Rand_ZeroOne() > 0.5f) {
                        func_80B88214(this);
                    } else {
                        func_80B88910(this);
...
void func_80B887AC(EnKaizoku* this, PlayState* play) {
    ...
    if (!func_80B85858(this, play) && !func_80B85A00(this, play, 0)) {
        ...
        if (Actor_IsFacingPlayer(&this->actor, 0x1388) != 0) {
...
void func_80B88964(EnKaizoku* this, PlayState* play) {
    ...
    if (this->skelAnime.curFrame <= 8.0f) {
        ...
        if (Animation_OnFrame(&this->skelAnime, 13.0f) != 0) {
            ...
            this->actor.speedXZ = 0.0f;
        } else if (Animation_OnFrame(&this->skelAnime, 24.0f) != 0) {
            this->unk_2D2 = -1;
        }
    }
...
void func_80B88D6C(EnKaizoku* this, PlayState* play) {
    ...
    if (!func_80B85858(this, play) && !func_80B85A00(this, play, 0)) {
        ...
        if (this->actor.xzDistToPlayer <= 65.0f) {
            ...
            if ((Actor_OtherIsTargeted(play, &this->actor) != 0) && (Rand_ZeroOne() > 0.5f)) {
                func_80B87E28(this);
            } else {
                func_80B872A4(this);
            }
...
void func_80B89280(EnKaizoku* this, PlayState* play) {
    ...
    if (this->unk_2B6 == 0 && this->unk_2B8 == 0 && (this->actor.flags & 0x2000) != 0x2000 &&
...
void func_80B8971C(EnKaizoku* this, PlayState* play) {
    ...
    if (this->unk_2DC <= curFrame) {
        this->unk_2D8 = 0;
        func_80B86B58(this);
    } else if (Animation_OnFrame(&this->skelAnime, 10.0f) != 0) {
...
void func_80B89A08(EnKaizoku* this, PlayState* play) {
    ...
    if (!(this->unk_420.base.atFlags & AT_BOUNCED) && (this->unk_420.base.atFlags & AT_HIT)) {
        if (gSaveContext.save.playerData.health <= 16 && this->unk_2B0 != 16) {
            ...
            return;
        } else if (this->unk_2B0 == 11 && this->unk_420.base.at == (Actor*)GET_PLAYER(play)) {
...
extern Color_RGBA8 D_80B8AB24[];
extern Color_RGBA8 D_80B8AB30[];
...
extern Vec3f D_80B8AC78;
extern Vec3f D_80B8AC84;
extern Vec3f D_80B8AC90;
extern Vec3f D_80B8AC9C;
extern Vec3f D_80B8ACA8;
extern Vec3f D_80B8ACB4;
extern Vec3f D_80B8ACC0;
...
void func_80B8A468(PlayState* play, s32 limbIndex, Gfx** dList, Vec3s* rot, Actor* thisx) {
    ...
    if (limbIndex == 0xB) {
        ...
        Actor_SetFeetPos(&this->actor, limbIndex, 19, &D_80B8AC78, 22, &D_80B8AC78);
    }
    if (limbIndex == 0x13) {
        Matrix_MultVec3f(&D_80B8AC78, &this->unk_58C);
    } else if (limbIndex == 0x16) {
        Matrix_MultVec3f(&D_80B8AC78, &this->unk_580);
    }
    if (limbIndex == 2 || limbIndex == 6 || limbIndex == 7 || limbIndex == 8 || limbIndex == 0xA || limbIndex == 0xC ||
        limbIndex == 0xD || limbIndex == 0xF || limbIndex == 0x11 || limbIndex == 0x12 || limbIndex == 0x13 ||
        limbIndex == 0x14 || limbIndex == 0x15 || limbIndex == 0x16 || limbIndex == 0x17) {
...
void func_80B8A718(Actor* thisx, PlayState* play) {
    ...
    if (this->unk_2B8 != 0) {
        ...
        Actor_DrawDamageEffects(play, &this->actor, this->unk_310, 0xF, this->unk_2C0, this->unk_2C4, sp34,
                                this->unk_2BA);
    }
    CLOSE_DISPS(play->state.gfxCtx);
}
