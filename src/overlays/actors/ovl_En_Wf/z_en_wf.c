...
void func_80990E4C(EnWf* this, GlobalContext* globalCtx) {
    if (Animation_OnFrame(&this->skelAnime, 1.0f) && (this->actor.bgCheckFlags & 1)) {
        ...
        Actor_PlaySfxAtProjectedPos(&this->actor, NA_SE_EN_WOLFOS_WALK);
    }
}
...
void func_80990ED4(EnWf* this) {
    ...
    this->actor.shape.rot.y = this->actor.yawTowardsPlayer;
    Actor_PlaySfxAtProjectedPos(&this->actor, NA_SE_EN_WOLFOS_APPEAR);
    func_80991438(this);
}
    ...
    if (!func_8099408C(globalCtx, this) && !func_80990948(globalCtx, this, 0)) {
        ...
        if ((this->actor.xzDistToPlayer < 80.0f) && (player->swordState != 0) && (phi_v1 >= 0x1F40)) {
            ...
            if (this->unk_2A0 == 0) {
                ...
                if (this->unk_2A2 == 0) {
                    Actor_PlaySfxAtProjectedPos(&this->actor, NA_SE_EN_WOLFOS_CRY);
                }
            }
        }
    }
...
void func_80991C80(EnWf* this, GlobalContext* globalCtx) {
    ...
    if (((this->skelAnime.curFrame >= 9.0f) && (this->skelAnime.curFrame < 13.0f)) ||
        ...
        if (!(this->collider1.base.atFlags & AT_ON)) {
            Actor_PlaySfxAtProjectedPos(&this->actor, NA_SE_EN_WOLFOS_ATTACK);
        }
...
void func_8099223C(EnWf* this) {
    ...
    this->actor.shape.rot.y = this->actor.yawTowardsPlayer;
    this->actor.world.rot.y = this->actor.yawTowardsPlayer;
    Actor_PlaySfxAtProjectedPos(&this->actor, NA_SE_EN_TEKU_JUMP);
...
void func_8099245C(EnWf* this) {
    ...
    this->unk_298 = 0;
    this->actor.world.rot.y = this->actor.yawTowardsPlayer;
    Actor_PlaySfxAtProjectedPos(&this->actor, NA_SE_EN_WOLFOS_DAMAGE);
...
void func_80992D6C(EnWf* this) {
    ...
    this->actor.flags &= ~1;
    this->unk_2A0 = 25;
    Actor_PlaySfxAtProjectedPos(&this->actor, NA_SE_EN_WOLFOS_DEAD);
    ...
    if ((this->collider2.base.acFlags & AC_HIT) || (this->collider3.base.acFlags & AC_HIT)) {
        ...
        if (((this->unk_296 != 10) ||
            ...
            if (this->actor.colChkInfo.damageEffect == 1) {
                ...
                Actor_PlaySfxAtProjectedPos(&this->actor, NA_SE_EN_COMMON_FREEZE);
                func_809923B0(this);
