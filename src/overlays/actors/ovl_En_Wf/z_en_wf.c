...
void func_809907D4(EnWf* this) {
    ...
    Actor_SetColorFilter(&this->actor, COLORFILTER_COLORFLAG_RED, 0xFF, COLORFILTER_BUFFLAG_OPA, 80);
}
    ...
    if ((this->collider2.base.acFlags & AC_HIT) || (this->collider3.base.acFlags & AC_HIT)) {
        ...
        if (((this->drawDmgEffType != ACTOR_DRAW_DMGEFF_FROZEN_NO_SFX) ||
            ...
            if (this->actor.colChkInfo.damageEffect == 1) {
                this->unk_2A0 = 40;
                Actor_SetColorFilter(&this->actor, COLORFILTER_COLORFLAG_BLUE, 0x78, COLORFILTER_BUFFLAG_OPA, 40);
                Actor_PlaySfxAtPos(&this->actor, NA_SE_EN_COMMON_FREEZE);
                func_809923B0(this);
            } else if (this->actor.colChkInfo.damageEffect == 5) {
                this->unk_2A0 = 40;
                Actor_SetColorFilter(&this->actor, COLORFILTER_COLORFLAG_BLUE, 0xFF, COLORFILTER_BUFFLAG_OPA, 40);
