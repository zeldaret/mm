...
void func_80B2951C(EnFish2* this) {
    ...
    Actor_PlaySfxAtProjectedPos(&this->actor, NA_SE_EN_DODO_M_EAT);
    ...
    switch (this->unk_2C4) {
        ...
        case 1:
            ...
            if ((fabsf(this->actor.world.rot.y - this->unk_34A) < 100.0f) && (fabsf(this->actor.world.rot.x) < 30.0f)) {
                ...
                this->unk_2B6 = 4;
                Actor_PlaySfxAtProjectedPos(&this->actor, NA_SE_EV_FISH_GROW_UP);
                this->unk_2C4++;
            }
            break;
...
void func_80B2A498(EnFish2* this, GlobalContext* globalCtx) {
    ...
    if ((this->unk_2AC == 4) && Animation_OnFrame(&this->skelAnime, 13.0f)) {
        ...
        if (temp_v0 != NULL) {
            ...
            Actor_PlaySfxAtProjectedPos(&this->actor, NA_SE_SY_PIECE_OF_HEART);
