...
void EnTalkGibud_GetTextIdForRequestedItem(EnTalkGibud* this, GlobalContext* globalCtx) {
    switch (this->requestedItemIndex) {
        case EN_TALK_GIBUD_REQUESTED_ITEM_INDEX_BLUE_POTION:
            func_801518B0(globalCtx, TEXTID_TALK_GIBUD_BLUE_POTION, &this->actor);
            this->textId = TEXTID_TALK_GIBUD_BLUE_POTION;
            break;
        case EN_TALK_GIBUD_REQUESTED_ITEM_INDEX_BEANS:
            func_801518B0(globalCtx, TEXTID_TALK_GIBUD_MAGIC_BEANS, &this->actor);
            this->textId = TEXTID_TALK_GIBUD_MAGIC_BEANS;
            break;
        case EN_TALK_GIBUD_REQUESTED_ITEM_INDEX_SPRING_WATER:
            func_801518B0(globalCtx, TEXTID_TALK_GIBUD_SPRING_WATER, &this->actor);
            this->textId = TEXTID_TALK_GIBUD_SPRING_WATER;
            break;
        case EN_TALK_GIBUD_REQUESTED_ITEM_INDEX_FISH:
            func_801518B0(globalCtx, TEXTID_TALK_GIBUD_FISH, &this->actor);
            this->textId = TEXTID_TALK_GIBUD_FISH;
            break;
        case EN_TALK_GIBUD_REQUESTED_ITEM_INDEX_BUGS:
            func_801518B0(globalCtx, TEXTID_TALK_GIBUD_BUGS, &this->actor);
            this->textId = TEXTID_TALK_GIBUD_BUGS;
            break;
        case EN_TALK_GIBUD_REQUESTED_ITEM_INDEX_DEKU_NUTS:
            func_801518B0(globalCtx, TEXTID_TALK_GIBUD_DEKU_NUTS, &this->actor);
            this->textId = TEXTID_TALK_GIBUD_DEKU_NUTS;
            break;
        case EN_TALK_GIBUD_REQUESTED_ITEM_INDEX_BOMBS:
            func_801518B0(globalCtx, TEXTID_TALK_GIBUD_BOMBS, &this->actor);
            this->textId = TEXTID_TALK_GIBUD_BOMBS;
            break;
        case EN_TALK_GIBUD_REQUESTED_ITEM_INDEX_HOT_SPRING_WATER:
            func_801518B0(globalCtx, TEXTID_TALK_GIBUD_HOT_SPRING_WATER, &this->actor);
            this->textId = TEXTID_TALK_GIBUD_HOT_SPRING_WATER;
            break;
        case EN_TALK_GIBUD_REQUESTED_ITEM_INDEX_BIG_POE:
            func_801518B0(globalCtx, TEXTID_TALK_GIBUD_BIG_POE, &this->actor);
            this->textId = TEXTID_TALK_GIBUD_BIG_POE;
            break;
        case EN_TALK_GIBUD_REQUESTED_ITEM_INDEX_MILK:
            func_801518B0(globalCtx, TEXTID_TALK_GIBUD_MILK, &this->actor);
            this->textId = TEXTID_TALK_GIBUD_MILK;
            break;
    }
}
...
void EnTalkGibud_GetNextTextBoxId(EnTalkGibud* this, GlobalContext* globalCtx) {
    if (func_80147624(globalCtx)) {
        switch (this->textId) {
            case TEXTID_TALK_GIBUD_LEAVE_IT:
                EnTalkGibud_GetTextIdForRequestedItem(this, globalCtx);
                break;
            case TEXTID_TALK_GIBUD_BLUE_POTION:
            case TEXTID_TALK_GIBUD_MAGIC_BEANS:
            case TEXTID_TALK_GIBUD_SPRING_WATER:
            case TEXTID_TALK_GIBUD_FISH:
            case TEXTID_TALK_GIBUD_BUGS:
            case TEXTID_TALK_GIBUD_DEKU_NUTS:
            case TEXTID_TALK_GIBUD_BOMBS:
            case TEXTID_TALK_GIBUD_HOT_SPRING_WATER:
            case TEXTID_TALK_GIBUD_BIG_POE:
            case TEXTID_TALK_GIBUD_MILK:
                func_801518B0(globalCtx, TEXTID_OPEN_THE_SELECT_ITEM_SCREEN, &this->actor);
                this->textId = TEXTID_OPEN_THE_SELECT_ITEM_SCREEN;
                break;
        }
    }
}
        ...
        if (this->itemActionParam > PLAYER_AP_NONE) {
            switch (EnTalkGibud_PresentedItemMatchesRequest(this, globalCtx, this->itemActionParam)) {
                case EN_TALK_GIBUD_REQUESTED_ITEM_MET:
                    player->actor.textId = TEXTID_TALK_GIBUD_NO_REMORSE;
                    this->textId = TEXTID_TALK_GIBUD_NO_REMORSE;
                    break;
                case EN_TALK_GIBUD_REQUESTED_ITEM_NOT_ENOUGH_AMMO:
                    player->actor.textId = TEXTID_TALK_GIBUD_NOT_ENOUGH;
                    this->textId = TEXTID_TALK_GIBUD_NOT_ENOUGH;
                    break;
                case EN_TALK_GIBUD_REQUESTED_ITEM_NOT_MET:
                    player->actor.textId = TEXTID_TALK_GIBUD_AWAY;
                    this->textId = TEXTID_TALK_GIBUD_AWAY;
                    break;
                default:
                    break;
            }
            ...
            func_801518B0(globalCtx, TEXTID_TALK_GIBUD_AWAY, &this->actor);
            this->textId = TEXTID_TALK_GIBUD_AWAY;
        }
    }
}
...
void EnTalkGibud_PassiveIdle(EnTalkGibud* this, GlobalContext* globalCtx) {
    if (Actor_ProcessTalkRequest(&this->actor, &globalCtx->state)) {
        this->isTalking = true;
        func_801518B0(globalCtx, TEXTID_TALK_GIBUD_LEAVE_IT, &this->actor);
        this->textId = TEXTID_TALK_GIBUD_LEAVE_IT;
        Actor_PlaySfxAtPos(&this->actor, NA_SE_EN_REDEAD_AIM);
...
void EnTalkGibud_Talk(EnTalkGibud* this, GlobalContext* globalCtx) {
    ...
    switch (Message_GetState(&globalCtx->msgCtx)) {
        ...
        case 6:
            if (func_80147624(globalCtx)) {
                if (this->textId == TEXTID_TALK_GIBUD_NO_REMORSE) {
