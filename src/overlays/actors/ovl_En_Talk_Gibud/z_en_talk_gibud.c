...
void EnTalkGibud_SetupIdle(EnTalkGibud* this) {
    Actor_ChangeAnimationByInfo(&this->skelAnime, sAnimations, EN_TALK_GIBUD_ANIM_IDLE);
...
void EnTalkGibud_SetupWalkToPlayer(EnTalkGibud* this) {
    Actor_ChangeAnimationByInfo(&this->skelAnime, sAnimations, EN_TALK_GIBUD_ANIM_WALK);
...
void EnTalkGibud_SetupGrab(EnTalkGibud* this) {
    Actor_ChangeAnimationByInfo(&this->skelAnime, sAnimations, EN_TALK_GIBUD_ANIM_GRAB_START);
    ...
    switch (this->grabState) {
        case EN_TALK_GIBUD_GRAB_START:
            ...
            if (Animation_OnFrame(&this->skelAnime, this->skelAnime.endFrame) && (inPositionToAttack == true)) {
                ...
                Actor_ChangeAnimationByInfo(&this->skelAnime, sAnimations, EN_TALK_GIBUD_ANIM_GRAB_ATTACK);
            }
            break;
        ...
        case EN_TALK_GIBUD_GRAB_ATTACK:
            ...
            if (!(player->stateFlags2 & 0x80) || (player->unk_B62 != 0)) {
                ...
                Actor_ChangeAnimationByInfo(&this->skelAnime, sAnimations, EN_TALK_GIBUD_ANIM_GRAB_END);
                this->actor.flags |= ACTOR_FLAG_1;
...
void EnTalkGibud_SetupGrabFail(EnTalkGibud* this) {
    Actor_ChangeAnimationByInfo(&this->skelAnime, sAnimations, EN_TALK_GIBUD_ANIM_DAMAGE);
...
void EnTalkGibud_SetupDead(EnTalkGibud* this) {
    Actor_ChangeAnimationByInfo(&this->skelAnime, sAnimations, EN_TALK_GIBUD_ANIM_DEATH);
    this->actor.flags &= ~ACTOR_FLAG_1;
