...
s32 func_80BF19A0(EnIg* this, PlayState* play) {
    ...
    if (((this->unk_3D0 & SUBS_OFFER_MODE_MAX) != SUBS_OFFER_MODE_NONE) &&
        Actor_ProcessTalkRequest(&this->actor, &play->state)) {
        SubS_UpdateFlags(&this->unk_3D0, SUBS_OFFER_MODE_NONE, SUBS_OFFER_MODE_MAX);
        this->unk_3F6 = 0;
        this->unk_3F8 = NULL;
...
s32 func_80BF1D78(EnIg* this, PlayState* play, ScheduleOutput* scheduleOutput) {
    ...
    if (func_80BF1C44(this, play, scheduleOutput, ACTORCAT_NPC, ACTOR_EN_AN)) {
        func_80BF1284(this, 0);
        SubS_UpdateFlags(&this->unk_3D0, SUBS_OFFER_MODE_ONSCREEN, SUBS_OFFER_MODE_MAX);
        this->unk_3D0 |= 0x20;
        this->unk_3D0 |= 0x100;
        sp2C = true;
    }
