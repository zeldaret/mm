...
static u8 D_80BF3260[] = {
    /* 0x0000 */ SCHEDULE_CMD_CHECK_DAY_L(1, 0x00B6 - 0x0005),
    /* 0x0005 */ SCHEDULE_CMD_CHECK_SCENE_S(SCENE_TOWN, 0x0057 - 0x0009),
    /* 0x0009 */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(15, 25, 15, 45, 0x0051 - 0x000F),
    /* 0x000F */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(15, 45, 15, 50, 0x004B - 0x0015),
    /* 0x0015 */ SCHEDULE_CMD_CHECK_FLAG_S(0x4B, 0x10, 0x001A - 0x0019),
    /* 0x0019 */ SCHEDULE_CMD_RET_NONE(),
    /* 0x001A */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(16, 50, 16, 55, 0x0045 - 0x0020),
    /* 0x0020 */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(16, 55, 17, 15, 0x003F - 0x0026),
    /* 0x0026 */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(17, 15, 18, 0, 0x0039 - 0x002C),
    /* 0x002C */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(18, 0, 6, 0, 0x0033 - 0x0032),
    /* 0x0032 */ SCHEDULE_CMD_RET_NONE(),
    /* 0x0033 */ SCHEDULE_CMD_RET_TIME(18, 0, 6, 0, 4),
    /* 0x0039 */ SCHEDULE_CMD_RET_TIME(17, 15, 6, 0, 2),
    /* 0x003F */ SCHEDULE_CMD_RET_TIME(16, 55, 17, 15, 11),
    /* 0x0045 */ SCHEDULE_CMD_RET_TIME(16, 50, 16, 55, 6),
    /* 0x004B */ SCHEDULE_CMD_RET_TIME(15, 45, 15, 50, 5),
    /* 0x0051 */ SCHEDULE_CMD_RET_TIME(15, 25, 15, 45, 10),
    /* 0x0057 */ SCHEDULE_CMD_CHECK_SCENE_S(SCENE_YADOYA, 0x00B5 - 0x005B),
    /* 0x005B */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(15, 45, 15, 50, 0x00AF - 0x0061),
    /* 0x0061 */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(15, 50, 16, 10, 0x00A9 - 0x0067),
    /* 0x0067 */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(16, 10, 16, 30, 0x00A3 - 0x006D),
    /* 0x006D */ SCHEDULE_CMD_CHECK_FLAG_S(0x4B, 0x10, 0x008A - 0x0071),
    /* 0x0071 */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(16, 30, 16, 50, 0x0084 - 0x0077),
    /* 0x0077 */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(16, 50, 16, 55, 0x007E - 0x007D),
    /* 0x007D */ SCHEDULE_CMD_RET_NONE(),
    /* 0x007E */ SCHEDULE_CMD_RET_TIME(16, 50, 16, 55, 8),
    /* 0x0084 */ SCHEDULE_CMD_RET_TIME(16, 30, 16, 50, 13),
    /* 0x008A */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(16, 30, 16, 50, 0x009D - 0x0090),
    /* 0x0090 */ SCHEDULE_CMD_CHECK_TIME_RANGE_S(16, 50, 16, 55, 0x0097 - 0x0096),
    /* 0x0096 */ SCHEDULE_CMD_RET_NONE(),
    /* 0x0097 */ SCHEDULE_CMD_RET_TIME(16, 50, 16, 55, 9),
    /* 0x009D */ SCHEDULE_CMD_RET_TIME(16, 30, 16, 50, 14),
    /* 0x00A3 */ SCHEDULE_CMD_RET_TIME(16, 10, 16, 30, 3),
    /* 0x00A9 */ SCHEDULE_CMD_RET_TIME(15, 50, 16, 10, 12),
    /* 0x00AF */ SCHEDULE_CMD_RET_TIME(15, 45, 15, 50, 7),
    /* 0x00B5 */ SCHEDULE_CMD_RET_NONE(),
    /* 0x00B6 */ SCHEDULE_CMD_RET_NONE(),
};
