...
static MsgScript D_80BF335C[] = {
    ...
    /* 0x0003 0x05 */ MSCRIPT_BRANCH_ON_WEEK_EVENT_REG(WEEKEVENTREG_RECEIVED_ROOM_KEY, 0x0027 - 0x0008),
    ...
    /* 0x0054 0x03 */ MSCRIPT_BRANCH_ON_CALLBACK(0x0),
    /* 0x0057 0x03 */ MSCRIPT_SET_WEEK_EVENT_REG(WEEKEVENTREG_86_10),
    ...
    /* 0x007E 0x03 */ MSCRIPT_BRANCH_ON_CALLBACK(0x0),
