...
s32 func_80BF1C44(EnIg* this, PlayState* play, ScheduleOutput* arg2, s32 arg3, s32 arg4) {
...
s32 func_80BF1D78(EnIg* this, PlayState* play, ScheduleOutput* arg2) {
    s32 sp2C = 0;
...
s32 func_80BF1DF4(EnIg* this, PlayState* play, ScheduleOutput* arg2) {
...
s32 func_80BF1FA8(EnIg* this, PlayState* play, ScheduleOutput* arg2) {
...
s32 func_80BF219C(EnIg* this, PlayState* play, ScheduleOutput* arg2) {
    u8 sp4F = ENIG_GET_FF(&this->actor);
    Vec3f sp40;
    Vec3f sp34;
    Vec3s* sp30;
...
s32 func_80BF2368(EnIg* this, PlayState* play, ScheduleOutput* arg2) {
    s32 ret = false;
