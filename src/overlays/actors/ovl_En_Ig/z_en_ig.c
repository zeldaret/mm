...
s32 func_80BF1C44(EnIg* this, PlayState* play, ScheduleResult* arg2, s32 arg3, s32 arg4) {
    ...
    if (D_80BF3318[arg2->result] >= 0) {
        this->unk_274 = SubS_GetAdditionalPath(play, sp4F, D_80BF3318[arg2->result]);
    }
...
s32 func_80BF1DF4(EnIg* this, PlayState* play, ScheduleResult* arg2) {
    ...
    if (D_80BF3318[arg2->result] >= 0) {
        this->unk_274 = SubS_GetAdditionalPath(play, sp55, D_80BF3318[arg2->result]);
    }
...
s32 func_80BF1FA8(EnIg* this, PlayState* play, ScheduleResult* arg2) {
    ...
    if (D_80BF3318[arg2->result] >= 0) {
        this->unk_274 = SubS_GetAdditionalPath(play, sp2B, D_80BF3318[arg2->result]);
    }
...
s32 func_80BF2470(EnIg* this, PlayState* play) {
    ...
    if (!SubS_InCsMode(play) && (this->unk_3EC != 0)) {
        if ((door != NULL) && (door->dyna.actor.update != NULL)) {
...
s32 func_80BF25E8(EnIg* this, PlayState* play) {
    ...
    if (!(this->unk_3D0 & 8)) {
        ...
        func_8013B6B0(this->unk_274, &this->unk_284, &this->unk_294, this->unk_28C, this->unk_288, &this->unk_290, sp7C,
                      &sp58, this->unk_3EC);
        func_8013B878(play, this->unk_274, this->unk_290, &sp58);
