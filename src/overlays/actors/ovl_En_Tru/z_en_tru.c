...
static MsgScript D_80A8892C[] = {
    /* 0x0000 0x03 */ MSCRIPT_CHECK_CALLBACK(0x0),
    /* 0x0003 0x03 */ MSCRIPT_CHECK_HUMAN(0x000B - 0x0006),
    ...
    /* 0x0025 0x07 */ MSCRIPT_CHECK_CALLBACK_MULTI(0x0, 0x004A - 0x002C, 0x0053 - 0x002C),
    ...
    /* 0x0045 0x03 */ MSCRIPT_CHECK_CALLBACK(0x0),
...
static MsgScript D_80A88984[] = {
    ...
    /* 0x0003 0x03 */ MSCRIPT_CHECK_CALLBACK(0x0),
