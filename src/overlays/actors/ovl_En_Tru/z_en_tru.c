...
static MsgScript D_80A88918[] = {
    ...
    /* 0x0008 0x01 */ MSCRIPT_UNSET_AUTOTALK(),
...
static MsgScript D_80A8892C[] = {
    ...
    /* 0x000B 0x05 */ MSCRIPT_BRANCH_ON_WEEK_EVENT_REG(WEEKEVENTREG_TALKED_KOUME_INJURED, 0x001B - 0x0010),
    ...
    /* 0x001F 0x03 */ MSCRIPT_WEEK_EVENT_REG_SET(WEEKEVENTREG_TALKED_KOUME_INJURED),
    /* 0x0022 0x03 */ MSCRIPT_BEGIN_TEXT(0x00FF),
    /* 0x0025 0x07 */ MSCRIPT_BRANCH_ON_CALLBACK_MULTI(0x0, 0x004A - 0x002C, 0x0053 - 0x002C),
    /* 0x002C 0x03 */ MSCRIPT_PLAYER_TALK(0x0864),
    /* 0x002F 0x01 */ MSCRIPT_AWAIT_TEXT(),
    /* 0x0030 0x03 */ MSCRIPT_JUMP(0x0),
    ...
    /* 0x0045 0x03 */ MSCRIPT_BRANCH_ON_CALLBACK(0x0),
    /* 0x0048 0x01 */ MSCRIPT_CLOSE_TEXT(),
    /* 0x0049 0x01 */ MSCRIPT_DONE(),

    /* 0x004A 0x03 */ MSCRIPT_PLAYER_TALK(0x0855),
    /* 0x004D 0x01 */ MSCRIPT_AWAIT_TEXT(),
    /* 0x004E 0x03 */ MSCRIPT_JUMP(0x0),
...
static MsgScript D_80A88984[] = {
    /* 0x0000 0x03 */ MSCRIPT_PLAYER_TALK(0xFFFF),
    /* 0x0003 0x03 */ MSCRIPT_BRANCH_ON_CALLBACK(0x0),
