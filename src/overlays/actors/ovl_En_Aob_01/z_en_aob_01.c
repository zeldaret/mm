...
s32 EnAob01_ProcessLaughAnim(EnAob01* this) {
    ...
    if (this->animIndex == EN_AOB01_ANIM_LAUGH_START) {
        if (curFrame == lastFrame) {
            ...
            Actor_ChangeAnimByInfo(&this->skelAnime, sAnimationInfo, EN_AOB01_ANIM_LAUGH_LOOP);
            return true;
        }
...
s32 EnAob01_ProcessSurpriseAnim(EnAob01* this) {
    ...
    if ((this->animIndex == EN_AOB01_ANIM_IDLE_1) || (this->animIndex == EN_AOB01_ANIM_IDLE_2)) {
        if (curFrame == lastFrame) {
            ...
            Actor_ChangeAnimByInfo(&this->skelAnime, sAnimationInfo, EN_AOB01_ANIM_SURPRISE_START);
            return true;
        }
    } else if (this->animIndex == EN_AOB01_ANIM_SURPRISE_START) {
        if (curFrame == lastFrame) {
            this->animIndex = EN_AOB01_ANIM_SURPRISE_LOOP;
            Actor_ChangeAnimByInfo(&this->skelAnime, sAnimationInfo, EN_AOB01_ANIM_SURPRISE_LOOP);
            return true;
        }
...
s32 EnAob01_ProcessIdleAnim(EnAob01* this) {
    ...
    if ((this->animIndex != EN_AOB01_ANIM_IDLE_1) && (this->animIndex != EN_AOB01_ANIM_IDLE_2)) {
        if (curFrame == lastFrame) {
            ...
            Actor_ChangeAnimByInfo(&this->skelAnime, sAnimationInfo, EN_AOB01_ANIM_IDLE_2);
            return true;
        }
    } else {
        return true;
...
void EnAob01_BeforeRace_HandleConversation(EnAob01* this, PlayState* play) {
    ...
    switch (this->textId) {
        ...
        case 0x3523: // Hurry up and bring me a dog!
            ...
            Actor_ChangeAnimByInfo(&this->skelAnime, sAnimationInfo, EN_AOB01_ANIM_LAUGH_START);
            break;
...
void EnAob01_Init(Actor* thisx, PlayState* play) {
    ...
    Actor_ChangeAnimByInfo(&this->skelAnime, sAnimationInfo, EN_AOB01_ANIM_IDLE_1);
