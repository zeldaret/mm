...
ActorInit En_Okarina_Effect_InitVars = {
    ACTOR_EN_OKARINA_EFFECT, ACTORCAT_ITEMACTION,     FLAGS,
    GAMEPLAY_KEEP,           sizeof(EnOkarinaEffect), EnOkarinaEffect_Init,
    EnOkarinaEffect_Destroy, EnOkarinaEffect_Update,  NULL,
};
