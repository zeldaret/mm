...
void func_8096B174(EnOkarinaEffect* this, GlobalContext* globalCtx) {
    DECR(this->unk144);
    if (!globalCtx->pauseCtx.unk1EC && !globalCtx->gameOverCtx.state && !globalCtx->msgCtx.unk11F10 &&
