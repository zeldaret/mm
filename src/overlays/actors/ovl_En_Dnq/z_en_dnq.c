...
s32 func_80A52648(EnDnq* this, PlayState* play) {
    ...
    if (play->csCtx.state != CS_STATE_IDLE) {
        ...
        SubS_UpdateFlags(&this->unk_37C, SUBS_OFFER_MODE_NONE, SUBS_OFFER_MODE_MAX);
        ret = true;
    } else {
        if (this->unk_37C & 0x20) {
            this->picto.actor.flags |= ACTOR_FLAG_1;
            this->cueId = 255;
            this->unk_37C &= ~0x20;
            SubS_UpdateFlags(&this->unk_37C, SUBS_OFFER_MODE_ONSCREEN, SUBS_OFFER_MODE_MAX);
        }
    }
...
s32 func_80A52D44(EnDnq* this, PlayState* play) {
    ...
    if (((this->unk_37C & SUBS_OFFER_MODE_MAX) != SUBS_OFFER_MODE_NONE) &&
...
void EnDnq_Update(Actor* thisx, PlayState* play) {
    ...
    if (!func_80A52D44(this, play) && func_80A52648(this, play)) {
        ...
        this->unk_394 = this->picto.actor.xzDistToPlayer;
        func_80A52C6C(this, play);
        SubS_OfferItem(&this->picto.actor, play, this->unk_390, fabsf(this->picto.actor.playerHeightRel) + 1.0f,
                       PLAYER_IA_NONE, this->unk_37C & SUBS_OFFER_MODE_MAX);
        this->picto.actor.xzDistToPlayer = this->unk_394;
