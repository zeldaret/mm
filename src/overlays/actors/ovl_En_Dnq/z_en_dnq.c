...
static MsgScript D_80A53400[] = {
    /* 0x0000 0x05 */ MSCRIPT_BRANCH_ON_WEEK_EVENT_REG(WEEKEVENTREG_18_01, 0x001A - 0x0005),
    ...
    /* 0x0016 0x03 */ MSCRIPT_SET_WEEK_EVENT_REG(WEEKEVENTREG_18_01),
...
static MsgScript D_80A53420[] = {
    /* 0x0000 0x05 */ MSCRIPT_BRANCH_ON_WEEK_EVENT_REG(WEEKEVENTREG_18_02, 0x0011 - 0x0005),
    /* 0x0005 0x03 */ MSCRIPT_BEGIN_TEXT(0x089D),
    /* 0x0008 0x01 */ MSCRIPT_AWAIT_TEXT(),
    /* 0x0009 0x03 */ MSCRIPT_CONTINUE_TEXT(0x089E),
    /* 0x000C 0x01 */ MSCRIPT_AWAIT_TEXT(),
    /* 0x000D 0x03 */ MSCRIPT_SET_WEEK_EVENT_REG(WEEKEVENTREG_18_02),
...
s32 func_80A52D44(EnDnq* this, PlayState* play) {
    ...
    if (((this->unk_37C & SUBS_OFFER_MODE_MASK) != SUBS_OFFER_MODE_NONE) &&
        ...
        SubS_SetOfferMode(&this->unk_37C, SUBS_OFFER_MODE_NONE, SUBS_OFFER_MODE_MASK);
        this->msgEventScript = func_80A52CF8(this, play);
...
void func_80A52FB8(EnDnq* this, PlayState* play) {
    ...
    if (MsgEvent_RunScript(&this->picto.actor, play, this->msgEventScript, NULL, &this->msgEventScriptPos)) {
        SubS_SetOfferMode(&this->unk_37C, SUBS_OFFER_MODE_ONSCREEN, SUBS_OFFER_MODE_MASK);
        this->unk_386 = 0;
