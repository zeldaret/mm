...
void func_8096FBB8(EnKakasi* this, PlayState* play) {
    if ((play->msgCtx.lastOcarinaButtonIndex == OCARINA_BTN_A) ||
        (play->msgCtx.lastOcarinaButtonIndex == OCARINA_BTN_C_DOWN) ||
        (play->msgCtx.lastOcarinaButtonIndex == OCARINA_BTN_C_RIGHT) ||
        (play->msgCtx.lastOcarinaButtonIndex == OCARINA_BTN_C_LEFT) ||
        (play->msgCtx.lastOcarinaButtonIndex == OCARINA_BTN_C_UP)) {
