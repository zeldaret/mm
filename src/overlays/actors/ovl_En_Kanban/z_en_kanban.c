...
extern Gfx D_06000CB0[];
extern Gfx D_06000DB8[];
extern Gfx D_06000E78[];
extern Gfx D_06000F38[];
extern Gfx D_06000FF8[];
extern Gfx D_060010B8[];
extern Gfx D_060011C0[];
extern Gfx D_060012C8[];
extern Gfx D_060013D0[];
extern Gfx D_06001488[];
extern Gfx D_06001540[];
    ...
    switch (this->actionState) {
        case ENKANBAN_SIGN:
                ...
                if (this->unk_19C != this->collider.base.ac) {
                    ...
                    if (piece != NULL) {
                        ...
                        piece->actor.world.rot.y =
                            BINANG_ROT180((s32)randPlusMinusPoint5Scaled(16384.0f) + this->actor.yawTowardsPlayer);
            ...
            if (this->cutMarkTimer != 0) {
                if (this->cutMarkTimer >= 5) {
                    ...
                    if (this->cutMarkAlpha >= 0x100) {
                        this->cutMarkAlpha = 0xFF;
                    }
                } else {
            ...
            if (onGround) {
                ...
                if (this->bounceCount <= 0) {
                    ...
                    if (this->unk_197 != 0) {
                        ...
                        this->actor.world.rot.y += (s16)randPlusMinusPoint5Scaled(16384.0f);
                    }
                    bounced = true;
                } else {
                    this->actor.velocity.y = 0.0f;
        ...
        nextCase:
            ...
            if (this->actionState == ENKANBAN_WATER) {
                ...
                this->spinVel.y = randPlusMinusPoint5Scaled(6144.0f);
...
static Gfx* sDisplayLists[] = {
    D_06000CB0, D_06000DB8, D_06000E78, D_06000F38, D_06000FF8, D_060010B8,
    D_060011C0, D_060012C8, D_060013D0, D_06001488, D_06001540,
};

#include "z_en_kanban_gfx.h"
...
void EnKanban_Draw(Actor* thisx, GlobalContext* globalCtx) {
    ...
    if ((this->actor.projectedPos.z <= 400.0f) && (this->actor.projectedPos.z > 0.0f) &&
        ...
        if (this->actionState == ENKANBAN_SIGN) {
            Matrix_RotateStateAroundXAxis(-0.62831855f);
        }
