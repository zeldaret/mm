...
void EnMinislime_AddIceShardEffect(EnMinislime* this) {
    ...
    this->frozenAlpha = 0;
    Actor_PlaySfxAtProjectedPos(&this->actor, NA_SE_EV_ICE_BROKEN);
}
...
void EnMinislime_SetupGrowAndShrink(EnMinislime* this) {
    ...
    Actor_PlaySfxAtProjectedPos(&this->actor, NA_SE_EN_SLIME_JUMP2);
...
void EnMinislime_SetupBounce(EnMinislime* this) {
    ...
    Actor_PlaySfxAtProjectedPos(&this->actor, NA_SE_EN_SLIME_JUMP1);
