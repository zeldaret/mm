...
void EnSyatekiWf_SetupRun(EnSyatekiWf* this) {
    Actor_ChangeAnimByInfo(&this->skelAnime, sAnimationInfo, EN_SYATEKI_WF_ANIM_RUN);
...
void EnSyatekiWf_SetupJump(EnSyatekiWf* this) {
    ...
    Actor_ChangeAnimByInfo(&this->skelAnime, sAnimationInfo, EN_SYATEKI_WF_ANIM_JUMP);
...
void EnSyatekiWf_SetupLand(EnSyatekiWf* this) {
    this->actor.speed = 0.0f;
    Actor_ChangeAnimByInfo(&this->skelAnime, sAnimationInfo, EN_SYATEKI_WF_ANIM_LAND);
...
void EnSyatekiWf_SetupHowl(EnSyatekiWf* this) {
    ...
    Actor_ChangeAnimByInfo(&this->skelAnime, sAnimationInfo, EN_SYATEKI_WF_ANIM_DAMAGED);
...
void EnSyatekiWf_SetupDead(EnSyatekiWf* this, PlayState* play) {
    ...
    Actor_ChangeAnimByInfo(&this->skelAnime, sAnimationInfo, EN_SYATEKI_WF_ANIM_REAR_UP_FALL_OVER);
