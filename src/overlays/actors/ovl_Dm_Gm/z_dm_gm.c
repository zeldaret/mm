...
s32 DmGm_UpdateAnim(DmGm* this, PlayState* play) {
    ...
    if (play->csCtx.state != CS_STATE_IDLE) {
        ...
        if (Cutscene_IsCueInChannel(play, CS_CMD_ACTOR_CUE_557)) {
            ...
            if (this->cueId != (u8)cueId) {
                this->cueId = cueId;
                this->unk_2D4 = 1;
                DmGm_ChangeAnim(this, play, sp28[cueId]);
            }
        ...
        this->unk_2D0 = 0;
        this->unk_2D4 = 0;
        DmGm_ChangeAnim(this, play, this->unk_2CC);
    }
}
