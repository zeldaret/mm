...
MsgScript D_80B2C23C[] = {
    ...
    /* 0x0007 0x07 */ MSCRIPT_BRANCH_ON_CALLBACK_MULTI(0x0, 0x003F - 0x000E, 0x0047 - 0x000E),
    /* 0x000E 0x03 */ MSCRIPT_BRANCH_ON_CALLBACK_CONTINUE(0x001B - 0x0011),
    /* 0x0011 0x01 */ MSCRIPT_CLOSE_TEXT(),
    /* 0x0012 0x03 */ MSCRIPT_PLAYER_TALK(0x27A4),
    ...
    /* 0x001C 0x03 */ MSCRIPT_PLAYER_TALK(0x2787),
    /* 0x001F 0x01 */ MSCRIPT_AWAIT_TEXT(),
    /* 0x0020 0x03 */ MSCRIPT_JUMP_3(0x0),
    /* 0x0023 0x01 */ MSCRIPT_AWAIT_TEXT(),
    /* 0x0024 0x03 */ MSCRIPT_SET_WEEK_EVENT_REG(WEEKEVENTREG_DEPOSITED_LETTER_TO_KAFEI_SOUTH_UPPER_CLOCKTOWN),
    /* 0x0027 0x03 */ MSCRIPT_DELETE_ITEM(ITEM_LETTER_TO_KAFEI),
    /* 0x002A 0x05 */ MSCRIPT_BRANCH_ON_WEEK_EVENT_REG(WEEKEVENTREG_27_40, 0x0037 - 0x002F),
    ...
    /* 0x0040 0x03 */ MSCRIPT_PLAYER_TALK(0x2785),
...
MsgScript D_80B2C288[] = {
    ...
    /* 0x0020 0x03 */ MSCRIPT_JUMP_3(0x0),
    /* 0x0023 0x01 */ MSCRIPT_AWAIT_TEXT(),
    /* 0x0024 0x03 */ MSCRIPT_SET_WEEK_EVENT_REG(WEEKEVENTREG_DEPOSITED_LETTER_TO_KAFEI_NORTH_CLOCKTOWN),
    /* 0x0027 0x03 */ MSCRIPT_DELETE_ITEM(ITEM_LETTER_TO_KAFEI),
    /* 0x002A 0x05 */ MSCRIPT_BRANCH_ON_WEEK_EVENT_REG(WEEKEVENTREG_27_80, 0x0037 - 0x002F),
    /* 0x002F 0x03 */ MSCRIPT_CONTINUE_TEXT(0x2788),
    /* 0x0032 0x03 */ MSCRIPT_NOTEBOOK_EVENT(BOMBERS_NOTEBOOK_EVENT_DEPOSITED_LETTER_TO_KAFEI),
    /* 0x0035 0x01 */ MSCRIPT_AWAIT_TEXT(),
    /* 0x0036 0x01 */ MSCRIPT_DONE(),
...
MsgScript D_80B2C2D4[] = {
    ...
    /* 0x0020 0x03 */ MSCRIPT_JUMP_3(0x0),
    /* 0x0023 0x01 */ MSCRIPT_AWAIT_TEXT(),
    /* 0x0024 0x03 */ MSCRIPT_SET_WEEK_EVENT_REG(WEEKEVENTREG_DEPOSITED_LETTER_TO_KAFEI_EAST_UPPER_CLOCKTOWN),
    /* 0x0027 0x03 */ MSCRIPT_DELETE_ITEM(ITEM_LETTER_TO_KAFEI),
    /* 0x002A 0x05 */ MSCRIPT_BRANCH_ON_WEEK_EVENT_REG(WEEKEVENTREG_28_01, 0x0037 - 0x002F),
    /* 0x002F 0x03 */ MSCRIPT_CONTINUE_TEXT(0x2788),
    /* 0x0032 0x03 */ MSCRIPT_NOTEBOOK_EVENT(BOMBERS_NOTEBOOK_EVENT_DEPOSITED_LETTER_TO_KAFEI),
    /* 0x0035 0x01 */ MSCRIPT_AWAIT_TEXT(),
    /* 0x0036 0x01 */ MSCRIPT_DONE(),
...
MsgScript D_80B2C320[] = {
    ...
    /* 0x0020 0x03 */ MSCRIPT_JUMP_3(0x0),
    /* 0x0023 0x01 */ MSCRIPT_AWAIT_TEXT(),
    /* 0x0024 0x03 */ MSCRIPT_SET_WEEK_EVENT_REG(WEEKEVENTREG_DEPOSITED_LETTER_TO_KAFEI_EAST_LOWER_CLOCKTOWN),
    /* 0x0027 0x03 */ MSCRIPT_DELETE_ITEM(ITEM_LETTER_TO_KAFEI),
    /* 0x002A 0x05 */ MSCRIPT_BRANCH_ON_WEEK_EVENT_REG(WEEKEVENTREG_28_02, 0x0037 - 0x002F),
    /* 0x002F 0x03 */ MSCRIPT_CONTINUE_TEXT(0x2788),
    /* 0x0032 0x03 */ MSCRIPT_NOTEBOOK_EVENT(BOMBERS_NOTEBOOK_EVENT_DEPOSITED_LETTER_TO_KAFEI),
    /* 0x0035 0x01 */ MSCRIPT_AWAIT_TEXT(),
    /* 0x0036 0x01 */ MSCRIPT_DONE(),
...
MsgScript D_80B2C36C[] = {
    ...
    /* 0x0020 0x03 */ MSCRIPT_JUMP_3(0x0),
    /* 0x0023 0x01 */ MSCRIPT_AWAIT_TEXT(),
    /* 0x0024 0x03 */ MSCRIPT_SET_WEEK_EVENT_REG(WEEKEVENTREG_DEPOSITED_LETTER_TO_KAFEI_SOUTH_LOWER_CLOCKTOWN),
    /* 0x0027 0x03 */ MSCRIPT_DELETE_ITEM(ITEM_LETTER_TO_KAFEI),
    /* 0x002A 0x05 */ MSCRIPT_BRANCH_ON_WEEK_EVENT_REG(WEEKEVENTREG_28_04, 0x0037 - 0x002F),
    /* 0x002F 0x03 */ MSCRIPT_CONTINUE_TEXT(0x2788),
    /* 0x0032 0x03 */ MSCRIPT_NOTEBOOK_EVENT(BOMBERS_NOTEBOOK_EVENT_DEPOSITED_LETTER_TO_KAFEI),
    /* 0x0035 0x01 */ MSCRIPT_AWAIT_TEXT(),
    /* 0x0036 0x01 */ MSCRIPT_DONE(),
...
MsgScript D_80B2C3B8[] = {
    ...
    /* 0x0009 0x05 */ MSCRIPT_BRANCH_ON_WEEK_EVENT_REG(WEEKEVENTREG_81_08, 0x001D - 0x000E),
    /* 0x000E 0x05 */ MSCRIPT_OFFER_ITEM(GI_HEART_PIECE, 0x0),
    /* 0x0013 0x03 */ MSCRIPT_SET_COLLECTIBLE(0x000C),
    /* 0x0016 0x01 */ MSCRIPT_AWAIT_TEXT(),
    /* 0x0017 0x03 */ MSCRIPT_SET_WEEK_EVENT_REG(WEEKEVENTREG_81_08),
    /* 0x001A 0x03 */ MSCRIPT_AUTOTALK(0x0029 - 0x001D),
    /* 0x001D 0x05 */ MSCRIPT_OFFER_ITEM(GI_RUPEE_GREEN, 0x0),
    /* 0x0022 0x03 */ MSCRIPT_SET_COLLECTIBLE(0x0001),
    /* 0x0025 0x01 */ MSCRIPT_AWAIT_TEXT(),
    /* 0x0026 0x03 */ MSCRIPT_AUTOTALK(0x0),
    /* 0x0029 0x03 */ MSCRIPT_BEGIN_TEXT(0x27A3),
    /* 0x002C 0x01 */ MSCRIPT_AWAIT_TEXT(),
    /* 0x002D 0x01 */ MSCRIPT_UNSET_AUTOTALK(),
    /* 0x002E 0x01 */ MSCRIPT_DONE(),
};

MsgScript D_80B2C3E8[] = {
    /* 0x0000 0x03 */ MSCRIPT_PLAYER_TALK(0x2787),
    /* 0x0003 0x01 */ MSCRIPT_AWAIT_TEXT(),
    /* 0x0004 0x03 */ MSCRIPT_SET_WEEK_EVENT_REG(WEEKEVENTREG_DEPOSITED_LETTER_TO_KAFEI_SOUTH_UPPER_CLOCKTOWN),
    /* 0x0007 0x03 */ MSCRIPT_DELETE_ITEM(ITEM_LETTER_TO_KAFEI),
    /* 0x000A 0x05 */ MSCRIPT_BRANCH_ON_WEEK_EVENT_REG(WEEKEVENTREG_27_40, 0x0017 - 0x000F),
...
MsgScript D_80B2C408[] = {
    /* 0x0000 0x03 */ MSCRIPT_PLAYER_TALK(0x2787),
    /* 0x0003 0x01 */ MSCRIPT_AWAIT_TEXT(),
    /* 0x0004 0x03 */ MSCRIPT_SET_WEEK_EVENT_REG(WEEKEVENTREG_DEPOSITED_LETTER_TO_KAFEI_NORTH_CLOCKTOWN),
    /* 0x0007 0x03 */ MSCRIPT_DELETE_ITEM(ITEM_LETTER_TO_KAFEI),
    /* 0x000A 0x05 */ MSCRIPT_BRANCH_ON_WEEK_EVENT_REG(WEEKEVENTREG_27_80, 0x0017 - 0x000F),
    /* 0x000F 0x03 */ MSCRIPT_CONTINUE_TEXT(0x2788),
    /* 0x0012 0x03 */ MSCRIPT_NOTEBOOK_EVENT(BOMBERS_NOTEBOOK_EVENT_DEPOSITED_LETTER_TO_KAFEI),
    /* 0x0015 0x01 */ MSCRIPT_AWAIT_TEXT(),
    /* 0x0016 0x01 */ MSCRIPT_DONE(),
...
MsgScript D_80B2C428[] = {
    /* 0x0000 0x03 */ MSCRIPT_PLAYER_TALK(0x2787),
    /* 0x0003 0x01 */ MSCRIPT_AWAIT_TEXT(),
    /* 0x0004 0x03 */ MSCRIPT_SET_WEEK_EVENT_REG(WEEKEVENTREG_DEPOSITED_LETTER_TO_KAFEI_EAST_UPPER_CLOCKTOWN),
    /* 0x0007 0x03 */ MSCRIPT_DELETE_ITEM(ITEM_LETTER_TO_KAFEI),
    /* 0x000A 0x05 */ MSCRIPT_BRANCH_ON_WEEK_EVENT_REG(WEEKEVENTREG_28_01, 0x0017 - 0x000F),
    /* 0x000F 0x03 */ MSCRIPT_CONTINUE_TEXT(0x2788),
    /* 0x0012 0x03 */ MSCRIPT_NOTEBOOK_EVENT(BOMBERS_NOTEBOOK_EVENT_DEPOSITED_LETTER_TO_KAFEI),
    /* 0x0015 0x01 */ MSCRIPT_AWAIT_TEXT(),
    /* 0x0016 0x01 */ MSCRIPT_DONE(),
...
MsgScript D_80B2C448[] = {
    /* 0x0000 0x03 */ MSCRIPT_PLAYER_TALK(0x2787),
    /* 0x0003 0x01 */ MSCRIPT_AWAIT_TEXT(),
    /* 0x0004 0x03 */ MSCRIPT_SET_WEEK_EVENT_REG(WEEKEVENTREG_DEPOSITED_LETTER_TO_KAFEI_EAST_LOWER_CLOCKTOWN),
    /* 0x0007 0x03 */ MSCRIPT_DELETE_ITEM(ITEM_LETTER_TO_KAFEI),
    /* 0x000A 0x05 */ MSCRIPT_BRANCH_ON_WEEK_EVENT_REG(WEEKEVENTREG_28_02, 0x0017 - 0x000F),
    /* 0x000F 0x03 */ MSCRIPT_CONTINUE_TEXT(0x2788),
    /* 0x0012 0x03 */ MSCRIPT_NOTEBOOK_EVENT(BOMBERS_NOTEBOOK_EVENT_DEPOSITED_LETTER_TO_KAFEI),
    /* 0x0015 0x01 */ MSCRIPT_AWAIT_TEXT(),
    /* 0x0016 0x01 */ MSCRIPT_DONE(),
...
MsgScript D_80B2C468[] = {
    /* 0x0000 0x03 */ MSCRIPT_PLAYER_TALK(0x2787),
    /* 0x0003 0x01 */ MSCRIPT_AWAIT_TEXT(),
    /* 0x0004 0x03 */ MSCRIPT_SET_WEEK_EVENT_REG(WEEKEVENTREG_DEPOSITED_LETTER_TO_KAFEI_SOUTH_LOWER_CLOCKTOWN),
    /* 0x0007 0x03 */ MSCRIPT_DELETE_ITEM(ITEM_LETTER_TO_KAFEI),
    /* 0x000A 0x05 */ MSCRIPT_BRANCH_ON_WEEK_EVENT_REG(WEEKEVENTREG_28_04, 0x0017 - 0x000F),
    /* 0x000F 0x03 */ MSCRIPT_CONTINUE_TEXT(0x2788),
    /* 0x0012 0x03 */ MSCRIPT_NOTEBOOK_EVENT(BOMBERS_NOTEBOOK_EVENT_DEPOSITED_LETTER_TO_KAFEI),
    /* 0x0015 0x01 */ MSCRIPT_AWAIT_TEXT(),
    /* 0x0016 0x01 */ MSCRIPT_DONE(),
...
MsgScript D_80B2C488[] = {
    /* 0x0000 0x03 */ MSCRIPT_PLAYER_TALK(0x27A4),
    /* 0x0003 0x01 */ MSCRIPT_AWAIT_TEXT(),
    /* 0x0004 0x01 */ MSCRIPT_DONE(),
};

MsgScript D_80B2C490[] = {
    /* 0x0000 0x03 */ MSCRIPT_PLAYER_TALK(0x2785),
    /* 0x0003 0x01 */ MSCRIPT_AWAIT_TEXT(),
    /* 0x0004 0x01 */ MSCRIPT_DONE(),
};
