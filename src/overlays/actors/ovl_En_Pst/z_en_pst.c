...
MsgScript D_80B2C23C[] = {
    ...
    /* 0x0020 0x03 */ MSCRIPT_JUMP(0x0),
    /* 0x0023 0x01 */ MSCRIPT_AWAIT_TEXT(),
    /* 0x0024 0x03 */ MSCRIPT_WEEK_EVENT_REG_SET(WEEKEVENTREG_DEPOSITED_LETTER_TO_KAFEI_SOUTH_UPPER_CLOCKTOWN),
    ...
    /* 0x0044 0x03 */ MSCRIPT_JUMP(0x0019 - 0x0047),
...
MsgScript D_80B2C288[] = {
    ...
    /* 0x0020 0x03 */ MSCRIPT_JUMP(0x0),
    /* 0x0023 0x01 */ MSCRIPT_AWAIT_TEXT(),
    /* 0x0024 0x03 */ MSCRIPT_WEEK_EVENT_REG_SET(WEEKEVENTREG_DEPOSITED_LETTER_TO_KAFEI_NORTH_CLOCKTOWN),
    /* 0x0027 0x03 */ MSCRIPT_DEL_ITEM(ITEM_LETTER_TO_KAFEI),
...
MsgScript D_80B2C2D4[] = {
    ...
    /* 0x0020 0x03 */ MSCRIPT_JUMP(0x0),
    /* 0x0023 0x01 */ MSCRIPT_AWAIT_TEXT(),
    /* 0x0024 0x03 */ MSCRIPT_WEEK_EVENT_REG_SET(WEEKEVENTREG_DEPOSITED_LETTER_TO_KAFEI_EAST_UPPER_CLOCKTOWN),
    /* 0x0027 0x03 */ MSCRIPT_DEL_ITEM(ITEM_LETTER_TO_KAFEI),
...
MsgScript D_80B2C320[] = {
    ...
    /* 0x0020 0x03 */ MSCRIPT_JUMP(0x0),
    /* 0x0023 0x01 */ MSCRIPT_AWAIT_TEXT(),
    /* 0x0024 0x03 */ MSCRIPT_WEEK_EVENT_REG_SET(WEEKEVENTREG_DEPOSITED_LETTER_TO_KAFEI_EAST_LOWER_CLOCKTOWN),
    /* 0x0027 0x03 */ MSCRIPT_DEL_ITEM(ITEM_LETTER_TO_KAFEI),
...
MsgScript D_80B2C36C[] = {
    ...
    /* 0x0020 0x03 */ MSCRIPT_JUMP(0x0),
    /* 0x0023 0x01 */ MSCRIPT_AWAIT_TEXT(),
    /* 0x0024 0x03 */ MSCRIPT_WEEK_EVENT_REG_SET(WEEKEVENTREG_DEPOSITED_LETTER_TO_KAFEI_SOUTH_LOWER_CLOCKTOWN),
    /* 0x0027 0x03 */ MSCRIPT_DEL_ITEM(ITEM_LETTER_TO_KAFEI),
...
MsgScript D_80B2C3B8[] = {
    ...
    /* 0x0017 0x03 */ MSCRIPT_WEEK_EVENT_REG_SET(WEEKEVENTREG_81_08),
...
MsgScript D_80B2C3E8[] = {
    ...
    /* 0x0003 0x01 */ MSCRIPT_AWAIT_TEXT(),
    /* 0x0004 0x03 */ MSCRIPT_WEEK_EVENT_REG_SET(WEEKEVENTREG_DEPOSITED_LETTER_TO_KAFEI_SOUTH_UPPER_CLOCKTOWN),
...
MsgScript D_80B2C408[] = {
    /* 0x0000 0x03 */ MSCRIPT_PLAYER_TALK(0x2787),
    /* 0x0003 0x01 */ MSCRIPT_AWAIT_TEXT(),
    /* 0x0004 0x03 */ MSCRIPT_WEEK_EVENT_REG_SET(WEEKEVENTREG_DEPOSITED_LETTER_TO_KAFEI_NORTH_CLOCKTOWN),
    /* 0x0007 0x03 */ MSCRIPT_DEL_ITEM(ITEM_LETTER_TO_KAFEI),
...
MsgScript D_80B2C428[] = {
    /* 0x0000 0x03 */ MSCRIPT_PLAYER_TALK(0x2787),
    /* 0x0003 0x01 */ MSCRIPT_AWAIT_TEXT(),
    /* 0x0004 0x03 */ MSCRIPT_WEEK_EVENT_REG_SET(WEEKEVENTREG_DEPOSITED_LETTER_TO_KAFEI_EAST_UPPER_CLOCKTOWN),
    /* 0x0007 0x03 */ MSCRIPT_DEL_ITEM(ITEM_LETTER_TO_KAFEI),
...
MsgScript D_80B2C448[] = {
    /* 0x0000 0x03 */ MSCRIPT_PLAYER_TALK(0x2787),
    /* 0x0003 0x01 */ MSCRIPT_AWAIT_TEXT(),
    /* 0x0004 0x03 */ MSCRIPT_WEEK_EVENT_REG_SET(WEEKEVENTREG_DEPOSITED_LETTER_TO_KAFEI_EAST_LOWER_CLOCKTOWN),
    /* 0x0007 0x03 */ MSCRIPT_DEL_ITEM(ITEM_LETTER_TO_KAFEI),
...
MsgScript D_80B2C468[] = {
    /* 0x0000 0x03 */ MSCRIPT_PLAYER_TALK(0x2787),
    /* 0x0003 0x01 */ MSCRIPT_AWAIT_TEXT(),
    /* 0x0004 0x03 */ MSCRIPT_WEEK_EVENT_REG_SET(WEEKEVENTREG_DEPOSITED_LETTER_TO_KAFEI_SOUTH_LOWER_CLOCKTOWN),
    /* 0x0007 0x03 */ MSCRIPT_DEL_ITEM(ITEM_LETTER_TO_KAFEI),
