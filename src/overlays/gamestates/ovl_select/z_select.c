...
const char* D_80802334[12] = {
    ...
    "\x8C" "ｺｰﾋｰ ﾌﾞﾚｲｸ",
    "\x8C" "Bﾒﾝｦｾｯﾄｼﾃｸﾀﾞｻｲ",
    "\x8D" "ｼﾞｯﾄ" "\x8C" "ｶﾞﾏﾝ" "\x8D" "ﾉ" "\x8C" "ｺ" "\x8D" "ﾃﾞｱｯﾀ",
    "\x8D" "ｲﾏｼﾊﾞﾗｸｵﾏﾁｸﾀﾞｻｲ",
    "\x8D" "ｱﾜﾃﾅｲｱﾜﾃﾅｲ｡ﾋﾄﾔｽﾐﾋﾄﾔｽﾐ｡",
};
...
void func_808016E8(SelectContext* this, GfxPrint* printer, u16 arg2) {
    ...
    switch (arg2) {
        case 0:
            // clang-format off
            gSaveContext.time = CLOCK_TIME(12, 0); phi_a2 = "\x8D" "ｵﾋﾙ\x8Cｼﾞｬﾗ";
            // clang-format on
            break;

        case 0x8000:

            gSaveContext.time = CLOCK_TIME(6, 0)+1; phi_a2 = "\x8D" "ｱｻ \x8Cｼﾞｬﾗ";
            // clang-format on
            break;
