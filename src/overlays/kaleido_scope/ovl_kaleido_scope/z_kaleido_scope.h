...
typedef enum {
    /* 0x00 */ PAUSE_MAINSTATE_IDLE,
    /* 0x01 */ PAUSE_MAINSTATE_SWITCHING_PAGE,
    /* 0x02 */ PAUSE_MAINSTATE_SONG_PLAYBACK,
    /* 0x03 */ PAUSE_MAINSTATE_EQUIP_ITEM,
    /* 0x04 */ PAUSE_MAINSTATE_SONG_PLAYER_PLAYING_INIT,
    /* 0x05 */ PAUSE_MAINSTATE_SONG_PLAYER_PLAYING,
    /* 0x06 */ PAUSE_MAINSTATE_SONG_PLAYER_PLAYING_DONE,
    /* 0x07 */ PAUSE_MAINSTATE_7,
    /* 0x08 */ PAUSE_MAINSTATE_IDLE_CURSOR_ON_SONG,
    /* 0x09 */ PAUSE_MAINSTATE_9,
    /* 0x0A */ PAUSE_MAINSTATE_A,
    /* 0x0B */ PAUSE_MAINSTATE_B,
    /* 0x0C */ PAUSE_MAINSTATE_C,
