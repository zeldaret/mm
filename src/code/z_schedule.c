...
s32 Schedule_CheckFlagS(GlobalContext* globalCtx, u8** script, ScheduleOutput* output) {
...
s32 Schedule_CheckFlagL(GlobalContext* globalCtx, u8** script, ScheduleOutput* output) {
...
s32 Schedule_CheckTimeRangeS(GlobalContext* globalCtx, u8** script, ScheduleOutput* output) {
    s32 inRange = false;
...
s32 Schedule_CheckTimeRangeL(GlobalContext* globalCtx, u8** script, ScheduleOutput* output) {
    s32 inRange = false;
...
s32 Schedule_ReturnValueL(GlobalContext* globalCtx, u8** script, ScheduleOutput* output) {
...
s32 Schedule_ReturnNone(GlobalContext* globalCtx, u8** script, ScheduleOutput* output) {
    output->hasResult = false;

    return true;
}

s32 Schedule_ReturnEmpty(GlobalContext* globalCtx, u8** script, ScheduleOutput* output) {
    output->hasResult = true;

    return true;
}

s32 Schedule_Nop(GlobalContext* globalCtx, u8** script, ScheduleOutput* output) {
    return false;
}

s32 Schedule_CheckMiscS(GlobalContext* globalCtx, u8** script, ScheduleOutput* output) {
...
s32 Schedule_ReturnValueS(GlobalContext* globalCtx, u8** script, ScheduleOutput* output) {
...
s32 Schedule_CheckNotInSceneS(GlobalContext* globalCtx, u8** script, ScheduleOutput* output) {
...
s32 Schedule_CheckNotInSceneL(GlobalContext* globalCtx, u8** script, ScheduleOutput* output) {
...
s32 Schedule_CheckNotInDayS(GlobalContext* globalCtx, u8** script, ScheduleOutput* output) {
...
s32 Schedule_CheckNotInDayL(GlobalContext* globalCtx, u8** script, ScheduleOutput* output) {
...
s32 Schedule_ReturnTime(GlobalContext* globalCtx, u8** script, ScheduleOutput* output) {
...
s32 Schedule_CheckBeforeTimeS(GlobalContext* globalCtx, u8** script, ScheduleOutput* output) {
...
s32 Schedule_CheckBeforeTimeL(GlobalContext* globalCtx, u8** script, ScheduleOutput* output) {
...
s32 Schedule_BranchS(GlobalContext* globalCtx, u8** script, ScheduleOutput* output) {
...
s32 Schedule_BranchL(GlobalContext* globalCtx, u8** script, ScheduleOutput* output) {
...
static s32 (*sScheduleCmdFuncs[])(GlobalContext*, u8**, ScheduleOutput*) = {
...
s32 Schedule_RunScript(GlobalContext* globalCtx, u8* script, ScheduleOutput* output) {
    ...
    do {
        ...
        stop = (*sScheduleCmdFuncs[*script])(globalCtx, &script, output);
        script += size;
    } while (!stop);
