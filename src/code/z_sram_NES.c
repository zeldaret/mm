...
#define DEFINE_SCENE(_name, _enumValue, _textId, _drawConfig, _restrictionFlags, switch0, switch1, chest, collectible) \
    { switch0, switch1, chest, collectible },

#define DEFINE_SCENE_UNSET(_enumValue) { 0, 0, 0, 0 },
