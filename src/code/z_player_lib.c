...
u8 sActionModelGroups[PLAYER_AP_MAX] = {
    ...
    PLAYER_MODELGROUP_2,   // PLAYER_AP_SWORD_KOKIRI
    PLAYER_MODELGROUP_2,   // PLAYER_AP_SWORD_RAZOR
    PLAYER_MODELGROUP_2,   // PLAYER_AP_SWORD_GILDED
    PLAYER_MODELGROUP_5,   // PLAYER_AP_SWORD_GREAT_FAIRY
    PLAYER_MODELGROUP_10, // PLAYER_AP_STICK
    PLAYER_MODELGROUP_14, // PLAYER_AP_ZORA_FINS
    PLAYER_MODELGROUP_6,   // PLAYER_AP_BOW
    PLAYER_MODELGROUP_6,   // PLAYER_AP_BOW_FIRE
    PLAYER_MODELGROUP_6,   // PLAYER_AP_BOW_ICE
    PLAYER_MODELGROUP_6,   // PLAYER_AP_BOW_LIGHT
    PLAYER_MODELGROUP_9,   // PLAYER_AP_HOOKSHOT
    PLAYER_MODELGROUP_7,   // PLAYER_AP_BOMB
    PLAYER_MODELGROUP_7,   // PLAYER_AP_POWDER_KEG
    PLAYER_MODELGROUP_7,   // PLAYER_AP_BOMBCHU
    PLAYER_MODELGROUP_8,   // PLAYER_AP_11
    PLAYER_MODELGROUP_DEFAULT,   // PLAYER_AP_NUT
    PLAYER_MODELGROUP_DEFAULT,   // PLAYER_AP_PICTO_BOX
    PLAYER_MODELGROUP_11,// PLAYER_AP_OCARINA
    PLAYER_MODELGROUP_12, // PLAYER_AP_BOTTLE
    PLAYER_MODELGROUP_12, // PLAYER_AP_BOTTLE_FISH
    PLAYER_MODELGROUP_12, // PLAYER_AP_BOTTLE_SPRING_WATER
    PLAYER_MODELGROUP_12, // PLAYER_AP_BOTTLE_HOT_SPRING_WATER
    PLAYER_MODELGROUP_12, // PLAYER_AP_BOTTLE_ZORA_EGG
    PLAYER_MODELGROUP_12, // PLAYER_AP_BOTTLE_DEKU_PRINCESS
    PLAYER_MODELGROUP_12, // PLAYER_AP_BOTTLE_GOLD_DUST
    PLAYER_MODELGROUP_12, // PLAYER_AP_BOTTLE_1C
    PLAYER_MODELGROUP_12, // PLAYER_AP_BOTTLE_SEA_HORSE
    PLAYER_MODELGROUP_12, // PLAYER_AP_BOTTLE_MUSHROOM
    PLAYER_MODELGROUP_12, // PLAYER_AP_BOTTLE_HYLIAN_LOACH
    PLAYER_MODELGROUP_12, // PLAYER_AP_BOTTLE_BUG
    PLAYER_MODELGROUP_12, // PLAYER_AP_BOTTLE_POE
    PLAYER_MODELGROUP_12, // PLAYER_AP_BOTTLE_BIG_POE
    PLAYER_MODELGROUP_12, // PLAYER_AP_BOTTLE_POTION_RED
    PLAYER_MODELGROUP_12, // PLAYER_AP_BOTTLE_POTION_BLUE
    PLAYER_MODELGROUP_12, // PLAYER_AP_BOTTLE_POTION_GREEN
    PLAYER_MODELGROUP_12, // PLAYER_AP_BOTTLE_MILK
    PLAYER_MODELGROUP_12, // PLAYER_AP_BOTTLE_MILK_HALF
    PLAYER_MODELGROUP_12, // PLAYER_AP_BOTTLE_CHATEAU
    PLAYER_MODELGROUP_12,// PLAYER_AP_BOTTLE_FAIRY
...
PlayerModelIndices gPlayerModelTypes[PLAYER_MODELGROUP_MAX] = {
    /* PLAYER_MODELGROUP_0 */  
    { PLAYER_ANIMTYPE_2, PLAYER_MODELTYPE_LH_0, PLAYER_MODELTYPE_RH_8, PLAYER_MODELTYPE_SHEATH_12, PLAYER_MODELTYPE_WAIST },
    /* PLAYER_MODELGROUP_1 */  
    { PLAYER_ANIMTYPE_1, PLAYER_MODELTYPE_LH_2, PLAYER_MODELTYPE_RH_7, PLAYER_MODELTYPE_SHEATH_15, PLAYER_MODELTYPE_WAIST },
    /* PLAYER_MODELGROUP_2 */  
    { PLAYER_ANIMTYPE_1, PLAYER_MODELTYPE_LH_2, PLAYER_MODELTYPE_RH_8, PLAYER_MODELTYPE_SHEATH_13, PLAYER_MODELTYPE_WAIST },
    /* PLAYER_MODELGROUP_DEFAULT */  
    { PLAYER_ANIMTYPE_0, PLAYER_MODELTYPE_LH_0, PLAYER_MODELTYPE_RH_6, PLAYER_MODELTYPE_SHEATH_14, PLAYER_MODELTYPE_WAIST },
    /* PLAYER_MODELGROUP_4 */  
    { PLAYER_ANIMTYPE_0, PLAYER_MODELTYPE_LH_0, PLAYER_MODELTYPE_RH_6, PLAYER_MODELTYPE_SHEATH_14, PLAYER_MODELTYPE_WAIST },
    /* PLAYER_MODELGROUP_5 */  
    { PLAYER_ANIMTYPE_3, PLAYER_MODELTYPE_LH_3, PLAYER_MODELTYPE_RH_7, PLAYER_MODELTYPE_SHEATH_14, PLAYER_MODELTYPE_WAIST },
    /* PLAYER_MODELGROUP_6 */  
    { PLAYER_ANIMTYPE_4, PLAYER_MODELTYPE_LH_1, PLAYER_MODELTYPE_RH_9, PLAYER_MODELTYPE_SHEATH_14, PLAYER_MODELTYPE_WAIST },
    /* PLAYER_MODELGROUP_7 */  
    { PLAYER_ANIMTYPE_5, PLAYER_MODELTYPE_LH_0, PLAYER_MODELTYPE_RH_6, PLAYER_MODELTYPE_SHEATH_14, PLAYER_MODELTYPE_WAIST },
    /* PLAYER_MODELGROUP_8 */  
    { PLAYER_ANIMTYPE_0, PLAYER_MODELTYPE_LH_4, PLAYER_MODELTYPE_RH_6, PLAYER_MODELTYPE_SHEATH_14, PLAYER_MODELTYPE_WAIST },
    /* PLAYER_MODELGROUP_9 */  
    { PLAYER_ANIMTYPE_4, PLAYER_MODELTYPE_LH_0, PLAYER_MODELTYPE_RH_11, PLAYER_MODELTYPE_SHEATH_14, PLAYER_MODELTYPE_WAIST },
    /* PLAYER_MODELGROUP_10 */ 
    { PLAYER_ANIMTYPE_3, PLAYER_MODELTYPE_LH_1, PLAYER_MODELTYPE_RH_7, PLAYER_MODELTYPE_SHEATH_14, PLAYER_MODELTYPE_WAIST },
    /* PLAYER_MODELGROUP_11 */ 
    { PLAYER_ANIMTYPE_0, PLAYER_MODELTYPE_LH_0, PLAYER_MODELTYPE_RH_10, PLAYER_MODELTYPE_SHEATH_14, PLAYER_MODELTYPE_WAIST },
    /* PLAYER_MODELGROUP_12 */ 
    { PLAYER_ANIMTYPE_0, PLAYER_MODELTYPE_LH_5, PLAYER_MODELTYPE_RH_6, PLAYER_MODELTYPE_SHEATH_14, PLAYER_MODELTYPE_WAIST },
    /* PLAYER_MODELGROUP_13 */ 
    { PLAYER_ANIMTYPE_0, PLAYER_MODELTYPE_LH_2, PLAYER_MODELTYPE_RH_6, PLAYER_MODELTYPE_SHEATH_15, PLAYER_MODELTYPE_WAIST },
    /* PLAYER_MODELGROUP_14 */ 
    { PLAYER_ANIMTYPE_0, PLAYER_MODELTYPE_LH_1, PLAYER_MODELTYPE_RH_7, PLAYER_MODELTYPE_SHEATH_14, PLAYER_MODELTYPE_WAIST },
};
