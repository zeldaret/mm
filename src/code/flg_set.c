...
static FlagSetEntry sFlagEntries[] = {
    ...
    { &gSaveContext.eventInf[EVENTINF_00], "event_inf[0]" },
    { &gSaveContext.eventInf[EVENTINF_01], "event_inf[1]" },
    { &gSaveContext.eventInf[EVENTINF_02], "event_inf[2]" },
    { &gSaveContext.eventInf[EVENTINF_03], "event_inf[3]" },
    { &gSaveContext.eventInf[EVENTINF_04], "event_inf[4]" },
    { &gSaveContext.eventInf[EVENTINF_05], "event_inf[5]" },
    { &gSaveContext.eventInf[EVENTINF_06], "event_inf[6]" },
    { &gSaveContext.eventInf[EVENTINF_07], "event_inf[7]" },
