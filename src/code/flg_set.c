/**
 * File: flg_set.c
 * Description: Event Editor, used to view and edit weekEventReg, eventInf and moonMasksBits flags.
 * Controls:
...
static FlagSetEntry sFlagEntries[] = {
    ...
    { &gSaveContext.moonMasksBits[0], "mask_mask_bit[0]" },
    { &gSaveContext.moonMasksBits[1], "mask_mask_bit[1]" },
    { &gSaveContext.moonMasksBits[2], "mask_mask_bit[2]" },
