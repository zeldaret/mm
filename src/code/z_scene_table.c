...
SceneTableEntry gSceneTable[] = {
    SCENE_ENTRY(southern_swamp_clear_scene, 0x0116, SCENE_DRAW_CFG_MAT_ANIM),
    SCENE_ENTRY_NONE(),
    SCENE_ENTRY_NONE(),
    SCENE_ENTRY_NONE(),
    SCENE_ENTRY_NONE(),
    SCENE_ENTRY_NONE(),
    SCENE_ENTRY_NONE(),
    SCENE_ENTRY(grottos_scene, 0x0000, SCENE_DRAW_CFG_MAT_ANIM),
    SCENE_ENTRY(cutscene_map_scene, 0x0000, SCENE_DRAW_CFG_NOTHING),
    SCENE_ENTRY_NONE(),
    SCENE_ENTRY(magic_hags_potion_shop_scene, 0x011A, SCENE_DRAW_CFG_MAT_ANIM),
    SCENE_ENTRY(majoras_lair_scene, 0x0000, SCENE_DRAW_CFG_MAT_ANIM),
    SCENE_ENTRY(beneath_the_graveyard_scene, 0x0113, SCENE_DRAW_CFG_MAT_ANIM),
    SCENE_ENTRY(curiosity_shop_scene, 0x010E, SCENE_DRAW_CFG_MAT_ANIM),
    SCENE_ENTRY_NONE(),
    SCENE_ENTRY_NONE(),
    SCENE_ENTRY(romani_ranch_buildings_scene, 0x0132, SCENE_DRAW_CFG_DEFAULT),
    SCENE_ENTRY(honey_and_darling_scene, 0x0108, SCENE_DRAW_CFG_MAT_ANIM),
    SCENE_ENTRY(mayors_residence_scene, 0x010B, SCENE_DRAW_CFG_DEFAULT),
    SCENE_ENTRY(ikana_canyon_scene, 0x0141, SCENE_DRAW_CFG_MAT_ANIM),
    SCENE_ENTRY(pirates_fortress_scene, 0x0000, SCENE_DRAW_CFG_MAT_ANIM),
    SCENE_ENTRY(milk_bar_scene, 0x010C, SCENE_DRAW_CFG_MAT_ANIM),
    SCENE_ENTRY(stone_tower_temple_scene, 0x0144, SCENE_DRAW_CFG_MAT_ANIM),
    SCENE_ENTRY(treasure_chest_shop_scene, 0x0109, SCENE_DRAW_CFG_DEFAULT),
    SCENE_ENTRY(inverted_stone_tower_temple_scene, 0x0144, SCENE_DRAW_CFG_MAT_ANIM),
    SCENE_ENTRY(clock_town_rooftop_scene, 0x0000, SCENE_DRAW_CFG_DEFAULT),
    SCENE_ENTRY(before_clock_town_scene, 0x0000, SCENE_DRAW_CFG_MAT_ANIM),
    SCENE_ENTRY(woodfall_temple_scene, 0x011F, SCENE_DRAW_CFG_MAT_ANIM),
    SCENE_ENTRY(path_to_mountain_village_scene, 0x0000, SCENE_DRAW_CFG_DEFAULT),
    SCENE_ENTRY(ikana_castle_scene, 0x0142, SCENE_DRAW_CFG_MAT_ANIM),
    SCENE_ENTRY(deku_scrub_playground_scene, 0x0000, SCENE_DRAW_CFG_MAT_ANIM),
    SCENE_ENTRY(odolwas_lair_scene, 0x0000, SCENE_DRAW_CFG_DEFAULT),
    SCENE_ENTRY(town_shooting_gallery_scene, 0x0107, SCENE_DRAW_CFG_MAT_ANIM),
    SCENE_ENTRY(snowhead_temple_scene, 0x012B, SCENE_DRAW_CFG_MAT_ANIM),
    SCENE_ENTRY(milk_road_scene, 0x0149, SCENE_DRAW_CFG_DEFAULT),
    SCENE_ENTRY(pirates_fortress_interior_scene, 0x0000, SCENE_DRAW_CFG_MAT_ANIM),
    SCENE_ENTRY(swamp_shooting_gallery_scene, 0x011B, SCENE_DRAW_CFG_DEFAULT),
    SCENE_ENTRY(pinnacle_rock_scene, 0x0135, SCENE_DRAW_CFG_MAT_ANIM),
    SCENE_ENTRY(fairys_fountain_scene, 0x013E, SCENE_DRAW_CFG_MAT_ANIM),
    SCENE_ENTRY(swamp_spider_house_scene, 0x011E, SCENE_DRAW_CFG_MAT_ANIM),
    SCENE_ENTRY(ocean_spider_house_scene, 0x013F, SCENE_DRAW_CFG_MAT_ANIM),
    SCENE_ENTRY(astral_observatory_scene, 0x0114, SCENE_DRAW_CFG_MAT_ANIM),
    SCENE_ENTRY(moon_deku_trial_scene, 0x0000, SCENE_DRAW_CFG_DEFAULT),
    SCENE_ENTRY(deku_palace_scene, 0x0118, SCENE_DRAW_CFG_MAT_ANIM),
    SCENE_ENTRY(mountain_smithy_scene, 0x0127, SCENE_DRAW_CFG_MAT_ANIM),
    SCENE_ENTRY(termina_field_scene, 0x0100, SCENE_DRAW_CFG_MAT_ANIM),
    SCENE_ENTRY(post_office_scene, 0x0111, SCENE_DRAW_CFG_DEFAULT),
    SCENE_ENTRY(marine_research_lab_scene, 0x013A, SCENE_DRAW_CFG_MAT_ANIM),
    SCENE_ENTRY(dampes_house_scene, 0x0113, SCENE_DRAW_CFG_MAT_ANIM),
    SCENE_ENTRY_NONE(),
    SCENE_ENTRY(goron_shrine_scene, 0x0124, SCENE_DRAW_CFG_DEFAULT),
    SCENE_ENTRY(zora_hall_scene, 0x0136, SCENE_DRAW_CFG_MAT_ANIM),
    SCENE_ENTRY(trading_post_scene, 0x010F, SCENE_DRAW_CFG_MAT_ANIM),
    SCENE_ENTRY(romani_ranch_scene, 0x012E, SCENE_DRAW_CFG_DEFAULT),
    SCENE_ENTRY(twinmolds_lair_scene, 0x0000, SCENE_DRAW_CFG_MAT_ANIM),
    SCENE_ENTRY(great_bay_coast_scene, 0x0134, SCENE_DRAW_CFG_MAT_ANIM),
    SCENE_ENTRY(zora_cape_scene, 0x0134, SCENE_DRAW_CFG_MAT_ANIM),
    SCENE_ENTRY(lottery_shop_scene, 0x0112, SCENE_DRAW_CFG_DEFAULT),
    SCENE_ENTRY_NONE(),
    SCENE_ENTRY(pirates_fortress_exterior_scene, 0x0138, SCENE_DRAW_CFG_MAT_ANIM),
    SCENE_ENTRY(fishermans_hut_scene, 0x013B, SCENE_DRAW_CFG_MAT_ANIM),
    SCENE_ENTRY(goron_shop_scene, 0x0129, SCENE_DRAW_CFG_MAT_ANIM),
    SCENE_ENTRY(deku_kings_chamber_scene, 0x011C, SCENE_DRAW_CFG_MAT_ANIM),
    SCENE_ENTRY(moon_goron_trial_scene, 0x0000, SCENE_DRAW_CFG_DEFAULT),
    SCENE_ENTRY(road_to_southern_swamp_scene, 0x0000, SCENE_DRAW_CFG_MAT_ANIM),
    SCENE_ENTRY(doggy_racetrack_scene, 0x0130, SCENE_DRAW_CFG_DEFAULT),
    SCENE_ENTRY(cucco_shack_scene, 0x012F, SCENE_DRAW_CFG_DEFAULT),
    SCENE_ENTRY(ikana_graveyard_scene, 0x0106, SCENE_DRAW_CFG_DEFAULT),
    SCENE_ENTRY(gohts_lair_scene, 0x0000, SCENE_DRAW_CFG_DEFAULT),
    SCENE_ENTRY(southern_swamp_poisoned_scene, 0x0116, SCENE_DRAW_CFG_MAT_ANIM),
    SCENE_ENTRY(woodfall_scene, 0x0117, SCENE_DRAW_CFG_MAT_ANIM),
    SCENE_ENTRY(moon_zora_trial_scene, 0x0000, SCENE_DRAW_CFG_MAT_ANIM),
    SCENE_ENTRY(goron_village_spring_scene, 0x0123, SCENE_DRAW_CFG_MAT_ANIM),
    SCENE_ENTRY(great_bay_temple_scene, 0x013D, SCENE_DRAW_CFG_GREAT_BAY_TEMPLE),
    SCENE_ENTRY(waterfall_rapids_scene, 0x0137, SCENE_DRAW_CFG_MAT_ANIM),
    SCENE_ENTRY(beneath_the_well_scene, 0x0145, SCENE_DRAW_CFG_MAT_ANIM),
    SCENE_ENTRY(zora_hall_rooms_scene, 0x0000, SCENE_DRAW_CFG_MAT_ANIM),
    SCENE_ENTRY(goron_village_winter_scene, 0x0123, SCENE_DRAW_CFG_MAT_ANIM),
    SCENE_ENTRY(goron_graveyard_scene, 0x012A, SCENE_DRAW_CFG_MAT_ANIM),
    SCENE_ENTRY(sakons_hideout_scene, 0x0143, SCENE_DRAW_CFG_MAT_ANIM_MANUAL_STEP),
    SCENE_ENTRY(mountain_village_winter_scene, 0x0122, SCENE_DRAW_CFG_MAT_ANIM),
    SCENE_ENTRY(ghost_hut_scene, 0x0146, SCENE_DRAW_CFG_DEFAULT),
    SCENE_ENTRY(deku_shrine_scene, 0x0120, SCENE_DRAW_CFG_MAT_ANIM),
    SCENE_ENTRY(road_to_ikana_scene, 0x0000, SCENE_DRAW_CFG_DEFAULT),
    SCENE_ENTRY(swordmans_school_scene, 0x0110, SCENE_DRAW_CFG_DEFAULT),
    SCENE_ENTRY(music_box_house_scene, 0x0147, SCENE_DRAW_CFG_MAT_ANIM_MANUAL_STEP),
    SCENE_ENTRY(igos_du_ikanas_lair_scene, 0x0142, SCENE_DRAW_CFG_MAT_ANIM),
    SCENE_ENTRY(tourist_information_scene, 0x0119, SCENE_DRAW_CFG_DEFAULT),
    SCENE_ENTRY(stone_tower_scene, 0x0140, SCENE_DRAW_CFG_DEFAULT),
    SCENE_ENTRY(inverted_stone_tower_scene, 0x0000, SCENE_DRAW_CFG_DEFAULT),
    SCENE_ENTRY(mountain_village_spring_scene, 0x0122, SCENE_DRAW_CFG_MAT_ANIM),
    SCENE_ENTRY(path_to_snowhead_scene, 0x0000, SCENE_DRAW_CFG_DEFAULT),
    SCENE_ENTRY(snowhead_scene, 0x0125, SCENE_DRAW_CFG_MAT_ANIM),
    SCENE_ENTRY(path_to_goron_village_winter_scene, 0x0000, SCENE_DRAW_CFG_MAT_ANIM),
    SCENE_ENTRY(path_to_goron_village_spring_scene, 0x0000, SCENE_DRAW_CFG_MAT_ANIM),
    SCENE_ENTRY(gyorgs_lair_scene, 0x0000, SCENE_DRAW_CFG_MAT_ANIM),
    SCENE_ENTRY(secret_shrine_scene, 0x012C, SCENE_DRAW_CFG_MAT_ANIM),
    SCENE_ENTRY(stock_pot_inn_scene, 0x010A, SCENE_DRAW_CFG_MAT_ANIM),
    SCENE_ENTRY(great_bay_cutscene_scene, 0x0139, SCENE_DRAW_CFG_MAT_ANIM),
    SCENE_ENTRY(clock_tower_interior_scene, 0x0000, SCENE_DRAW_CFG_MAT_ANIM),
    SCENE_ENTRY(woods_of_mystery_scene, 0x011D, SCENE_DRAW_CFG_MAT_ANIM),
    SCENE_ENTRY(lost_woods_scene, 0x0000, SCENE_DRAW_CFG_MAT_ANIM),
    SCENE_ENTRY(moon_human_trial_scene, 0x0000, SCENE_DRAW_CFG_DEFAULT),
    SCENE_ENTRY(moon_field_scene, 0x0000, SCENE_DRAW_CFG_DEFAULT),
    SCENE_ENTRY(bomb_shop_scene, 0x010D, SCENE_DRAW_CFG_DEFAULT),
    SCENE_ENTRY(giants_chamber_scene, 0x0000, SCENE_DRAW_CFG_MAT_ANIM),
    SCENE_ENTRY(gorman_track_scene, 0x0131, SCENE_DRAW_CFG_MAT_ANIM),
    SCENE_ENTRY(goron_racetrack_scene, 0x0126, SCENE_DRAW_CFG_DEFAULT),
    SCENE_ENTRY(east_clock_town_scene, 0x0101, SCENE_DRAW_CFG_DEFAULT),
    SCENE_ENTRY(west_clock_town_scene, 0x0102, SCENE_DRAW_CFG_DEFAULT),
    SCENE_ENTRY(north_clock_town_scene, 0x0103, SCENE_DRAW_CFG_DEFAULT),
    SCENE_ENTRY(south_clock_town_scene, 0x0104, SCENE_DRAW_CFG_MAT_ANIM),
    SCENE_ENTRY(laundry_pool_scene, 0x0105, SCENE_DRAW_CFG_MAT_ANIM),
};
...
static EntranceTableEntry sRomaniRanchBuildingsEntrance0[] = {
    { 0x10, 0x00, 0x0102 },
};

static EntranceTableEntry sRomaniRanchBuildingsEntrance1[] = {
    { 0x10, 0x01, 0x4102 },
};

static EntranceTableEntry* sRomaniRanchBuildingsEntranceTable[] = {
    sRomaniRanchBuildingsEntrance0,
    sRomaniRanchBuildingsEntrance1,
};
...
static EntranceTableEntry sBeforeClockTownEntrance0[] = {
    { 0xE6, 0x00, 0x0102 },
    { 0xE6, 0x00, 0x8102 },
};

static EntranceTableEntry sBeforeClockTownEntrance1[] = {
    { 0xE6, 0x01, 0x0102 },
};

static EntranceTableEntry sBeforeClockTownEntrance2[] = {
    { 0xE6, 0x02, 0x0102 },
};

static EntranceTableEntry sBeforeClockTownEntrance3[] = {
    { 0xE6, 0x03, 0x0102 },
};

static EntranceTableEntry sBeforeClockTownEntrance4[] = {
    { 0xE6, 0x04, 0x058B },
};

static EntranceTableEntry* sBeforeClockTownEntranceTable[] = {
    sBeforeClockTownEntrance0, sBeforeClockTownEntrance1, sBeforeClockTownEntrance2,
    sBeforeClockTownEntrance3, sBeforeClockTownEntrance4,
};
...
static SceneEntranceTableEntry sSceneEntranceTable[] = {
    ...
    SCENE_ENTRANCE(sRomaniRanchBuildingsEntranceTable, "Z2_OMOYA"),
    ...
    SCENE_ENTRANCE(sBeforeClockTownEntranceTable, "Z2_OPENINGDAN"),
