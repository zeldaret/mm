...
SceneTableEntry gSceneTable[] = {
    SCENE_ENTRY(Z2_20SICHITAI2, 0x0116, 1),
    SCENE_ENTRY_NONE(),
    SCENE_ENTRY_NONE(),
    SCENE_ENTRY_NONE(),
    SCENE_ENTRY_NONE(),
    SCENE_ENTRY_NONE(),
    SCENE_ENTRY_NONE(),
    SCENE_ENTRY(KAKUSIANA, 0x0000, 1),
    SCENE_ENTRY(SPOT00, 0x0000, 2),
    SCENE_ENTRY_NONE(),
    SCENE_ENTRY(Z2_WITCH_SHOP, 0x011A, 1),
    SCENE_ENTRY(Z2_LAST_BS, 0x0000, 1),
    SCENE_ENTRY(Z2_HAKASHITA, 0x0113, 1),
    SCENE_ENTRY(Z2_AYASHIISHOP, 0x010E, 1),
    SCENE_ENTRY_NONE(),
    SCENE_ENTRY_NONE(),
    SCENE_ENTRY(Z2_OMOYA, 0x0132, 0),
    SCENE_ENTRY(Z2_BOWLING, 0x0108, 1),
    SCENE_ENTRY(Z2_SONCHONOIE, 0x010B, 0),
    SCENE_ENTRY(Z2_IKANA, 0x0141, 1),
    SCENE_ENTRY(Z2_KAIZOKU, 0x0000, 1),
    SCENE_ENTRY(Z2_MILK_BAR, 0x010C, 1),
    SCENE_ENTRY(Z2_INISIE_N, 0x0144, 1),
    SCENE_ENTRY(Z2_TAKARAYA, 0x0109, 0),
    SCENE_ENTRY(Z2_INISIE_R, 0x0144, 1),
    SCENE_ENTRY(Z2_OKUJOU, 0x0000, 0),
    SCENE_ENTRY(Z2_OPENINGDAN, 0x0000, 1),
    SCENE_ENTRY(Z2_MITURIN, 0x011F, 1),
    SCENE_ENTRY(Z2_13HUBUKINOMITI, 0x0000, 0),
    SCENE_ENTRY(Z2_CASTLE, 0x0142, 1),
    SCENE_ENTRY(Z2_DEKUTES, 0x0000, 1),
    SCENE_ENTRY(Z2_MITURIN_BS, 0x0000, 0),
    SCENE_ENTRY(Z2_SYATEKI_MIZU, 0x0107, 1),
    SCENE_ENTRY(Z2_HAKUGIN, 0x012B, 1),
    SCENE_ENTRY(Z2_ROMANYMAE, 0x0149, 0),
    SCENE_ENTRY(Z2_PIRATE, 0x0000, 1),
    SCENE_ENTRY(Z2_SYATEKI_MORI, 0x011B, 0),
    SCENE_ENTRY(Z2_SINKAI, 0x0135, 1),
    SCENE_ENTRY(Z2_YOUSEI_IZUMI, 0x013E, 1),
    SCENE_ENTRY(Z2_KINSTA1, 0x011E, 1),
    SCENE_ENTRY(Z2_KINDAN2, 0x013F, 1),
    SCENE_ENTRY(Z2_TENMON_DAI, 0x0114, 1),
    SCENE_ENTRY(Z2_LAST_DEKU, 0x0000, 0),
    SCENE_ENTRY(Z2_22DEKUCITY, 0x0118, 1),
    SCENE_ENTRY(Z2_KAJIYA, 0x0127, 1),
    SCENE_ENTRY(Z2_00KEIKOKU, 0x0100, 1),
    SCENE_ENTRY(Z2_POSTHOUSE, 0x0111, 0),
    SCENE_ENTRY(Z2_LABO, 0x013A, 1),
    SCENE_ENTRY(Z2_DANPEI2TEST, 0x0113, 1),
    SCENE_ENTRY_NONE(),
    SCENE_ENTRY(Z2_16GORON_HOUSE, 0x0124, 0),
    SCENE_ENTRY(Z2_33ZORACITY, 0x0136, 1),
    SCENE_ENTRY(Z2_8ITEMSHOP, 0x010F, 1),
    SCENE_ENTRY(Z2_F01, 0x012E, 0),
    SCENE_ENTRY(Z2_INISIE_BS, 0x0000, 1),
    SCENE_ENTRY(Z2_30GYOSON, 0x0134, 1),
    SCENE_ENTRY(Z2_31MISAKI, 0x0134, 1),
    SCENE_ENTRY(Z2_TAKARAKUJI, 0x0112, 0),
    SCENE_ENTRY_NONE(),
    SCENE_ENTRY(Z2_TORIDE, 0x0138, 1),
    SCENE_ENTRY(Z2_FISHERMAN, 0x013B, 1),
    SCENE_ENTRY(Z2_GORONSHOP, 0x0129, 1),
    SCENE_ENTRY(Z2_DEKU_KING, 0x011C, 1),
    SCENE_ENTRY(Z2_LAST_GORON, 0x0000, 0),
    SCENE_ENTRY(Z2_24KEMONOMITI, 0x0000, 1),
    SCENE_ENTRY(Z2_F01_B, 0x0130, 0),
    SCENE_ENTRY(Z2_F01C, 0x012F, 0),
    SCENE_ENTRY(Z2_BOTI, 0x0106, 0),
    SCENE_ENTRY(Z2_HAKUGIN_BS, 0x0000, 0),
    SCENE_ENTRY(Z2_20SICHITAI, 0x0116, 1),
    SCENE_ENTRY(Z2_21MITURINMAE, 0x0117, 1),
    SCENE_ENTRY(Z2_LAST_ZORA, 0x0000, 1),
    SCENE_ENTRY(Z2_11GORONNOSATO2, 0x0123, 1),
    SCENE_ENTRY(Z2_SEA, 0x013D, 6),
    SCENE_ENTRY(Z2_35TAKI, 0x0137, 1),
    SCENE_ENTRY(Z2_REDEAD, 0x0145, 1),
    SCENE_ENTRY(Z2_BANDROOM, 0x0000, 1),
    SCENE_ENTRY(Z2_11GORONNOSATO, 0x0123, 1),
    SCENE_ENTRY(Z2_GORON_HAKA, 0x012A, 1),
    SCENE_ENTRY(Z2_SECOM, 0x0143, 7),
    SCENE_ENTRY(Z2_10YUKIYAMANOMURA, 0x0122, 1),
    SCENE_ENTRY(Z2_TOUGITES, 0x0146, 0),
    SCENE_ENTRY(Z2_DANPEI, 0x0120, 1),
    SCENE_ENTRY(Z2_IKANAMAE, 0x0000, 0),
    SCENE_ENTRY(Z2_DOUJOU, 0x0110, 0),
    SCENE_ENTRY(Z2_MUSICHOUSE, 0x0147, 7),
    SCENE_ENTRY(Z2_IKNINSIDE, 0x0142, 1),
    SCENE_ENTRY(Z2_MAP_SHOP, 0x0119, 0),
    SCENE_ENTRY(Z2_F40, 0x0140, 0),
    SCENE_ENTRY(Z2_F41, 0x0000, 0),
    SCENE_ENTRY(Z2_10YUKIYAMANOMURA2, 0x0122, 1),
    SCENE_ENTRY(Z2_14YUKIDAMANOMITI, 0x0000, 0),
    SCENE_ENTRY(Z2_12HAKUGINMAE, 0x0125, 1),
    SCENE_ENTRY(Z2_17SETUGEN, 0x0000, 1),
    SCENE_ENTRY(Z2_17SETUGEN2, 0x0000, 1),
    SCENE_ENTRY(Z2_SEA_BS, 0x0000, 1),
    SCENE_ENTRY(Z2_RANDOM, 0x012C, 1),
    SCENE_ENTRY(Z2_YADOYA, 0x010A, 1),
    SCENE_ENTRY(Z2_KONPEKI_ENT, 0x0139, 1),
    SCENE_ENTRY(Z2_INSIDETOWER, 0x0000, 1),
    SCENE_ENTRY(Z2_26SARUNOMORI, 0x011D, 1),
    SCENE_ENTRY(Z2_LOST_WOODS, 0x0000, 1),
    SCENE_ENTRY(Z2_LAST_LINK, 0x0000, 0),
    SCENE_ENTRY(Z2_SOUGEN, 0x0000, 0),
    SCENE_ENTRY(Z2_BOMYA, 0x010D, 0),
    SCENE_ENTRY(Z2_KYOJINNOMA, 0x0000, 1),
    SCENE_ENTRY(Z2_KOEPONARACE, 0x0131, 1),
    SCENE_ENTRY(Z2_GORONRACE, 0x0126, 0),
    SCENE_ENTRY(Z2_TOWN, 0x0101, 0),
    SCENE_ENTRY(Z2_ICHIBA, 0x0102, 0),
    SCENE_ENTRY(Z2_BACKTOWN, 0x0103, 0),
    SCENE_ENTRY(Z2_CLOCKTOWER, 0x0104, 1),
    SCENE_ENTRY(Z2_ALLEY, 0x0105, 1),
};
