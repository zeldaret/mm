...
#pragma GLOBAL_ASM("asm/non_matchings/code/z_bgcheck/BgCheck_GetBgCamDataSetting.s")
...
#pragma GLOBAL_ASM("asm/non_matchings/code/z_bgcheck/BgCheck_GetBgCamDataVec3s.s")
