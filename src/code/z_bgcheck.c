...
u16 SurfaceType_GetCameraSetting(CollisionContext* colCtx, CollisionPoly* poly, s32 bgId) {
    ...
    return BgCheck_GetBgCamDataSetting(colCtx, SurfaceType_GetCamDataIndex(colCtx, poly, bgId), bgId);
}
...
Vec3s* SurfaceType_GetCamPosData(CollisionContext* colCtx, CollisionPoly* poly, s32 bgId) {
    ...
    return BgCheck_GetBgCamDataVec3s(colCtx, SurfaceType_GetCamDataIndex(colCtx, poly, bgId), bgId);
}
