...
RestrictionFlags sRestrictionFlags[] = {
    ...
    { SCENE_UNSET_01, RESTRICTIONS_NONE },
    { SCENE_UNSET_02, RESTRICTIONS_NONE },
    { SCENE_UNSET_03, RESTRICTIONS_NONE },
    { SCENE_UNSET_04, RESTRICTIONS_NONE },
    { SCENE_UNSET_05, RESTRICTIONS_NONE },
    { SCENE_UNSET_06, RESTRICTIONS_NONE },
    { SCENE_KAKUSIANA, RESTRICTIONS_NONE },
    { SCENE_SPOT00, RESTRICTIONS_NONE },
    { SCENE_UNSET_09, RESTRICTIONS_NONE },
    ...
    { SCENE_UNSET_0E, RESTRICTIONS_NONE },
    { SCENE_UNSET_0F, RESTRICTIONS_NONE },
