...
CameraModeValue sSetNormal0ModeNormalData[] = {
    NORMAL1_FIXED_DATA(-20, 280, 320, 10, 22, 15, 40, 60, 84,
                       CAM_INTERFACE_FLAGS(CAM_SHRINKWINVAL_NONE, CAM_HUD_VISIBILITY_50,
...
CameraModeValue sSetNormal0ModeFirstPersonData[] = {
    SUBJECT1_FIXED_DATA(0, 5, 50, 10, 0, 0, 0, 45,
                        CAM_INTERFACE_FLAGS(CAM_SHRINKWINVAL_NONE, CAM_HUD_VISIBILITY_50, 0)),
};
...
CameraModeValue sSetNormal0ModeFreeFallData[] = {
    PARALLEL1_FIXED_DATA(
        ...
        CAM_INTERFACE_FLAGS(CAM_SHRINKWINVAL_NONE, CAM_HUD_VISIBILITY_50, PARALLEL1_FLAG_7 | PARALLEL1_FLAG_3), 60, 12),
};

CameraModeValue sSetNormal0ModeChargeData[] = {
    PARALLEL1_FIXED_DATA(0xFFB0, 300, -20, 50, 0, 50, 5, 80, 20,
                         CAM_INTERFACE_FLAGS(CAM_SHRINKWINVAL_NONE, CAM_HUD_VISIBILITY_50, 0), 60, 10),
};

CameraModeValue sSetNormal0ModeChargeZData[] = {
    PARALLEL1_FIXED_DATA(0xFFB0, 300, -20, 40, 0, 50, 5, 80, 20,
                         CAM_INTERFACE_FLAGS(CAM_SHRINKWINVAL_NONE, CAM_HUD_VISIBILITY_50, PARALLEL1_FLAG_1), 60, 0),
};
...
CameraModeValue sSetNormal3ModeNormalData[] = {
    JUMP3_FIXED_DATA(-40, 280, 300, 20, 15, 5, 40, 60, 100,
                     CAM_INTERFACE_FLAGS(CAM_SHRINKWINVAL_NONE, CAM_HUD_VISIBILITY_50, JUMP3_FLAG_7 | JUMP3_FLAG_2)),
};
...
CameraModeValue sSetNormal3ModeFreeFallData[] = {
    JUMP3_FIXED_DATA(0, 80, 100, 30, 10, 5, 40, 80, 20,
                     CAM_INTERFACE_FLAGS(CAM_SHRINKWINVAL_NONE, CAM_HUD_VISIBILITY_50, JUMP3_FLAG_2)),
};

CameraModeValue sSetNormal3ModeGoronJumpData[] = {
    JUMP3_FIXED_DATA(-40, 150, 240, -5, 18, 5, 40, 70, 40,
                     CAM_INTERFACE_FLAGS(CAM_SHRINKWINVAL_NONE, CAM_HUD_VISIBILITY_50, JUMP3_FLAG_3 | JUMP3_FLAG_2)),
};

CameraModeValue sSetNormal3ModeDekuFlyData[] = {
    JUMP3_FIXED_DATA(-40, 150, 250, 10, 18, 5, 60, 60, 60,
                     CAM_INTERFACE_FLAGS(CAM_SHRINKWINVAL_NONE, CAM_HUD_VISIBILITY_50, JUMP3_FLAG_2 | JUMP3_FLAG_0)),
};

CameraModeValue sSetNormal3ModeDekuHideData[] = {
    JUMP3_FIXED_DATA(
        0xFFC4, 150, 250, -15, 18, 5, 60, 60, 40,
        CAM_INTERFACE_FLAGS(CAM_SHRINKWINVAL_NONE, CAM_HUD_VISIBILITY_50, JUMP3_FLAG_7 | JUMP3_FLAG_2 | JUMP3_FLAG_0)),
};
...
CameraModeValue sSetPivotDivingModeNormalData[] = {
    UNIQUE2_FIXED_DATA(-40, 60, 60, CAM_INTERFACE_FLAGS(CAM_SHRINKWINVAL_NONE, CAM_HUD_VISIBILITY_50, UNIQUE2_FLAG_1)),
};
...
CameraModeValue sSetHorseModeNormalData[] = {
    NORMAL3_FIXED_DATA(-50, 220, 250, 10, 10, 20, 60, 80,
                       CAM_INTERFACE_FLAGS(CAM_SHRINKWINVAL_NONE, CAM_HUD_VISIBILITY_6, NORMAL3_FLAG_5)),
};
...
CameraModeValue sSetHorseModeJumpData[] = {
    NORMAL3_FIXED_DATA(-50, 220, 260, 10, 10, 20, 60, 50,
                       CAM_INTERFACE_FLAGS(CAM_SHRINKWINVAL_NONE, CAM_HUD_VISIBILITY_6, 0)),
};
...
CameraModeValue sSetZoraDivingModeNormalData[] = {
    NORMAL3_FIXED_DATA(-20, 250, 250, 0, 20, 20, 60, 50,
                       CAM_INTERFACE_FLAGS(CAM_SHRINKWINVAL_NONE, CAM_HUD_VISIBILITY_6, NORMAL3_FLAG_7)),
};
...
CameraModeValue sSetPrerendFixedModeNormalData[] = {
    FIXED3_FIXED_DATA(CAM_INTERFACE_FLAGS(CAM_SHRINKWINVAL_NONE, CAM_HUD_VISIBILITY_50, 0)),
};
...
CameraModeValue sSetPrerendPivotModeNormalData[] = {
    UNIQUE7_FIXED_DATA(60, CAM_INTERFACE_FLAGS(CAM_SHRINKWINVAL_NONE, CAM_HUD_VISIBILITY_50, 0)),
};
...
CameraModeValue sSetDoorCModeNormalData[] = {
    SPECIAL9_FIXED_DATA(-5, 60, CAM_INTERFACE_FLAGS(CAM_SHRINKWINVAL_NONE_4, CAM_HUD_VISIBILITY_2, SPECIAL9_FLAG_1)),
};
...
CameraModeValue D_801B4EF8[] = {
    NORMAL1_FIXED_DATA(
        ...
        CAM_INTERFACE_FLAGS(CAM_SHRINKWINVAL_NONE, CAM_HUD_VISIBILITY_50, NORMAL1_FLAG_6 | NORMAL1_FLAG_1)),
};
...
CameraModeValue sSetNormal1ModeNormalData[] = {
    NORMAL1_FIXED_DATA(-20, 280, 320, 15, 18, 12, 70, 60, 80,
                       CAM_INTERFACE_FLAGS(CAM_SHRINKWINVAL_NONE, CAM_HUD_VISIBILITY_50, NORMAL1_FLAG_1)),
};
...
CameraModeValue D_801B4FF0[] = {
    NORMAL1_FIXED_DATA(
        ...
        CAM_INTERFACE_FLAGS(CAM_SHRINKWINVAL_NONE, CAM_HUD_VISIBILITY_50, NORMAL1_FLAG_1 | NORMAL1_FLAG_0)),
};
...
CameraModeValue D_801B5018[] = {
    FIXED2_FIXED_DATA(-40, 40, 0x3200, 10, 20, 60,
                      CAM_INTERFACE_FLAGS(CAM_SHRINKWINVAL_NONE, CAM_HUD_VISIBILITY_50, FIXED2_FLAG_0)),
};
...
CameraModeValue D_801B506C[] = {
    FIXED1_FIXED_DATA(-40, 10, 60, CAM_INTERFACE_FLAGS(CAM_SHRINKWINVAL_NONE, CAM_HUD_VISIBILITY_50, 0)),
};
...
CameraModeValue sSetSpiralDoorModeNormalData[] = {
    SPECIAL8_FIXED_DATA(-40, 50, 80, 60, 10,
                        CAM_INTERFACE_FLAGS(CAM_SHRINKWINVAL_NONE, CAM_HUD_VISIBILITY_50, SPECIAL8_FLAG_0)),
};
...
CameraModeValue sSetDungeon0ModeFreeFallData[] = {
    PARALLEL1_FIXED_DATA(
        ...
        CAM_INTERFACE_FLAGS(CAM_SHRINKWINVAL_NONE, CAM_HUD_VISIBILITY_50, PARALLEL1_FLAG_7 | PARALLEL1_FLAG_3), 70, 12),
};
...
CameraModeValue sSetMazeModeNormalData[] = {
    PARALLEL2_FIXED_DATA(0xFFDD, 160, 65, -5, 2, 70, 99,
                         CAM_INTERFACE_FLAGS(CAM_SHRINKWINVAL_NONE, CAM_HUD_VISIBILITY_50, PARALLEL2_FLAG_1)),
};
...
CameraModeValue sSetRemoteBombModeNormalData[] = {
    NORMAL2_FIXED_DATA(20, 200, 800, 15, 6, 70, 40,
                       CAM_INTERFACE_FLAGS(CAM_SHRINKWINVAL_NONE, CAM_HUD_VISIBILITY_50, NORMAL2_FLAG_1)),
};
...
CameraModeValue D_801B58F4[] = {
    FIXED1_FIXED_DATA(-40, 100, 60, CAM_INTERFACE_FLAGS(CAM_SHRINKWINVAL_NONE, CAM_HUD_VISIBILITY_50, 0)),
};
...
CameraModeValue sSetTowerClimbModeNormalData[] = {
    NORMAL0_FIXED_DATA(0, 350, 400, 20, 20, 50, 65, 50,
                       CAM_INTERFACE_FLAGS(CAM_SHRINKWINVAL_NONE, CAM_HUD_VISIBILITY_50, NORMAL0_FLAG_0)),
};
...
CameraModeValue D_801B59F4[] = {
    UNIQUE0_FIXED_DATA(0, 100, CAM_INTERFACE_FLAGS(CAM_SHRINKWINVAL_NONE, CAM_HUD_VISIBILITY_50, UNIQUE0_FLAG_0)),
};
...
CameraModeValue D_801B5A00[] = {
    UNIQUE0_FIXED_DATA(
        0, 30, CAM_INTERFACE_FLAGS(CAM_SHRINKWINVAL_NONE, CAM_HUD_VISIBILITY_50, UNIQUE0_FLAG_4 | UNIQUE0_FLAG_0)),
};
...
CameraModeValue D_801B5C80[] = {
    PARALLEL1_FIXED_DATA(
        100, 300, -20, 40, 0, 4, 5, 80, 60,
        CAM_INTERFACE_FLAGS(CAM_SHRINKWINVAL_NONE, CAM_HUD_VISIBILITY_50, PARALLEL1_FLAG_5 | PARALLEL1_FLAG_1), 60, 20),
};
...
CameraModeValue sSetTreasureChestMinigameModeNormalData[] = {
    NORMAL1_FIXED_DATA(
        ...
        CAM_INTERFACE_FLAGS(CAM_SHRINKWINVAL_NONE, CAM_HUD_VISIBILITY_50, NORMAL1_FLAG_7 | NORMAL1_FLAG_1)),
};
...
CameraModeValue sSetTelescopeModeNormalData[] = {
    SUBJECT1_FIXED_DATA(0, 5, 50, 10, 0, 0, 0, 30, CAM_INTERFACE_FLAGS(CAM_SHRINKWINVAL_NONE, CAM_HUD_VISIBILITY_2, 0)),
};

CameraModeValue sSetTelescopeModeTargetData[] = {
    SUBJECT1_FIXED_DATA(0, 5, 50, 10, 0, 0, 0, 15, CAM_INTERFACE_FLAGS(CAM_SHRINKWINVAL_NONE, CAM_HUD_VISIBILITY_2, 0)),
};

CameraModeValue sSetTelescopeModeFirstPersonData[] = {
    SUBJECT1_FIXED_DATA(0, 5, 50, 10, 0, 0, 0, 30,
                        CAM_INTERFACE_FLAGS(CAM_SHRINKWINVAL_NONE, CAM_HUD_VISIBILITY_2, SUBJECT1_FLAG_4)),
};
...
CameraModeValue D_801B61DC[] = {
    PARALLEL1_FIXED_DATA(
        ...
        CAM_INTERFACE_FLAGS(CAM_SHRINKWINVAL_NONE, CAM_HUD_VISIBILITY_50, PARALLEL1_FLAG_7 | PARALLEL1_FLAG_3), 65, 12),
};

CameraModeValue D_801B620C[] = {
    PARALLEL1_FIXED_DATA(0xFFB0, 240, -20, 50, 0, 50, 5, 80, 20,
                         CAM_INTERFACE_FLAGS(CAM_SHRINKWINVAL_NONE, CAM_HUD_VISIBILITY_50, 0), 65, 10),
};

CameraModeValue D_801B623C[] = {
    PARALLEL1_FIXED_DATA(0xFFB0, 240, -20, 40, 0, 50, 5, 80, 20,
                         CAM_INTERFACE_FLAGS(CAM_SHRINKWINVAL_NONE, CAM_HUD_VISIBILITY_50, PARALLEL1_FLAG_1), 65, 0),
};
...
CameraModeValue D_801B6418[] = {
    FIXED2_FIXED_DATA(-40, 40, 0x3200, 5, 25, 60,
                      CAM_INTERFACE_FLAGS(CAM_SHRINKWINVAL_NONE, CAM_HUD_VISIBILITY_50, FIXED2_FLAG_2 | FIXED2_FLAG_0)),
};
...
CameraModeValue sSetWhirlpoolModeNormalData[] = {
    JUMP3_FIXED_DATA(
        ...
        CAM_INTERFACE_FLAGS(CAM_SHRINKWINVAL_NONE, CAM_HUD_VISIBILITY_50, JUMP3_FLAG_7 | JUMP3_FLAG_5 | JUMP3_FLAG_2)),
};

CameraModeValue sSetWhirlpoolModeFreeFallData[] = {
    JUMP3_FIXED_DATA(0, 180, 300, 30, 12, 5, 25, 75, 20,
                     CAM_INTERFACE_FLAGS(CAM_SHRINKWINVAL_NONE, CAM_HUD_VISIBILITY_50, JUMP3_FLAG_4 | JUMP3_FLAG_2)),
};

CameraModeValue sSetWhirlpoolModeGoronJumpData[] = {
    JUMP3_FIXED_DATA(
        -40, 320, 350, -5, 12, 5, 25, 65, 40,
        CAM_INTERFACE_FLAGS(CAM_SHRINKWINVAL_NONE, CAM_HUD_VISIBILITY_50, JUMP3_FLAG_4 | JUMP3_FLAG_3 | JUMP3_FLAG_2)),
};

CameraModeValue sSetWhirlpoolModeDekuFlyData[] = {
    JUMP3_FIXED_DATA(
        -40, 300, 350, 10, 15, 5, 30, 65, 60,
        CAM_INTERFACE_FLAGS(CAM_SHRINKWINVAL_NONE, CAM_HUD_VISIBILITY_50, JUMP3_FLAG_5 | JUMP3_FLAG_2 | JUMP3_FLAG_0)),
};

CameraModeValue sSetWhirlpoolModeDekuHideData[] = {
    JUMP3_FIXED_DATA(
        0xFFC4, 150, 250, -18, 15, 5, 30, 60, 40,
        CAM_INTERFACE_FLAGS(CAM_SHRINKWINVAL_NONE, CAM_HUD_VISIBILITY_50, JUMP3_FLAG_7 | JUMP3_FLAG_4 | JUMP3_FLAG_2)),
};
...
CameraModeValue D_801B71D4[] = {
    PARALLEL1_FIXED_DATA(
        ...
        CAM_INTERFACE_FLAGS(CAM_SHRINKWINVAL_NONE, CAM_HUD_VISIBILITY_50, PARALLEL1_FLAG_3 | PARALLEL1_FLAG_1), 80, 0),
};
...
CameraModeValue D_801B7204[] = {
    UNIQUE0_FIXED_DATA(0, 100, CAM_INTERFACE_FLAGS(CAM_SHRINKWINVAL_NONE, CAM_HUD_VISIBILITY_50, UNIQUE0_FLAG_1)),
};
