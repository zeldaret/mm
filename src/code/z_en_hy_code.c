...
void func_800F0BB4(EnHy* enHy, PlayState* play, EnDoor* door, s16 arg3, s16 arg4) {
    ...
    enHy->skelAnime.baseTransl = enHy->skelAnime.jointTable[LIMB_INDEX_MODEL_TRANSLATION];
    enHy->skelAnime.prevTransl = enHy->skelAnime.jointTable[LIMB_INDEX_MODEL_TRANSLATION];
