...
s8 gEnHyLimbToShadowBodyParts[ENHY_LIMB_MAX] = {
    ...
    ENHY_SHADOW_BODYPART_1,  // ENHY_LIMB_PELVIS
    ENHY_SHADOW_BODYPART_12, // ENHY_LIMB_LEFT_THIGH
    ENHY_SHADOW_BODYPART_13, // ENHY_LIMB_LEFT_SHIN
    ENHY_SHADOW_BODYPART_14, // ENHY_LIMB_LEFT_FOOT
    ENHY_SHADOW_BODYPART_9,  // ENHY_LIMB_RIGHT_THIGH
    ENHY_SHADOW_BODYPART_10, // ENHY_LIMB_RIGHT_SHIN
    ENHY_SHADOW_BODYPART_11, // ENHY_LIMB_RIGHT_FOOT
    ENHY_SHADOW_BODYPART_0,  // ENHY_LIMB_TORSO
    ENHY_SHADOW_BODYPART_6,  // ENHY_LIMB_LEFT_UPPER_ARM
    ENHY_SHADOW_BODYPART_7,  // ENHY_LIMB_LEFT_FOREARM
    ENHY_SHADOW_BODYPART_8,  // ENHY_LIMB_LEFT_HAND
    ENHY_SHADOW_BODYPART_3,  // ENHY_LIMB_RIGHT_UPPER_ARM
    ENHY_SHADOW_BODYPART_4,  // ENHY_LIMB_RIGHT_FOREARM
    ENHY_SHADOW_BODYPART_5,  // ENHY_LIMB_RIGHT_HAND
    ENHY_SHADOW_BODYPART_2,  // ENHY_LIMB_HEAD
};

s8 gEnHyParentShadowBodyParts[ENHY_SHADOW_BODYPART_MAX] = {
    ENHY_SHADOW_BODYPART_0,  // ENHY_SHADOW_BODYPART_0
    ENHY_SHADOW_BODYPART_0,  // ENHY_SHADOW_BODYPART_1
    ENHY_SHADOW_BODYPART_0,  // ENHY_SHADOW_BODYPART_2
    ENHY_SHADOW_BODYPART_0,  // ENHY_SHADOW_BODYPART_3
    ENHY_SHADOW_BODYPART_3,  // ENHY_SHADOW_BODYPART_4
    ENHY_SHADOW_BODYPART_4,  // ENHY_SHADOW_BODYPART_5
    ENHY_SHADOW_BODYPART_0,  // ENHY_SHADOW_BODYPART_6
    ENHY_SHADOW_BODYPART_6,  // ENHY_SHADOW_BODYPART_7
    ENHY_SHADOW_BODYPART_7,  // ENHY_SHADOW_BODYPART_8
    ENHY_SHADOW_BODYPART_0,  // ENHY_SHADOW_BODYPART_9
    ENHY_SHADOW_BODYPART_9,  // ENHY_SHADOW_BODYPART_10
    ENHY_SHADOW_BODYPART_10, // ENHY_SHADOW_BODYPART_11
    ENHY_SHADOW_BODYPART_0,  // ENHY_SHADOW_BODYPART_12
    ENHY_SHADOW_BODYPART_12, // ENHY_SHADOW_BODYPART_13
    ENHY_SHADOW_BODYPART_13, // ENHY_SHADOW_BODYPART_14
};

u8 gEnHyShadowSizes[ENHY_SHADOW_BODYPART_MAX] = {
    0, // ENHY_SHADOW_BODYPART_0
    0, // ENHY_SHADOW_BODYPART_1
    0, // ENHY_SHADOW_BODYPART_2
    0, // ENHY_SHADOW_BODYPART_3
    0, // ENHY_SHADOW_BODYPART_4
    0, // ENHY_SHADOW_BODYPART_5
    0, // ENHY_SHADOW_BODYPART_6
    0, // ENHY_SHADOW_BODYPART_7
    0, // ENHY_SHADOW_BODYPART_8
    0, // ENHY_SHADOW_BODYPART_9
    0, // ENHY_SHADOW_BODYPART_10
    0, // ENHY_SHADOW_BODYPART_11
    0, // ENHY_SHADOW_BODYPART_12
    0, // ENHY_SHADOW_BODYPART_13
    0, // ENHY_SHADOW_BODYPART_14
};
