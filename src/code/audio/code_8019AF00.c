...
#pragma GLOBAL_ASM("asm/non_matchings/code/code_8019AF00/Audio_SetSequenceMode.s")

#pragma GLOBAL_ASM("asm/non_matchings/code/code_8019AF00/Audio_SetBgmEnemyVolume.s")
