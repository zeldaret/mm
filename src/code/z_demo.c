...
void Cutscene_Command_Misc(PlayState* play2, CutsceneContext* csCtx, CsCmdBase* cmd) {
    ...
    switch (cmd->base) {
        ...
        case 0x1B:
            if (isStartFrame) {
                play->nextEntranceIndex = NEXT_ENTRANCE(ENTRANCE_SCENE_CUTSCENE, 0, 0);
            ...
            switch (D_801F4DE2) {
                case 0x1F:
                    if (gSaveContext.save.weekEventReg[20] & 2) {
                        play->nextEntranceIndex = NEXT_ENTRANCE(ENTRANCE_SCENE_WOODFALL_TEMPLE, 1, 0);
                        play->transitionTrigger = TRANS_TRIGGER_START;
                        play->transitionType = TRANS_TYPE_03;
                    } else {
                        play->nextEntranceIndex = NEXT_ENTRANCE(ENTRANCE_SCENE_WOODFALL, 0, 0);
                ...
                case 0x44:
                    if (gSaveContext.save.weekEventReg[33] & 0x80) {
                        play->nextEntranceIndex = NEXT_ENTRANCE(ENTRANCE_SCENE_MOUNTAIN_VILLAGE_SPRING, 7, 0);
                        play->transitionTrigger = TRANS_TRIGGER_START;
                        play->transitionType = TRANS_TYPE_03;
                    } else {
                        play->nextEntranceIndex = NEXT_ENTRANCE(ENTRANCE_SCENE_MOUNTAIN_VILLAGE_SPRING, 0, 0);
                        gSaveContext.nextCutsceneIndex = 0xFFF0;
                        play->transitionTrigger = TRANS_TRIGGER_START;
                        play->transitionType = TRANS_TYPE_03;
                    }
                ...
                case 0x5F:
                    ...
                    play->nextEntranceIndex = NEXT_ENTRANCE(ENTRANCE_SCENE_ZORA_CAPE, 8, 0);
                    gSaveContext.nextCutsceneIndex = 0xFFF0;
                    play->transitionTrigger = TRANS_TRIGGER_START;
                    play->transitionType = TRANS_TYPE_03;
                    break;
                ...
                case 0x36:
                    ...
                    play->nextEntranceIndex = NEXT_ENTRANCE(ENTRANCE_SCENE_IKANA_CANYON, 0, 0);
