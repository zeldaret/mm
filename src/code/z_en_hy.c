...
static AnimationInfoS animations[] = {
    { &D_0600007C, 1.0f, 0, -1, ANIMMODE_LOOP, 0 },  { &D_06001494, 1.0f, 0, -1, ANIMMODE_LOOP, 0 },
    { &D_06001494, 1.0f, 0, -1, ANIMMODE_LOOP, -8 }, { &D_06001908, 1.0f, 0, -1, ANIMMODE_LOOP, 0 },
    { &D_06001908, 1.0f, 0, -1, ANIMMODE_LOOP, -8 }, { &D_060008C0, 1.0f, 0, -1, ANIMMODE_LOOP, 0 },
    { &D_06005DC4, 1.0f, 0, -1, ANIMMODE_LOOP, 0 },  { &D_06000FDC, 1.0f, 0, -1, ANIMMODE_LOOP, 0 },
    { &D_06000AB0, 1.0f, 0, -1, ANIMMODE_LOOP, -8 }, { &D_0600066C, 1.0f, 0, -1, ANIMMODE_LOOP, 0 },
    { &D_0600071C, 1.0f, 0, -1, ANIMMODE_LOOP, 0 },  { &D_06001EE0, 1.0f, 0, -1, ANIMMODE_LOOP, 0 },
    { &D_0600DED8, 1.5f, 0, -1, ANIMMODE_ONCE, 0 },  { &D_0600F920, 1.5f, 0, -1, ANIMMODE_ONCE, 0 },
    { &D_0600FC1C, 1.0f, 0, -1, ANIMMODE_LOOP, 0 },  { &D_0600FEE4, 1.0f, 0, -1, ANIMMODE_LOOP, 0 },
    { &D_06010330, 1.0f, 0, -1, ANIMMODE_LOOP, 0 },  { &D_0600FC1C, 1.0f, 0, -1, ANIMMODE_LOOP, -8 },
    { &D_0600FEE4, 1.0f, 0, -1, ANIMMODE_LOOP, -8 }, { &D_06010330, 1.0f, 0, -1, ANIMMODE_LOOP, -8 },
    { &D_06005D9C, 1.0f, 0, -1, ANIMMODE_LOOP, -8 },
};
