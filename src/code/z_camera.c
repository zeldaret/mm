...
s32 Camera_Normal0(Camera *camera) {
    ...
    *sp40 = *sp38;
    ...
    if (camera->status == CAM_STAT_ACTIVE) {
        if ((camera->globalCtx->kankyoContext.skyboxDisabled == 0) || (norm0->unk_1E & 0x10)) {
...
s32 Camera_Parallel1(Camera *camera) {
    ...
    if ((para1->unk_26 & (0x8 | 0x4 | 0x2)) == (0x8 | 0x4 | 0x2)) {
        camera->xzOffsetUpdateRate = Camera_LERPCeilF(0.1f, camera->xzOffsetUpdateRate, spA0, 0.0001f);
        camera->yOffsetUpdateRate = Camera_LERPCeilF(0.1f, camera->yOffsetUpdateRate, sp9C, 0.0001f);
    } else if (para1->unk_26 & 0x80) {
        camera->xzOffsetUpdateRate = Camera_LERPCeilF(0.5f, camera->xzOffsetUpdateRate, spA0, 0.0001f);
    ...
    if (camera->status == CAM_STAT_ACTIVE) {
        if ((camera->globalCtx->kankyoContext.skyboxDisabled == 0) || (para1->unk_26 & 0x10)) {
            spB0 = *sp40;
            if ((camera->player->stateFlags1 & 0x4000) || (camera->player->stateFlags1 & 4) || ((para1->unk_26 & (0x8 | 0x4 | 0x2)) == 6)) {
                spB0.y += sp60;
            }
...
s32 Camera_Jump3(Camera* camera) {
    ...
    func_8010C764(&sp9C, sp44, sp48);
    func_8010C764(&sp94, sp44, sp40);
    ...
    if (!RELOAD_PARAMS && !sp58) {
        ...
        pad1 = sp78 * 0.01f * sp5C;
        // if (phi_f2) {}
        
        jump3->unk_00 = NEXTSETTING * pad1;
        jump3->unk_04 = NEXTSETTING * pad1;
        if (1) {}
        jump3->unk_08 = NEXTSETTING * pad1;
    ...
    spD0 *=  0.5f;
    phi_f2 = camera->speedRatio * 0.2f;
    spCC = phi_f2;

    new_var2 = (D_801EDC30[camera->thisIdx].unk_64 == 1) ? 0.5f : spD0;
    ...
    if (D_801EDC30[camera->thisIdx].unk_66 != 0) {
        ...
        camera->yawUpdateRateInv = Camera_LERPCeilF(D_801EDC30[camera->thisIdx].unk_5C.r, camera->yawUpdateRateInv, new_var2, 0.1f);
    ...
    if (jump3->unk_22 & 0x80) {
        camera->xzOffsetUpdateRate = Camera_LERPCeilF(0.01f, camera->xzOffsetUpdateRate, spD0, 0.0001f);
        ...
        camera->speedRatio = func_8010C36C(sp5C / func_800CB780(camera), 1.8f);
        phi_f2 = camera->speedRatio * 0.2f;
    } else {
        camera->xzOffsetUpdateRate = Camera_LERPCeilF(0.05f, phi_f14 = camera->xzOffsetUpdateRate, spD0, 0.0001f);
    ...
    camera->yOffsetUpdateRate = Camera_LERPCeilF(0.05f, camera->yOffsetUpdateRate, phi_f2, 0.0001f);
    ...
    if (jump3->unk_22 & 0x20) {
        new_var1 = CLAMP_MAX(camera->speedRatio * 1.3f, 0.6f);
        phi_f2 = new_var1;
        spAC.pitch = Camera_LERPCeilS((spAC.pitch * new_var1) + (jump3->unk_20 * (1.0f - new_var1)), sp94.pitch, 1.0f / ((camera->pitchUpdateRateInv + 1.0f) - (camera->pitchUpdateRateInv * new_var1)), 5);
        ...
        spAC.pitch = Camera_LERPCeilS(D_801EDC30[camera->thisIdx].unk_5C.pitch, sp94.pitch, temp_f0, 5);
    } else if (jump3->unk_22 & 0x88) {
        spAC.yaw = Camera_CalcDefaultYaw(camera, sp94.yaw, sp3C->rot.y, jump3->unk_14, 0.0f);
        phi_f2 = (new_var1 = CLAMP_MAX(camera->speedRatio * 1.3f, 1.0f));
        spAC.pitch = Camera_LERPCeilS((spAC.pitch * phi_f2) + (jump3->unk_20 * (1.0f - phi_f2)), sp94.pitch, 1.0f / ((((0, spD0 = camera->pitchUpdateRateInv)) + 1.0f) - (camera->pitchUpdateRateInv * phi_f2)), 5);
    } else {
        spAC.yaw = Camera_CalcDefaultYaw(camera, sp94.yaw, sp3C->rot.y, jump3->unk_14, 0.0f);
    ...
    func_8010C7B8(sp40, sp44, &spAC);
    if ((camera->status == CAM_STAT_ACTIVE) && !(jump3->unk_22 & 0x40)) {
        if (func_800CBA7C(camera) == 0) {
            func_800CED90(camera, &spAC, &sp9C, jump3->unk_04, phi_f14 = jump3->unk_0C, &D_801EDC30[camera->thisIdx], &anim->unk_10);
        }
        if (jump3->unk_22 & 4) {
    ...
    if (spF0 == false) {
        ...
        if (camera->status == CAM_STAT_ACTIVE) {
            if (!(batt1->unk_30 & 0x10)) {
                if ((camera->globalCtx->kankyoContext.skyboxDisabled == 0) || (batt1->unk_30 & 1)) {
                ...
                *sp50 = spC4;;
                anim->unk_1A &= ~0x10;
            } else if ((camera->globalCtx->kankyoContext.skyboxDisabled == 0) || ((batt1->unk_30 & 1) != 0)) {
                if (func_800CBC84(camera, sp4C, &spC4, 0) != 0) {
                    anim->unk_1A |= 0x1000;
    ...
    if (sp78 == 0) {
        ...
        if (camera->status == CAM_STAT_ACTIVE) {
            if (!(keep1->unk_2C & 0x10)) {
                ...
                *sp48 = sp7C.pos;
                anim->unk_18 &= ~0x10;
            } else if ((camera->globalCtx->kankyoContext.skyboxDisabled == 0) || (keep1->unk_2C & 1)) {
                if (func_800CBC84(camera, sp44, &sp7C, 0) != 0) {
                    anim->unk_18 |= 0x1000;
...
s32 Camera_KeepOn3(Camera* camera) {
    ...
    VecSph sp88;
    VecSph sp80;
    Vec3f* temp_s0 = &camera->focalPoint;
    s32 sp78;
    f32 phi_f14;
    PosRot* sp70;
    s16 sp6E;
    ...
    func_8010C764(&sp88, temp_s0, sp48);
    func_8010C764(&sp80, temp_s0, pad);
    func_800B81E0(&camera->targetPosRot, camera->target);
    spD8 = sp3C->pos;
    spD8.y += sp58;
    func_8010C764(&spA0, &spD8, &camera->targetPosRot);
    ...
    if ((camera->animState == 0) || (camera->animState == 0xA) || (camera->animState == 0x14)) {
        ...
        func_8010C7B8(&anim->unk_10, &spD8, &spA0);
        ...
        if (sp78 != 0) {
            ...
            i = 0;
            sp78 = 14;
            func_8010C7B8(&spCC, &anim->unk_10, &sp98);
    ...
    if (anim->unk_1C != 0) {
        ...
        func_8010C7B8(pad, temp_s0, &sp98);
        *sp48 = *pad;
    ...
    camera->dist = CamMath_Distance(temp_s0, sp48);
    if (camera->flags & 8) {
...
s32 Camera_KeepOn4(Camera* camera) {
    ...
    func_8010C764(&spB0, sp40, sp44_2);
    data = &D_801EDDD0;
    func_8010C764(&spA8, sp40, sp3C);
    D_801EDDD0 = sp38->pos;
    ...
    if (keep4->unk_10 != 0.0f) {
        ...
        spB8.pitch = 0;
        spB8.yaw = sp38->rot.y;
        func_8010C7B8(&D_801EDDD0, &D_801EDDD0, &spB8);
    }
            ...
            switch (keep4->unk_1C & (0x8 | 0x4 | 0x2)) {
                ...
                case (0x8 | 0x2):
                    if (camera->target != 0) {
                        ...
                        spA2 = DEGF_TO_BINANG(keep4->unk_08);
                        sp9E = Camera_XZAngle(&sp4C.pos, sp38);
...
s32 Camera_Subj1(Camera* camera) {
    ...
    func_800B81E0(&sp58.pos, camera->player);
    ...
    func_8010C7B8(&sp84, &sp90, &sp7C);
    func_8010C764(&sp74, &camera->focalPoint, sp34);
    ...
    if (anim->unk_08 != 0) {
        ...
        func_8010C7B8(sp2C, temp_s1, &sp74);
        *sp34 = *sp2C;
        anim->unk_08--;
    } else {
        ...
        func_8010C7B8(&camera->eyeNext, temp_s1, &sp74);
        sp74.r = subj1->unk_04;
        func_8010C7B8(sp34, temp_s1, &sp74);
    }

    if (camera->globalCtx->kankyoContext.skyboxDisabled == 0) {
...
s32 Camera_Demo0(Camera* camera) {
    ...
    if (camera->animState == 0) {
        func_8010C764(&anim->unk_04, &subCam->focalPoint, subEye);
        func_8010C764(&anim->unk_0C, &camera->focalPoint, mainEye);
        ...
        anim->unk_00 = CamMath_Distance(mainEye, subEye);
    ...
    if (anim->unk_1A != 0) {
        ...
        focalPoint->x += (subCam->focalPoint.x - camera->focalPoint.x) / temp_f0_2;
        focalPoint->y += (subCam->focalPoint.y - camera->focalPoint.y) / temp_f0_2;
        focalPoint->z += (subCam->focalPoint.z - camera->focalPoint.z) / temp_f0_2;
        ...
        func_8010C7B8(mainEye, focalPoint, &anim->unk_0C);
...
Vec3s* Camera_Update(Vec3s* inputDir, Camera* camera) {
        ...
        if (camera->player != NULL) {
            ...
            if ((sp98 != 0) && (Camera_fabsf(camera->playerPosRot.pos.y - camera->playerGroundY) < 11.0f)) {
                ...
                if (meshActor != NULL) {
                    ...
                    camera->playerPosDelta.x -= meshActor->actor.world.pos.x - camera->unk_16C.x;
                    camera->playerPosDelta.y -= meshActor->actor.world.pos.y - camera->unk_16C.y;
                    camera->playerPosDelta.z -= meshActor->actor.world.pos.z - camera->unk_16C.z;
                    camera->unk_16C = meshActor->actor.world.pos;
                }
            }

            sp88 = func_800CB780(camera) * 1.5f;
            sp84 = Camera_Vec3fMagnitude(&camera->playerPosDelta);
            camera->xzSpeed = func_8010C36C(sp84, sp88);
            camera->speedRatio = func_8010C36C(sp84 / sp88, 1.8f);
            ...
            if ((camera->flags & 1) && (camera->flags & 4) && !(camera->flags & 0x400) && 
                (!(camera->flags & 0x200) || func_800CBB58(camera)) && !(camera->flags & (s16)0x8000) && 
    ...
    if (camera->status == CAM_STAT_ACTIVE) {
        ...
        } else if ((camera->globalCtx->unk18B4A != 0) && (camera->thisIdx != MAIN_CAM)) {
            sCameraInterfaceFlags = 0xFF00;
            Camera_UpdateInterface(sCameraInterfaceFlags);
        } else {
            Camera_UpdateInterface(sCameraInterfaceFlags);
    ...
    if (sp9C != 0) {
        spC4.x = camera->focalPoint.x + sp48.focalPointOffset.x;
        spC4.y = camera->focalPoint.y + sp48.focalPointOffset.y;
        spC4.z = camera->focalPoint.z + sp48.focalPointOffset.z;
        spB8.x = camera->eye.x + sp48.eyeOffset.x;
        spB8.y = camera->eye.y + sp48.eyeOffset.y;
        spB8.z = camera->eye.z + sp48.eyeOffset.z;
        func_8010C764(&sp3C, &spB8, &spC4);
        Camera_CalcUpFromPitchYawRoll(&spAC, sp3C.pitch, sp3C.yaw, camera->roll + sp48.unk_18);
        sp80 = camera->fov + (sp48.zoom * 0.00549325f);
    } else if (D_801B9E54 != 0) {
        spC4 = camera->focalPoint;
        spB8 = camera->eye;
        func_8010C764(&sp3C, &spB8, &spC4);
        spAC = camera->upDir;
        sp80 = camera->fov;
