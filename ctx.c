...
typedef struct BgKin2Fence {
                ...
                ColliderJntSphElement colliderElements[4];
                BgKin2FenceActionFunc actionFunc;
                s8 unk280;
                s8 unk281;
                s8 unk282;
                s8 unk283;
...
void func_80B6EBF4(BgKin2Fence* this);
void func_80B6EC08(BgKin2Fence* this, GlobalContext* globalCtx);
void func_80B6EC70(BgKin2Fence* this);
void func_80B6EC8C(BgKin2Fence* this, GlobalContext* globalCtx);
void func_80B6ECC4(BgKin2Fence* this);
...
extern Color_RGBA8 D_80B6EEE0;
extern Color_RGBA8 D_80B6EEE4;
extern Vec3f D_80B6EE80[];
...
void func_80B6E890(BgKin2Fence *this, GlobalContext *globalCtx, s32 mask)
{
  s32 i;
  Vec3f *phi_s1;
  Vec3f sp58;
  int new_var;
  new_var = (sizeof(&D_80B6EE80)) / (sizeof(&D_80B6EE80[0]));
  ...
  phi_s1 = &D_80B6EE80[mask];
  if (!this)
  {
  }
  for (i = 0; i < ((s32) new_var); i++)
  {
    SysMatrix_MultiplyVector3fByState(&D_80B6EE80[i], &sp58);
    EffectSsKiraKira_SpawnDispersed(globalCtx, &sp58, &D_801D15B0, &D_801D15B0, &D_80B6EEE0, &D_80B6EEE4, 6000, -10);
  }
}
void BgKin2Fence_Init(Actor* thisx, GlobalContext* globalCtx) {
