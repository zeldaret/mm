...
typedef struct Actor {
                ...
                f32 gravity;
                f32 minVelocityY;
                struct CollisionPoly* wallPoly;
                struct CollisionPoly* floorPoly;
                u8 wallBgId;
                u8 floorBgId;
                s16 wallYaw;
                f32 floorHeight;
...
typedef struct {
               ...
               f32 xzPosRandScale;
               f32 scale;
} EffectSsBubbleInitParams;
typedef struct {
               Vec3f pos;
               s16 radius;
               s16 radiusMax;
               s16 life;
} EffectSsGRippleInitParams;
typedef struct {
               Vec3f pos;
               u8 type;
               u8 customColor;
               ...
               Color_RGBA8 primColor;
               Color_RGBA8 envColor;
} EffectSsGSplashInitParams;
typedef struct {
               Vec3f pos;
} EffectSsGFireInitParams;
typedef struct {
               Vec3f pos;
               Color_RGBA8 primColor;
               Color_RGBA8 envColor;
...
typedef enum {
               ...
               FHGFLASH_LIGHTBALL_LIGHTBLUE,
               FHGFLASH_LIGHTBALL_RED,
               FHGFLASH_LIGHTBALL_YELLOW,
               FHGFLASH_LIGHTBALL_BLUE,
               FHGFLASH_LIGHTBALL_PURPLE,
               FHGFLASH_LIGHTBALL_ORANGE,
               FHGFLASH_LIGHTBALL_WHITE1,
               FHGFLASH_LIGHTBALL_WHITE2
...
typedef struct {
               ...
               Vec3f accel;
               s16 scale;
} EffectSsIceBlockInitParams;
typedef enum {
               ITEM_KEY_SMALL = 0x78,
               ITEM_MAGIC_SMALL = 0x79,
               ITEM_MAGIC_LARGE = 0x7A,
               ITEM_HEART = 0x83,
               ITEM_RUPEE_GREEN = 0x84,
               ITEM_RUPEE_BLUE = 0x85,
               ITEM_RUPEE_10 = 0x86,
               ITEM_RUPEE_RED = 0x87,
               ITEM_RUPEE_PURPLE = 0x88,
               ITEM_RUPEE_100 = 0x89,
               ITEM_RUPEE_ORANGE = 0x8A,
               ITEM_BOMBS_5 = 0x8F,
               ITEM_BOMBS_10 = 0x90,
               ITEM_BOMBS_20 = 0x91,
               ITEM_BOMBS_30 = 0x92,
...
typedef struct {
              u16 keyFrameLength;
              u16 keyFrameCount;
              F3DPrimColor* primColors;
              F3DEnvColor* envColors;
              u16* keyFrames;
...
typedef struct {
                ...
                s8 pad74[0x12C];
                Gfx* unk1A0;
                TwoHeadGfxArena unk1A4;
                Gfx* unk1B4;
                TwoHeadGfxArena unk1B8;
                s8 pad1C8[0xAC];
                OSViMode* unk274;
                void* zbuffer;
                s8 pad27C[0x1C];
...
struct GlobalContext {
                  ...
                  u8 transitionCtx.nbTransitionActors;
                  s8 pad18761[0x3];
                  ...
                  void* setupPathList;
                  void* unk18868;
                  MaterialAnimation* sceneMaterialAnims;
                  s8 pad18870[0x4];
                  u8 unk18874;
                  s8 unk18875;
                  s8 pad18876[0x4];
...
s32 func_800B8A1C(Actor* actor, GlobalContext* ctxt, s32 iParm3, f32 fParm4, f32 param_5);
...
void func_800CA1E8(GlobalContext* globalCtx, CollisionContext* bgCtxt, f32 arg2, f32 arg3, f32* arg4, void* arg5);
...
void Scene_HeaderCmdSpawnList(GlobalContext* ctxt, SceneCmd* entry);
void Scene_HeaderCmdActorList(GlobalContext* ctxt, SceneCmd* entry);
void Scene_HeaderCmdActorCutsceneCamList(GlobalContext* ctxt, SceneCmd* entry);
void Scene_HeaderCmdColHeader(GlobalContext* ctxt, SceneCmd* entry);
void Scene_HeaderCmdRoomList(GlobalContext* ctxt, SceneCmd* entry);
void Scene_HeaderCmdEntranceList(GlobalContext* ctxt, SceneCmd* entry);
void Scene_HeaderCmdSpecialFiles(GlobalContext* ctxt, SceneCmd* entry);
void Scene_HeaderCmdRoomBehavior(GlobalContext* ctxt, SceneCmd* entry);
void Scene_HeaderCmdMesh(GlobalContext* ctxt, SceneCmd* entry);
void Scene_HeaderCmdObjectList(GlobalContext* ctxt, SceneCmd* entry);
void Scene_HeaderCmdLightList(GlobalContext* ctxt, SceneCmd* entry);
void Scene_HeaderCmdPathList(GlobalContext* ctxt, SceneCmd* entry);
void Scene_HeaderCmdTransiActorList(GlobalContext* ctxt, SceneCmd* entry);
void Transition_Init(GlobalContext* ctxt, u8* nbTransitionActors);
void Scene_HeaderCmdEnvLightSettings(GlobalContext* ctxt, SceneCmd* entry);
s32 Scene_LoadAreaTextures(GlobalContext* ctxt, s32 fileIndex);
void Scene_HeaderCmdSkyboxSettings(GlobalContext* ctxt, SceneCmd* entry);
void Scene_HeaderCmdSkyboxDisables(GlobalContext* ctxt, SceneCmd* entry);
void Scene_HeaderCmdTimeSettings(GlobalContext* ctxt, SceneCmd* entry);
void Scene_HeaderCmdWindSettings(GlobalContext* ctxt, SceneCmd* entry);
void Scene_HeaderCmdExitList(GlobalContext* ctxt, SceneCmd* entry);
void Scene_HeaderCmd09(GlobalContext* ctxt, SceneCmd* entry);
void Scene_HeaderCmdSoundSettings(GlobalContext* ctxt, SceneCmd* entry);
void Scene_HeaderCmdEchoSetting(GlobalContext* ctxt, SceneCmd* entry);
void Scene_HeaderCmdAltHeaderList(GlobalContext* ctxt, SceneCmd* entry);
void Scene_HeaderCmdCutsceneList(GlobalContext* ctxt, SceneCmd* entry);
void Scene_HeaderCmdActorCutsceneList(GlobalContext* ctxt, SceneCmd* entry);
void Scene_HeaderCmdMiniMap(GlobalContext* ctxt, SceneCmd* entry);
void Scene_HeaderCmd1D(GlobalContext* ctxt, SceneCmd* entry);
void Scene_HeaderCmdMiniMapCompassInfo(GlobalContext* ctxt, SceneCmd* entry);
void Scene_HeaderCmdSetAreaVisitedFlag(GlobalContext* ctxt, SceneCmd* entry);
void Scene_HeaderCmdMaterialAnimations(GlobalContext* ctxt, SceneCmd* entry);
void Scene_SetExitFade(GlobalContext* ctxt);
...
void Scene_CreateEntranceFromSpawn(u32 spawnIndex);
...
void SceneProc_SetColor(GlobalContext* globalCtx, u32 segment, F3DPrimColor* primColor, F3DEnvColor* envColor);
...
void SceneProc_DrawMatAnimColorNonLinearInterp(GlobalContext* ctxt, u32 segment, MaterialColorAnimParams* params);
...
void SceneProc_DrawMaterialAnimStepOpa(GlobalContext* globalCtx, MaterialAnimation* matAnim, u32 step);
void SceneProc_DrawMaterialAnimStepXlu(GlobalContext* globalCtx, MaterialAnimation* matAnim, u32 step);
void SceneProc_DrawMaterialAnimAlphaStep(GlobalContext* globalCtx, MaterialAnimation* matAnim, f32 alphaRatio, u32 step);
...
s32 func_801660B8(GlobalContext* ctxt, s32 param_2);
...
extern u8 _Z2_17SETUGEN2SegmentRomStart[]; extern u8 _Z2_17SETUGEN2SegmentRomEnd[];
...
extern s32 D_0405BEF0;
extern s32 D_0405B6F0;
extern s32 D_0405C6F0;
extern s32 D_0405CEF0;
extern s32 D_0405E6F0;
extern Gfx D_0405F6F0[];
extern s32 D_0405F7C0;
extern s32 D_0405FFC0;
extern s32 D_040607C0;
extern s32 D_04060FC0;
extern s32 D_040617C0;
extern s32 D_04061FC0;
extern s32 D_04061FE0;
extern s32 D_04062000;
extern s32 D_04062020;
extern s32 D_04062040;
extern s32 D_04062060;
...
extern Gfx D_05017EA0[];
extern Gfx D_05018090[];
...
extern u16 gFramebuffer1[240][320];
extern u16 gFramebufferHighRes1[454][576];
...
extern void* D_801ADF30[5];
extern void* D_801ADF44[12];
extern u8 sDropTable[16 * 17];
extern u8 sDropTableAmounts[16 * 17];
...
extern u8 D_801C2078[1];
extern u8 D_801C2079;
extern u8 D_801C207E;
extern SceneIdList scenesPerMapArea[11];
extern RomFile tatlMessageFiles[2];
extern RomFile sceneTextureFiles[9];
...
extern u32 gSystemHeap[1];
extern u16 gFramebufferHighRes0[454][576];
extern u8 D_80780000[0x4600];
extern u8 D_80784600[0x56200];
extern u16 gFramebuffer0[240][320];
extern uintptr_t osVirtualToPhysical(void*);
extern void* osPhysicalToVirtual(uintptr_t);
extern GraphicsContext* __gfxCtx;
static Gfx sSceneDrawDefaultDL[] = {
    { (((unsigned int) (((unsigned int)((0xdb)) & ((0x01 << (8)) - 1)) << (24))) | ((unsigned int) (((unsigned int)((0x06)) & ((0x01 << (8)) - 1)) << (16))) | ((unsigned int) (((unsigned int)(((0x08)*4)) & ((0x01 << (16)) - 1)) << (0)))), (unsigned int)(gEmptyDL) },
    { (((unsigned int) (((unsigned int)((0xdb)) & ((0x01 << (8)) - 1)) << (24))) | ((unsigned int) (((unsigned int)((0x06)) & ((0x01 << (8)) - 1)) << (16))) | ((unsigned int) (((unsigned int)(((0x09)*4)) & ((0x01 << (16)) - 1)) << (0)))), (unsigned int)(gEmptyDL) },
    { (((unsigned int) (((unsigned int)((0xdb)) & ((0x01 << (8)) - 1)) << (24))) | ((unsigned int) (((unsigned int)((0x06)) & ((0x01 << (8)) - 1)) << (16))) | ((unsigned int) (((unsigned int)(((0x0A)*4)) & ((0x01 << (16)) - 1)) << (0)))), (unsigned int)(gEmptyDL) },
    { (((unsigned int) (((unsigned int)((0xdb)) & ((0x01 << (8)) - 1)) << (24))) | ((unsigned int) (((unsigned int)((0x06)) & ((0x01 << (8)) - 1)) << (16))) | ((unsigned int) (((unsigned int)(((0x0B)*4)) & ((0x01 << (16)) - 1)) << (0)))), (unsigned int)(gEmptyDL) },
    { (((unsigned int) (((unsigned int)((0xdb)) & ((0x01 << (8)) - 1)) << (24))) | ((unsigned int) (((unsigned int)((0x06)) & ((0x01 << (8)) - 1)) << (16))) | ((unsigned int) (((unsigned int)(((0x0C)*4)) & ((0x01 << (16)) - 1)) << (0)))), (unsigned int)(gEmptyDL) },
    { (((unsigned int) (((unsigned int)((0xdb)) & ((0x01 << (8)) - 1)) << (24))) | ((unsigned int) (((unsigned int)((0x06)) & ((0x01 << (8)) - 1)) << (16))) | ((unsigned int) (((unsigned int)(((0x0D)*4)) & ((0x01 << (16)) - 1)) << (0)))), (unsigned int)(gEmptyDL) },
    { (((unsigned int) (((unsigned int)((0xdb)) & ((0x01 << (8)) - 1)) << (24))) | ((unsigned int) (((unsigned int)((0x06)) & ((0x01 << (8)) - 1)) << (16))) | ((unsigned int) (((unsigned int)(((0x06)*4)) & ((0x01 << (16)) - 1)) << (0)))), (unsigned int)(gEmptyDL) },
    { ((unsigned int) (((unsigned int)(0xe7) & ((0x01 << (8)) - 1)) << (24))), 0 },
    { (((unsigned int) (((unsigned int)(0xfa) & ((0x01 << (8)) - 1)) << (24))) | ((unsigned int) (((unsigned int)(0) & ((0x01 << (8)) - 1)) << (8))) | ((unsigned int) (((unsigned int)(0) & ((0x01 << (8)) - 1)) << (0)))), (((unsigned int) (((unsigned int)(128) & ((0x01 << (8)) - 1)) << (24))) | ((unsigned int) (((unsigned int)(128) & ((0x01 << (8)) - 1)) << (16))) | ((unsigned int) (((unsigned int)(128) & ((0x01 << (8)) - 1)) << (8))) | ((unsigned int) (((unsigned int)(128) & ((0x01 << (8)) - 1)) << (0)))) },
    { ((unsigned int) (((unsigned int)(0xfb) & ((0x01 << (8)) - 1)) << (24))), (unsigned int)((((unsigned int) (((unsigned int)(128) & ((0x01 << (8)) - 1)) << (24))) | ((unsigned int) (((unsigned int)(128) & ((0x01 << (8)) - 1)) << (16))) | ((unsigned int) (((unsigned int)(128) & ((0x01 << (8)) - 1)) << (8))) | ((unsigned int) (((unsigned int)(128) & ((0x01 << (8)) - 1)) << (0))))) },
...
void SceneProc_ExecuteSceneDrawConfig(GlobalContext* globalCtx) {
    static SceneDrawConfigFunc sceneDrawConfigFuncs[] = {
        ...
        SceneProc_SceneDrawConfig3,
        SceneProc_DrawSceneConfig4,
        SceneProc_SceneDrawConfig5,
...
void SceneProc_SceneDrawConfigDefault(GlobalContext* globalCtx) {
    { GraphicsContext* __gfxCtx = globalCtx->state.gfxCtx; s32 __dispPad;;
    do {{ Gfx *_g = (Gfx *)(__gfxCtx->polyOpa.p++); _g->words.w0 = (((unsigned int) (((unsigned int)((0xde)) & ((0x01 << (8)) - 1)) << (24))) | ((unsigned int) (((unsigned int)((0x00)) & ((0x01 << (8)) - 1)) << (16))) | ((unsigned int) (((unsigned int)((0)) & ((0x01 << (16)) - 1)) << (0)))); _g->words.w1 = (unsigned int)(sSceneDrawDefaultDL); }} while (0);
    do {{ Gfx *_g = (Gfx *)(__gfxCtx->polyXlu.p++); _g->words.w0 = (((unsigned int) (((unsigned int)((0xde)) & ((0x01 << (8)) - 1)) << (24))) | ((unsigned int) (((unsigned int)((0x00)) & ((0x01 << (8)) - 1)) << (16))) | ((unsigned int) (((unsigned int)((0)) & ((0x01 << (16)) - 1)) << (0)))); _g->words.w1 = (unsigned int)(sSceneDrawDefaultDL); }} while (0);
    } (void)0;
}
Gfx* SceneProc_SingleLayerTexScroll(GlobalContext* globalCtx, MaterialTexScrollAnimParams* params) {
...
void SceneProc_DrawMatAnimTexScroll(GlobalContext* globalCtx, u32 segment, MaterialTexScrollAnimParams* params) {
    ...
    { GraphicsContext* __gfxCtx = globalCtx->state.gfxCtx; s32 __dispPad;;
    if (sMatAnimFlags & 1) {
        do {{ Gfx *_g = (Gfx *)((__gfxCtx->polyOpa.p++)); _g->words.w0 = (((unsigned int) (((unsigned int)((0xdb)) & ((0x01 << (8)) - 1)) << (24))) | ((unsigned int) (((unsigned int)((0x06)) & ((0x01 << (8)) - 1)) << (16))) | ((unsigned int) (((unsigned int)(((segment)*4)) & ((0x01 << (16)) - 1)) << (0)))); _g->words.w1 = (unsigned int)(texScrollDList); }} while (0);
    }
    if (sMatAnimFlags & 2) {
        do {{ Gfx *_g = (Gfx *)((__gfxCtx->polyXlu.p++)); _g->words.w0 = (((unsigned int) (((unsigned int)((0xdb)) & ((0x01 << (8)) - 1)) << (24))) | ((unsigned int) (((unsigned int)((0x06)) & ((0x01 << (8)) - 1)) << (16))) | ((unsigned int) (((unsigned int)(((segment)*4)) & ((0x01 << (16)) - 1)) << (0)))); _g->words.w1 = (unsigned int)(texScrollDList); }} while (0);
    }
    } (void)0;
}
Gfx* SceneProc_TwoLayerTexScroll(GlobalContext* globalCtx, MaterialTexScrollAnimParams* params) {
...
void SceneProc_SetColor(GlobalContext* globalCtx, u32 segment, F3DPrimColor* primColorResult, F3DEnvColor* envColor) {
    Gfx* colorDList = (Gfx*)((globalCtx->state.gfxCtx)->polyOpa.d = (Gfx*)((u8*)(globalCtx->state.gfxCtx)->polyOpa.d - (sizeof(Gfx) * 4)));
    { GraphicsContext* __gfxCtx = globalCtx->state.gfxCtx; s32 __dispPad;;
    if (sMatAnimFlags & 1) { do {{ Gfx *_g = (Gfx *)((__gfxCtx->polyOpa.p++)); _g->words.w0 = (((unsigned int) (((unsigned int)((0xdb)) & ((0x01 << (8)) - 1)) << (24))) | ((unsigned int) (((unsigned int)((0x06)) & ((0x01 << (8)) - 1)) << (16))) | ((unsigned int) (((unsigned int)(((segment)*4)) & ((0x01 << (16)) - 1)) << (0)))); _g->words.w1 = (unsigned int)(colorDList); }} while (0); }
    if (sMatAnimFlags & 2) { do {{ Gfx *_g = (Gfx *)((__gfxCtx->polyXlu.p++)); _g->words.w0 = (((unsigned int) (((unsigned int)((0xdb)) & ((0x01 << (8)) - 1)) << (24))) | ((unsigned int) (((unsigned int)((0x06)) & ((0x01 << (8)) - 1)) << (16))) | ((unsigned int) (((unsigned int)(((segment)*4)) & ((0x01 << (16)) - 1)) << (0)))); _g->words.w1 = (unsigned int)(colorDList); }} while (0); }
    do {{ Gfx *_g = (Gfx *)(colorDList++); _g->words.w0 = (((unsigned int) (((unsigned int)(0xfa) & ((0x01 << (8)) - 1)) << (24))) | ((unsigned int) (((unsigned int)(0) & ((0x01 << (8)) - 1)) << (8))) | ((unsigned int) (((unsigned int)(primColorResult->lodFrac) & ((0x01 << (8)) - 1)) << (0)))); _g->words.w1 = (((unsigned int) (((unsigned int)(primColorResult->r) & ((0x01 << (8)) - 1)) << (24))) | ((unsigned int) (((unsigned int)(primColorResult->g) & ((0x01 << (8)) - 1)) << (16))) | ((unsigned int) (((unsigned int)(primColorResult->b) & ((0x01 << (8)) - 1)) << (8))) | ((unsigned int) (((unsigned int)((u8)(primColorResult->a * sMatAnimAlphaRatio)) & ((0x01 << (8)) - 1)) << (0)))); }} while (0);
    if (envColor != 0) {
        do {{ Gfx *_g = (Gfx *)(colorDList++); _g->words.w0 = ((unsigned int) (((unsigned int)(0xfb) & ((0x01 << (8)) - 1)) << (24))); _g->words.w1 = (unsigned int)((((unsigned int) (((unsigned int)(envColor->r) & ((0x01 << (8)) - 1)) << (24))) | ((unsigned int) (((unsigned int)(envColor->g) & ((0x01 << (8)) - 1)) << (16))) | ((unsigned int) (((unsigned int)(envColor->b) & ((0x01 << (8)) - 1)) << (8))) | ((unsigned int) (((unsigned int)(envColor->a) & ((0x01 << (8)) - 1)) << (0))))); }} while (0);
    }
    do {{ Gfx *_g = (Gfx *)(colorDList++); _g->words.w0 = ((unsigned int) (((unsigned int)(0xdf) & ((0x01 << (8)) - 1)) << (24))); _g->words.w1 = 0; }} while (0);
    } (void)0;
}
void SceneProc_DrawMatAnimColor(GlobalContext* globalCtx, u32 segment, void* params) {
    ...
    primColor += curFrame;
    envColor = (colorAnimParams->envColors != 0)
...
void SceneProc_DrawMatAnimColorLerp(GlobalContext* globalCtx, u32 segment, void* params) {
    ...
    SceneProc_SetColor(globalCtx, segment, &primColorResult, (envColorMax != 0) ? &envColorResult : 0);
}
f32 SceneProc_LagrangeInterp(s32 n, f32 x[], f32 fx[], f32 xp) {
    f32 weights[50];
    f32 xVal;
...
#pragma GLOBAL_ASM("./asm/non_matchings/code/z_scene_proc/SceneProc_DrawMatAnimColorNonLinearInterp.asm")
void SceneProc_DrawMatAnimTexCycle(GlobalContext* globalCtx, u32 segment, void* params) {
    ...
    { GraphicsContext* __gfxCtx = globalCtx->state.gfxCtx; s32 __dispPad;;
    if (sMatAnimFlags & 1) {
        do {{ Gfx *_g = (Gfx *)((__gfxCtx->polyOpa.p++)); _g->words.w0 = (((unsigned int) (((unsigned int)((0xdb)) & ((0x01 << (8)) - 1)) << (24))) | ((unsigned int) (((unsigned int)((0x06)) & ((0x01 << (8)) - 1)) << (16))) | ((unsigned int) (((unsigned int)(((segment)*4)) & ((0x01 << (16)) - 1)) << (0)))); _g->words.w1 = (unsigned int)(tex); }} while (0);
    }
    if (sMatAnimFlags & 2) {
        do {{ Gfx *_g = (Gfx *)((__gfxCtx->polyXlu.p++)); _g->words.w0 = (((unsigned int) (((unsigned int)((0xdb)) & ((0x01 << (8)) - 1)) << (24))) | ((unsigned int) (((unsigned int)((0x06)) & ((0x01 << (8)) - 1)) << (16))) | ((unsigned int) (((unsigned int)(((segment)*4)) & ((0x01 << (16)) - 1)) << (0)))); _g->words.w1 = (unsigned int)(tex); }} while (0);
    }
    } (void)0;
}
...
void SceneProc_SceneDrawConfig3(GlobalContext* globalCtx) {
    ...
    do {{ Gfx *_g = (Gfx *)((__gfxCtx->polyXlu.p++)); _g->words.w0 = (((unsigned int) (((unsigned int)((0xdb)) & ((0x01 << (8)) - 1)) << (24))) | ((unsigned int) (((unsigned int)((0x06)) & ((0x01 << (8)) - 1)) << (16))) | ((unsigned int) (((unsigned int)(((0x08)*4)) & ((0x01 << (16)) - 1)) << (0)))); _g->words.w1 = (unsigned int)(Gfx_TexScroll(globalCtx->state.gfxCtx, 0, (frames * 1) % 64, 256, 16)); }} while (0);
    do {{ Gfx *_g = (Gfx *)((__gfxCtx->polyXlu.p++)); _g->words.w0 = (((unsigned int) (((unsigned int)((0xdb)) & ((0x01 << (8)) - 1)) << (24))) | ((unsigned int) (((unsigned int)((0x06)) & ((0x01 << (8)) - 1)) << (16))) | ((unsigned int) (((unsigned int)(((0x09)*4)) & ((0x01 << (16)) - 1)) << (0)))); _g->words.w1 = (unsigned int)(Gfx_TwoTexScroll(globalCtx->state.gfxCtx, 0, 127 - (frames % 128), (frames * 1) % 128, 32, 32, 1, frames % 128, (frames * 1) % 128, 32, 32)); }} while (0);
    do {{ Gfx *_g = (Gfx *)((__gfxCtx->polyOpa.p++)); _g->words.w0 = (((unsigned int) (((unsigned int)((0xdb)) & ((0x01 << (8)) - 1)) << (24))) | ((unsigned int) (((unsigned int)((0x06)) & ((0x01 << (8)) - 1)) << (16))) | ((unsigned int) (((unsigned int)(((0x0A)*4)) & ((0x01 << (16)) - 1)) << (0)))); _g->words.w1 = (unsigned int)(Gfx_TwoTexScroll(globalCtx->state.gfxCtx, 0, 0, 0, 32, 32, 1, 0, 127 - (frames * 1) % 128, 32, 32)); }} while (0);
    do {{ Gfx *_g = (Gfx *)((__gfxCtx->polyOpa.p++)); _g->words.w0 = (((unsigned int) (((unsigned int)((0xdb)) & ((0x01 << (8)) - 1)) << (24))) | ((unsigned int) (((unsigned int)((0x06)) & ((0x01 << (8)) - 1)) << (16))) | ((unsigned int) (((unsigned int)(((0x0B)*4)) & ((0x01 << (16)) - 1)) << (0)))); _g->words.w1 = (unsigned int)(Gfx_TexScroll(globalCtx->state.gfxCtx, 0, (frames * 1) % 128, 32, 32)); }} while (0);
    do {{ Gfx *_g = (Gfx *)((__gfxCtx->polyXlu.p++)); _g->words.w0 = (((unsigned int) (((unsigned int)((0xdb)) & ((0x01 << (8)) - 1)) << (24))) | ((unsigned int) (((unsigned int)((0x06)) & ((0x01 << (8)) - 1)) << (16))) | ((unsigned int) (((unsigned int)(((0x0C)*4)) & ((0x01 << (16)) - 1)) << (0)))); _g->words.w1 = (unsigned int)(Gfx_TwoTexScroll(globalCtx->state.gfxCtx, 0, 0, (frames * 50) % 2048, 8, 512, 1, 0, (frames * 60) % 2048, 8, 512)); }} while (0);
    do {{ Gfx *_g = (Gfx *)((__gfxCtx->polyOpa.p++)); _g->words.w0 = (((unsigned int) (((unsigned int)((0xdb)) & ((0x01 << (8)) - 1)) << (24))) | ((unsigned int) (((unsigned int)((0x06)) & ((0x01 << (8)) - 1)) << (16))) | ((unsigned int) (((unsigned int)(((0x0D)*4)) & ((0x01 << (16)) - 1)) << (0)))); _g->words.w1 = (unsigned int)(Gfx_TwoTexScroll(globalCtx->state.gfxCtx, 0, 0, 0, 32, 64, 1, 0, (frames * 1) % 128, 32, 32)); }} while (0);
    do {{ Gfx *_g = (Gfx *)(__gfxCtx->polyXlu.p++); _g->words.w0 = ((unsigned int) (((unsigned int)(0xe7) & ((0x01 << (8)) - 1)) << (24))); _g->words.w1 = 0; }} while (0);
    do {{ Gfx *_g = (Gfx *)(__gfxCtx->polyXlu.p++); _g->words.w0 = ((unsigned int) (((unsigned int)(0xfb) & ((0x01 << (8)) - 1)) << (24))); _g->words.w1 = (unsigned int)((((unsigned int) (((unsigned int)(128) & ((0x01 << (8)) - 1)) << (24))) | ((unsigned int) (((unsigned int)(128) & ((0x01 << (8)) - 1)) << (16))) | ((unsigned int) (((unsigned int)(128) & ((0x01 << (8)) - 1)) << (8))) | ((unsigned int) (((unsigned int)(128) & ((0x01 << (8)) - 1)) << (0))))); }} while (0);
    do {{ Gfx *_g = (Gfx *)(__gfxCtx->polyOpa.p++); _g->words.w0 = ((unsigned int) (((unsigned int)(0xe7) & ((0x01 << (8)) - 1)) << (24))); _g->words.w1 = 0; }} while (0);
    do {{ Gfx *_g = (Gfx *)(__gfxCtx->polyOpa.p++); _g->words.w0 = ((unsigned int) (((unsigned int)(0xfb) & ((0x01 << (8)) - 1)) << (24))); _g->words.w1 = (unsigned int)((((unsigned int) (((unsigned int)(128) & ((0x01 << (8)) - 1)) << (24))) | ((unsigned int) (((unsigned int)(128) & ((0x01 << (8)) - 1)) << (16))) | ((unsigned int) (((unsigned int)(128) & ((0x01 << (8)) - 1)) << (8))) | ((unsigned int) (((unsigned int)(128) & ((0x01 << (8)) - 1)) << (0))))); }} while (0);
    } (void)0;
}
void SceneProc_DrawSceneConfig4(GlobalContext* globalCtx) {
    u32 frames;
    { GraphicsContext* __gfxCtx = globalCtx->state.gfxCtx; s32 __dispPad;;
    frames = globalCtx->unk18840;
    do {{ Gfx *_g = (Gfx *)((__gfxCtx->polyXlu.p++)); _g->words.w0 = (((unsigned int) (((unsigned int)((0xdb)) & ((0x01 << (8)) - 1)) << (24))) | ((unsigned int) (((unsigned int)((0x06)) & ((0x01 << (8)) - 1)) << (16))) | ((unsigned int) (((unsigned int)(((0x08)*4)) & ((0x01 << (16)) - 1)) << (0)))); _g->words.w1 = (unsigned int)(Gfx_TwoTexScroll(globalCtx->state.gfxCtx, 0, 127 - frames % 128, (frames * 1) % 128, 32, 32, 1, frames % 128, (frames * 1) % 128, 32, 32)); }} while (0);
    do {{ Gfx *_g = (Gfx *)(__gfxCtx->polyOpa.p++); _g->words.w0 = ((unsigned int) (((unsigned int)(0xe7) & ((0x01 << (8)) - 1)) << (24))); _g->words.w1 = 0; }} while (0);
    do {{ Gfx *_g = (Gfx *)(__gfxCtx->polyOpa.p++); _g->words.w0 = ((unsigned int) (((unsigned int)(0xfb) & ((0x01 << (8)) - 1)) << (24))); _g->words.w1 = (unsigned int)((((unsigned int) (((unsigned int)(128) & ((0x01 << (8)) - 1)) << (24))) | ((unsigned int) (((unsigned int)(128) & ((0x01 << (8)) - 1)) << (16))) | ((unsigned int) (((unsigned int)(128) & ((0x01 << (8)) - 1)) << (8))) | ((unsigned int) (((unsigned int)(128) & ((0x01 << (8)) - 1)) << (0))))); }} while (0);
    do {{ Gfx *_g = (Gfx *)(__gfxCtx->polyXlu.p++); _g->words.w0 = ((unsigned int) (((unsigned int)(0xe7) & ((0x01 << (8)) - 1)) << (24))); _g->words.w1 = 0; }} while (0);
    do {{ Gfx *_g = (Gfx *)(__gfxCtx->polyXlu.p++); _g->words.w0 = ((unsigned int) (((unsigned int)(0xfb) & ((0x01 << (8)) - 1)) << (24))); _g->words.w1 = (unsigned int)((((unsigned int) (((unsigned int)(128) & ((0x01 << (8)) - 1)) << (24))) | ((unsigned int) (((unsigned int)(128) & ((0x01 << (8)) - 1)) << (16))) | ((unsigned int) (((unsigned int)(128) & ((0x01 << (8)) - 1)) << (8))) | ((unsigned int) (((unsigned int)(128) & ((0x01 << (8)) - 1)) << (0))))); }} while (0);
...
void SceneProc_SetRenderModeXlu(GlobalContext* globalCtx, s32 index, u32 flags) {
    ...
    static Gfx renderModeSetXluSingleCycleDL[] = {
        { ((unsigned int) (((unsigned int)(0xe2) & ((0x01 << (8)) - 1)) << (24)))|((unsigned int) (((unsigned int)(32-(3)-(29)) & ((0x01 << (8)) - 1)) << (8)))|((unsigned int) (((unsigned int)((29)-1) & ((0x01 << (8)) - 1)) << (0))), (unsigned int)((0x8 | 0x10 | 0x40 | 0x80 | 0x100 | 0x800 | 0x4000 | (0) << 30 | (3) << 26 | (0) << 22 | (2) << 18) | (0x8 | 0x10 | 0x40 | 0x100 | 0x80 | 0x4000 | 0x800 | (0) << 28 | (0) << 24 | (1) << 20 | (0) << 16)) },
        { ((unsigned int) (((unsigned int)(0xdf) & ((0x01 << (8)) - 1)) << (24))), 0 },
        { ((unsigned int) (((unsigned int)(0xe2) & ((0x01 << (8)) - 1)) << (24)))|((unsigned int) (((unsigned int)(32-(3)-(29)) & ((0x01 << (8)) - 1)) << (8)))|((unsigned int) (((unsigned int)((29)-1) & ((0x01 << (8)) - 1)) << (0))), (unsigned int)((0x8 | 0x10 | 0x40 | 0x80 | 0x100 | 0x800 | 0x4000 | (3) << 30 | (2) << 26 | (0) << 22 | (0) << 18) | (0x8 | 0x10 | 0x40 | 0x100 | 0x80 | 0x4000 | 0x800 | (0) << 28 | (0) << 24 | (1) << 20 | (0) << 16)) },
        { ((unsigned int) (((unsigned int)(0xdf) & ((0x01 << (8)) - 1)) << (24))), 0 },
    };
    static Gfx renderModeSetXluTwoCycleDL[] = {
        { ((unsigned int) (((unsigned int)(0xe2) & ((0x01 << (8)) - 1)) << (24)))|((unsigned int) (((unsigned int)(32-(3)-(29)) & ((0x01 << (8)) - 1)) << (8)))|((unsigned int) (((unsigned int)((29)-1) & ((0x01 << (8)) - 1)) << (0))), (unsigned int)((0x8 | 0x10 | 0x20 | 0x40 | 0x80 | 0x100 | 0x800 | 0x4000 | (0) << 30 | (3) << 26 | (0) << 22 | (2) << 18) | (0x8 | 0x10 | 0x20 | 0x40 | 0x80 | 0x100 | 0x800 | 0x4000 | (0) << 28 | (0) << 24 | (1) << 20 | (0) << 16)) },
        { ((unsigned int) (((unsigned int)(0xdf) & ((0x01 << (8)) - 1)) << (24))), 0 },
        { ((unsigned int) (((unsigned int)(0xe2) & ((0x01 << (8)) - 1)) << (24)))|((unsigned int) (((unsigned int)(32-(3)-(29)) & ((0x01 << (8)) - 1)) << (8)))|((unsigned int) (((unsigned int)((29)-1) & ((0x01 << (8)) - 1)) << (0))), (unsigned int)((0x8 | 0x10 | 0x20 | 0x40 | 0x80 | 0x100 | 0x800 | 0x4000 | (3) << 30 | (2) << 26 | (0) << 22 | (0) << 18) | (0x8 | 0x10 | 0x20 | 0x40 | 0x80 | 0x100 | 0x800 | 0x4000 | (0) << 28 | (0) << 24 | (1) << 20 | (0) << 16)) },
        { ((unsigned int) (((unsigned int)(0xdf) & ((0x01 << (8)) - 1)) << (24))), 0 },
    };
    static Gfx* dLists[] = {
        renderModeSetNoneDL,
    ...
    { GraphicsContext* __gfxCtx = globalCtx->state.gfxCtx; s32 __dispPad;;
    if (flags & 1) {
        do {{ Gfx *_g = (Gfx *)((__gfxCtx->polyOpa.p++)); _g->words.w0 = (((unsigned int) (((unsigned int)((0xdb)) & ((0x01 << (8)) - 1)) << (24))) | ((unsigned int) (((unsigned int)((0x06)) & ((0x01 << (8)) - 1)) << (16))) | ((unsigned int) (((unsigned int)(((0x0C)*4)) & ((0x01 << (16)) - 1)) << (0)))); _g->words.w1 = (unsigned int)(dList); }} while (0);
    }
    if (flags & 2) {
        do {{ Gfx *_g = (Gfx *)((__gfxCtx->polyXlu.p++)); _g->words.w0 = (((unsigned int) (((unsigned int)((0xdb)) & ((0x01 << (8)) - 1)) << (24))) | ((unsigned int) (((unsigned int)((0x06)) & ((0x01 << (8)) - 1)) << (16))) | ((unsigned int) (((unsigned int)(((0x0C)*4)) & ((0x01 << (16)) - 1)) << (0)))); _g->words.w1 = (unsigned int)(dList); }} while (0);
    }
    } (void)0;
}
void SceneProc_SetCullFlag(GlobalContext* globalCtx, s32 index, u32 flags) {
    static Gfx setBackCullDL[] = {
        { (((unsigned int) (((unsigned int)(0xd9) & ((0x01 << (8)) - 1)) << (24)))|((unsigned int) (((unsigned int)(~(u32)(0)) & ((0x01 << (24)) - 1)) << (0)))),(u32)((0x00000400)) },
        { ((unsigned int) (((unsigned int)(0xdf) & ((0x01 << (8)) - 1)) << (24))), 0 },
    };
    static Gfx setFrontCullDL[] = {
        { (((unsigned int) (((unsigned int)(0xd9) & ((0x01 << (8)) - 1)) << (24)))|((unsigned int) (((unsigned int)(~(u32)(0)) & ((0x01 << (24)) - 1)) << (0)))),(u32)((0x00000200)) },
        { ((unsigned int) (((unsigned int)(0xdf) & ((0x01 << (8)) - 1)) << (24))), 0 },
    };
    static Gfx* dLists[] = {
        setBackCullDL,
...
void SceneProc_SceneDrawConfig5(GlobalContext* globalCtx) {
    ...
    if (alpha == 0) {
        ...
        do {{ Gfx *_g = (Gfx *)(__gfxCtx->polyOpa.p++); _g->words.w0 = ((unsigned int) (((unsigned int)(0xfb) & ((0x01 << (8)) - 1)) << (24))); _g->words.w1 = (unsigned int)((((unsigned int) (((unsigned int)(255) & ((0x01 << (8)) - 1)) << (24))) | ((unsigned int) (((unsigned int)(255) & ((0x01 << (8)) - 1)) << (16))) | ((unsigned int) (((unsigned int)(255) & ((0x01 << (8)) - 1)) << (8))) | ((unsigned int) (((unsigned int)(alpha) & ((0x01 << (8)) - 1)) << (0))))); }} while (0);
        do {{ Gfx *_g = (Gfx *)(__gfxCtx->polyXlu.p++); _g->words.w0 = ((unsigned int) (((unsigned int)(0xfb) & ((0x01 << (8)) - 1)) << (24))); _g->words.w1 = (unsigned int)((((unsigned int) (((unsigned int)(255) & ((0x01 << (8)) - 1)) << (24))) | ((unsigned int) (((unsigned int)(255) & ((0x01 << (8)) - 1)) << (16))) | ((unsigned int) (((unsigned int)(255) & ((0x01 << (8)) - 1)) << (8))) | ((unsigned int) (((unsigned int)(alpha) & ((0x01 << (8)) - 1)) << (0))))); }} while (0);
        } (void)0;
    }
}
void SceneProc_SceneDrawConfigMatAnimManualStep(GlobalContext* globalCtx) {
...
void SceneProc_SceneDrawConfigGreatBayTemple(GlobalContext* globalCtx) {
    static Gfx greatBayTempleColorSetDL[] = {
        { (((unsigned int) (((unsigned int)(0xfa) & ((0x01 << (8)) - 1)) << (24))) | ((unsigned int) (((unsigned int)(0) & ((0x01 << (8)) - 1)) << (8))) | ((unsigned int) (((unsigned int)(255) & ((0x01 << (8)) - 1)) << (0)))), (((unsigned int) (((unsigned int)(255) & ((0x01 << (8)) - 1)) << (24))) | ((unsigned int) (((unsigned int)(255) & ((0x01 << (8)) - 1)) << (16))) | ((unsigned int) (((unsigned int)(255) & ((0x01 << (8)) - 1)) << (8))) | ((unsigned int) (((unsigned int)(255) & ((0x01 << (8)) - 1)) << (0)))) },
        { ((unsigned int) (((unsigned int)(0xdf) & ((0x01 << (8)) - 1)) << (24))), 0 },
    };
    s32 lodFrac;
    s32 i;
    ...
    dList = (Gfx*)((globalCtx->state.gfxCtx)->polyOpa.d = (Gfx*)((u8*)(globalCtx->state.gfxCtx)->polyOpa.d - (sizeof(Gfx) * 18)));
    SceneProc_DrawMaterialAnim(globalCtx, globalCtx->sceneMaterialAnims);
    { GraphicsContext* __gfxCtx = globalCtx->state.gfxCtx; s32 __dispPad;;
    for (dListHead = dList, i = 0; i < 9; i++, dListHead += 2) {
        ...
        do {{ Gfx *_g = (Gfx *)(dListHead); _g->words.w0 = (((unsigned int) (((unsigned int)(0xfa) & ((0x01 << (8)) - 1)) << (24))) | ((unsigned int) (((unsigned int)(0) & ((0x01 << (8)) - 1)) << (8))) | ((unsigned int) (((unsigned int)(lodFrac) & ((0x01 << (8)) - 1)) << (0)))); _g->words.w1 = (((unsigned int) (((unsigned int)(255) & ((0x01 << (8)) - 1)) << (24))) | ((unsigned int) (((unsigned int)(255) & ((0x01 << (8)) - 1)) << (16))) | ((unsigned int) (((unsigned int)(255) & ((0x01 << (8)) - 1)) << (8))) | ((unsigned int) (((unsigned int)(255) & ((0x01 << (8)) - 1)) << (0)))); }} while (0);
    }
    do {{ Gfx *_g = (Gfx *)((__gfxCtx->polyOpa.p++)); _g->words.w0 = (((unsigned int) (((unsigned int)((0xdb)) & ((0x01 << (8)) - 1)) << (24))) | ((unsigned int) (((unsigned int)((0x06)) & ((0x01 << (8)) - 1)) << (16))) | ((unsigned int) (((unsigned int)(((0x06)*4)) & ((0x01 << (16)) - 1)) << (0)))); _g->words.w1 = (unsigned int)(dList); }} while (0);
    do {{ Gfx *_g = (Gfx *)((__gfxCtx->polyXlu.p++)); _g->words.w0 = (((unsigned int) (((unsigned int)((0xdb)) & ((0x01 << (8)) - 1)) << (24))) | ((unsigned int) (((unsigned int)((0x06)) & ((0x01 << (8)) - 1)) << (16))) | ((unsigned int) (((unsigned int)(((0x06)*4)) & ((0x01 << (16)) - 1)) << (0)))); _g->words.w1 = (unsigned int)(dList); }} while (0);
    } (void)0;
}
