...
void EnRecepgirl_Update(Actor* thisx, PlayState* play) {
    ...
    func_800E9250(play, (Actor *) this, this + 0x2AE, (Vec3s *) &sp30, (bitwise Vec3f) this->actor.focus.pos.x, this->actor.focus.pos.y, this->actor.focus.pos.z);
    func_80C100DC(this);
}
```
...
void EnRecepgirl_Update(Actor* thisx, PlayState* play) {
    ...
    this->actionFunc(this, play);
    func_800E9250(play, &this->actor, this + 0x2AE, (Vec3s *) &sp30, (bitwise Vec3f) this->actor.focus.pos.x, this->actor.focus.pos.y, this->actor.focus.pos.z);
    func_80C100DC(this);
}
```
...
```C
s32 func_800E9250(PlayState* play, Actor* actor, Vec3s* param_3, Vec3s* param_4, Vec3f param_5)
```
...
void EnRecepgirl_Update(EnRecepgirl* this, PlayState* play) {
    ...
    this->actionFunc(this, play);
    func_800E9250(play, &this->actor, &this->unk_2AE, &sp30, this->actor.focus.pos);
    func_80C100DC(this);
}
```
