...
wordReplace = {
    ...
    "play->actorCtx.targetCtx.unk4A": "play->actorCtx.targetCtx.arrowPointedActorCategory",
    ...
    "play->actorCtx.targetCtx.unk_94": "play->actorCtx.targetCtx.targetableOption",
