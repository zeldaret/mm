...
wordReplace = {
    ...
    "gSaveContext.isMagicAcquired": "gSaveContext.save.playerData.isMagicAcquired",
    "gSaveContext.isDoubleMagicAcquired": "gSaveContext.save.playerData.isDoubleMagicAcquired",
