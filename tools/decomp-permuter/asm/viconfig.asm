...
/* 000352 0x800805E0 27BDFFE8 */ addiu	$sp, $sp, -0X18
...
/* 000358 0x800805F8 11C00028 */ beqz	$t6, .L8008069C
/* 000359 0x800805FC 00000000 */ nop
/* 000360 0x80080600 8C420300 */ lw	$v0, %lo(osTvType)($v0)
/* 000361 0x80080604 24010001 */ li	$at, 0X1
/* 000362 0x80080608 3C048009 */ lui	$a0, %hi(osViModePalLan1)
/* 000363 0x8008060C 1040000B */ beqz	$v0, .L8008063C
/* 000364 0x80080610 00000000 */ nop
/* 000365 0x80080614 1041000D */ beq	$v0, $at, .L8008064C
/* 000366 0x80080618 3C048009 */ lui	$a0, %hi(osViModeNtscLan1)
/* 000367 0x8008061C 24010002 */ li	$at, 0X2
/* 000368 0x80080620 1441000A */ bne	$v0, $at, .L8008064C
...
/* 000373 0x80080634 10000007 */ b	.L80080654
...
/* 000377 0x80080644 10000003 */ b	.L80080654
...
/* 000383 0x8008065C 50800004 */ beqzl	$a0, .L80080670
...
/* 000393 0x80080684 45030029 */ bc1tl .L8008072C
...
/* 000397 0x80080694 10000025 */ b	.L8008072C
...
/* 000403 0x800806AC 10800003 */ beqz	$a0, .L800806BC
...
/* 000409 0x800806C4 50800004 */ beqzl	$a0, .L800806D8
...
/* 000419 0x800806EC 45010006 */ bc1t .L80080708
...
/* 000430 0x80080718 45030004 */ bc1tl .L8008072C
...
/* 000439 0x8008073C 27BD0018 */ addiu	$sp, $sp, 0X18
