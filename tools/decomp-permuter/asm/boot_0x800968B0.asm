...
/* 023062 0x800968B8 24840001 */ addiu	$a0, $a0, 0X1
/* 023063 0x800968BC 24A50001 */ addiu	$a1, $a1, 0X1
/* 023064 0x800968C0 10620003 */ beq	$v1, $v0, .L800968D0
/* 023065 0x800968C4 00403825 */ move	$a3, $v0
/* 023066 0x800968C8 03E00008 */ jr	$ra
/* 023067 0x800968CC 00E31023 */ subu	$v0, $a3, $v1
.L800968D0:
/* 023068 0x800968D0 5440FFF8 */ bnezl	$v0, .L800968B4
