...
glabel EnTorch_Init
/* 000000 0x80973550 27BDFFC8 */ addiu	$sp, $sp, -0X38
...
/* 000024 0x809735B0 24A41CA0 */ addiu	$a0, $a1, 0X1CA0
/* 000025 0x809735B4 24060006 */ li	$a2, 0X6
...
/* 000032 0x809735D0 27BD0038 */ addiu	$sp, $sp, 0X38
