...
if path.exists("baserom-decompressed.z64"):
    with open("baserom-decompressed.z64", mode="rb") as file:
...
print("Writing new ROM 'baserom-decompressed.z64'.")
with open("baserom-decompressed.z64", "wb") as file:
