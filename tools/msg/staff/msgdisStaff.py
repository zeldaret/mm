...
STAFF_MESSAGE_TABLE_ADDR = 0x12A048 # Location of Staff message table in baseroms/n64-us/segments/code
...
def main(outfile):
    ...
    buf = []
    with open("baseroms/n64-us/segments/staff_message_data_static", "rb") as f:
        buf = f.read()
