...
cmd_info = [
    ...
    ('MSCRIPT_CHECK_GORON', 0x03, '', '>h', (0,)),
    ('MSCRIPT_CHECK_ZORA', 0x03, '', '>h', (0,)),
    ('MSCRIPT_CHECK_DEKU', 0x03, '', '>h', (0,)),
    ('MSCRIPT_CHECK_HUMAN', 0x03, '', '>h', (0,)),
    ('MSCRIPT_CHECK_TEXT_CHOICE', 0x07, '', '>hhh', (0,1,2)),
    ('MSCRIPT_OFFER_ITEM', 0x05, '', '>Hh', (1,)),
    ('MSCRIPT_AUTOTALK', 0x03, '', '>h', (0,)),
    ('MSCRIPT_CHECK_RUPEES', 0x05, '', '>Hh', (1,)),
    ('MSCRIPT_CHECK_CALLBACK', 0x03, '', '>h', (0,)),
    ('MSCRIPT_CHECK_DAY', 0x0d, '', '>hhhhhh', (0,1,2,3,4,5)),
    ('MSCRIPT_AWAIT_TEXT_JUMP', 0x03, '', '>h', (0,)),
    ('MSCRIPT_AWAIT_TEXT', 0x01, '', '', ()),
    ('MSCRIPT_AWAIT_TEXT_END', 0x01, '', '', ()),
    ...
    ('MSCRIPT_CHECK_QUEST_ITEM', 0x05, '', '>Hh', (1,)),
    ('MSCRIPT_CHECK_EVENT_INF', 0x05, '', '>Hh', (1,)),
    ('MSCRIPT_SET_EVENT_INF', 0x03, '', '>H', ()),
    ('MSCRIPT_UNSET_EVENT_INF', 0x03, '', '>H', ()),
    ('MSCRIPT_CHECK_ITEM_ACTION', 0x09, '', '>Hhhh', (1,2,3)),
    ('MSCRIPT_CHECK_HAS_SONG', 0x05, '', '>Hh', (1,)),
    ('MSCRIPT_CHECK_WORN_MASK', 0x05, '', '>Hh', (1,)),
    ('MSCRIPT_CHECK_AFTER_TIME', 0x05, '', '>BBh', (2,)),
    ('MSCRIPT_CHECK_BEFORE_TIME', 0x05, '', '>BBh', (2,)),
    ('MSCRIPT_CHECK_SWITCH_FLAG', 0x05, '', '>Hh', (1,)),
    ('MSCRIPT_SET_SWITCH_FLAG', 0x03, '', '>H', ()),
    ('MSCRIPT_CHECK_ITEM', 0x05, '', '>Hh', (1,)),
    ('MSCRIPT_CHECK_BETWEEN_TIME', 0x07, '', '>BBBBh', (4,)),
    ('MSCRIPT_CHECK_IN_DAY', 0x05, '', '>Hh', (1,)),
    ('MSCRIPT_CHECK_CALLBACK_CONTINUE', 0x03, '', '>h', (0,)),
    ('MSCRIPT_CHECK_HAS_POWDER_KEG', 0x03, '', '>h', (0,)),
    ('MSCRIPT_DELETE_ITEM', 0x03, '', '>h', ()),
    ('MSCRIPT_CHECK_CALLBACK_MULTI', 0x07, '', '>hhh', (0,1,2)),
