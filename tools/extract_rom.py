...
TEXTURE_NAMES = {
    ...
    1114:'scene_texture_01', # Map Textures - Building Interiors I
    1115:'scene_texture_02', # Map Textures - Building Interiors II
    1116:'scene_texture_03', # Map Textures - Lost Woods
    1117:'scene_texture_04', # Map Textures - Mountains
    1118:'scene_texture_05', # Map Textures - Ocean
    1119:'scene_texture_06', # Map Textures - Swamp
    1120:'scene_texture_07',
    1121:'scene_texture_08', # Map Textures - Field
    1123:'title_static',
...
OVERLAY_NAMES = {
    ...
    383:'ovl_En_Bigokuta',
    384:'ovl_Bg_Icefloe',
    385:'ovl_fbdemo_triforce',
    386:'ovl_fbdemo_wipe1',
    387:'ovl_fbdemo_wipe3',
    388:'ovl_fbdemo_wipe4',
    389:'ovl_fbdemo_wipe5',
...
def GetFileName(index):
    tbls = [ SCENE_NAMES, OBJECT_NAMES, TEXTURE_NAMES, AUDIO_NAMES, MISC_NAMES, OVERLAY_NAMES, ASM_NAMES ]
    paths = [ "baserom/assets/scenes", "baserom/assets/objects", "baserom/assets/textures", "baserom/assets/audio", "baserom/assets/misc", "baserom/overlays", "baserom" ]

    for i in range(0, len(tbls)):
        tbl = tbls[i]
        if index in tbl:
            return [ tbl[index], paths[i] ]

    return [ "ERROR", "baserom" ]
...
if __name__ == '__main__':
    ...
    paths = [ "baserom", "baserom/assets", "baserom/assets/scenes", "baserom/assets/objects", "baserom/assets/textures", "baserom/assets/audio", "baserom/assets/misc", "baserom/overlays" ]
    for path in paths:
        try:
            os.mkdir(path)
        except:
    ...
    for i in range(0, file_count):
        ...
        if compressed:
            print('decompressing (' + str(i) + ') ' + filename + ", to " + outPath)
