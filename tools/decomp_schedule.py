...
cmdInfos: dict[str, CommandInfo] = {
    ...
    "SCHEDULE_CMD_CHECK_MISC_S":            CommandInfo(isBranch=True, needsToInvert=True),
    ...
    "SCHEDULE_CMD_CHECK_BEFORE_TIME_S":     CommandInfo(isBranch=True, needsToInvert=True),
    "SCHEDULE_CMD_CHECK_BEFORE_TIME_L":     CommandInfo(isBranch=True, needsToInvert=True),
