...
def bootstrap(ovl_path, ovl_text):
    ...
    with open(os.path.join(data_dir, ovl_name + "/" + ovl_name + ".data.s")) as f:
        data_text = f.read()
    ...
    effect_id = int(lines[1][28:], 16)
    init_func = lines[2][28:]
...
def get_header(header_path):
    ...
    ifndef = "#ifndef Z_EFF_SS_" + short_name.upper() + "_H\n" + \
             "#define Z_EFF_SS_" + short_name.upper() + "_H\n\n"
...
exclude = set(['/home/elliptic/oot-decomp/mm/tools/../tools/z64compress'])
