        ...
        try:
            ...
            if "Offset" in reselem.attrib:
                ...
                if offset_str.startswith(".+"):
                    ...
                    # TODO make resources offsets relative to start_offset rather than this hack
                    if "RangeStart" in fileelem.attrib and offset >= int(
                        fileelem.attrib["RangeStart"], 16
                    ):
                        offset -= int(fileelem.attrib["RangeStart"], 16)
            else:
                if prev_resource_end_offset is None:
                    raise Exception(
...
def _get_resource_handler(tag: str) -> ResourceHandler:
    ...
    resource_handlers = {
        ...
        "TextureAnimation": z64resources.handler_TextureAnimation,
        "KeyFrameAnimation": z64resources.handler_KeyFrameAnimation,
        "KeyFrameSkel": z64resources.handler_KeyFrameSkel,
    }
