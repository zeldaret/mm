...
def main():
    ...
    from tools.version import version_config
    from tools.buildtools import dmadata
    ...
    if 0:
        ...
        file_gIdentityMtx.add_resource(
            MtxResource(file_gIdentityMtx, 0, "gIdentityMtx")
        )
