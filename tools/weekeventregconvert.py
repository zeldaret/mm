...
weekEventReg = {
    ...
    (25 << 8) | 0x40: "WEEKEVENTREG_TALKED_FISHERMANS_SEAHORSE",
    (25 << 8) | 0x80: "WEEKEVENTREG_TALKED_FISHERMAN_AS_ZORA",
    (26 << 8) | 0x01: "WEEKEVENTREG_TALKED_FISHERMAN_AS_HUMAN",
    (26 << 8) | 0x02: "WEEKEVENTREG_26_02",
    (26 << 8) | 0x04: "WEEKEVENTREG_LOOKED_AT_PIRATE_POSTER",
    (26 << 8) | 0x08: "WEEKEVENTREG_RECEIVED_SEAHORSE",
    ...
    (27 << 8) | 0x40: "WEEKEVENTREG_POSTMAN_CHECKED_SOUTH_UPPER_CLOCKTOWN",
    (27 << 8) | 0x80: "WEEKEVENTREG_POSTMAN_CHECKED_NORTH_CLOCKTOWN",
    (28 << 8) | 0x01: "WEEKEVENTREG_POSTMAN_CHECKED_EAST_UPPER_CLOCKTOWN",
    (28 << 8) | 0x02: "WEEKEVENTREG_POSTMAN_CHECKED_EAST_LOWER_CLOCKTOWN",
    (28 << 8) | 0x04: "WEEKEVENTREG_POSTMAN_CHECKED_SOUTH_LOWER_CLOCKTOWN",
    (28 << 8) | 0x08: "WEEKEVENTREG_LETTER_TO_KAFEI_SCHEDULED_DAY_2",
    (28 << 8) | 0x10: "WEEKEVENTREG_LETTER_TO_KAFEI_SCHEDULED_DAY_3",
    ...
    (30 << 8) | 0x10: "WEEKEVENTREG_WORE_DEKU_MASK",
    (30 << 8) | 0x20: "WEEKEVENTREG_WORE_GORON_MASK",
    (30 << 8) | 0x40: "WEEKEVENTREG_WORE_ZORA_MASK",
    (30 << 8) | 0x80: "WEEKEVENTREG_WORE_FIERCE_DEITY_MASK",
    ...
    (50 << 8) | 0x01: "WEEKEVENTREG_HELPED_GORMAN_DAY_1",
    ...
    (51 << 8) | 0x02: "WEEKEVENTREG_LETTER_TO_KAFEI_SCHEDULED_TODAY",
    (51 << 8) | 0x04: "WEEKEVENTREG_HIT_LAUNDRY_POOL_BELL",
    (51 << 8) | 0x08: "WEEKEVENTREG_KAFEI_ENTRUSTED_LINK",
    ...
    (51 << 8) | 0x80: "WEEKEVENTREG_HELPED_GORMAN_DAY_2",
    ...
    (56 << 8) | 0x10: "WEEKEVENTREG_PLAYED_WIND_FISH_AS_HUMAN",
    (56 << 8) | 0x20: "WEEKEVENTREG_PLAYED_WIND_FISH_AS_DEKU",
    (56 << 8) | 0x40: "WEEKEVENTREG_PLAYED_WIND_FISH_AS_ZORA",
    (56 << 8) | 0x80: "WEEKEVENTREG_PLAYED_WIND_FISH_AS_GORON",
    ...
    (64 << 8) | 0x20: "WEEKEVENTREG_CAN_USE_CURIOSITY_SHOP_PEEPHOLE",
    ...
    (82 << 8) | 0x08: "WEEKEVENTREG_PLAYING_SWORDSMAN_MINIGAME ",
    ...
    (90 << 8) | 0x08: "WEEKEVENTREG_POSTMAN_RECEIVED_LETTER_TO_KAFEI",
    (90 << 8) | 0x10: "WEEKEVENTREG_RECEIVED_GOSSIP_STONE_GROTTO_HEART_PIECE",
    (90 << 8) | 0x20: "WEEKEVENTREG_PLAYING_FISHERMAN_JUMPING_GAME",
    (90 << 8) | 0x40: "WEEKEVENTREG_90_40",
    (90 << 8) | 0x80: "WEEKEVENTREG_90_80",
    (91 << 8) | 0x01: "WEEKEVENTREG_91_01",
    (91 << 8) | 0x02: "WEEKEVENTREG_91_02",
    (91 << 8) | 0x04: "WEEKEVENTREG_LETTER_TO_KAFEI_SENT_IN_TIME",
    (91 << 8) | 0x08: "WEEKEVENTREG_LETTER_TO_KAFEI_SENT_LATE",
